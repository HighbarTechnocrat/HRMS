        ...
        <div class="col-sm-12">
           ...
           <div class="row">
  			<div class="col-sm-3 team-box">
				 <a href='<%=ReturnUrl("pressreleaseOnCommunication")%>'><img src="Images/Gallery/Insidepages/Press Release.jpg" alt="Press Release" class="img-responsive"/></a>
				 <p>&nbsp</p>      
            </div>
			   <div class="col-sm-3 team-box">
				 <a href="http://localhost/hrms/ps/L7S11lAQzL9NKuo_x0byJg=="><img src="Images/Gallery/Insidepages/Interviews.jpg" alt="Interviews"   class="img-responsive"/></a>
			    <p>&nbsp</p>   
				 
			</div>
           <div class="col-sm-3 team-box">
				 <a href="http://localhost/hrms/financialresults.aspx"><img src="Images/Gallery/Insidepages/Financial Results.jpg" alt="Financial Results"  class="img-responsive"/></a>
			    <p>&nbsp</p>   
				 
			</div>
              <div class="col-sm-3 team-box">
				 <a href="http://localhost/hrms/annualreports.aspx"><img src="Images/Gallery/Insidepages/Annual Reports.jpg" alt="Annual Reports" class="img-responsive"/></a>
			    <p>&nbsp</p>   
