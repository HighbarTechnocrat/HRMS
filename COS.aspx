<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="COS.aspx.cs" Inherits="GalleryHome" %>
    ...
    <div class="auto-container">
        <div class="col-sm-12">
         <div class="sec-title wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
            <br />
                <h2>Policy & Procedure :  Corporate Office Services</h2>
            </div>
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href="http://localhost/hrms/emergencypreparedness">  <div style="border-color: transparent; padding: 110px 0px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/emergency.ico" height="100px"> </div>
                       <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Emergency Preprednes</span> </h4>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/emergencypreparedness">
                            <div class="right-arrow">+</div>
                            <h2>Emergency Preprednes</h2>
                        </a>
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/ohandsplanforheadoffice"> <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Headoffice.ico" width="100px"> </div>
                         <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">OHS Plan for HO</span> </h4>                      
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/ohandsplanforheadoffice">
                            <div class="right-arrow">+</div>
                            <h2>OHS Plan for HO</h2>
                        </a>
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/watermanagementplanforho"> <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/water.ico" width="100px"> </div>
                       <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Water Management Plan for HO</span> </h4>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/watermanagementplanforho">
                            <div class="right-arrow">+</div>
                            <h2>Water Management Plan for HO</h2>
                        </a>
