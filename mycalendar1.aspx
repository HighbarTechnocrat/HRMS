<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mycalendar1.aspx.cs" Inherits="mycalendar1" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/cms.master" AutoEventWireup="true" CodeFile="mycalendar1.aspx.cs" Inherits="eventcalendar" %>
    ...
    <div id="updatedialog" style="margin: 50px; display: none;"
        ...
        <table cellpadding="0" class="style1 updateevent">
            ...
            <asp:Panel ID="pnlupdtrem" runat="server">
                <tr class="startrtime">
                    <td class="alignRight">
                        <span class="reminder">Task Time:</span>
                    </td>
                    <td class="alignLeft">
               ...
               <%-- sagar added style="display:none" in below div for hiding display of select user 4jan2018 when adding new event--%>
...
<%--sagar added style="display:none" in below div for hiding select user display 4jan2018 when updating new event --%>
    ...
    <script type="text/javascript" defer="defer">
        ...
        $('#calendar').fullCalendar({
            ...
            editable: true,
            windowResize: true,//
            events: "<%=ReturnUrl("sitepathmain")%>MyJsonRes.ashx?id=" + $("#MainContent_hduser").val(),
