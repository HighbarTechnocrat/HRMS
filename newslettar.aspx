<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newslettar.aspx.cs" Inherits="newslettar" %>
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newsletters.aspx.cs" Inherits="newsletters" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="newslettar.aspx.cs" Inherits="newslettar" %>
            ...
            <span class="directoryreset">
                <asp:LinkButton ID="projectresetbtn" OnClick="lnkreset_Click" ToolTip="Reset Search"
                    TabIndex="4"><i class="fa fa-undo" aria-hidden="true"></i>
                            ...
                            <table>
                                <tr>
                                    <td class="new"><th>year</th>
                                    </td>
                                      <td class="new"><th>date</th>
                                    </td>
                                      <td class="new"><th>name</th>
                                    </td>
                                    </tr>
