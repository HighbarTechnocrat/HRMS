...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Policy & Procedure : Procedures</span> </div>
        ...
        <div class="col-sm-12">
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
			 ...
			 <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
            <a href="http://localhost/hrms/engineeringmanagement">
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/engineeringmanagement">
                            <div class="right-arrow">
                            <h2>Engineering Management</h2></div>
                        </a>
                ...
                <ul>
                    <li>
                        <a class="expand" href="IMSCommonProcedure.aspx">
                            <div class="right-arrow">
                            <h2>IMS Common Procedures</h2></div>
                        </a>
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/procurementandsubcontract">
                            <div class="right-arrow">
                            <h2>Procurement And Sub-Contract</h2></div>
                        </a>
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/humanresource"><div style="border-color: transparent; padding: 85px 20px 30px; background: #9b9b9b; min-height: 150px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/equipment"><div style="border-color: transparent; padding: 85px 31px 45px; background: #9b9b9b; min-height: 150px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">                        
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/contracts"><div style="border-color: transparent; padding: 85px 35px 45px; background: #9b9b9b; min-height: 150px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">                       
                ...
                <ul>
                    <li>
                        <a class="expand" ref="http://localhost/hrms/accountsfinanceandtaxation">
                            <div class="right-arrow">
                            <h2>Accounts, Finance & Taxation</h2></div>
                        </a>
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/centralprojectsplanningandmonitoring">
                            <div class="right-arrow">
                            <h2>Central Planning & Monitoring</h2></div>
                        </a>
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/cc">
                            <div class="right-arrow">
                            <h2>Corporate Communication</h2></div>
                        </a>                       
                    </li>
                </ul>
            </div>
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/cos">
                            <div class="right-arrow">
                            <h2>Corporate Office Services</h2></div>
                        </a>
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href="http://localhost/hrms/tara"> <div style="border-color: transparent; padding: 85px 47px 44px; background: #9b9b9b; min-height: 150px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">                        
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/siteprocedure"><div style="border-color: transparent; padding: 85px 20px 30px; background: #9b9b9b; min-height: 150px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">                       
