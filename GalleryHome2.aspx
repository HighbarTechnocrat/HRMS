...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Gallery</span> </div>
        ...
        <div class="col-sm-12" >
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/galleryphoto.aspx"> <div style="border-color: transparent; padding: 110px 78px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                      <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Photograph.png" height="100px"> </div>
                     <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Photographs</span> </h4>
           ...
           <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                         <a href="http://localhost/hrms/galleryphoto.aspx">                             
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/ps/ylAI0oJu7HJ7MQqa9fgC8w==">  <div style="border-color: transparent; padding: 113px 90px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/videos.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Videos</span> </h4>                       
