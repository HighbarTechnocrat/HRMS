<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="CustEscalationReport_Audit.aspx.cs" Inherits="CustEscalationReport_Audit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Customer Incident History Report"></asp:Label>
            </span>
        </div>
