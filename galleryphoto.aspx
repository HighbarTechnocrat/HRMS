...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <section class="markets">
        ...
        <div class="col-sm-12">
           <div class="userposts"><span>Photo Gallery</span> 
                <div class="comments-summery1">
               <span>
                     <a href='<%=ReturnUrl("gallaryhome")%>' style="font-size: small;" class="aaa" >Gallery</a>
                </span>  </div>   
           ...
           <div class="row">
  			<div class="col-sm-2 team-box">
				 <a  href='<%=ReturnUrl("HydroPower")%>'><img src="Images/Gallery/Insidepages/Hydro Power.jpg" class="img-responsive"/></a>
				 <p>&nbsp</p>      
            </div>
            <div class="col-sm-2 team-box" >
				 <a  href='<%=ReturnUrl("NuclearSpecialProjects")%>' ><img src="Images/Gallery/Insidepages/Nuclear & Special Projects.jpg" class="img-responsive"/></a>
				 <p>&nbsp</p>      
            </div>
			<div class="col-sm-2 team-box"  >
				 <a  href='<%=ReturnUrl("Transportation")%>'><img src="Images/Gallery/Insidepages/Transportation.jpg" class="img-responsive"></a>
			    <p>&nbsp</p> 			 
			</div>
            <div class="col-sm-2 team-box"  >
				 <a href='<%=ReturnUrl("WaterSolutions")%>' ><img src="Images/Gallery/Insidepages/Water Solutions.jpg" class="img-responsive"></a>
			    <p>&nbsp</p> 			 
			</div>
            <div class="col-sm-2 team-box"  >
				 <a  href='<%=ReturnUrl("BuildingsIndustrialPlants")%>'><img src="Images/Gallery/Insidepages/Buildings & Industrial Plants.jpg" class="img-responsive"></a>
			    <p>&nbsp</p> 			 
			</div>
         </div> 
		</div>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#myModal').on('show.bs.modal', function (e) {
            ...
            $(this).find('iframe').attr('src', 'http://www.youtube.com/embed/' + vid_id);
        });
    });
