...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Knowledge Center</span> </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/hrmsgroup.aspx"> <div style="border-color: transparent; padding: 110px 90px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                      <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/hrmsgroup.png" height="100px"> </div>
                     <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">HCC Group</span> </h4>
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/ho.aspx">  <div style="border-color: transparent; padding: 113px 90px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/whitepapers.aspx"><div style="border-color: transparent; padding: 113px 90px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Press.png" width="100px"> </div>
