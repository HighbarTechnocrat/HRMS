<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projectdetailc.aspx.cs" Inherits="projectdetailc" %>--%>

<%@ Page Language="C#" MasterPageFile="~/cms.master" AutoEventWireup="true" CodeFile="projectdetailc.aspx.cs" Inherits="projectdetailc" %>
            ...
            <div class="productsummerytitlenew">
                ...
                <asp:Repeater ID="rptrprojectdetail" runat="server">
                    <ItemTemplate>
						...
						<div class="projectstatusnew">
                             <span class="scopework">Completion Year : </span><div class="newdivp"><p><%# ((DateTime)DataBinder.Eval(Container, "DataItem.projectcompletedate")).ToString("yyyy")%></p> </div>
                        </div>
                            <div class="projdesc">
                                <p><%# DataBinder.Eval(Container, "DataItem.projectdescsmall")%> </p>
                            </div>

                            <div class="clientnew2">
                                <span class="scopework">Client:</span><p><%# DataBinder.Eval(Container, "DataItem.client")%></p>
                            </div>
                            <div class="clientvaluenew">
                                <span class="scopework">Value:</span><p><%# DataBinder.Eval(Container, "DataItem.Value")%> </p>
                            </div>
                            <div class="readmorenew2">
                                <span class="scopework">Scope Of Work:</span><div class="newdivp"><%# DataBinder.Eval(Container, "DataItem.projectdesclong")%></div>
                            </div>

                             <div class="projectstatusnew">
                               <span class="scopework">Project Status:</span><div class="newdivp"><%# DataBinder.Eval(Container, "DataItem.projectstatus")%> </div>
                           </div>
                ...
                <asp:Repeater ID="Repeater1" runat="server" Visible="false">
                    <ItemTemplate>
						...
						<h4 class="promanagertelephone1"><p><%# DataBinder.Eval(Container, "DataItem.designation")%></p></h4>
                            <img id="imgprofile2" runat="server" src='<%#getuserimage(Eval("projectimage")) %>' style="width: 150px; height: 150px" visible="true" />
                            <div class="managername">
                                <%--        <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.projectmanager")%>'></asp:Label><br/>
                                              <asp:Label ID="Label2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.telephoneno")%>' ></asp:Label>--%>
                                <h4 class="promanagername1"><%# DataBinder.Eval(Container, "DataItem.projectmanager")%></h4>
                                <h4 class="promanagertelephone1"><span></span><%# DataBinder.Eval(Container, "DataItem.telephoneno")%></h4>
                ...
                <asp:Panel ID="pnlimg" runat="server">
                    <div class="slidercouraselnew">
                        <p class="scopework12">Project Photograph:</p>
