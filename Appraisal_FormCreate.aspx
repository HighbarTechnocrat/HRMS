<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Appraisal_FormCreate.aspx.cs" Inherits="Appraisal_FormCreate" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View My Performance Appraisal Form"></asp:Label>
                    </span>
                </div>
                        ...
                        <Columns>
                          ...
                          <%--  <asp:BoundField HeaderText="From" 
                           ...
                           <asp:TemplateField HeaderText="Details" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" >
                            <ItemTemplate>
                            <asp:LinkButton ID="lnkLeaveDetails" runat="server" Visible="false" Text='View' OnClick="lnkLeaveDetails_Click">
                            </asp:LinkButton>
