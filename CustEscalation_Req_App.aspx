<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="CustEscalation_Req_App.aspx.cs" Inherits="CustEscalation_Req_App" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
		...
		#MainContent_btnbackA ,#MainContent_lnk_Update_Incident,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Customer First Incident "></asp:Label>
					</span>
				</div>
				<div>
				...
				<span runat="server" id="backToArr" visible="false">
					<a href="InboxCustEscalation_Arch.aspx" class="aaaa">Back</a>
				</span>
				<span>
				...
				<div class="edit-contact">
					...
					<ul id="editform" runat="server" visible="false">
						...
						<li class="mobile_inboxEmpCode">
							<span>Incident Description</span>&nbsp;&nbsp;<span style="color: red">*</span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtFirstDeacription" runat="server" TextMode="MultiLine" Rows="6" Width="188%" CssClass="noresize" Enabled="false"  onKeyUp="javascript:Count1(this);" ></asp:TextBox>
						</li>
						<li style="visibility: hidden"></li>
						<li class="mobile_grid">
							<span>Uploaded File</span>
							<br />
							<asp:FileUpload AutoComplete="off" ID="FileUpdate" Visible="false" runat="server" />
							<a href="#" onclick="return DownloadFileEmployee()"><span runat="server" id="lblCreateFile" class="ViewFiles"></span></a>
						</li>
						<li style="visibility: hidden"></li>
						<li class="mobile_inboxEmpCode" style="width: 100%;padding-top:20px;" runat="server" id="liupdate">
							<asp:LinkButton ID="lnk_Update_Incident" Visible="false" runat="server" Text="Update Incident" ToolTip="Update Incident" CssClass="Savebtnsve" OnClientClick="return SendForUpdate();" OnClick="lnk_Update_Incident_Click">Update Incident</asp:LinkButton>
							</li>
						...
						<li class="claimmob_fromdate" runat="server" id="ResponseTime">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtResponceDate" runat="server" AutoPostBack="true" class="OfferDates" OnTextChanged="txtResponceDate_TextChanged"></asp:TextBox>
						...
						<li class="claimmob_fromdate" runat="server" id="Delivery">
							...
							<br />
							<asp:TextBox AutoComplete="off" AutoPostBack="true" ID="txtDeliveryDate" runat="server" class="OfferDates" OnTextChanged="txtDeliveryDate_TextChanged" ></asp:TextBox>
						...
						<li class="claimmob_Amount" runat="server" id="empShow4">
							<span runat="server" id="lblActionAssginComment">Comment (Can be entered after discussion with employee/concerned person) </span>&nbsp;&nbsp;<span style="color: red">*</span>
							<br />
						...
						<%--<li class="claimmob_fromdate">
							<span runat="server" id="Span1">Action Date &nbsp;&nbsp;<span style="color:red">*</span></span>
                            <asp:TextBox AutoComplete="off" ID="TxtActionDate"  runat="server"></asp:TextBox>
						...
						<li class="claimmob_fromdate">
							<span runat="server" id="Span2">Action Title</span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <asp:TextBox AutoComplete="off" ID="txtActionTitle"  runat="server" Rows="4" TextMode="MultiLine" Width="84%" CssClass="noresize" onKeyUp="javascript:Count(this);"></asp:TextBox>
						</li>
						<li class="claimmob_fromdate">
							<span runat="server" id="Span3">Remarks</span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <asp:TextBox AutoComplete="off" ID="txtRemarks"  runat="server" Rows="4" TextMode="MultiLine" Width="84%" CssClass="noresize" onKeyUp="javascript:Count(this);"></asp:TextBox>
						</li>
						<li class="claimmob_fromdate">
							<span runat="server" id="Span4"> Task Completed</span>&nbsp;&nbsp;<span style="color:red"></span>
                            <asp:CheckBox  ID="ckckTask" runat="server" />
						...
						<li class="mobile_inboxEmpCode" style="width: 100%" runat="server" id="empShow6">
							<asp:LinkButton ID="service_btnAssgine" Visible="false" runat="server" Text="Assign Incident" ToolTip="Assign Incident" CssClass="Savebtnsve" OnClientClick="return SendForAssigne();" OnClick="service_btnAssgine_Click">Assign Incident</asp:LinkButton>
							...
							<asp:LinkButton ID="service_btnEscelateToHOD" Visible="false" runat="server" Text="Escelate to HOD" ToolTip="Escelate to HOD" CssClass="Savebtnsve" Style="display:none" OnClick="service_btnEscelateToHOD_Click" OnClientClick="return SendForHOD();">Escelate to HOD</asp:LinkButton>
							...
							<asp:LinkButton ID="mobile_btnPrintPV" runat="server" Text="Update Response" Visible="false" ToolTip="Update Response" CssClass="Savebtnsve" OnClick="mobile_btnPrintPV_Click" OnClientClick="SendForResponse()">Update Response</asp:LinkButton>
	...
	<div class="mobile_Savebtndiv">
		<asp:Panel ID="PnlIrSheet" runat="server" CssClass="IRmodalPopup" Style="display: none" Height="400px">
			<div id="Div2" runat="server" style="max-height: 500px;">
				...
				<table class="TLQuestio">
					<tr>
						<td>
							...
							<asp:TextBox AutoComplete="off" ID="TxtActionDate" runat="server" AutoPostBack="true" CssClass="OfferDates" OnTextChanged="TxtActionDate_TextChanged"></asp:TextBox>
							<ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" TargetControlID="TxtActionDate"
								runat="server">
							</ajaxToolkit:CalendarExtender>
						</td>
				...
				<hr />
				<div>
					<asp:LinkButton ID="mobile_btnSave" runat="server" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click" OnClientClick="return ActionMultiClick();">Submit</asp:LinkButton>
				</div>
				<br />
				<div class="IRSheetBtn">
					<asp:LinkButton ID="trvldeatils_delete_btn" runat="server" ToolTip="Back" CssClass="Savebtnsve" OnClick="trvldeatils_delete_btn_Click">Back</asp:LinkButton>
				</div>
			</div>
		</asp:Panel>
	...
	<asp:HiddenField ID="hdnApporvalType" runat="server" />
	...
	<script type="text/javascript">
		...
		function SendForUpdate() {
			try {
				var msg = "Are you sure you want to update incident?";
				var retunboolean = true;
				var ele = document.getElementById('<%=lnk_Update_Incident.ClientID%>');
		...
		function SendForSPOC() {
			try {
				var msg = "Are you sure you want to sent back to Coordinator?";//To Be Change
				var retunboolean = true;
		...
		function SendForResponse() {
			try {
				var msg = "Are you sure you want to Update this Response ?";//To Be Change
				var retunboolean = true;
		...
		function ClearAction()
		{
			...
			document.getElementById("<%=txtTaskCompletedDate.ClientID%>").value = "";		
			...
			$("#MainContent_ModalPopupExtenderIRSheet").dialog("Close");
			//$('#MainContent_ModalPopupExtenderIRSheet_foregroundElement')
		}
