<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="OrganizationalKnowledage.aspx.cs" Inherits="GalleryHome" %>
    ...
    <div class="auto-container">
        <div class="col-sm-12">
             <div class="sec-title wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
                <br />
                <h2>Policy & Procedure : Organizational Knowledge</h2>
            </div>
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 325px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <a href="http://localhost/hrms/organizationalknowledgeenggmanagement"><div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/power.png"> </div><br />
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        ...
                        <div class="detail">
                                  <a href="http://localhost/hrms/organizationalknowledgeenggmanagement">
                                    Engg Management</a>                                   
                        </div>
                    </li>
                </ul>
            ...
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 325px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <a href="http://localhost/hrms/organizationalknowledgefinanceandaccounts"> <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/transportaion.png"> </div><br />
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        ...
                        <div class="detail">
                            <a href="http://localhost/hrms/organizationalknowledgefinanceandaccounts">
            ...
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 325px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <a href="http://localhost/hrms/organizationalknowledgecorporateofficeservices">  <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/water.png"> </div><br />
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        ...
                        <div class="detail">
                        <a href="http://localhost/hrms/organizationalknowledgecorporateofficeservices">
                                   Corporate Office Services   </a>
                        </div>
                    </li>
                </ul>
            </div>
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 325px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <a href="http://localhost/hrms/organizationalknowledgecorporatesocialresponsibility"> <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/industrial-building.png" > </div><br /><br />
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 15px !important;nowrap"> <span class="cshero-title-main">Corporate Social Responsibility</span> </h4>
                         </div></a>
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        ...
                        <div class="detail">
                              <a href="http://localhost/hrms/organizationalknowledgecorporatesocialresponsibility">
            ...
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 325px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" style="min-height: 107px; width: 100px;" src="Images/Gallery/My Videos.ico"> </div><br />
                       <a href="http://localhost/hrms/organizationalknowledgecontracts">  <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">Contracts</span> </h4> </a>                      
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        ...
                        <div class="detail">
                              <a href="http://localhost/hrms/organizationalknowledgecontracts">
                                  Contracts                          </a>
                        </div>
                    </li>
                </ul>
