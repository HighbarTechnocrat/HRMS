<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Attend_Req.aspx.cs" Inherits="Attend_Req" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Regularize : On Duty / Work From Home"></asp:Label>
                    </span>
...
<%--                        <div class="cancelbtndiv">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="upload">
                            ...
                            <asp:UpdatePanel Visible="false" ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                        ...
                        <li>                                                         
                            <span id="idspnreasnforCancellation" visible="false" runat="server">Reason for Leave Cancellation </span>
                            <br />
                            <asp:TextBox ID="txtLeaveCancelReason" Visible="false" AutoComplete="off" runat="server" MaxLength="30"></asp:TextBox>
                        </li>
...
<%--                       <li>
    ...
    <div>
        ...
        <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/MyAttend_Req.aspx">Back</asp:LinkButton>
