                ...
                <div class="edit-contact">
                    ...
                    <li class="trvl_local" style="width: 89%;">                       
                     <span>Agreed Targets</span> <br /><br />
                      <%--      <asp:TextBox AutoComplete="off" ID="txtKRA" runat="server" MaxLength="150" height="50" TextMode="MultiLine"></asp:TextBox>--%>
                     </li>

                     <li class="trvl_local" style="width: 89%;">                       
                         <span>Description</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                          <br/><asp:TextBox placeholder="Maximum 256 characters, please attach additional sheet, if required" AutoComplete="off" ID="txtDescription" runat="server" height="100" TextMode="MultiLine"  onkeyup="ValidateLimit(this,300);" ></asp:TextBox>
                     </li>
                    <%-- <li class="trvl_local" style="width: 89%;">                       
                    ...
                    <%-- <li class="trvl_local"> 
                     ...
                     <li class="trvl_local">
                        <span>Points Allotted</span>&nbsp;&nbsp;<span style="color:red">*</span>
                         <asp:TextBox AutoComplete="off" ID="txtpointsAlloted" runat="server" MaxLength="3" ></asp:TextBox>
                     </li>
                    <li class="trvl_local">
                        <span id="Span6" runat="server">Revised : Points Allotted</span>
                         <asp:TextBox AutoComplete="off" ID="txtRevisedpointsAlloted" runat="server" MaxLength="3" ></asp:TextBox>
                     </li>
...
<%--                     <li class="claimmob_fromdate">
                    ...
                    <li class="trvl_local" style="width: 89%;" runat="server" id="lireviewee2">
                        <%--<span>Reason For Deviation</span>--%>
                         <span>Description</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                        <br />  <asp:TextBox placeholder="Maximum 256 characters, please attach additional sheet, if required" AutoComplete="off" ID="txtTargetAchDescription" runat="server"  height="100" TextMode="MultiLine" onkeyup="ValidateLimit(this,300);"></asp:TextBox>
                     </li>
                   
                     <li class="trvl_local" runat="server" id="lireviewee3">
                        <span>Points Achieved</span>&nbsp;&nbsp;<span style="color:red">*</span>
                         <asp:TextBox AutoComplete="off" ID="txtTargetAchPointAlloted" runat="server" MaxLength="3" ></asp:TextBox>
                     </li> <li class="trvl_local">
                        <span id="Span7" runat="server"><%--Revised : Points Achieved--%></span>
                         <asp:TextBox AutoComplete="off" ID="txtRevisedPointAchieved" runat="server" MaxLength="3" ></asp:TextBox>
                     </li>
                     <li class="trvl_local"  style="width: 89%;" runat="server" id="lireviewee4">
                        <span runat="server" id="spanuploadfile" >Upload File</span><br />
                        <span runat="server" id="spanuploadfiletext" style="background-color:#f2f2f2;font-size:10px">Attach additional sheet, if required.<br /> Maximum 3 files in PDF, Word or Excel format can be uploaded. The total files size should not exceed 10 MB.<br />
                            </span><br />
