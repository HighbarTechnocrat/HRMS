    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-sm-12">
             ...
             <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                     <div style="border-color: transparent; padding: 120px 60px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <a href="http://localhost/hrms/HR_Policies.aspx">  <div class="cshero-fancybox-inner">
            ...
            <div class="knowledageCenter wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 120px 60px 23px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                      <a href="http://localhost/hrms/HR_HolidayList.aspx"><div class="cshero-fancybox-inner">
