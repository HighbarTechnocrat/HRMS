...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-sm-12">
                ...
                <ul>
                    <li>
                        <a class="expand" href='<%=ReturnUrl("IMSonprocedure") %>'>
                            ...
                            <h2>Integrated Management System</h2></div>
                        </a>                       
                    </li>
                </ul>
            </div>
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href='<%=ReturnUrl("HRonprocedure") %>'>  <div style="border-color: transparent; padding: 113px 35px 30px; background: #9b9b9b; min-height: 319px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                      <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br /><br />
                ...
                <ul>
                    <li>
                        <a class="expand" href='<%=ReturnUrl("CConprocedure")%>'>
                            <div class="right-arrow">
                            <h2>Corporate Communications</h2></div>
                        </a>
                ...
                <ul>
                    <li>
                        <a class="expand" href='<%=ReturnUrl("CSRonprocedure")%>'>
                            <div class="right-arrow">
                            <h2>Corporate Social Responsibility</h2></div>
                        </a>
            ...
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href='<%=ReturnUrl("policiesonprocedure")%>'><div style="border-color: transparent; padding: 113px 30px 30px; background: #9b9b9b; min-height: 320px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br /><br />
