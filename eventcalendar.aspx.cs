...
public partial class eventcalendar : System.Web.UI.Page
{
    ...
    public static string UpdateEvent(CalendarEvent cevent)
    {
        ...
        if (idList != null && idList.Contains(cevent.id))
        {
            ...
            {
                EventDAO.updateEvent(username,cevent.id, cevent.title, cevent.description, Convert.ToDateTime(cevent.start.ToShortDateString() + " " + DateTime.Now.ToString("HH:mm:ss tt")), Convert.ToDateTime(cevent.end.ToShortDateString() + " " + DateTime.MaxValue.ToString("HH:mm:ss tt")),"","","");
    ...
    public static int addEvent(ImproperCalendarEvent improperEvent)
    {
        ...
        CalendarEvent cevent = new CalendarEvent()
        {
            title = improperEvent.title,
            description = improperEvent.description,
            start = Convert.ToDateTime(improperEvent.start + " " + DateTime.Now.ToString("HH:mm:ss tt")),
            end = Convert.ToDateTime(improperEvent.end + " " + DateTime.Now.ToString("HH:mm:ss tt")),
