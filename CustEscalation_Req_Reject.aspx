<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="CustEscalation_Req_Reject.aspx.cs" Inherits="CustEscalation_Req_Reject" %>
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<span runat="server" id="backToArr" visible="true">
					<a href="InboxCustEscalationApp.aspx" class="aaaa">Back</a>
				</span>
				<span>
				...
				<div class="edit-contact">
					...
					<ul id="editform" runat="server" visible="false">
						...
						<li class="mobile_date" runat="server" id="empShow1">
							<span><b runat="server" id="lblAssgineTitle">Closure Confirmation  Details </b></span>
							<br />
						...
						<li class="claimmob_fromdate" runat="server" id="Delivery">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtDeliveryDate" runat="server" class="OfferDates"></asp:TextBox>
						...
						<li class="mobile_inboxEmpCode" style="width: 100%" runat="server" id="empShow6">
							...
							<asp:LinkButton ID="Service_Approval" runat="server" Text="Approve" ToolTip="Approve" CssClass="Savebtnsve" OnClick="Service_Approval_Click" OnClientClick="SendForCEO()">Approve</asp:LinkButton>
							<asp:LinkButton ID="Customer_Reject" runat="server" Text="Reject" Visible="true" ToolTip="Reject" CssClass="Savebtnsve" OnClick="Customer_Reject_Click" OnClientClick="SendForReject()">Reject</asp:LinkButton>
				...
				<table class="TLQuestio">
					<tr>
						<td>
							...
							<asp:TextBox AutoComplete="off" ID="TxtActionDate" runat="server" Enabled="false"></asp:TextBox>
					...
					<tr>
						<td>
							...
							<asp:TextBox AutoComplete="off" ID="txtActionTitle" runat="server" Rows="4" TextMode="MultiLine" Width="80%" CssClass="noresize" Enabled="false" onKeyUp="javascript:Count(this);"></asp:TextBox>
						</td>
						<td>
							<span runat="server" id="Span3" class="Actiontd">Remarks&nbsp;&nbsp;<span style="color: red">*</span></span>
							<asp:TextBox AutoComplete="off" ID="txtRemarks" runat="server" Rows="4" TextMode="MultiLine" Width="80%" CssClass="noresize" Enabled="false" onKeyUp="javascript:Count(this);"></asp:TextBox>
						</td>
					</tr>
					<tr>
						<td>
							<span runat="server" id="Span4" class="Actiontd">Task Completed (Yes/No)</span>&nbsp;&nbsp;<span style="color: red"></span>
							<asp:CheckBox ID="ckckTask" runat="server" CssClass="Actiontd" Enabled="false" />

						</td>
						
							<td>
							<span runat="server" id="TaskDate1" class="Actiontd" visible="false">Task Completed Date &nbsp;&nbsp;<span style="color: red">*</span></span>
							<asp:TextBox AutoComplete="off" ID="txtTaskCompletedDate" runat="server" Visible="false" CssClass="OfferDates"  Enabled="false" ></asp:TextBox>
							<ajaxToolkit:CalendarExtender ID="CalendarExtender4" Format="dd/MM/yyyy" TargetControlID="txtTaskCompletedDate" 
								runat="server">
							</ajaxToolkit:CalendarExtender>
