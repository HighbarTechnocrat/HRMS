...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Policy & Procedure : Organizational Knowledge</span> </div>
        ...
        <div class="col-sm-12">
             ...
             <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/organizationalknowledgeenggmanagement"><div style="border-color: transparent; padding: 113px 28px 30px; background: #9b9b9b; min-height: 319px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
                        ...
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">Engg Management</span> </h4>                      
                    </div>
                </div></a>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/organizationalknowledgeenggmanagement">
                            <div class="right-arrow"></div>
                            <h2>Engg Management</h2>
                        </a>                       
                    </li>
                </ul>
            </div>
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href="http://localhost/hrms/organizationalknowledgefinanceandaccounts">  <div style="border-color: transparent; padding: 113px 35px 30px; background: #9b9b9b; min-height: 319px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                      <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br />><br />
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">Finance And Accounts   </span> </h4>                                          
                    </div>
                </div></a>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/organizationalknowledgefinanceandaccounts">
                            <div class="right-arrow"></div>
            ...
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/organizationalknowledgecorporateofficeservices"><div style="border-color: transparent; padding: 113px 20px 30px; background: #9b9b9b; min-height: 320px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br /><br />
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/organizationalknowledgecorporateofficeservices">
                            <div class="right-arrow"></div>
            ...
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/organizationalknowledgecorporatesocialresponsibility"><div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 320px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br /><br />
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/organizationalknowledgecorporatesocialresponsibility">
                            <div class="right-arrow">+</div>
            ...
            <div class="PolicyProcedure wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/organizationalknowledgecontracts"><div style="border-color: transparent; padding: 113px 46px 65px; background: #9b9b9b; min-height: 320px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div><br />
                         <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">Contracts</span> </h4>                                               
                    </div>
                </div></a>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand"  href="http://localhost/hrms/organizationalknowledgecontracts">
                            <div class="right-arrow">+</div>
                            <h2>Contracts</h2>
                        </a>
