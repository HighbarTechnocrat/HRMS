                    ...
                    <ul id="editform" runat="server" visible="false">
                      <%--  <li class="mobile_inboxEmpCode">
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_Meeting_Type" AppendDataBoundItems="false" AutoPostBack="false" OnSelectedIndexChanged="ddl_Meeting_Type_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li></li>
                        <hr />
                        ...
                        <li>
                           ...
                           <asp:DropDownList  runat="server" ID="ddl_Organizer"  AppendDataBoundItems="false" AutoPostBack="false" >
                            </asp:DropDownList>
						</li>
						...
						<li id="liAttendees"  runat="server"  >
                            ...
                            <asp:ListBox SelectionMode="Multiple" runat="server" ID="ddl_Attendees"  AppendDataBoundItems="false" AutoPostBack="false" OnSelectedIndexChanged="ddl_Attendees_SelectedIndexChanged">
                            </asp:ListBox>
                        </li>
                        ...
                        <li style="width:100%"> <asp:Label runat="server" ID="id2" Style="color: blue; font-size: 16px; font-weight: 500; text-align: center;">Note : Please click on below submit button at the bottom to save or update the changes. </asp:Label><br /><br />
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_Task_Supervisor" AppendDataBoundItems="false" AutoPostBack="true" OnSelectedIndexChanged="ddl_Meeting_Type_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li class="mobile_InboxEmpName">
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_Task_Executor" AppendDataBoundItems="false" AutoPostBack="false" OnSelectedIndexChanged="ddl_Meeting_Id_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                         <li class="mobile_InboxEmpName">
                        ...
                        <li style="width:100%;text-align:center">
                            <br />
                            <br />
                            <asp:LinkButton ID="lnk_Final_Submit" Visible="true" runat="server" Text="Submit" ToolTip="Submit" OnClientClick="return FinalSubmitClick();" CssClass="Savebtnsve" OnClick="lnk_Final_Submit_Click"></asp:LinkButton>
                        </li>
                        <li></li>
                    </ul>
                </div>
