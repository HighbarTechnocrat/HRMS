...
/// <summary>
/// Summary description for EventDAOS
/// </summary>
public class EventDAOS
{
    ...
    public static List<CalendarEvent> getEvents()
    {
        ...
        DataTable dtp = classcategory.geteventsbycatidsdisplayhome(Convert.ToString(ConfigurationManager.AppSettings["EventM"].ToString().Trim()));
    ...
    public static List<CalendarEvent> getMyEvents(string username)
    {
        ...
        //Remove for online
        DataTable dtp = classcategory.getmyevents(Convert.ToString(ConfigurationManager.AppSettings["EventM"].ToString().Trim()), username);
    ...
    public static int addEvent(CalendarEvent cevent, string username)
    {
        ...
        if (key > 0)
        {
            ...
            classproduct.addcategorytoproduct((Convert.ToInt32(topid1)), Convert.ToInt32(ConfigurationManager.AppSettings["EventM"].ToString().Trim()));
