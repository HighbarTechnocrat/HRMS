<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TravelDeskAccomodation.aspx.cs" Inherits="TravelDeskAccomodation" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="Accomodation_trip">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtTripId" runat="server" Visible="True"></asp:TextBox>
                        ...
                        <li class="Accomodation_location">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtLocation" runat="server" CssClass="Dropdown"></asp:TextBox>
                        ...
                        <li class="Accomodation_type" >
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtAcctype" runat="server" CssClass="Dropdown" Visible ="True"></asp:TextBox>
                            <asp:Panel ID="Panel4" Style="display: none;" runat="server" CssClass="taskparentclasskkk">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:ListBox ID="lstAccType" runat="server" CssClass="taskparentclasskkk" AutoPostBack="true" OnSelectedIndexChanged="lstAccType_SelectedIndexChanged">
                            ...
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender3" PopupControlID="Panel4" TargetControlID="txtAcctype"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>
                        </li>
                        <%--<li></li>--%>
    ...
    <script type="text/javascript">
        ...
        function SetCntrls(Deviation) {
            ...
            if (Deviation == "Booked") {
                ...
                document.getElementById("<%=txtAcctype.ClientID%>").disabled = false
                document.getElementById("<%=txtAcctype.ClientID%>").style.backgroundColor = "#ffffff"; // backcolor
            }
            else {
                ...
                document.getElementById("<%=txtAcctype.ClientID%>").disabled = true
                document.getElementById("<%=txtAcctype.ClientID%>").value = "";
                document.getElementById("<%=txtAcctype.ClientID%>").style.backgroundColor = "#ebebe4"; // backcolor
            }
            return;
        }

        function validateTripType(Deviation) {
