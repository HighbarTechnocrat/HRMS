<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="MyTravelRequisitions.aspx.cs" 
    Inherits="procs_MyTravelRequisitions" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts"><br />
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Travel Requisitions"></asp:Label>
                    </span>
                </div>
  ...
  <span>
                ...
                <div class="edit-contact" style="display:none">
                    ...
                    <asp:GridView ID="TravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="Trvl_Req_ID,trvl_Req_status" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false" PageSize="10" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" OnSelectedIndexChanged="gvMngTravelRqstList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Travel Requisition Creation Date"
                                DataField="CreatedOn"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
