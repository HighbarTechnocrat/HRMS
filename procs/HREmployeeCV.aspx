<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="HREmployeeCV.aspx.cs"
    MaintainScrollPositionOnPostback="true"
    Inherits="procs_HREmployeeCV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="Ul1" runat="server">
                          <li  style="padding-left:200px">
                           <span>Search By Employee Code</span>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        <li class="mobile_inboxEmpCode">
                            <span><b>Employee CV Details</b></span><br />
                            <br />
                        ...
                        <li class="mobile_inboxEmpCode">
                         ...
                         <li>
                            ...
                            <br />
                            <asp:CheckBox Visible="false" AutoComplete="off" AutoPostBack="false" ID="chk_Passport" OnCheckedChanged="chk_Passport_CheckedChanged1" runat="server"></asp:CheckBox>
                       ...
                       <li ><br />
                         ...
                         <li style="margin-top: 10px;">
                            ...
                            <asp:LinkButton ID="lnk_Update_Profile" Visible="true" runat="server" Text="Update" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveProfileClick();" OnClick="lnk_Update_Profile_Click"></asp:LinkButton>
                        <br />
                              <br />
                         </li>
                        <li>
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_Degree" AutoPostBack="false" OnSelectedIndexChanged="ddl_Degree_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li>
                            <br />
                       ...
                       <li>
                        ...
                        <li>
                            ...
                            <asp:DropDownList runat="server" ID="ddl_Stream" AutoPostBack="false" OnSelectedIndexChanged="ddl_Board_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li>
                        ...
                        <li></li>
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_ed_Save" Visible="true" runat="server" Text="Save" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveEDClick();" OnClick="lnk_ed_Save_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_ed_Update" Visible="false" runat="server" Text="Update" ToolTip="Update" CssClass="Savebtnsve" OnClientClick="return SaveED2Click();" OnClick="lnk_ed_Save_Click"></asp:LinkButton>
                        ...
                        <li class="mobile_inboxEmpCode" style="width:60% !important;">
                            <span><b>Certification Details</b></span><span style="color:red"> (Note: Please upload your certificate copy)</span><br /><br />
                        </li>
                        <li>
                        ...
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_CD_Save" Visible="true" runat="server" Text="Save" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveCDClick();" OnClick="lnk_CD_Save_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_CD_Update" Visible="false" runat="server" Text="Update" ToolTip="Update" CssClass="Savebtnsve" OnClientClick="return SaveCD2Click();" OnClick="lnk_CD_Save_Click"></asp:LinkButton>
                        ...
                        <li class="mobile_inboxEmpCode" style="width: 100% !important">
                            ...
                            <span><b>Professional Experience </b></span><span>(Note: Please ensure you fill your experience in ascending order starting from current project at Highbar)</span>
                            <br />
                        ...
                        <li>
                            ...
                            <asp:DropDownList runat="server" ID="ddl_PD_OrgName" AutoPostBack="false" OnSelectedIndexChanged="ddl_PD_ProjectType_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>                       
                        <li>
                            <br />
                      ...
                      <li>
                        ...
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_PD_Save" Visible="true" runat="server" Text="Save" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SavePDClick();" OnClick="lnk_PD_Save_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_PD_Update" Visible="false" runat="server" Text="Update" ToolTip="Update" CssClass="Savebtnsve" OnClientClick="return SavePD2Click();" OnClick="lnk_PD_Save_Click"></asp:LinkButton>
                        ...
                        <li>
                            ...
                            <asp:DropDownList runat="server" ID="ddl_DD_OrgName" AutoPostBack="false" OnSelectedIndexChanged="ddl_PD_ProjectType_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li>
                            <br />
                      ...
                      <li>
                       ...
                       <li></li>
                        ...
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_DD_Save" Visible="true" runat="server" Text="Save" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveDDClick();" OnClick="lnk_DD_Save_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_DD_Update" Visible="false" runat="server" Text="Update" ToolTip="Update" CssClass="Savebtnsve" OnClientClick="return SaveDD2Click();" OnClick="lnk_DD_Save_Click"></asp:LinkButton>
                        ...
                        <li style="width: 100% !important">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtJobDescription" runat="server" Rows="20" MaxLength="500" 
                        ...
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_FileSave" Visible="true" runat="server" Text="Save" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveFileClick();" OnClick="lnk_FileSave_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_FileUpdate" Visible="false" runat="server" Text="Update" ToolTip="Update" CssClass="Savebtnsve" OnClientClick="return SaveFile1Click();" OnClick="lnk_FileSave_Click"></asp:LinkButton>
    ...
    <asp:HiddenField ID="HDHREMpCodeLogin" runat="server" />
    ...
    <script type="text/javascript">      
        $(document).ready(function () {
            ...
            $("#MainContent_lstEmpCode").select2();
