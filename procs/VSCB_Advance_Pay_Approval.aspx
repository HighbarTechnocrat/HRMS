<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="VSCB_Advance_Pay_Approval.aspx.cs" Inherits="procs_VSCB_Advance_Pay_Approval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Approve Advance Payment Request"></asp:Label>
                    </span>
                </div>
                <div>
                </div>
                <div>
                    ...
                    <span>
                        <a href="VSCB_Inbox_ADV_Payment.aspx?Type=Pending" title="Back" runat="server" visible="false" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                        <a href="VSCB_Inbox_ADV_Payment.aspx?Type=View" title="Back" runat="server" visible="false" id="btnRecBack1" style="margin-right: 10px;" class="aaaa">Back</a>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul id="Ul2" runat="server">
                                <li class="trvl_date" style="padding-bottom: 20px">
                                    <span style="text-decoration: underline; color: #F28820; font-size: 16px">Advance Payment Request View : </span>&nbsp;&nbsp;
                                    <br />
                                </li>
                                <li>
                                ...
                                <li class="trvl_date">
                                    <span>Advance Payment Amount (without GST)</span>&nbsp;&nbsp; 
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAmountPaidWithoutTax" CssClass="number" runat="server" Enabled="false"></asp:TextBox> 
                                </li>


                                <li class="trvl_date" id="liGSTAmt_1" runat="server" visible="true">
                                    <span>CGST Amount</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtCGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                </li>
                                <li class="trvl_date" id="liGSTAmt_2" runat="server" visible="true">
                                    <span>SGST Amount</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtSGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                </li>
                                <li class="trvl_date" id="liGSTAmt_3" runat="server" visible="true">
                                    <span>IGST Amount</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtIGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                </li>

                                <li class="trvl_date" id="liAdvAmtWithGSt_1" runat="server" visible="true">
                                ...
                                <li class="trvl_date" id="liAdvAmtWithGSt_2" runat="server" visible="true"></li>
                                <li class="trvl_date" id="liAdvAmtWithGSt_3" runat="server" visible="true"></li>

                                <li class="trvl_date" runat="server" id="Account4">
                                    <span>Direct Tax Sections</span>&nbsp;&nbsp;<span style="color: red"></span>
                                    <br />
                                    <asp:DropDownList ID="lstDirectTaxSections_ACC" runat="server" CssClass="DropdownListSearch" Width="98%" AutoPostBack="true" OnSelectedIndexChanged="lstDirectTaxSections_ACC_SelectedIndexChanged"></asp:DropDownList>
                                </li>
                                <li class="trvl_date" runat="server" id="Account5">
                                    <span>Percentage(%)</span>&nbsp;&nbsp;<span style="color: red"></span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txt_Tax_Percentage" CssClass="number" Enabled="false" AutoPostBack="true" MaxLength="5" OnTextChanged="txt_Tax_Percentage_TextChanged" runat="server"></asp:TextBox>

                                </li>
                                <li class="trvl_date" runat="server" id="Account6">
                                    <span>Is LDC Available</span>&nbsp;&nbsp;<span style="color: red"></span>
                                    <br />
                                    <asp:CheckBox ID="chkLDC_Applicable_ACC" Enabled="false" runat="server" AutoPostBack="true" Text="" OnCheckedChanged="chkLDC_Applicable_ACC_CheckedChanged" />

                                </li>

                                <li class="trvl_date" runat="server" id="Account3">
                                    <span>Direct Tax Amount</span>&nbsp;&nbsp;<span style="color: red"></span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txt_Direct_Tax_Amt" CssClass="number" Enabled="false" runat="server"></asp:TextBox>
                                ...
                                <li class="trvl_date" runat="server" id="Account1">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <br />
                                            <asp:TextBox AutoComplete="off" ID="txtAccountPaidAmt" runat="server" CssClass="number" Enabled="false" OnTextChanged="txtAccountPaidAmt_TextChanged"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <li class="trvl_date" runat="server" id="Account2">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <span style="display:none">Balance Amount </span> 
                                         
                                            <asp:TextBox AutoComplete="off" ID="txtAccountAmtBal" runat="server" Enabled="false" Visible="false"></asp:TextBox>
                                ...
                                <li class="trvl_date" runat="server" id="Li1">
                                    <span>Payment Type </span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtPaymentType" runat="server" Enabled="false"></asp:TextBox>

                                </li>
                                <li class="trvl_date" runat="server" id="Li2"></li>
                                <li class="trvl_date" runat="server" id="Li3"></li>
                                <li class="trvl_date">
                                    <span>Remark </span>&nbsp;&nbsp;<span style="color: red">* &nbsp;&nbsp;</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtRemark" CssClass="noresize" runat="server" Width="288%" TextMode="MultiLine" Rows="5" Enabled="false" onKeyUp="javascript:Count(this);"></asp:TextBox>
                                </li>
                                <li></li>
                                <li></li>
                                <li class="trvl_date" runat="server" id="ST">
                                    <span>Approval Remark </span>&nbsp;&nbsp;<span style="color: red">* &nbsp;&nbsp;Maximum 250 Characters</span>
                                    <br />
                                ...
                                <div>
                                    ...
                                    <span id="spnSupportingFiles" runat="server" visible="false">Supporting Files</span>
    ...
    <div class="Req_Savebtndiv" style="text-align: center">
        ...
        <asp:LinkButton ID="trvldeatils_cancel_btn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="trvldeatils_cancel_btn_Click">   Back</asp:LinkButton> <%--PostBackUrl="~/procs/VSCB_Inbox_ADV_Payment.aspx?Type=View"--%>
