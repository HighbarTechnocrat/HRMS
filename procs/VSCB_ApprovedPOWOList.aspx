<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_ApprovedPOWOList.aspx.cs" Inherits="procs_VSCB_ApprovedPOWOList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="All PO/ WO List"></asp:Label>
                    </span>
                </div>
                ...
                <%--<div class="manage_grid" style="overflow: scroll; width: 100%; padding-top: 20px; margin-bottom: 30px;">--%>
                    ...
                    <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="POID,Request_status" CellPadding="3" AutoGenerateColumns="False" Width="130%" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="PO/ WO Amount (With GST) (A)"
                                DataField="POWOAmt"
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="7%" ItemStyle-BorderColor="Navy" />
                              ...
                              <asp:BoundField HeaderText="Direct Tax Amount (B)"
                                DataField="DirectTaxCollection_Amt"
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="7%" ItemStyle-BorderColor="Navy" NullDisplayText="0.00"/>  

                            <asp:BoundField HeaderText="PO/ WO Paid Amount (C)"
                                DataField="POWOPaidAmount"
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="7%" ItemStyle-BorderColor="Navy" />   
                            ...
                            <asp:BoundField HeaderText="PO/ WO Balance Amount (A-B-C)"
                                DataField="PO_Bal_Amt"
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="7%" ItemStyle-BorderColor="Navy" />
