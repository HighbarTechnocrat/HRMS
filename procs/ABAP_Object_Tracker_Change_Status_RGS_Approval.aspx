<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_RGS_Approval.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_RGS_Approval" EnableSessionState="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_LinkBtnSavePopup, #MainContent_LinkBtnBackPopup, #MainContent_LinkButton1, #MainContent_LinkButton2, #MainContent_btn_SumitTimesheet, #MainContent_LinkButton3, #MainContent_LinkBtnCorrection {
            background: #3D1956;
            color: #febf39 !important;
            padding: 8px 18px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="RGS Approval"></asp:Label>
                    </span>
                </div>
                <div>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:TextBox ID="Txt_DevelopmentDescription" Enabled="false" runat="server" Width="700px"></asp:TextBox>
                                </li>
                                <li></li>
                                <li></li>
                                ...
                                <li class="trvl_date" runat="server" visible="false"></li>
                                <li class="trvl_date" runat="server" visible="false"></li>
                                ...
                                <li>
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="RGS Attachment"
                                                DataField="FileName"
                                            ...
                                            <asp:TemplateField HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="lnkDownload" runat="server" Width="20px" ToolTip="Download RGS Attachment" Height="15px" CommandArgument='<%# Eval("FileName") %>' OnClick="ibdownloadbtn_Click" ImageUrl="~/Images/Download.png" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <li class="trvl_Savebtndiv" style="width: auto;">

                                    <asp:LinkButton ID="LinkBtnSavePopup" runat="server" Text="Approve" ToolTip="Approve" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="LinkBtnSavePopup_ClickNew">Approve</asp:LinkButton>

                                    <asp:LinkButton ID="LinkBtnCorrection" runat="server" Text="Send for Correction" ToolTip="Send for Correction" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="LinkBtnCorrection_Click">Send For Correction</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdnProjectLocation" runat="server" />
