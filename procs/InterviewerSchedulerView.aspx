<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InterviewerSchedulerView.aspx.cs" 
    MaintainScrollPositionOnPostback="true"
    Inherits="procs_InterviewerSchedulerView" %>
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div>
					...
					<span>
                       <a href="Rec_RecruiterInbox.aspx?type=VRRIS" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
				</div>
				...
				<asp:GridView ID="GVCandidateRoundHistory" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px"
					...
					<Columns>
						...
						<asp:BoundField HeaderText="Inter. Round" DataField="InterviewRound" ItemStyle-HorizontalAlign="center"
							ItemStyle-Width="10%" ItemStyle-BorderColor="Navy" />
						<asp:BoundField HeaderText="Interviewer Comments" DataField="InterviewerComments" ItemStyle-HorizontalAlign="Left"
							ItemStyle-Width="25%" ItemStyle-BorderColor="Navy" />
						<asp:TemplateField HeaderText="IR Sheet" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%">
							<ItemTemplate>
