<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="travelRequisitionBooking_view.aspx.cs"
    Inherits="procs_travelRequisitionBooking_view" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <div class="wishlistpagediv">
            ...
            <div class="edit-contact">
                ...
                <ul id="editform" runat="server" visible="true">
                    ...
                    <li class="trvl_type" id="li_Admin_Acc_1" runat="server" visible="false">
                        <span>Confirm Accomodation Location </span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                        <asp:TextBox AutoComplete="off" ID="txtconfirmAccomodation" runat="server" MaxLength="500"></asp:TextBox>
                    </li>
                    <li class="trvl_type" id="li_Admin_Acc_2" runat="server" visible="false">
                        <div style="display:none">
                        <span>Accomodation Booked Amount </span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                        <asp:TextBox AutoComplete="off" ID="txtaccamt" runat="server" MaxLength="500" Enabled="false"></asp:TextBox>
                            </div>
                    </li>
                    <li class="trvl_type" id="li_Admin_Acc_3" runat="server" visible="false">
                        <div style="display:none">
                        <span>Travel Booked Amount  </span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                    ...
                    <li class="trvl_type" id="li_Admin_Cancel_Amt_1" runat="server" visible="false">
                        <span>Cancle Booked Amount </span>&nbsp;&nbsp;<span style="color: red">*</span><br />
    ...
    <div class="trvl_Savebtndiv">
        <asp:LinkButton ID="trvl_btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" >Submit</asp:LinkButton>
