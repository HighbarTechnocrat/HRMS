...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform10.aspx.cs" Inherits="myaccount_SampleForm" %>
...
<div class="containerDiv10">

  <div class="rowDivHead10">
    <div class="cellDivAttendance10">Date</div>
    <div class="cellDivAttendance10"> Type</div>
    <div class="cellDivAttendance10">Time</div>
    <div class="cellDivAttendance10"> Status</div>
    <div class="cellDivAttendance10">Category*</div>
    <div class="cellDivAttendance10">Reason / Remark</div>
    <div class="cellDivAttendance10">Approver 1</div>
    <div class="cellDivAttendance10">Approver 2</div>
    <div class="cellDivAttendance10">Approver 3</div>
   </div>

    <div class="rowDiv">
   <div class="cellDivregularization10">'01/09/2017</div>
    <div class="cellDivregularization10">Out</div>
    <div class="cellDivregularization10">04:30:00 PM</div>
    <div class="cellDivregularization10">ABSENT</div>
    <div class="cellDivregularization10">Early Going</div>
    <div class="cellDivregularization10">tttt</div>
       <div class="cellDivregularization10">Approved</div>
    <div class="cellDivregularization10"></div>
    <div class="cellDivregularization10"></div>
