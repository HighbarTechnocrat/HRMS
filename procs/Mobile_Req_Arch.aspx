<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Mobile_Req_Arch.aspx.cs" Inherits="myaccount_AppMobile_RemRequest_Acc" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Approved Mobile Claim"></asp:Label>
                    </span>
                </div>
                <div>
...
<%--                        <li class="mobile_inboxEmpCode">
                        ...
                        <li class="mobile_inboxEmpCode">
                            ...
                            <asp:TextBox AutoComplete="off" ID="Txt_COSRecommended" runat="server" MaxLength="30" visible="false" Enabled="false"> </asp:TextBox>
                        </li>

                        <li class="mobile_Amount">
                            <span runat="server" id="Spn_HOD_Recm_Amt" visible="false">HOD Recommended Amount </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="Txt_HOD_Recm_Amt" runat="server" MaxLength="100" Visible ="false" Enabled="false"></asp:TextBox>
                        </li>

                        <li class="mobile_inboxEmpCode">
                            <span runat="server" id="Spn_CFO_Recm_Amt" visible="false">CFO Recommended Amount </span>
                            <br />
                        ...
                        <li class="mobile_inboxEmpCode">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtComment" runat="server" MaxLength="100"> </asp:TextBox>
                            <asp:TextBox AutoComplete="off" ID="txtRecommendation_COS" runat="server" Visible="false" MaxLength="100"> </asp:TextBox>
                        </li>
    ...
    <div class="mobile_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" Visible="false" runat="server" Text="Approve" ToolTip="Approve" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click">Approve</asp:LinkButton>
        <asp:LinkButton ID="mobile_btnSave_COSACC" runat="server" Visible="false" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click">Submit</asp:LinkButton>
         <asp:LinkButton ID="mobile_btnReject" Visible="false" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="mobile_btnReject_Click">Reject</asp:LinkButton>
