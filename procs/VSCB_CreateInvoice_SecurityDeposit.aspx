<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
	MaintainScrollPositionOnPostback="true" CodeFile="VSCB_CreateInvoice_SecurityDeposit.aspx.cs" Inherits="VSCB_CreateInvoice" EnableSessionState="True" %>
						...
						<li class="trvl_grid" id="litrvlgrid" runat="server">
							<div>
								...
								<asp:GridView ID="dgTravelRequest" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="130%" EditRowStyle-Wrap="false"
									...
									<Columns>
										<asp:TemplateField HeaderText="Invoice Amount (Without GST)" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" Visible="false">
											<ItemTemplate>
										...
										<asp:TemplateField HeaderText="Milestone Settlement Amount" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" Visible="false">
											<ItemTemplate>
