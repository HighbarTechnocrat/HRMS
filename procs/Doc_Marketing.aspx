<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Doc_Marketing.aspx.cs" Inherits="procs_Doc_Marketing" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Marketing"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                    ...
                    <div class="leavegridMain">
                        ...
                        <asp:GridView ID="dghbtPolicies" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                            ...
                            <Columns>
<%--                                <asp:BoundField DataField="SubDocDescription" HeaderText="Marketing Document">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Center" Width="80%" />
                                </asp:BoundField>--%>
                                <asp:TemplateField HeaderText="Marketing Document" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true">
                                    <ItemTemplate>
 ...
 <br />
                         <a href="https://ess.highbartech.com/hrms/procs/appraisalindex.aspx" target="_self">Appraisal </a>
                        <br /><br /><br /><br /><br /><br />
                    </div>
                </div>
            </div>
