<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="Ref_CandidateInfo.aspx.cs" Inherits="procs_Ref_CandidateInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Refer Candidate"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span>
                        <a href="MyRef_Candidate_Index.aspx" id="lnkback" style="margin-right: 20px" runat="server" visible="false" class="aaaa">Back</a>
                    </span>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li class="mobile_InboxEmpName">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="Txt_CandidateMobile" MaxLength="10" runat="server"></asp:TextBox>
                        </li>
                        ...
                        <li>
                            ...
                            <span>Total Experience In(Year) </span>
                            <br />
                        ...
                        <li>
                            ...
                            <span>Relevant Experience In(Year) </span>
                            <br />
                        ...
                        <li>
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtNoticePeriod" Class="number" MaxLength="3" runat="server"></asp:TextBox>
                        </li>
                        <li class="mobile_InboxEmpName">
                            <span>Additional Skillset </span> 
                            <br />
                    ...
                    <div style="padding-left: 40px">
                        <span runat="server" id="GRDReferral" visible="false">Referral Status </span>
                        <br />
                        <asp:GridView ID="DgvApprover" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="50%">
    ...
    <div class="mobile_Savebtndiv">
        ...
        <asp:LinkButton ID="mobile_cancel" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Ref_Employee_Index.aspx">Back</asp:LinkButton>
    </div>
    <br />
