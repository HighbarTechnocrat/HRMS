<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="false"
	MaintainScrollPositionOnPostback="true" CodeFile="VSCB_ApproveInvoice.aspx.cs" Inherits="VSCB_ApproveInvoice" ViewStateMode="Disabled" %>
				...
				<div class="edit-contact">
					...
					<ul id="editform" runat="server" visible="true">
						<li class="trvl_type">
							...
							<asp:TextBox AutoComplete="off" ID="txtTriptype" runat="server" CssClass="Dropdown" Visible="true"></asp:TextBox>
						</li>
						<li class="trvl_date">
