<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="AppreciationLetter_ViewApprovedRedeemedReq.aspx.cs" Inherits="AppreciationLetter_ViewApprovedRedeemedReq" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Approved Redmption Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 90%; height: auto;">
                          ...
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="id"   CellPadding="3" AutoGenerateColumns="False" Width="90%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  AllowPaging="true" PageSize="15" EditRowStyle-Wrap="false">
