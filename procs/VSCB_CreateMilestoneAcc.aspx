<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="VSCB_CreateMilestoneAcc.aspx.cs" Inherits="VSCB_CreateMilestoneAcc" EnableSessionState="True" ValidateRequest="false" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtBasePOWOWAmt" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                        ...
                        <li class="trvl_local" id="idSingPOCopy_1" runat="server">
                            <span>Select Sign PO Copy </span> 
                            <asp:FileUpload ID="POUploadfile" runat="server" AllowMultiple="false"></asp:FileUpload>                             
                               
                        </li>

                        <li class="trvl_date"  id="idSingPOCopy_2" runat="server" >
                             &nbsp;&nbsp;&nbsp; <asp:LinkButton ID="trvldeatils_btnSave" runat="server" Text="Upload Sign PO Copy" ToolTip="Upload Sign PO Copy" CssClass="Savebtnsve"  OnClick="trvldeatils_btnSave_Click"></asp:LinkButton>
                        </li>
                        <li class="trvl_date"  id="idSingPOCopy_3" runat="server"></li>
                        ...
                        <li class="trvl_date" style="display:none"></li>
                          ...
                          <li class="trvl_local" id="liRemarks_1" runat="server" visible="false">
                            ...
                            <br />
                            <span>Remarks</span><span style="color: red; font-size: 10px; font-weight: normal; font-style: italic;"> Maximum 200 Characters</span><br />
