...
public partial class AppreciationLetter_View_ApprovelReq : System.Web.UI.Page
{
    ...
    private void Redmption_Point_GridView()
    {
        try
        {
            ...
            spars[0] = new SqlParameter("@qtype", SqlDbType.VarChar);
            spars[0].Value = "View_Approvel_Redmption_Point";
    ...
    protected void lnkAppreciationLetter_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnReqid.Value != "0")
            {
                Response.Redirect("AppreciationLetter_AdminApprovel.aspx?reqid=" + hdnReqid.Value);
            }
