<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="Custs_InboxServiceRequest_Arch.aspx.cs" Inherits="Custs_InboxServiceRequest_Arch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Processed CUSTOMERFIRST Service Requests"></asp:Label>
        </span>
    </div>
        <div class="leavegrid">
        <a href="Custs_Service.aspx" class="aaaa">CustomerFIRST Service Request</a>
    </div>
