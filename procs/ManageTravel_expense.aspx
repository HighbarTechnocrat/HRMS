<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ManageTravel_expense.aspx.cs" Inherits="myaccount_ManageTravel_expense" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Travel Expenses"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <center>
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField ItemStyle-Width="5%" HeaderText="Details" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
