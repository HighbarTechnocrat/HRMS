...
public partial class procs_VSCB_Myapprovedinvoice_Reversal : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_ApproveInvoice_Reversal.aspx?invid=" + hdnInvoiceId.Value + "&mngexp=1");
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_Invoice_List_Approvers_Reversal";
    ...
    private void get_InboxInvoices_DropdownList()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_MyApprovedInvoice_Search_DropdownList_Reversal";
