...
public partial class VSCB_CreateInvoice_Org : System.Web.UI.Page
{
    ...
    private void Create_Invoice_Without_POWO()
    {
        ...
        if (dtApproverEmailIds.Tables[0].Rows.Count > 0)
        {
            ...
            DataSet dtMaxreqID = new DataSet();
            dtMaxreqID = spm.InsertUpdate_Invoice(txtEmpCode.Text, "Insertinvoice", 0, Convert.ToString(txtInvoiceNo.Text).Trim(), strInvoiceDate, Convert.ToDecimal(txtAmtWithOutTax.Text), rCGST, rSGST, rIGST, rCGST_Per, rSGST_Per, rIGST_Per, Convert.ToDecimal(txtAmtWithTax_Invoice.Text), dMilestoneBalAmt, 1, 1, blnIswithPO, dProject_Dept_id, iVendorId,"","","","",Convert.ToString(txtInvocieRemarks.Text));
    ...
    public void GetPODetails_List()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value ="get_Approved_POWOList"; // "get_Approved_POWOList_CreateInvoice";
