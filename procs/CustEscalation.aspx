<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="CustEscalation.aspx.cs" Inherits="CustEscalation" %>
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server"  OnClick="lnk_leaverequest_Click">Create Customer Incident</asp:LinkButton>                                         
                                    </td>
                                     <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/MyCustEscalation_Req.aspx">My Customer Incident</asp:LinkButton>
                                    </td>                                    
                                </tr>
                                ...
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <br />
                                        <span id="span_App_head" runat="server" style="font-size: 12pt; font-weight: bold; color: #3D1956;">Incident Owner : </span>
                                    </td>
                                </tr>                                 
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                    <asp:LinkButton ID="lnk_leaveinbox" runat="server" Text="" PostBackUrl="~/procs/InboxCustEscalation.aspx">Inbox</asp:LinkButton>
                                    </td>                 
                                </tr>
								 <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_reimbursmentReport" runat="server"  Visible="false" Text="" PostBackUrl="~/procs/InboxCustEscalationApp.aspx"> Closure Confirmation Inbox</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle" runat="server" id="showPSR">
                                        <asp:LinkButton ID="lnk_MobACC" runat="server" Text="" PostBackUrl="~/procs/InboxCustEscalation_Arch.aspx">Processed Customer  Incident</asp:LinkButton>
                                    </td>
                                     <td class="formtitle" runat="server" id="Td1">
                                               <asp:LinkButton ID="lnk_reimbursmentReport_1" runat="server" Text="" Visible="false" PostBackUrl="~/procs/CustEscalationReport_Audit.aspx">Customer Incident History Report</asp:LinkButton>
                                    </td>
                                </tr>
                                 <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle" runat="server" id="Td2">
                                      <asp:LinkButton ID="lnk_summary_report" runat="server" Text="" Visible="false" PostBackUrl="~/procs/CustEscalationReport_Audit_Summary.aspx">Customer Incident History Summary Report</asp:LinkButton>
                                    </td>
                                </tr>
								<tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <br />
                                        <span id="SPReport" runat="server" visible="false" style="font-size:12pt;font-weight:bold; color:#3D1956;">Report : </span>
                                        
                                    </td>
                                </tr>   
								 <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle" runat="server" id="Report" visible="false" >
                                        <asp:LinkButton ID="lnk_CustomerFirstReport" runat="server" Text="" Visible="false"  PostBackUrl="~/procs/CustEscalation_Report.aspx">Detail Report</asp:LinkButton>
                                    </td>
                                	
								 <td class="formtitle" runat="server" id="View">
                                        <asp:LinkButton ID="lnk_CustomerFirstView" runat="server"  Visible="True" Text="" PostBackUrl="~/procs/CustEscalationView_Index.aspx">Customer Incident View</asp:LinkButton>
                                    </td>
								</tr>
