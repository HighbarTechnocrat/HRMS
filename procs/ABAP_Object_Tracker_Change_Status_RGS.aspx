<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_RGS.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_RGS" EnableSessionState="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="RGS - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <span style="float: right;">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" Text="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/ABAP_Object_Tracker_Index.aspx" BackColor="#3D1956" style="margin: 0px 20px 0px 0px !important;"><%=System.Configuration.ConfigurationManager.AppSettings["ABAPObjectPageTitle"]%></asp:LinkButton>
                </span>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date" id="rgsupload_1" runat="server" visible="false">
                                    <br />
                                    <asp:Label runat="server" ID="lbl" Visible="True" Style="color: red; font-size: 16px; font-weight: 500; text-align: center;"></asp:Label><b></b>
                                    <span>RGS Attachment:</span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <asp:FileUpload ID="furgsupload" runat="server" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" AllowMultiple="true"></asp:FileUpload>

                                </li>
                                <li id="rgsupload_2" runat="server" visible="false"></li>
                                <li id="rgsupload_3" runat="server" visible="false"></li>
                                ...
                                <li>
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="RGS Stage Uploaded Attachment"
                                                DataField="FileName"
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <br />
                            <span class="rgs" runat="server" visible="false" id="rgs">RGS</span>
                            ...
                            <asp:GridView ID="gvRGSDetails" runat="server" CssClass="Milestones" DataKeyNames="RGSDetailsId" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="lnkEdit" runat="server" Height="10px" OnClick="lnkEdit_Click"
                                    ...
                                    <asp:BoundField HeaderText="RGS Status"
                                        DataField="RGS_DisplayName"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="10%" HeaderStyle-Width="10%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="RGS Approved/ Rejected By"
                                        DataField="RGSApprovalName"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="10%" HeaderStyle-Width="10%"
                                        ItemStyle-BorderColor="Navy" visible="false"/>
                                    <%--DataField="RGSStatuss" --%>
                                    ...
                                    <asp:BoundField HeaderText="Revised / Actual Preparation Start Date"
                                        ...
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%" HeaderStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
    ...
    <asp:HiddenField ID="hdnProjectManagerMail" runat="server" />
    <asp:HiddenField ID="hdnRGSConsultantMail" runat="server" />
    <asp:HiddenField ID="hdnRGSConsultantName" runat="server" />
