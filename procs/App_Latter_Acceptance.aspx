<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" ValidateRequest="false"
	CodeFile="App_Latter_Acceptance.aspx.cs" Inherits="procs_App_Latter_Acceptance" %>
...
.scrollbar-width-thin::-webkit-scrollbar-button {
    background: #ccc
}
.scrollbar-width-thin::-webkit-scrollbar-track-piece {
    background: #888
}
.scrollbar-width-thin::-webkit-scrollbar-thumb {
    background: #eee
		...
		.scrollbar-width-thin{
			width: 200%; height: 130px !important;  overflow-y: scroll; border: solid 1px #aaa; padding: 15px;
		}
	</style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Appointment Letter Issued Details"></asp:Label>
					</span>
				</div>
				<div class="edit-contact">
					<ul id="editform" runat="server" visible="false">
						...
						<li class="mobile_inboxEmpCode">
							<span>Appointment latter File <span style="color:red">(Click on file download)</span> </span>
							<br />
						...
						<li style="width: 60%">
							...
							<asp:CheckBox AutoComplete="off" CssClass="AcceptedAgreement" Text="" ID="chk_Read_Acceptance" runat="server"></asp:CheckBox>
							<span>By clicking here, I state that I have read and understood the terms and conditions.</span>
						</li>
						<li></li>
						<li style="display:none">
							<br />
							Upload Signed & Scan Appointment Letter <span style="color: red">* (Only pdf file)</span>
							<asp:FileUpload ID="uploadfilesigned" runat="server" AllowMultiple="false" accept=".pdf" onchange="fValidFileExt(this.value);" />
							<br />
					...
					<ul id="UlModeration" runat="server" visible="false">
						...
						<li>
							<span>Remark  </span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtRemark" Enabled="false" Style="width: 84%;" CssClass="noresize" runat="server" Rows="5" TextMode="MultiLine"></asp:TextBox>
						</li>
						<li></li>
					...
					<div class="Req_Savebtndiv" style="text-align: center">
						...
						<asp:LinkButton ID="lnk_Cancle" Visible="true" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/App_Latter_Index.aspx"></asp:LinkButton>
	...
	<asp:HiddenField ID="hdnAppointmentNo" runat="server" />
