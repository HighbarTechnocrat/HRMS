<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_HBTTesting.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_HBTTesting" EnableSessionState="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    z-index: 1000;
        ...
        select#MainContent_ddlStage, select#MainContent_DDLReason {
            background: white !important;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="HBT Testing - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date">
                                    <asp:Label ID="lbl4" runat="server" Text="Revised / Actual Approval"></asp:Label><span style="color: red" runat="server" id="approvemendatory">*</span>
                                    <br />
                                ...
                                <li class="trvl_date">
                                    <asp:Label ID="lbl5" runat="server" Text="Status"></asp:Label><span style="color: red" runat="server" id="spnstatusmandatory" visible="false">*</span>
                                    <br />
                                ...
                                <li class="trvl_date" id="li_ddl_stage_1" runat="server" visible="false">
                                    <br />
                                    <span>Select Stage</span><span style="color: red" runat="server" id="spnstagemandatory" visible="false">*</span>
                                    <br />
                                    <asp:DropDownList ID="ddlStage" runat="server" Width="250px" OnSelectedIndexChanged="ddlStage_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Text="Select a Stage" Value="" />
                                        <asp:ListItem Text="FS" Value="FS" />
                                        <asp:ListItem Text="ABAP" Value="ABAP" />
                                    </asp:DropDownList>
                                </li>
                                <li id="li_ddl_stage_2" runat="server" visible="false">
                                    <br />
                                    <span runat="server" id="spnreason">Select Reason</span><span style="color: red" runat="server" id="Span1">*</span>
                                ...
                                <li>
                                    <br />
                                    <asp:Label ID="lblreason" runat="server" Text="CTM Failed Reason"></asp:Label>
                                ...
                                <li class="trvl_date" id="lihbttestcase_1" runat="server" visible="false">
                                    <span runat="server" id="Span3">Upload HBT Test Case</span><span style="color: red" runat="server" id="Span4">*</span>
                                    ...
                                    <asp:FileUpload ID="uplHBTTestCase" runat="server" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" Width="75%"></asp:FileUpload>
                                </li>
                                <li class="trvl_date" id="lihbttestcase_2" runat="server" visible="false"></li>
                                <li class="trvl_date" id="lihbttestcase_3" runat="server" visible="false"></li>
                                ...
                                <li>
                                    ...
                                    <asp:GridView ID="gvHBTTestCaseFailedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                        AutoGenerateColumns="False" Width="80%" EditRowStyle-Wrap="false" DataKeyNames="Srno">
                                        <FooterStyle BackColor="White" ForeColor="#000066" />
                                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                        <RowStyle ForeColor="#000066" />
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="HBT Test Case File"
                                                DataField="FileName"
                                                ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left"
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <br />
                            <span class="hbttest" runat="server" visible="false" id="hbttest"><br />HBT Testing</span>
    ...
    <asp:HiddenField ID="hdnRevisedStartDt" runat="server" />
    <asp:HiddenField ID="hdnRevisedFinishDt" runat="server" />
