<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="SkillSetAdd.aspx.cs" 
    Inherits="procs_SkillSetAdd" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Skill Set Add Info"></asp:Label>
                    </span>
                </div>
				 <div>
                ...
                <span>
					...
					<ul id="editform" runat="server" >
                        <li class="trvl_date">                        
                            <span  style="padding-left:300px">Skillset  </span>&nbsp;&nbsp;<span style="color:red">*</span>
                           
                              </li>

                       <li class="trvl_date"> 

                           <asp:TextBox ID="Txt_Skillset" Width="250px"   MaxLength="150" runat="server"></asp:TextBox>
                          
                           </li> 
				
						<div style=" padding-left:380px">							
							<br />							
                            <asp:LinkButton ID="mobile_btnSave" Text="Add SkillSet"  ToolTip="Add SkillSet"  runat="server" OnClick="mobile_btnSave_Click" ></asp:LinkButton>
                ...
                <br />
                 ...
                 <div class="edit-contact">
					<ul id="Ul1" runat="server">
                        <li class="trvl_date"> 
                             <span >Search By SkillSet </span>&nbsp;&nbsp;<span style="color:red"></span>
                            <br />
          ...
          <asp:Label runat="server" ID="lbltotalRecords"  Style="color: red; font-size: 15px; font-weight: 500; text-align: center;"></asp:Label>
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="ModuleId"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="15" AllowPaging="true"  OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
                        ...
                        <Columns>
                             ...
                             <asp:ImageButton id="lnkEdit" runat="server" Width="15px" Height="15px" ImageUrl="~/Images/edit.png"  OnClick="lnkEdit_Click"/>
                                 <%--<asp:HiddenField ID="GridHDModuleID" runat="server" Value='<%# Bind("ModuleId") %>' />--%>
                             </ItemTemplate>
                             <ItemStyle HorizontalAlign="Center" />
                         </asp:TemplateField>
                            <asp:BoundField HeaderText="Skill Set" DataField="ModuleDesc"
