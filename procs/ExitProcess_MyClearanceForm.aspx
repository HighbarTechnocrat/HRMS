<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ExitProcess_MyClearanceForm.aspx.cs" Inherits="procs_ExitProcess_MyClearanceForm" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Clearance Forms"></asp:Label>
                    </span>
                </div>
                    ...
                    <center>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Resignation submitted on"
                                ...
                                ItemStyle-BorderColor="Navy"
                                />
                            <asp:BoundField HeaderText="Clearance Form  Submitted on"
                                DataField="Clearance Form  Submitted on"
                                 ItemStyle-HorizontalAlign="center"
                                ItemStyle-Width="8%" 
                                ItemStyle-BorderColor="Navy"
                                />
