<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_Changed_FS_Consultant.aspx.cs" Inherits="ABAP_Object_Tracker_Changed_FS_Consultant" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Change RGS/ FS/ HBT Consultant"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <div>
                        <br />
                        <span><b>Note:  Please select ABAP Devlopement Description from dropdown list to view the change history.</b></span>
                    </div>
                            ...
                            <asp:GridView ID="gvFSDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Old Consultant"
                                        ...
                                        ItemStyle-HorizontalAlign="left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="18%"  HeaderStyle-Width="2%"
                                        ItemStyle-BorderColor="Navy" />
