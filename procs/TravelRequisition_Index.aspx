<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="TravelRequisition_Index.aspx.cs" Inherits="TravelRequisition_Index" %>
            ...
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts"> <br />
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Travel Requisition"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                            ...
                            <table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle" id="td1" runat="server">
                                        <asp:LinkButton ID="lnk_leaveinbox" runat="server" Visible="true" ToolTip="Create Travel Requisition" PostBackUrl="~/procs/employeeTravelRequisitionForm.aspx">Create Travel Requisition</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_MobACC" runat="server" Visible="true" ToolTip="My Travel Requisition" PostBackUrl="~/procs/MyTravelRequisitions.aspx">My Travel Requisition</asp:LinkButton>
                                    </td>
                                </tr>
