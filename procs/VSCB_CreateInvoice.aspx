<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
	MaintainScrollPositionOnPostback="true" CodeFile="VSCB_CreateInvoice.aspx.cs" Inherits="VSCB_CreateInvoice" EnableSessionState="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div class="edit-contact">
					...
					<ul>
						<li class="trvl_date">
							<asp:CheckBox ID="chkIsInvoiceWithoutPO" runat="server" Text="Is Invoice Without PO" OnCheckedChanged="chkIsInvoiceWithoutPO_CheckedChanged" AutoPostBack="true" />
						</li>

						<li class="trvl_date">
							<a href="https://ess.highbartech.com/hrms/procs/Service_Req.aspx" class="BtnShow" target="_blank">Click here to Send PO/ WO Creation Request to Account Team</a>
						</li>
					...
					<ul id="editform" runat="server" visible="true">
						...
						<li class="trvl_date">
							...
							<asp:DropDownList runat="server" ID="lstPOType" AutoPostBack="false" CssClass="DropdownListSearch" Visible="false">
							</asp:DropDownList>
							<asp:TextBox AutoComplete="off" ID="txtPOtype" runat="server" CssClass="Dropdown" Visible="true" ReadOnly="true" Enabled="False"></asp:TextBox>
						</li>
						<li class="trvl_date">
						...
						<li class="trvl_type">
							...
							<asp:DropDownList runat="server" ID="lstforChangeCostCenter" Visible="true" AutoPostBack="true" CssClass="DropdownListSearch" OnSelectedIndexChanged="lstforChangeCostCenter_SelectedIndexChanged">
							</asp:DropDownList>
						...
						<li class="trvl_date">
							...
							<asp:TextBox AutoComplete="off" ID="txtDiretTaxAmt" runat="server" ReadOnly="true" Enabled="False" CssClass="textboxBackColor AmtTextAlign"></asp:TextBox>
						</li>
						<li class="trvl_date">
							<span>Paid Amount (With GST) (C)</span><br />
							<asp:TextBox AutoComplete="off" ID="txtPaidAmt" runat="server" ReadOnly="true" Enabled="False" Visible="false" CssClass="textboxBackColor AmtTextAlign"></asp:TextBox>
					...
					<ul id="editform1" runat="server">
						<li class="trvl_grid" id="litrvlgrid" runat="server">
							<div>
								...
								<asp:GridView ID="dgTravelRequest" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="130%" EditRowStyle-Wrap="false"
									DataKeyNames="srno,PaymentStatusID,MstoneID" OnRowDataBound="dgTravelRequest_RowDataBound">
									...
									<Columns>
										<asp:TemplateField HeaderText="Invoice Amount (Without GST)" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
											<ItemTemplate>
												<asp:LinkButton ID="lnkTravelDetailsEdit" CssClass="BtnShow" runat="server" Text='Create' OnClick="lnkTravelDetailsEdit_Click" Visible="false"></asp:LinkButton>
												<asp:TextBox ID="txtMilestoneInvoiceAmt" Text='<%# Eval("Milesstone_Amt_ForInvoice") %>' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" AutoComplete="off" runat="server" CssClass="txtWidth" AutoPostBack="true" OnTextChanged="txtMilestoneInvoiceAmt_TextChanged" MaxLength="18" Visible='<%# Eval("createbtn").ToString() == "1" ? false : true %>'></asp:TextBox>
											    <asp:TextBox ID="txtMilestoneDescription" Text='<%# Eval("MilestoneDescription") %>'  runat="server" Visible="false"></asp:TextBox>
											
                                            </ItemTemplate>
											<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
										</asp:TemplateField>

										<asp:TemplateField HeaderText="Milestone Settlement Amount" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
											<ItemTemplate>
												<asp:TextBox ID="txtMilestoneSettlementAmt" Text='<%# Eval("Milestone_settlementAmt") %>' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" AutoComplete="off" runat="server" CssClass="txtWidth" AutoPostBack="true" OnTextChanged="txtMilestoneInvoiceAmt_TextChanged" MaxLength="18" Visible='<%# Eval("createbtn").ToString() == "1" ? false : true %>'></asp:TextBox>
											</ItemTemplate>
											<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
										</asp:TemplateField>
										...
										<asp:BoundField HeaderText="Settlement Amount (D)"
											DataField="totalMilestoneSettlementAmt_Display"
											ItemStyle-HorizontalAlign="Right"
											HeaderStyle-HorizontalAlign="Right"
											ItemStyle-Width="6%"
											ItemStyle-BorderColor="Navy" />
						...
						<li class="trvl_date" id="idDirectTaxAmt" runat="server" style="display: none">
						...
						<li class="trvl_date" id="idMilestonePaidAmt" runat="server" style="display: none">
						...
						<li class="trvl_date" id="idMilestoneBlnk_1" runat="server" style="display: none"></li>
						...
						<li class="trvl_date" id="livoucher_3" runat="server" visible="false"></li>
						...
						<li class="trvl_date" id="liCGST_Per" runat="server" visible="false">
							<span>CGST(%)</span>
							<br />
						...
						<li class="trvl_date" id="liSGST_Per" runat="server" visible="false">
							<span>SGST(%)</span><br />
						...
						<li class="trvl_date" id="liIGST_Per" runat="server" visible="false">
							<span>IGST(%)</span><br />
						...
						<li>
                            <asp:CheckBox ID="ChkAdvSettlement" Visible="false" runat="server" Text="Is Payment Advance Settlement" OnCheckedChanged="ChkAdvSettlement_CheckedChanged" AutoPostBack="true" />
							
						</li>
						<li>
                            	<div runat="server" id="DAdvSet" visible="false">
								<span id="spnAdvAmttext" runat="server">Advance Settlement Amount (Without GST)</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
								<asp:TextBox AutoComplete="off" ID="txtAdv_Settlement_Amt" runat="server" AutoPostBack="true" OnTextChanged="txtAdv_Settlement_Amt_TextChanged"></asp:TextBox>
							</div>
						</li> 


						<li class="trvl_date">
							<asp:CheckBox ID="ChkSecuritySettlement" Visible="false" runat="server" Text="Is Security Deposit Settlement" OnCheckedChanged="ChkSecuritySettlement_CheckedChanged" AutoPostBack="true" />
							<span style="color: red; font-size: 13px;"></span>
						</li>
						<li class="trvl_date" runat="server">
							<div runat="server" id="SASecurity" visible="false">
								<span>Security Deposit Settlement Amount</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
								<asp:TextBox AutoComplete="off" ID="txtSecurityDeposit" runat="server" AutoPostBack="true" OnTextChanged="txtSecuryDeposit_TextChanged"></asp:TextBox>
							</div>
						</li>
						<li></li>

						<li class="trvl_date" runat="server">
							<div runat="server" id="SAADV_Amt"  visible="false">
							<span>Invoice Payable Amount </span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtAdv_Bal_Amt" runat="server" ReadOnly="true" ToolTip=" Exclude of Advance Amount" Enabled="False"></asp:TextBox>
								</div>
						</li>
						<li></li>
						<li></li>

						<li class="trvl_Approver" id="idliCostCenterList" runat="server" visible="false">
							...
							<br />
							<asp:LinkButton ID="trvldeatils_btnSave" Visible="false" runat="server" Text="Add Cost Center" ToolTip="Add Cost Center" CssClass="Savebtnsve" OnClick="trvldeatils_btnSave_Click"></asp:LinkButton>


							<asp:GridView ID="dgCostcenterList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="50%" OnRowDataBound="dgCostcenterList_RowDataBound">
								<FooterStyle BackColor="White" ForeColor="#000066" />
								<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
								<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
								<RowStyle ForeColor="#000066" />
								...
								<Columns>
									<asp:TemplateField HeaderText="Cost Center" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
										<ItemTemplate>
											<asp:DropDownList ID="lstMilestoneAmtCostCenter" runat="server" CssClass="DropdownListSearch" Width="300px"></asp:DropDownList>
										</ItemTemplate>
										<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
									</asp:TemplateField>
									<asp:TemplateField HeaderText="Cost Center Amount (Without GST)" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
										<ItemTemplate>
											<asp:TextBox ID="txtCostCenterAmt" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" AutoComplete="off" runat="server" CssClass="txtWidth" MaxLength="18" AutoPostBack="true" OnTextChanged="txtCostCenterAmt_TextChanged"></asp:TextBox>
										</ItemTemplate>
										<ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
									</asp:TemplateField>
							...
							<asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="Delete">
										<ItemTemplate>
											<asp:LinkButton ID="lnkDeleteexpFile" CssClass="BtnShow" runat="server" Text="Delete" OnClick="lnkDeleteexpFile_Click">
											</asp:LinkButton>
										</ItemTemplate>
									</asp:TemplateField>
								</Columns>
                        ...
                        <li class="trvl_date" id="liInvoiceDescription_PO" runat="server">
							<span>Invoice Description </span>&nbsp;&nbsp;<span style="color: red">*</span><br />
							<asp:TextBox AutoComplete="off" ID="txtinvoice_description" runat="server" TextMode="MultiLine" CssClass="InvoiceRemarksText" Height="20px" Width="265px"></asp:TextBox>
						</li>
	...
	<div class="trvl_Savebtndiv">
		...
		<asp:LinkButton ID="btnCancel" runat="server" Visible="true" Text="Cancel Invoice" ToolTip="Cancel Invoice" CssClass="Savebtnsve" OnClientClick="return CancelMultiClick();" OnClick="btnCancel_Click">Cancel Invoice</asp:LinkButton>
		<asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_MyInvoice.aspx">Back</asp:LinkButton>
	</div>
	...
	<div>
		...
		<asp:GridView ID="gvMngPaymentList_Batch" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
			...
			<Columns>
				<asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" Visible="false">
					<ItemTemplate>
	...
	<div style="display: none">
		...
		<li class="trvl_date" id="idWithoutInv_Expenses_3" runat="server"></li>
	</div>
	...
	<asp:HiddenField ID="hdnSecurityDeposit" runat="server" />
    ...
    <asp:HiddenField ID="hdnIsInvoiceWithPO" runat="server" />
    ...
    <asp:HiddenField ID="hdnGST_AMT" runat="server" /> 
	...
	<script type="text/javascript">
		...
		function DownloadFile(file) {
			...
			//window.open("https://192.168.21.193/oneHRAPI/api/ExcelDownload/Download?path1=" + localFilePath + "" + file); ;
