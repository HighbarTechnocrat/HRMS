...
public partial class procs_VSCB_AuditTrailReport : System.Web.UI.Page
{
    ...
    protected void mobile_btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (lstVendorName.SelectedIndex < 0)
        {
    ...
    private void GetPayment_Request_List()
    {
        try
        {
            ...
            string QueueType = "", ReportInvoice = "", ReportPayment = "", strtoDate = "", POWODate = "", PayementRDates = "", CostCentre = "",
                ProjectName = "", Parameter = "", Parameter2 = "", ReportBy = "";
            string[] strdate;
            ...
            if (lstreportType.SelectedValue == "0")
            {
                QueueType = "SelectInvoiceReportList";
                ReportInvoice = "AuditTrailReport";
                ReportPayment = "AuditTrailPayment";
            }
            else if (lstreportType.SelectedValue == "1")
            {
                QueueType = "SelectPaymentReportList";
                ReportPayment = "AuditTrailReport";
                ReportInvoice = "AuditTrailPayment";
            }
            else
            {
                QueueType = "SelectPayment_InvoiceReportList";
                ReportInvoice = "AuditTrailReport";
                ReportPayment = "AuditTrailPayment";
            }
            RequisitionList = spm.GetVSCB_Payment_Request_ReportList(Session["Empcode"].ToString(), QueueType, POID, Vendor_ID, InvoiceID, Payment_ID, Status_id, POWODate, PayementRDates, CostCentre, Dept_ID, "", "");
            if (RequisitionList.Tables[0].Rows.Count > 0)
            {
                ...
                if (InvoiceID != "")
                {
                    ...
                    {
                        Parameter = " InvoiceNo : " + lstInvoiceNo.SelectedItem.Text;
                    }
                }
                //if (Dept_ID != "")
                //{
                ...
                //param[4] = new ReportParameter("SkillSet", Convert.ToString(""));
                //param[5] = new ReportParameter("Status", Convert.ToString(""));
                //param[6] = new ReportParameter("Recruiter", Convert.ToString(""));
                //param[7] = new ReportParameter("Urgency", Convert.ToString(""));

                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/procs/Vscb_AuditTrailReportInvoice.rdlc");
    ...
    private void GetPOWONo()
    {
        try
        {
            ...
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportPOWONo");
    ...
    private void GetPOWODate()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportPOWODate");
    ...
    private void GetVendorName()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportVendorName");
    ...
    private void GetInvoiceNo()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportInvoiceNo");
    ...
    private void GetPaymentRequestNo()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportPaymentRequestNo");
    ...
    private void GetPaymentRequestDate()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectPaymentRequestDate");
    ...
    //	{
    //		dtPOWONo = new DataTable();
    //		dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportDepartment");
    ...
    private void GetCostCentre()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportCostCenter");
    ...
    private void GetPaymentStatus()
    {
        ...
        {
            dtPOWONo = new DataTable();
            dtPOWONo = spm.GetVSCB_POWONoList(hdnEmpCode.Value, "SelectReportPaymentStatus");
    ...
    protected void lstreportType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            PAYMENTNO.Visible = true;
            PAYMENTDATE.Visible = true;
        }
        else
        {
            PAYMENTNO.Visible = false;
