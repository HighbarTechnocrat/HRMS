<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InterviewerFeedbac.aspx.cs"
	MaintainScrollPositionOnPostback="true" Inherits="procs_InterviewerFeedbac" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text=" Interviewer Feedback Screen"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div>
					...
					<span>
						<a href="Rec_InterviewerInbox.aspx?type=InShPInter" title="Back" runat="server" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
					</span>
				</div>
					...
					<ul id="editform" runat="server">
						...
						<div id="DivRecruitment" class="edit-contact" runat="server" visible="false">
                            ...
                            <asp:LinkButton ID="LinkButton1"  Visible="false" runat="server" OnClientClick="DownloadFile1()" ></asp:LinkButton>
								...
								<li class="trvl_date Req_Position"></li>
								<li></li>
								<li class="trvl_date">
	...
	<br />
	<br />
	<div runat="server" id="DivViewrowWiseCandidateInformation">
		<div class="edit-contact">
			<ul id="Ul2" runat="server">
				...
				<li class="upload" style="margin-bottom: 15px">
					<span style="margin-bottom: 10px">Resume View</span>&nbsp;&nbsp;<br />
				...
				<li class="trvl_date" style="padding-bottom: 20px">
					<span style="font-size: larger; text-decoration: underline">Interview Feedback Information: </span>&nbsp;&nbsp;
                            <br />
				</li>
				<li class="mobile_inboxEmpCode">
					<span></span>&nbsp;&nbsp;
				...
				<li class="mobile_InboxEmpName" style="padding-bottom: 10px">
					<span>Interview Round </span>&nbsp;&nbsp;
                            <br />
					<asp:DropDownList runat="server" ID="DDLInterviewRound" CssClass="DropDownList" Enabled="false">
					</asp:DropDownList>
				</li>
				<li class="" style="padding-bottom: 10px">
					<span>Interview Status </span>&nbsp;&nbsp;<span style="color: red">*</span>
					<br />
					<asp:DropDownList runat="server" ID="DDLInterviewStatus" CssClass="DropDownList" AutoPostBack="true" OnSelectedIndexChanged="DDLInterviewStatus_SelectedIndexChanged">
					</asp:DropDownList>
				</li>
				<li class="mobile_InboxEmpName" style="padding-bottom: 10px">
					<span>Interview Feedback </span>&nbsp;&nbsp;<span style="color: red">*</span>
					<br />
					<asp:DropDownList runat="server" ID="DDLInterviewFeedback" CssClass="DropDownList" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="DDLInterviewFeedback_SelectedIndexChanged">
					</asp:DropDownList>
				</li>
				<li class="mobile_InboxEmpName">
					<span>Interview Date </span>&nbsp;&nbsp;
                            <br />
					<asp:TextBox AutoComplete="off" ID="TxtInterviewDate" Enabled="false" runat="server"></asp:TextBox>
				</li>
				<li class="mobile_InboxEmpName">
					<span>Interview Time </span>&nbsp;&nbsp;
                            <br />
					<asp:TextBox AutoComplete="off" ID="TxtInterviewTime" Enabled="false" MaxLength="9" runat="server"></asp:TextBox>
				</li>
				<li>
					<span>Interview Type </span>&nbsp;&nbsp;<span style="color: red">*</span>
					<br />
					<asp:DropDownList runat="server" ID="lstInterviewType" CssClass="DropDownList"  AutoPostBack="true" OnSelectedIndexChanged="lstInterviewType_SelectedIndexChanged">
					</asp:DropDownList>
				</li>

				<li class="mobile_InboxEmpName">
					<span>Interview Next Round</span>&nbsp;&nbsp;
                            <asp:CheckBox runat="server" ID="chkbonxtround" Enabled="false" />
				</li>
				<li></li>
				<li></li>
				...
				<li class="mobile_InboxEmpName">
					<span>Interviewer Comments </span>&nbsp;&nbsp;<span style="color: red">*</span>
					<br />
					<asp:TextBox AutoComplete="off" ID="TxtInterviewerComments" MaxLength="200" runat="server" TextMode="MultiLine" Rows="5" CssClass="noresize"></asp:TextBox>
				</li>
				<li></li>
				<li></li>
				<li class="mobile_InboxEmpName">

					<asp:LinkButton ID="trvl_accmo_btn" runat="server" Text="Fill IR Sheet" ToolTip="Fill IR Sheet" CssClass="Savebtnsve" OnClick="trvl_accmo_btn_Click"></asp:LinkButton>

				</li>
				<li class="mobile_InboxEmpName">

					<asp:LinkButton ID="localtrvl_delete_btn" runat="server" Text="IR sheet Summary" ToolTip="IR sheet Summary" CssClass="Savebtnsve" OnClick="trvl_accmo_btn_Click"></asp:LinkButton>

				</li>

				<%--  <li class="mobile_InboxEmpName"> 
                              <span style="margin-bottom:10px">Download Blank IR Sheet</span>&nbsp;&nbsp;<br />
                             <asp:LinkButton ID="lnkbtnIRSheet"  runat="server" ForeColor="#ff0000" OnClientClick="return DownloadFileBlankIRSheet();"></asp:LinkButton>
                        </li>--%>


				<li class="mobile_InboxEmpName"></li>
				<li class="mobile_InboxEmpName">
					<span>Other File</span><br />
					<asp:FileUpload ID="uploadotherfile" runat="server" AllowMultiple="true" Width="200px" />
				...
				<li class="mobile_InboxEmpName" runat="server" id="liCandidatePhoto" visible="true" >
					<span>Candidate Photo</span> &nbsp;&nbsp;<span style="color: red;font-size: 16px;" id="SPPhoto" runat="server">*(only .jpg/ .jpeg/ .png/ .bmp)</span> 
					<asp:FileUpload ID="FilePhoto" runat="server" Visible="true" Width="200px" accept=".png,.jpg,.jpeg,.bmp,.PNG,.BMP,.JPG,.JPEG" AllowMultiple="false" onchange="fValidFileExt(this.value);" />
				</li>

				<li class="upload" style="margin-bottom: 15px" runat="server" id="viewphoto" visible="false">
				<span style="margin-bottom: 10px" >Candidate Photo</span>&nbsp;&nbsp;<br />
				<%-- <asp:FileUpload ID="uploadfile" runat="server" Enabled="false"/>--%>
				<asp:LinkButton ID="CandidatePhoto" runat="server" ForeColor="#ff0000" OnClientClick="return DownloadFiles();"></asp:LinkButton>
</li>
			</ul>
			<%--panel IR sheet--%>
			...
			<div id="IRsheetDetails" runat="server" visible="false">
				<div class="edit-contact">
					<ul>
						<li class="trvl_date" style="padding-bottom: 20px">
							<span style="font-size: larger; text-decoration: underline">IR sheet Details : </span>&nbsp;&nbsp;
                            <br />
						</li>
						<li></li>
						<li></li>
						<li class="mobile_inboxEmpCode">
							<span>Candidate's Name </span>&nbsp;&nbsp;<span style="color: red">*</span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtCandidName" runat="server" Enabled="false"></asp:TextBox>
						</li>
						<li class="mobile_InboxEmpName">
							<span>Position Titile </span>&nbsp;&nbsp;<span style="color: red"></span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtposotiontitile" runat="server" Enabled="false"></asp:TextBox>
						</li>
						<li class="mobile_InboxEmpName">
							<span>Experince(In Yrs)  </span>&nbsp;&nbsp;<span style="color: red"></span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtExperinceFrom" runat="server" Enabled="false"></asp:TextBox>
						</li>
						<%--<p>COMPETENCE EVALUATION</p>--%>
						<asp:GridView ID="DgvIrSheet" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
							DataKeyNames="Main_Type_ID,Ishedeing,SubType_Rating,SubType_ID" Width="100%" OnRowDataBound="DgvIrSheet_RowDataBound">
							<FooterStyle BackColor="White" ForeColor="#000066" />
							<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
							<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
							<RowStyle ForeColor="#000066" />
							...
							<Columns>
								...
								<asp:BoundField HeaderText="Competency"
									...
									ItemStyle-Width="30%"
									ItemStyle-BorderColor="Navy" />
								<asp:TemplateField HeaderText="Observation" HeaderStyle-Width="55%">
									<ItemTemplate>
										<asp:TextBox ID="txtObservationRemark" runat="server" onKeyUp="javascript:Count(this);" placeholder=" Observation Remarks" CssClass="noresize" AutoComplete="off" TextMode="MultiLine" Width="85%" Style="margin: 0px !important;"></asp:TextBox>
										<%--<span style="color: red">*</span>--%>
									</ItemTemplate>
									<ItemStyle HorizontalAlign="Center" Width="1%" />
								</asp:TemplateField>
								<asp:TemplateField HeaderText="Rating" HeaderStyle-Width="15%">
									<ItemTemplate>
										<asp:DropDownList runat="server" ID="ddlRating" Style="margin-top: 0px !important">
						...
						<br />
						<li><span>Remarks </span>&nbsp;&nbsp;<span style="color: red">*</span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtinterviewrRemark" onKeyUp="javascript:Count(this);" runat="server" CssClass="noresize" Style="width: 387%" Rows="4" TextMode="MultiLine"></asp:TextBox>
						</li>
						<asp:GridView ID="GRDOverallRating" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false"
							Width="100%" DataKeyNames="Rec_Main_Irsheet_ID" ShowFooter="true" OnRowDataBound="GRDOverallRating_RowDataBound">
							<FooterStyle BackColor="White" ForeColor="#000066" />
							<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
							<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
							<RowStyle ForeColor="#000066" />
							...
							<Columns>
								...
								<asp:TemplateField HeaderText="Interviewer level" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center">
									<ItemTemplate>
										<asp:Label ID="Label1" runat="server" Text='<%# Bind("InterviewRound") %>'></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label ID="lblRoundName" runat="server"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField HeaderText="Overall Rating" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center">
									<ItemTemplate>
										<asp:Label ID="Label3" runat="server" Text='<%# Bind("RatingName") %>'></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:DropDownList runat="server" ID="ddlOverallrating" Style="margin-top: 0px !important">
										</asp:DropDownList>
										<span style="color: red">*</span>
									</FooterTemplate>
								</asp:TemplateField>
								<asp:TemplateField HeaderText="Selection Recommendation" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center">
									<ItemTemplate>
										<asp:Label ID="Label4" runat="server" Text='<%# Bind("Selection_Recommendation") %>'></asp:Label>
									</ItemTemplate>

									<FooterTemplate>

										<asp:DropDownList runat="server" ID="ddlRecommendation" AutoPostBack="True" Style="margin-top: 0px !important" OnSelectedIndexChanged="ddlRecommendation_SelectedIndexChanged">
											<asp:ListItem Text="Select" Value="0"></asp:ListItem>
								...
								<asp:TemplateField HeaderText="Notes if any" HeaderStyle-Width="40%" ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center">
									<ItemTemplate>
										<asp:Label ID="Label5" runat="server" Text='<%# Bind("Notes") %>'></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:TextBox AutoComplete="off" ID="txtNotes" runat="server" onKeyUp="javascript:Count(this);" CssClass="noresize" TextMode="MultiLine" Style="margin: 0px !important;"></asp:TextBox>
										<span style="color: white">*</span>
									</FooterTemplate>
									<ItemStyle HorizontalAlign="Center" Width="1%" />
								</asp:TemplateField>
								<asp:TemplateField HeaderText="Name of the Interviewer" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="center" FooterStyle-HorizontalAlign="Center">
									<ItemTemplate>
										<asp:Label ID="Label6" runat="server" Text='<%# Bind("Emp_Name") %>'></asp:Label>
									</ItemTemplate>
									<FooterTemplate>
										<asp:Label ID="lblInterviewrName" runat="server"></asp:Label>
									</FooterTemplate>
								</asp:TemplateField>
							</Columns>
						</asp:GridView>
					...
					<div class="mobile_Savebtndiv">
						<asp:LinkButton ID="mobile_btnSave" runat="server" Text="Save IR Sheet" ToolTip="Save" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click" OnClientClick="return SaveMultiClickIR();">  Save IR Sheet</asp:LinkButton>
					</div>
				</div>
			</div>
		</div>
	</div>
	<%-- trvldeatils_btnSave first button  Send Reschedule Request--%>
	<%-- mobile_btnBack Second button  Submit Feedback--%>
	<div class="mobile_Savebtndiv" id="DivInterviewerShortListButton" runat="server">
		<asp:LinkButton ID="trvldeatils_btnSave" Visible="false" runat="server" Text="Submit" ToolTip="Submit"
			CssClass="Savebtnsve" OnClick="trvldeatils_btnSave_Click" OnClientClick="return SaveMultiClick();"></asp:LinkButton>
		<asp:LinkButton ID="mobile_btnBack" Visible="false" runat="server" Text="Clear Search" OnClientClick="return SaveMultiClickK();" ToolTip="Submit" OnClick="mobile_btnBack_Click"
			class="trvl_Savebtndiv">Submit</asp:LinkButton>
	...
	<asp:HiddenField ID="hdfilenameIRSheetvalue" runat="server" />
	<asp:HiddenField ID="hdnBankDetailID" runat="server" />
	<asp:HiddenField ID="HFISLMID" runat="server" />
	<asp:HiddenField ID="HFDCandidateScheduleRound_ID" runat="server" />
	<asp:HiddenField ID="hdnYesNo" runat="server" />
	<asp:HiddenField ID="HFFlagCheckFinilized" runat="server" />
	<asp:HiddenField ID="HFFlagCheckFinilizedNotJoin" runat="server" />
	...
	<asp:HiddenField ID="HiddenFieldInterviewFeedback" runat="server" />
	...
	<script type="text/javascript">
		...
		function SaveMultiClickK() {
			try {
				var retunboolean = true;
				var ele = document.getElementById('<%=mobile_btnBack.ClientID%>');
        ...
        function DownloadFiles() {
            var localFilePath = document.getElementById("<%=hdnPhoto.ClientID%>").value;
            var file = document.getElementById("<%=Hiddenphoto.ClientID%>").value;
				 //alert(localFilePath);
				 //alert(file); 
     //       window.open("http://localhost/APIAARP/api/ExcelDownload/Download?path1=" + localFilePath + "" + file); 
		...
		function DownloadFilemultiple(file) {
			var localFilePath = document.getElementById("<%=hdfilefath.ClientID%>").value;
             var file = document.getElementById("<%=hdnPhoto.ClientID%>").value;
			// alert(localFilePath); 
			// alert(file); 
		...
		$("#MainContent_trvl_accmo_btn").click(function () {
			// any value you need
		...
		function fValidFileExt(vfilePath) {
		 ...
		 // var varsource = vFileName;
			var varext = vFileName.substring(vFileName.lastIndexOf(".") + 1, vFileName.length).toLowerCase();
			var result = varext.toLowerCase();
			if (result == "jpeg" || result == "jpg" || result == "png" || result == "PNG" || result == "bmp" || result == "JPEG" || result == "JPG" || result == "BMP")
			{			
			}			
			else
			{
				alert("File Extension Is InValid - Only Upload jpg, jpeg,png, bmp");
				$('#MainContent_FilePhoto').val('');
			}
