<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TimesheetDetailsTReport.aspx.cs" Inherits="TimesheetDetailsTReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Team Timesheet Detail Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date" style="padding-bottom:15px">
                            ...
                            <span>From Date</span> &nbsp;&nbsp;       <span style="color:red">*</span>            
                                 <asp:TextBox ID="txtFromdate" CssClass="txtcls" Enabled="false"   AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date" style="padding-bottom:15px">
                            ...
                            <span>To Date</span> &nbsp;&nbsp;   <span style="color:red">*</span>          
                                 <asp:TextBox ID="txtToDate" CssClass="txtcls"  AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
