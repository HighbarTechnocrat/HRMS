<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_Plan_for_Approval.aspx.cs" Inherits="ABAP_Object_Tracker_Plan_for_Approval" EnableSessionState="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="ABAP Object Plan for Approval"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li>
                            <asp:LinkButton ID="lnkDownload" runat="server" OnClick="DownloadFile" Text="Download ABAP Object Plan" />
                        ...
                        <li class="trvl_grid" id="lirgsdetails" runat="server" visible="false">
                            ...
                            <asp:GridView ID="gvRGSDetails" runat="server" CssClass="Milestones" DataKeyNames="RGSDetailsId" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                CellPadding="3" AutoGenerateColumns="False" Width="130%">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                <PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
                                <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server" visible="false">
                            ...
                            <asp:GridView ID="gvFSDetails" runat="server" CssClass="Milestones" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
                                Width="110%" EditRowStyle-Wrap="true" DataKeyNames="FSDetailsId">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                <PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
                                <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvl_grid" id="liabapdev" runat="server" visible="false">
                            ...
                            <asp:GridView ID="gvABAPDevDetails" CssClass="Milestones" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                AutoGenerateColumns="False" Width="120%" EditRowStyle-Wrap="true" DataKeyNames="ABAPDetailsId">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                <PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
                                <RowStyle ForeColor="#000066" />
                    ...
                    <div class="trvl_Savebtndiv">
                        <asp:LinkButton ID="trvl_btnSave" runat="server" Text="Approve" ToolTip="Approve" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="ABAP_Object_Approve_btnSave_Click">Approve</asp:LinkButton>
                        <asp:LinkButton ID="btnCancel" runat="server" Text="Reject" ToolTip="Reject" CssClass="Savebtnsve" OnClientClick="return CancelMultiClick();" OnClick="ABAP_Object_Reject_btnSave_Click">Reject</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdnABAPObjectCreator_Email" runat="server" />
