<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_MyInvoiceACC.aspx.cs" Inherits="VSCB_MyInvoiceACC" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Uploaded Invoices"></asp:Label>
                    </span>
                </div>
