<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="Req_Vendor_Create.aspx.cs" Inherits="Req_Vendor_Create" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Create Vendor"></asp:Label>
                    </span>
                </div>
                 <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
                        <li class="mobile_inboxEmpCode">                            
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtVendorName" runat="server"></asp:TextBox>                            
                              </li>
    ...
    <div class="mobile_Savebtndiv">
        ...
        <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Req_Vendor_Details.aspx" >Back</asp:LinkButton>
