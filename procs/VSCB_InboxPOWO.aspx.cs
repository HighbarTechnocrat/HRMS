...
public partial class VSCB_InboxPOWO : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_ApprovePOWOMilestone.aspx?poid=" + hdnPOWOID.Value);
    }
    ...
    private void getMngTravelReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_Pending_POWOsList";
    ...
    private void get_myPOWOMilestone_DropdownList()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_Pendingpowo_Milestone_dropdown_List";
