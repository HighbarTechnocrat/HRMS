<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="RequisitionView.aspx.cs"
	MaintainScrollPositionOnPostback="true" Inherits="procs_RequisitionView" %>
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div>
					...
					<span>
						<a href="Rec_RequisitionViewListApproved.aspx" title="Back" runat="server" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
					</span>
					<br />
				</div>
