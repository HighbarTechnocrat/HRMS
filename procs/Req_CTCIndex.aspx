<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"  ValidateRequest="false"
	CodeFile="Req_CTCIndex.aspx.cs" Inherits="procs_Req_CTCIndex" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Inbox CTC Exception Approval Requests"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="manage_grid" style="width: 100%; height: auto; padding-top: 20px;">
					...
					<center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Recruitment_ReqID,Request_status,CTCID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging"  OnRowDataBound="gvMngTravelRqstList_RowDataBound" >
                        ...
                        <Columns>
							...
							<asp:BoundField DataField="Department_Name" HeaderText="Department" ItemStyle-Width="10px" />
							<asp:BoundField HeaderText="Skillset"
                                DataField="ModuleDesc" ItemStyle-Width="10px" />							
                            ...
                            <asp:BoundField HeaderText="Position Title"
                             ...
                             <asp:BoundField HeaderText="Band"
                                DataField="Band" ItemStyle-Width="2%" />

                             <asp:BoundField HeaderText="Location"
                                DataField="Location_name" ItemStyle-Width="15%" />

                             <asp:BoundField HeaderText="Reuqest Date"
                                DataField="CREATEDON"                                                            
                                ItemStyle-Width="7%" />
