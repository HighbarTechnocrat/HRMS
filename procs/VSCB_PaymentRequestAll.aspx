<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="VSCB_PaymentRequestAll.aspx.cs" 
    Inherits="procs_VSCB_PaymentRequestAll" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Pending Invoice's for payment"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="edit-contact">
					<ul id="editform" runat="server">
						...
						<li style="padding-top: 15px">
							...
							<asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstCostCentre" Visible="false">
							</asp:DropDownList>
				...
				<asp:Label runat="server" ID="RecordCount" Style="color: red; font-size: 14px;"></asp:Label>
                        ...
                        <asp:GridView ID="gvMngTravelRqstList" HeaderStyle-CssClass="GVFixedHeader" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="InvoiceID,POID,IsInvoiceWithPO"   CellPadding="3" AutoGenerateColumns="False" Width="120%"   EditRowStyle-Wrap="false" PageSize="15" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
                        ...
                        <Columns>
							 <asp:TemplateField HeaderText="View"  Visible="true">
                                <ItemTemplate >
                                 <asp:ImageButton id="lnkView" runat="server" ToolTip="View" Width="15px" Height="15px"  
                                     ImageUrl="~/Images/edit.png" OnClick="lnkView_Click"/>                               
                                </ItemTemplate> 
                                <ItemStyle HorizontalAlign="Center" />
                                 <ItemStyle Width="4%" />
								 
                            </asp:TemplateField>    
                            <asp:BoundField HeaderText="Invoice Created By" DataField="Emp_Name" 
                            ...
                            <asp:BoundField HeaderText="Invoice Amount (With GST) (A)" DataField="InvoiceAmount" 
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right" 
                                ItemStyle-Width="7%" /> 
                                
                            
							<asp:BoundField HeaderText="Direct Tax Amount (B)" DataField="DirectTaxAmount" 
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="7%" />

                            
							<asp:BoundField HeaderText="Invoice Payable Amount (C=A-B)" DataField="Payable_Amt_With_Tax" 
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-Width="8%" />
                            ...
                            <asp:BoundField HeaderText="Payment Requested Amount (With GST) (D)" DataField="PaymentRequested_Amt" 
                                ItemStyle-HorizontalAlign="Right"
                                 HeaderStyle-HorizontalAlign="Right" 
                                ItemStyle-Width="10%" />

                            <asp:BoundField HeaderText="Invoice Balance Amount (With GST) (E=C-D)" DataField="InvoiceBal_Amt" 
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right" 
                                ItemStyle-Width="8%" />
							
							<asp:BoundField HeaderText="PO/ WO Number" DataField="PONumber" 
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left" 
                                ItemStyle-Width="20%" />

                            <asp:BoundField HeaderText="PO/ WO Amount (With GST)" DataField="POWOAmt" 
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right" 
                                ItemStyle-Width="7%" />
				...
				<asp:HiddenField ID="hdnInvoiceWithPO" runat="server" />
