...
public partial class VSCB_MyPOWOMilestoneAcc : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_CreateMilestoneAcc.aspx?poid=" + hdnPOWOID.Value + "&mngexp=1");
    }
    ...
    private void getMngTravelReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_msgMilestoneList_ACC";
    ...
    private void get_myPOWOMilestone_DropdownList()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_mypowo_Milestone_dropdown_List_ACC";
