<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_Myapprovedbatch.aspx.cs" Inherits="VSCB_Myapprovedbatch" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Approved Batch Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li style="padding-top: 15px">
                              <span style="display:nonen">Cost Center</span> 
                    ...
                    <asp:GridView ID="gvMngTravelRqstList"  runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="Batch_ID" CellPadding="3" AutoGenerateColumns="False" Width="90%" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="View" ItemStyle-Width="3%" ItemStyle-HorizontalAlign="left">
                                <ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="No Of Batch Request"
                            ...
                            <asp:BoundField HeaderText="Batch Creator Name"
                                DataField="batch_Creator_name"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
