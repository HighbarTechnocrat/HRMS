<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_RGS_FS_ABAP_Test.aspx.cs"
    Inherits="procs_ABAP_Object_Tracker_Change_Status_RGS_FS_ABAP_Test" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Change Status RGS-FS-HBT-CTM-Test"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date">
                                    <asp:Label ID="lbl3" runat="server" Text="Revised / Actual Submission"></asp:Label>
                                    <br />
                                ...
                                <li class="trvl_date">
                                    <asp:Label ID="lbl4" runat="server" Text="Revised / Actual Approval"></asp:Label>
                                    <br />
                                ...
                                <li>
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="FS Stage Uploaded Attachment"
                                                DataField="FileName"
                ...
                <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtenderABAPTimesheet" runat="server"
                    ...
                    OnOkScript="ok()" CancelControlID="LinkButton3" />

                <asp:Panel ID="PnlABAPTimeSheet" runat="server" CssClass="testABAP">
                    <div runat="server" id="DivIDABAPTimesheetPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="Ul1">
                                ...
                                <li></li>
                                <li>
                                    <asp:LinkButton ID="LinkButton3" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="LinkBtnBackPopup_Click" BackColor="#3D1956">Back</asp:LinkButton>
                                </li>
                                ...
                                <li style="width: 100% !important">
                                    <asp:GridView ID="gvTimesheet" runat="server" CssClass="Milestones" DataKeyNames="ABAPDetailsId" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" ShowHeaderWhenEmpty="True">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Object Description"
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <asp:GridView ID="gvRGSDetails" runat="server" CssClass="Milestones"
                                DataKeyNames="RGSDetailsId"
                                BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Revised / Actual Preparation Start Date"
                                        DataField="RevActualPrepStart" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="Revised / Actual Preparation Finish Date"
                                        DataField="RevActualPrepFinish" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="Revised / Actual Submission Date"
                                        DataField="RevActualSubmit" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="Revised / Actual Approval Date"
                                        DataField="RevActualApprove" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="RGS Status"
                                        DataField="RGSStatuss" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
                            ...
                            <span class="fs" runat="server" visible="true" id="fs">
                                <br />
                                FS</span>
                            <asp:GridView ID="gvFSDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="6%">
                                        ...
                                        <ItemTemplate>
                                            <asp:HiddenField ID="hdcheckflag" runat="server" Value='<%# Bind("Checkflag") %>' />
                            ...
                            <span class="ABAP" runat="server" visible="true" id="ABAP">ABAP</span>
                            ...
                            <span class="hbttest" runat="server" visible="true" id="hbttest">
                                <br />
                                HBT Testing</span>
                            <asp:GridView ID="gvHBTTestDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="6%">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="lnkEdit" runat="server" Height="15px" OnClick="lnkEdit_Click3" OnClientClick="showPopup();" ImageUrl="~/Images/edit.png" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <span class="ctmtesting" runat="server" visible="true" id="ctmtesting">
                                <br />
                                CTM Testing</span>
                            <asp:GridView ID="gvCTMTestDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="6%">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="lnkEdit" runat="server" Height="15px" OnClick="lnkEdit_Click4" OnClientClick="showPopup();" ImageUrl="~/Images/edit.png" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField HeaderText="Planned Finish Date Date"
                        ...
                        <li style="width: 50%;">
                            <asp:LinkButton ID="btn_SumitTimesheet" runat="server" Text="Submit Timesheet" ToolTip="Submit Timesheet" BackColor="#3D1956" OnClick="btn_SumitTimesheet_Click" Visible="false">Submit Timesheet</asp:LinkButton>
