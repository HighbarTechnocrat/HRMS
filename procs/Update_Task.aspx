<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="Update_Task.aspx.cs" ValidateRequest="false" Inherits="Update_Task" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_lnk_Task_DeleteSubTask,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Edit Task"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <span runat="server" id="backToArr" visible="true">
                    <a href="MyTask.aspx" class="aaaa">Back</a>
                </span>
                <span>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_InboxEmpName">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_Metting_Dis" AutoPostBack="true" oncopy="return false" onpaste="return false" MaxLength="15" runat="server" OnTextChanged="txt_Metting_Dis_TextChanged"></asp:TextBox>
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_Meeting_Type" Width="350px" AppendDataBoundItems="false" AutoPostBack="false" OnSelectedIndexChanged="ddl_Meeting_Type_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li></li>
                        <hr />
                        ...
                        <li style="margin-top: 10px; align-items: center;">
                            ...
                            <asp:LinkButton ID="btn_ATT_Update" Visible="false" Style="padding: 4px 10px 4px 10px;" runat="server" Text="Update" ToolTip="Update" OnClientClick="return SaveFD2Click();" CssClass="Savebtnsve" OnClick="btn_ATT_Update_Click"></asp:LinkButton>
                        ...
                        <li>
                            <asp:Label runat="server" ID="Label3" Visible="True" Style="color: red; font-size: 16px; font-weight: 500; text-align: center;"></asp:Label></li>
                        <li style="width: 100%">
                        ...
                        <li class="mobile_InboxEmpName">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_TaskDescripation" MaxLength="250" CssClass="noresize" TextMode="MultiLine" Rows="4" runat="server" Visible="True"></asp:TextBox>
                        </li>
                        <li class="mobile_InboxEmpName">
                            <span>Task Remarks</span><span style="color: red">*</span><br />
                            <asp:TextBox AutoComplete="off" ID="txt_TaskRemark" MaxLength="250" runat="server" CssClass="noresize" TextMode="MultiLine" Rows="4" Visible="True"></asp:TextBox>
                        </li>
                        ...
                        <li style="margin-top: 10px; align-items: center; width: 100%; margin-left: 25%;">
                            ...
                            <asp:LinkButton ID="lnk_Task_DeleteSubTask" Visible="false" runat="server" Text="Delete Sub Task" ToolTip="Delete Sub Task" OnClientClick="return DeleteTaskClick();" CssClass="Savebtnsve" OnClick="lnk_Task_Create_Click"></asp:LinkButton>
                        </li>
                        ...
                        <li style="width: 100%; text-align: center">
                            <br />
                            <br />
                            <asp:LinkButton ID="lnk_Final_Submit" Visible="true" runat="server" Text="Submit" ToolTip="Create" OnClientClick="return FinalSubmitClick();" CssClass="Savebtnsve" OnClick="lnk_Final_Submit_Click" CommandArgument="0"></asp:LinkButton>
                            &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:HiddenField ID="hdnIstaskSaveAsDraft" runat="server" />
