<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_ABAP.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_ABAP" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="ABAP Development - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li id="li_ReusableClientName" runat="server">
                                    <span>Reusable Client Name</span>
                                    <br />
                                    <asp:TextBox ID="txt_ReusableClientName" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                <li id="li_ReusableStatus" runat="server">
                                    <span>Reusable Status</span>
                                    <br />
                                    <asp:TextBox ID="txt_ReusableStatus" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                <li id="li_ReusableAdditonalEffort" runat="server">
                                    <span>Reusable Additional Efforts (Days)</span>
                                    <br />
                                    <asp:TextBox ID="txt_ReusableAdditonalEffort" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                <li id="li_ReusablePercent" runat="server">
                                    <span>Reusable Percentage</span>
                                    <br />
                                    <asp:TextBox ID="txt_ReusablePercent" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                <li id="li_ReusableDetailsRemarks" runat="server">
                                    <span>Reusable Remarks</span>
                                    <br />
                                    <asp:TextBox ID="txt_ReusableDetailsRemarks" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                <li id="li_Custom_Tcode" runat="server">
                                    <span>Custom TCode</span>
                                    <br />
                                    <asp:TextBox ID="txt_Custom_Tcode" runat="server" Enabled="false" Width="200px"></asp:TextBox>
                                </li>
                                ...
                                <li style="width: 40%">
                                    <span runat="server" id="spnfsdocs" visible="false">Function Specification Doucment</span>
