<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="VSCB_PaymentRequestView.aspx.cs" Inherits="procs_VSCB_PaymentRequestView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text=" View Approve Payment Request"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span>
                        <a href="VSCB_InboxPaymentRequestView.aspx" title="Back" runat="server" visible="false" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul id="Ul2" runat="server">
                                ...
                                <span runat="server" id="SpanAccounttobepaid">
                                    <span class="LableName" runat="server"  id="Span2">Payment Invoice Detail
							</span> 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Amount To be Requested"
                                 ...
                                 <asp:BoundField HeaderText="Amount paid by Account"
                                        DataField="AccountpaidbyAmountt"
                                       ItemStyle-HorizontalAlign="right"
                                        HeaderStyle-HorizontalAlign="right"
                                        ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
                                ...
                                <li class="trvl_date" runat="server" id="Account1">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <br />
                                            <asp:TextBox AutoComplete="off" ID="txtAccountPaidAmt" runat="server" CssClass="number" AutoPostBack="true" OnTextChanged="txtAccountPaidAmt_TextChanged" MaxLength="20"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <%--<li class="trvl_date">
                                    ...
                                    <asp:TextBox AutoComplete="off" Visible="false" ID="txtApprovalRemark" CssClass="noresize" runat="server" Width="288%" TextMode="MultiLine" Rows="5" onKeyUp="javascript:Count(this);"></asp:TextBox>
                                </li>
                                <li></li>
                                <li></li>--%>

                                <li class="trvl_date" id="liPaySuppFiles1" runat="server" visible="false">
                                ...
                                <li id="liPaySuppFiles2" runat="server" visible="false"></li>
                                <li id="liPaySuppFiles3" runat="server" visible="false"></li>

                                <li class="trvl_grid" id="liGrdFileUpload" runat="server">
                                ...
                                <li id="liPayApproval" runat="server" visible="false">
                                    <br />
                                    <span class="LableName" runat="server" id="Span3">Approvals:
                                    </span>
                                </li>
                                <li id="liPayApproval2" runat="server" visible="false"></li>
                                <li id="liPayApproval3" runat="server" visible="false"></li>
                                

                                <li class="trvl_grid" id="liDgvApprover" runat="server" visible="false">
    ...
    <div class="Req_Savebtndiv" style="text-align: center">
        <br />
        <asp:LinkButton ID="localtrvl_btnSave" Visible="false" runat="server" Text="Save As Draft" ToolTip="Approve" CssClass="Savebtnsve" OnClick="localtrvl_btnSave_Click" OnClientClick="return SaveMultiClick();">Approve </asp:LinkButton>
        ...
        <asp:LinkButton ID="trvldeatils_cancel_btn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_InboxPaymentRequestView.aspx">   Back</asp:LinkButton>
