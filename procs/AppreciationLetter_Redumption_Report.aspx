<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="AppreciationLetter_Redumption_Report.aspx.cs" Inherits="AppreciationLetter_Redumption_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <br /> 
            <asp:Label ID="lblheading" runat="server" Text="Redumption Report"></asp:Label>
        </span>
    </div>
