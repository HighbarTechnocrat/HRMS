...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_service_btnInternalComments
        {
    background: #3D1956;
    ...
    margin: 0% 0% 0 0;
        ...
        #MainContent_service_btnAssgine, #MainContent_service_btnClose, #MainContent_service_btnEscelateToHOD, #MainContent_service_btnEscelateToCEO, #MainContent_service_btnClearText, #MainContent_service_btnSendSPOC, 
        #MainContent_mobile_btnCorrection,
        #MainContent_service_btnInternalComments
        {
            background: #3D1956;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="CustomerFIRST - Response Negative Feedback"><%=ConfigurationManager.AppSettings["CustomerFeedbackTitle"]%> - Response Negative Feedback</asp:Label>
                    </span>
                </div>
                <div>
                ...
                <span runat="server" id="homeBtn">
                    <a href="customerFirst.aspx" style="margin-right: 18px;" class="aaaa"><%=ConfigurationManager.AppSettings["CustomerFeedbackTitle"]%> Home</a>&nbsp;&nbsp; 
                </span>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_inboxEmpCode">
                         ...
                         <li class="mobile_inboxEmpCode" runat="server" id="litxtComment">
                            <span runat="server" id="lblCommentLble">Note for yourself</span>&nbsp;<span style="color:red">*</span>
                            <br />
                        ...
                        <li runat="server" id="libtn">
                            <asp:LinkButton ID="service_btnEscelateToCEO" Visible="false" runat="server" Text="Close Incident and Resend Survey" ToolTip="Close Incident and Resend Survey" CssClass="Savebtnsve" OnClientClick="return submitCEO();" OnClick="service_btnEscelateToCEO_Click">Close Incident and Resend Survey</asp:LinkButton>
                            <asp:LinkButton ID="service_btnEscelateToHOD" Visible="false" runat="server" Text="Close Incident and Resend Survey" ToolTip="Close Incident and Resend Survey" CssClass="Savebtnsve" OnClientClick="return submitHOD();" OnClick="service_btnEscelateToHOD_Click">Close Incident and Resend Survey</asp:LinkButton>
                            <asp:LinkButton ID="service_btnSendSPOC" Visible="false" runat="server" Text="Close Incident and Resend Survey" ToolTip="Close Incident and Resend Survey" CssClass="Savebtnsve" OnClientClick="return submitHODPM();" OnClick="service_btnSendSPOC_Click">Close Incident and Resend Survey</asp:LinkButton>
                            <asp:LinkButton ID="service_btnAssgine" Visible="false" runat="server" Text="Close Incident and Resend Survey" ToolTip="Close Incident and Resend Survey" CssClass="Savebtnsve" OnClientClick="return submitPM();" OnClick="btnSave_Click">Close Incident and Resend Survey</asp:LinkButton>
                        ...
                        <li>
                              <asp:LinkButton ID="service_btnInternalComments"  runat="server" Text="Save Internal Comments" ToolTip="Save Internal Comments" CssClass="Savebtnsve1" OnClick="service_btnInternalComments_Click" >Save Note for Yourself</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdnHODComment" runat="server" />
     <asp:HiddenField ID="hdnCEOComment" runat="server" />
    <asp:HiddenField ID="hdnStatus" runat="server" />

    <asp:HiddenField ID="hdnEmpCode_PRM" runat="server" />
    <asp:HiddenField ID="hdnEmpCode_DH" runat="server" />
    <asp:HiddenField ID="hdnEmpCode_CEO" runat="server" />
