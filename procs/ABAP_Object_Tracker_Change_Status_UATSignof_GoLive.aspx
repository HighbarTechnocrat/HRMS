<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableSessionState="True"
    CodeFile="ABAP_Object_Tracker_Change_Status_UATSignof_GoLive.aspx.cs" 
    Inherits="procs_ABAP_Object_Tracker_Change_Status_UATSignof_GoLive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Change Status UAT Sign-of / Go Live"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <asp:Panel ID="PnlIrSheet" runat="server" Style="display: none; position: fixed; top: 20%; left: 20%; transform: translate(-20%, -30%,-30%); width: 80%; padding: 20px; background-color: white; border: 1px solid #ccc; z-index: 1000;"
                    Height="500px">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:TextBox ID="Txt_DevelopmentDescription" Enabled="false" runat="server" Width="460px"></asp:TextBox>
                                </li>
                                <li>
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txt_RevisedDate" runat="server" Width="200px" 
                                ...
                                <li class="trvl_date" runat="server" id="UATDisplay2">
                                </li>
                                <li runat="server" id="UATDisplay3">
                                </li>

                                <li class="trvl_date">
                                   <asp:Label ID="lbl5" runat="server" Text="UAT Status"></asp:Label>
                                    <br />
                                    <asp:DropDownList runat="server" ID="AllStatus" Width="250px">
                                    </asp:DropDownList>
                                </li>
                                ...
                                <li></li>
                                  ...
                                  <%--<li class="trvl_date">
                                   <asp:Label ID="Label5" runat="server" Text="UAT Status"></asp:Label>
                                     <br />
                                      <asp:Label ID="Label6" runat="server" Text="UAT Status"></asp:Label>
                                </li>
                                 <li class="trvl_date">
                                    <asp:Label ID="Label7" runat="server" Text="UAT Status"></asp:Label>
                                     <br />
                                      <asp:Label ID="Label8" runat="server" Text="UAT Status"></asp:Label>
                                </li>
                                 <li class="trvl_date">
                                    <asp:Label ID="Label9" runat="server" Text="UAT Status"></asp:Label>
                                     <br />
                                      <asp:Label ID="Label10" runat="server" Text="UAT Status"></asp:Label>
                                </li>--%>
                                ...
                                <li id="PlnEmptyDate" runat="server">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <br />
                            <span class="rgs" runat="server" visible="true" id="rgs">UAT Sign Off</span>
                            <asp:GridView ID="gvRGSDetails" runat="server" CssClass="Milestones"
                                DataKeyNames="UATSignOffId"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Final Script Sub Date"
                                        DataField="Final_Script_Sub_Date"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
                                    ...
                                    <asp:BoundField HeaderText="UAT Status"
                                        DataField="UATStatus" ItemStyle-HorizontalAlign="Left"
                            ...
                            <br />
                            <span class="fs" runat="server" visible="true" id="fs">GO Live</span>
                            <asp:GridView ID="gvFSDetails" runat="server" BackColor="White" BorderColor="Navy" 
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            applyGridViewScroll('#MainContent_GVCTMDetails', gridOptions);
