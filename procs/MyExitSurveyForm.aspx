<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="MyExitSurveyForm.aspx.cs" Inherits="procs_MyExitSurveyForm" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Exit Survey Forms"></asp:Label>
                    </span>
                </div>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Reason Of Resignation"
                             ...
                             <asp:BoundField HeaderText="Resignation submitted on"
                                ...
                                ItemStyle-BorderColor="Navy"
                                />
                            <asp:BoundField HeaderText="Exit Survey Submitted on"
                                DataField="Exit Survey Submitted on"
                                 ItemStyle-HorizontalAlign="center"
                                ItemStyle-Width="10%" 
                                ItemStyle-BorderColor="Navy"
                                />
