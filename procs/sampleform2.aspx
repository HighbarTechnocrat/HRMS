...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform2.aspx.cs" Inherits="myaccount_SampleForm" %>
...
<div class="containerDiv1">
  ...
  <div class="rowDivHead">
    <div class="cellDivHead">Date</div>
    <div class="cellDivHead">Type</div>
    <div class="cellDivHead">Time</div>
    <div class="cellDivHead"> Status</div>
    <div class="cellDivHead">Category*</div>
    <div class="cellDivHead">Reason / Remark</div>
<div class="cellDivHead">Select</div>
  </div>

    <div class="rowDiv">
   <div class="cellDiv1">01/09/2017</div>
    <div class="cellDiv1">Out</div>
    <div class="cellDiv1">04:30:00 PM</div>
    <div class="cellDiv1">ABSENT</div>
    <div class="cellDiv1">Early Going</div>
    <div class="cellDiv1">tttt</div>
    <div class="cellDiv1"></div>
