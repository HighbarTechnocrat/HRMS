<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ThankyouCard_Index.aspx.cs" Inherits="ThankyouCard_Index" %>
                            ...
                            <table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle" id="td1" runat="server">
                                        <asp:LinkButton ID="lnk_leaveinbox" runat="server" Visible="true" ToolTip="Send Thank You Card" PostBackUrl="~/procs/Thank_You_Card.aspx">Send Thank You Card</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                         <asp:LinkButton ID="lnk_MobACC" runat="server" Visible="true" ToolTip="Thank You Card Report" PostBackUrl="~/procs/thankyou_card_report_View.aspx">Thank You Card Report</asp:LinkButton>
                                  <asp:LinkButton ID="lnk_MobACC1" runat="server" Visible="false" ToolTip="Thank You Card Report" PostBackUrl="~/procs/thankyoucard_report.aspx">My Thank You Card Report</asp:LinkButton>
                                        
                                        </td>
                                </tr>
                                 <tr style="padding-top: 1px; padding-bottom: 2px;" id="report" runat="server" visible="false">
                                        <td class="formtitle"> <asp:LinkButton ID="lnk_Index_Acc_Batch_Approval" runat="server" Visible="true" ToolTip="Thank You Card Report" PostBackUrl="~/procs/thankyoucard_report.aspx">Thank You Card Report (ALL Employee)</asp:LinkButton>
                                ...
                                <%--Create KRA--%>
                                <tr style="padding-top: 1px; padding-bottom: 2px;" id="trAdminBooking_Requets" runat="server" visible="false">
                                    <td class="formtitle" id="tdCreateKRA" runat="server">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server" Visible="true" ToolTip="Travel Requisitions for Booking" PostBackUrl="~/procs/TravelRequisitionsforBooking.aspx" >Inbox Travel Requisitions </asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" Visible="true" ToolTip="Travel Requisitions " PostBackUrl="~/procs/BookedNotBookedTravelRequisitions.aspx">Booked / Not Booked Travel Requisitions</asp:LinkButton>
                                    </td>
                                </tr>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle" id="td5" runat="server">
                                        <asp:LinkButton ID="lnk_Index_Acc_Batch_Approvals" runat="server" Visible="false" ToolTip="Reset KRA" PostBackUrl="~/procs/KRA_Reset.aspx">Reset KRA</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
