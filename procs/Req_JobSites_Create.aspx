<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Req_JobSites_Create.aspx.cs" Inherits="Req_JobSites_Create" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Create Job Sites"></asp:Label>
                    </span>
                </div>
                 <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
                        <li class="mobile_inboxEmpCode">                            
                            <span >Job Sites Name  </span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <br />
                               <asp:TextBox AutoComplete="off" ID="txtJobSitesName" runat="server"></asp:TextBox>                            
                               </li>
    ...
    <div class="mobile_Savebtndiv">
        ...
        <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Req_JobSites_Details.aspx" >Back</asp:LinkButton>
