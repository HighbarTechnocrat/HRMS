<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ABAP_Object_Tracker_Change_Status_ABAP_Accept_NotAccept.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_ABAP_Accept_NotAccept" EnableSessionState="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    z-index: 1000;
        ...
        select#MainContent_AllStatus, select#MainContent_DDLReason {
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Functional Specification Acceptance"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date" runat="server" id="liStart">
                                ...
                                <li class="trvl_date" runat="server" id="lifinish">
                                ...
                                <li runat="server" id="liEmpty1"></li>


                                <li class="trvl_date" runat="server" id="liSubmitssion">
                                ...
                                <li class="trvl_date" runat="server" id="liApproval">
                                ...
                                <li runat="server" id="liEmpty2"></li>

                                <li class="trvl_date">
                                    <asp:Label ID="lbl5" runat="server" Text="Status"></asp:Label><span style="color: red" runat="server" id="Span3">*</span>
                                    <br />
                                    <asp:DropDownList runat="server" ID="AllStatus" Width="250px" OnSelectedIndexChanged="AllStatus_SelectedIndexChanged" AutoPostBack="true" Style="margin: 5px 0 0 0 !important"></asp:DropDownList>
                                ...
                                <li>
                                    <br />
                                    <span runat="server" id="spnreason" visible="false">Select Reason</span><span style="color: red" runat="server" id="Span4" visible="false">*</span>
                                    <asp:DropDownList runat="server" ID="DDLReason" Visible="false"></asp:DropDownList>
                                </li>
                                <li></li>
                                <li></li>
                                ...
                                <li>
                                    <span runat="server" id="spnfsdocs" visible="false">Function Specification Doucment</span><br />
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                        AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false" DataKeyNames="Srno" Style="margin: 5px 0 0 0 !important">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                            ...
                            <asp:GridView ID="gvABAPDevDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Functional Status"
                                        DataField="FSAcceptance_DisplayName"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="8%" HeaderStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
                                    <%--DataField="ABAPFunctionalStatuss--%>
                                    ...
                                    <asp:BoundField HeaderText="Interface"
                                        ...
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="6%" HeaderStyle-Width="7%"
                                        ItemStyle-BorderColor="Navy" />
                        ...
                        <li style="width: 50%;">
                            ...
                            <%--<asp:LinkButton ID="btnRedirect" runat="server" Text="Fil the timesheet" OnClick="btnRedirect_Click" ></asp:LinkButton>--%>
