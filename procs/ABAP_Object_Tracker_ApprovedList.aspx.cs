...
public partial class ABAP_Object_Tracker_ApprovedList : System.Web.UI.Page
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect(ReturnUrl("sitepathmain") + "login.aspx?ReturnUrl=" + ReturnUrl("sitepathmain") + "procs/ABAP_Object_Tracker_Index.apspx");
            }
            else
            {
    ...
    #region Page Methods
    private void getABAPObjectPlanList()
    {
        try
        { 
            ...
            spars[0].Value = "GetABAPObjectPlanList";
            ...
            else if (objDS.Tables[2].Rows.Count > 0)
            {
