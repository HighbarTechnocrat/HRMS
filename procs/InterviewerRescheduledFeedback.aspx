<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InterviewerRescheduledFeedback.aspx.cs" 
    MaintainScrollPositionOnPostback="true" Inherits="procs_InterviewerRescheduledFeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Interview Scheduler Status Update Screen"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span>
                       <a href="InterviewRescheduledList.aspx" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
    ...
    <div class="manage_grid" style="width: 73%; height: auto; padding-left:40px" runat="server" id="DivSendshortlisting3">
                          <asp:GridView ID="gvCandidateinterviewroundInformation" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px" 
                            DataKeyNames="CandidateScheduleRound_ID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Interview Date"  DataField="InterviewDate"  ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left" ItemStyle-Width="15%" ItemStyle-BorderColor="Navy"/>
                             <asp:BoundField HeaderText="Enterview Time"  DataField="InterviewTime" ItemStyle-HorizontalAlign="center"
                                ItemStyle-Width="10%"   ItemStyle-BorderColor="Navy"  />
                            <asp:BoundField HeaderText="Interviewer / Interview Schedular"  DataField="InterviewerName" ItemStyle-HorizontalAlign="center"                                 
                            ...
                            <asp:BoundField HeaderText="Interview Feedback"  DataField="InterviewFeedback" ItemStyle-HorizontalAlign="center"
                                ItemStyle-Width="15%"   ItemStyle-BorderColor="Navy"  />
                           <asp:BoundField HeaderText="Interview Round"  DataField="InterviewRound" ItemStyle-HorizontalAlign="center" 
                                ItemStyle-Width="15%"   ItemStyle-BorderColor="Navy" />
                        </Columns>
                    </asp:GridView>
                </div>
                    ...
                    <ul id="Ul2" runat="server">
                      ...
                      <%--  <li class="trvl_date" style="padding-bottom:20px" runat="server" id="LiSalarySection1">                            
                        ...
                        <li></li>
                         ...
                         <li class="trvl_date" style="padding-bottom:20px">                            
                            <span  style="font-size:larger;text-decoration:underline"> Interview Information: </span>&nbsp;&nbsp;
                            <br />
                        </li>
                        <li class="mobile_inboxEmpCode">                            
                            <span > </span>&nbsp;&nbsp;
                        ...
                        <li class="mobile_InboxEmpName">                            
                         ...
                         <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="DDLInterviewRound" Enabled="false">
                            </asp:DropDownList>
                        </li>
                         <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                              <span>Interviewer</span>&nbsp;&nbsp;
                            <br />
                            <asp:DropDownList runat="server" ID="lstInterviewerOne"  Enabled="false">
                            </asp:DropDownList>
                        </li>
                        ...
                        <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="DDLInterviewStatus"  AutoPostBack="true" OnSelectedIndexChanged="DDLInterviewStatus_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        ...
                        <li class="trvl_date" style="padding-bottom:20px" runat="server" id="CreateRescheduleID1" visible="false">                            
                            <span  style="font-size:larger;text-decoration:underline">Reschedule Interview Process : </span>&nbsp;&nbsp;
                            <br />
                        </li>
                        <li class="mobile_inboxEmpCode" runat="server" id="CreateRescheduleID2" visible="false">                            
                            <span > </span>&nbsp;&nbsp;
                            <br />
                        </li>
                        <li class="mobile_InboxEmpName" runat="server" id="CreateRescheduleID3" visible="false">                            
                            <span > </span>&nbsp;&nbsp;
                            <br />
                        </li>

                        <li class="mobile_InboxEmpName" style="padding-bottom:10px" runat="server" id="CreateRescheduleID4" visible="false"> 
                              <span>New Interviewer</span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <br />
                            <asp:DropDownList runat="server" ID="lstCreateInterviewerOne">
                            </asp:DropDownList>
                        </li>
                        <li class="mobile_InboxEmpName" runat="server" id="CreateRescheduleID5" visible="false">                            
                            <span > Interview Date </span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TxtCreInterviewDate"   runat="server"></asp:TextBox>
                             <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" TargetControlID="TxtCreInterviewDate"
                                  OnClientDateSelectionChanged="checkDate"    runat="server">
                                </ajaxToolkit:CalendarExtender>
                        </li>
                        <li class="mobile_InboxEmpName" runat="server" id="CreateRescheduleID6" visible="false">                            
                            <span > Interview Time </span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TxtCreInterviewTime"  MaxLength="9" runat="server"></asp:TextBox>
                        </li>
      ...
      <div class="mobile_Savebtndiv"  id="DivInterviewerShortListButton"  runat="server">
        <asp:LinkButton ID="trvldeatils_btnSave" runat="server" Text="Submit" ToolTip="Submit"
         CssClass="Savebtnsve"  OnClick="trvldeatils_btnSave_Click" Visible="false" OnClientClick="return SaveMultiClick();" ></asp:LinkButton>
         <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Clear Search" Visible="false" OnClientClick="return SaveMultiClickK();" ToolTip="Submit"  OnClick="mobile_btnBack_Click"
    ...
    <script type="text/javascript">      
        $(document).ready(function () {
            ...
            $("#MainContent_DDLInterviewRound").select2();  
            $("#MainContent_DDLInterviewStatus").select2();
            $("#MainContent_lstInterviewerOne").select2(); 
            $("#MainContent_lstCreateInterviewerOne").select2();
        });
    </script>
