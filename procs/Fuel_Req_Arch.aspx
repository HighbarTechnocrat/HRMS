<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Fuel_Req_Arch.aspx.cs" Inherits="myaccount_AppFuel_RemRequest_o_ACC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <div class="commpagesdiv">
    ...
    <div class="fuel_Savebtndiv">
        <asp:LinkButton ID="fuel_btnSave" runat="server" Visible="false" Text="Approve" ToolTip="Approve" CssClass="Savebtnsve" OnClick="fuel_btnSave_Click" OnClientClick="return SaveMultiClick();">Approve</asp:LinkButton>
        <asp:LinkButton ID="fuel_btnSave_ACC" runat="server" Text="Submit" Visible="false" ToolTip="Submit" CssClass="Savebtnsve" OnClick="fuel_btnSave_Click" OnClientClick="return SaveMultiClick_ACC();">Submit</asp:LinkButton>
          ...
          <asp:LinkButton ID="fuel_btnCorrection" Visible="false" runat="server" Text="Send For Correction" ToolTip="Send For Correction" CssClass="Savebtnsve"  OnClientClick="return SendforCorrectionMultiClick();" OnClick="fuel_btnCorrection_Click" >Send For Correction</asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        function DownloadFile(file) {
            ...
            //alert(localFilePath);
            window.open("https://ess.highbartech.com/oneHRAPI/api/ExcelDownload/Download?path1=" + localFilePath + localFilefolder + "/" + file);
        }
    </script>
</asp:Content>
