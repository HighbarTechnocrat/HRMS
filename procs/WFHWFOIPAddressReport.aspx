<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="WFHWFOIPAddressReport.aspx.cs" Inherits="WFHWFOIPAddressReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Attendance Trace Report"></asp:Label>
                    </span>
                       ...
                       <%-- <li><span>Select Month Year</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                        ...
                        <li class="date">
                            ...
                            <span>From Date</span> &nbsp;&nbsp;<span style="color:red">*</span>      
                                 <asp:TextBox ID="txtFromdate" CssClass="txtcls" Enabled="true"   AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
