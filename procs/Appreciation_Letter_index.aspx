...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_lnk_RedmptionRequest:link, #MainContent_lnk_RedmptionRequest:visited,
        #MainContent_lnk_Redmption_req_view:link, #MainContent_lnk_Redmption_req_view:visited,
        #MainContent_lnk_viewbtn:link, #MainContent_lnk_viewbtn:visited,
        #MainContent_lnk_approvebtn:link, #MainContent_lnk_approvebtn:visited,
        #MainContent_lnk_report:link, #MainContent_lnk_report:visited
        {
        ...
        #MainContent_lnk_RedmptionRequest:hover, #MainContent_lnk_RedmptionRequest:active,
        #MainContent_lnk_Redmption_req_view:hover, #MainContent_lnk_Redmption_req_view:active,
        #MainContent_lnk_viewbtn:hover, #MainContent_lnk_viewbtn:active,
        #MainContent_lnk_lnk_report:hover, #MainContent_lnk_report:active,
        #MainContent_lnk_lnk_report:hover, #MainContent_lnk_report:active
        {
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    ...
                    <div>
                        <span>
                            <a href="http://ess.highbartech.com/hrms/PersonalDocuments.aspx" class="aaaa">My Corner</a>
                        </span>
                    </div>
                    <%--  <div class="leavegrid">
                        ...
                        <div class="editprofileform">
                            ...
                            <table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    ...
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_reimbursmentReport" runat="server" Visible="false" ToolTip="Appreciation Letter Report" PostBackUrl="~/procs/Send_Appreciationletter_report.aspx">Send Appreciation Letter Report</asp:LinkButton>
                                    </td>
                                </tr>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                 ...
                                 <tr style="padding-top: 1px; padding-bottom: 2px;">
                             <td class="formtitle">
                                 <asp:LinkButton ID="lnk_RedmptionRequest" runat="server"  ToolTip="Redmption Request" PostBackUrl="~/procs/AppreciationLetter_CreateRedmptionReq.aspx">Create Redmption Request</asp:LinkButton>
                             </td>
                             <td class="formtitle">
                                 <asp:LinkButton ID="lnk_Redmption_req_view" runat="server"  ToolTip="View Redmption Request" PostBackUrl="~/procs/AppreciationLetter_ViewRedmptionReq.aspx">View Redmption Request</asp:LinkButton>
                                   </td> 
                             </tr> 

                                    <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_viewbtn" runat="server" Visible="false" ToolTip="View Approvel Redmption Request" PostBackUrl="~/procs/AppreciationLetter_View_ApprovelReq.aspx">Inbox Redmption Request(0)</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_approvebtn" runat="server" Visible="false" ToolTip="View Approved Redmption Request" PostBackUrl="~/procs/AppreciationLetter_ViewApprovedRedeemedReq.aspx">Approved Redeemed Reuests</asp:LinkButton>
                                          </td> 
                                    </tr> 
                                 ...
                                 <td class="formtitle">
                                     ...
                                     <td class="formtitle">
                                     <asp:LinkButton ID="lnk_report" runat="server" Visible="false" ToolTip="Redmption Report" PostBackUrl="~/procs/AppreciationLetter_Redumption_Report.aspx">Redmption Report</asp:LinkButton>
