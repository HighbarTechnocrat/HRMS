<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_VendorList.aspx.cs" 
    Inherits="procs_VSCB_VendorList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="All Vendor List"></asp:Label>
                    </span>
                </div>
                    ...
                    <ul id="editform" runat="server">
                        ...
                        <li style="padding-top: 30px">
                            <span>Vendor Code</span>&nbsp;&nbsp;
                             <br />
                            <asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstVendorCode">
                            </asp:DropDownList>
                        </li>
                        <li style="padding-top: 30px">
                ...
                <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Create Vendor"  ToolTip="Create Vendor" class="trvl_Savebtndiv" OnClick="localtrvl_btnSave_Click" >Create Vendor </asp:LinkButton>
                </div>
                ...
                <%--<div class="manage_grid" style="overflow: scroll; width: 100%; padding-top: 20px; margin-bottom: 30px;">--%>
                    ...
                    <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="VendorID" CellPadding="3" AutoGenerateColumns="False" Width="130%" EditRowStyle-Wrap="false" PageSize="10" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Vendor Code"
                            ...
                            <asp:BoundField HeaderText="Vendor Name"
                             ...
                             <asp:BoundField HeaderText="Vendor Email Id"
                                DataField="VendorEmailAddress"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="18%" ItemStyle-BorderColor="Navy" />

                            <asp:BoundField HeaderText="GSTIN No."
                                DataField="GSTIN_NO"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                            ...
                            <asp:BoundField HeaderText="IFSC Code"
                              ...
                              <asp:BoundField HeaderText="Bank Name"
                                DataField="BankName"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="15%" ItemStyle-BorderColor="Navy" />  

                            <asp:BoundField HeaderText="Vendor Address"
