    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                //var lblipaddress = GetIPAddress();
                //lbltest.Text = lblipaddress;
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    lblmessage.Text = Request.UserAgent;
                }
            }
        }
        catch (Exception ex)
                    ...
                    if (TypeId == 2)
                    {
                        ...
                        if (getip != null)
                        {
                            if (getip.Tables[0].Rows.Count > 0)
                            {
                                ...
                                {
                                    IPAddress.Add(Convert.ToString(a).Trim());
                                }
                                var project = Convert.ToString(getip.Tables[0].Rows[0]["Project_Code"]);
                                var getIPAddress = GetIPAddress();
                                lbltest.Text = Convert.ToString(getIPAddress);

                                if (Convert.ToString(project).Trim() == "Nagpur Met" || Convert.ToString(project).Trim() == "S-NMRCL" || Convert.ToString(project).Trim() == "Maha-Metro - Property Development")
                                {
                                    lbltest.Text = project + "  - " + Convert.ToString(getIPAddress);
                                    lbltest.Visible = true;
                                }
