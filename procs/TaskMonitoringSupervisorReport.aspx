<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TaskMonitoringSupervisorReport.aspx.cs" Inherits="TaskMonitoringSupervisorReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Task Monitoring Supervisor Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date">
                            ...
                            <span>From Task Due Date</span> &nbsp;&nbsp;              
                                 <asp:TextBox ID="txtDueDateFrom" Enabled="true" AutoComplete="off" CssClass="TxtHeight" runat="server" AutoPostBack="true" OnTextChanged="txtDueDateFrom_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date">
                            ...
                            <span>To Task Due Date</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtDueDateTo" AutoComplete="off" runat="server" CssClass="TxtHeight" AutoPostBack="true" OnTextChanged="txtDueDateTo_TextChanged" MaxLength="10" Enabled="true" AutoCompleteType="Disabled"></asp:TextBox>
