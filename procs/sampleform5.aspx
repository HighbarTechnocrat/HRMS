...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform5.aspx.cs" Inherits="myaccount_SampleForm" %>
            ...
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        ...
                        <asp:Label ID="lblheading" runat="server" Text="Manage Leave Request"></asp:Label>
                    </span>
                </div>
...
<div class="containerDiv">
  ...
  <div class="rowDivHead">
    <div class="cellDivRequest">Request Date</div>
    <div class="cellDivRequest"> Type</div>
    <div class="cellDivRequest1">Period</div>
    <div class="cellDivRequest"> Status</div>
    <div class="cellDivRequest">Days</div>
    <div class="cellDivRequest">Action</div>
  </div>

    <div class="rowDiv">
   <div class="cellDivleave">07/11/2014</div>
    <div class="cellDivleave">SL</div>
    <div class="cellDivleave1">14/11/2014 - 14/11/2014</div>
    <div class="cellDivleave">Approved</div>
    <div class="cellDivleave">1</div>
    <div class="cellDivleave">View</div>
