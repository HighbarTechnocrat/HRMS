<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_Inbox_ADV_Payment.aspx.cs" Inherits="procs_VSCB_Inbox_ADV_Payment" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Inbox Advance Payment Requests"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="manage_grid" >
					...
					<center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Payment_ID,POID"   CellPadding="3" AutoGenerateColumns="False" Width="121%"   EditRowStyle-Wrap="false" PageSize="12" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging"   >
