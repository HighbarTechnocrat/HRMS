<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="Task_DueDateChange_Inbox.aspx.cs" ValidateRequest="false" Inherits="Task_DueDateChange_Inbox" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Due Date Change Request List"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                       <%-- <li class="mobile_inboxEmpCode">
                            <span><b>Due Date Change Request</b></span><br />
                            <br />
                        </li>
                        <li></li>--%>
                       <li style="width: 100%">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dv_TaskList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Task Current Due Date"
                                            DataField="Old_Due_Date"
                                            ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-Width="9%" ItemStyle-BorderColor="Navy" />                                      
                                        <asp:BoundField HeaderText="Requested Due date"
