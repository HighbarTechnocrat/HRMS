<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ClaimsReport_Mobile.aspx.cs" Inherits="ClaimsReport_Mobile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Mobile Claims Report - Self"></asp:Label>
            </span>
        </div>
           ...
           <table style="width:50%">
                <tr>
                    <td style="text-align:left">
                       ...
                       <asp:DropDownList ID="ddlYear"  runat="server" Width="200px" CssClass="DropDownList" TabIndex="0"> </asp:DropDownList>      
                    </td>
					<td >                       
                        <asp:LinkButton ID="btnSave" runat="server" Text="View Report" ToolTip="Mobile Claims Report" CssClass="leaverpt"  OnClick="btnSave_Click">Generate Report</asp:LinkButton>
