...
public partial class Appreciation_to_employee : System.Web.UI.Page
{
    ...
    private void InboxLeaveReqstList()
    {
        try
        {
            ...
            spars[0].Value = "GetAppreciationLetter_list_toemployee";
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnReqid.Value != "0")
            {
                Response.Redirect("Appreciation_toemployee_Details.aspx?reqid=" + hdnReqid.Value);
            }
