<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
     CodeFile="MyMobile_Req.aspx.cs" Inherits="MyMobile_Req" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Mobile Claims"></asp:Label>
                    </span>
                </div>
                    ...
                    <center>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Bill Type"
                             ...
                             <asp:BoundField HeaderText="Bill From Date"
                                DataField="From_Date"
                                ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="10%" />
                                                         
                            <asp:BoundField HeaderText="Bill To Date"
                                DataField="To_Date"
                                ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="10%" />
