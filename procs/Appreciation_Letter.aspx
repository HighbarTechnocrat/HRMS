   ...
   <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
    ...
    <div class="edit-contact">
        <ul>
            ...
            <li  id="txt_point" runat="server" visible="false" class="leavedays"> 
               ...
               <br />
                <div id="Appreciation_Draft" runat="server" visible="false">
                   ...
                   <%-- <textarea  id="ddl_letter" runat="server" style="height:500px;width:740px"    ></textarea>--%>
                    <asp:TextBox AutoComplete="off" ID="ddl_letter" runat="server" Rows="7" style="height:500px;width:740px" TextMode="MultiLine"></asp:TextBox>
                </div></li>
...
<input type="hidden" name="ddl_letter_hidden" id="ddl_letter_hidden" />

<script>
    // On form submit, copy innerHTML to hidden field
    document.forms[0].onsubmit = function () {
        document.getElementById("ddl_letter_hidden").value = document.getElementById("ddl_letter").innerHTML;
    };
</script>
