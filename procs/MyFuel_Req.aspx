<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
     CodeFile="MyFuel_Req.aspx.cs" Inherits="MyFuel_Req" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Fuel Claims"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <center>
                          <asp:GridView ID="gvMngFuelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Rem_id"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngFuelRqstList_PageIndexChanging">
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="Claim Date"
                              ...
                              <asp:BoundField HeaderText="Fuel Bill No"
                                DataField="Vouno"
                                 ItemStyle-HorizontalAlign="center"                                 
                                ItemStyle-Width="15%" />

                            <asp:BoundField HeaderText="Fuel Qty (litrs)"
                                DataField="Total_Quantity_Claimed"
                                 ItemStyle-HorizontalAlign="center"                                 
                                ItemStyle-Width="8%" />
