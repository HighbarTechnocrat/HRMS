<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="CustomerFirst_Survey_Rport.aspx.cs" Inherits="procs_CustomerFirst_Survey_Rport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Customer First Survey Report"></asp:Label>
            </span>
        </div>

       <div class="leavegrid">                    
             <a href="Timesheet.aspx" class="aaaa">Customer Survey Report</a>
        </div>  
       ...
       <div class="edit-contact">
           <ul>
                <li>
                    <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Survey Start Date <span style="color:red">*</span></span><br />
                ...
                <li>
                    <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Survey End Date</span><br />
