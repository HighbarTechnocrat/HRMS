<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_DetailSummary.aspx.cs" Inherits="ABAP_Object_Tracker_DetailSummary" EnableSessionState="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList runat="server" ID="DDLPriorities" AutoPostBack="false" CssClass="DropdownListSearch">
    </asp:DropDownList>

    <asp:LinkButton ID="LinkButton1" runat="server" ToolTip="Generate Report" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="btnGenerateReport_Click">Generate Report</asp:LinkButton>
            ...
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <br />
                        &nbsp;&nbsp;
                        <asp:Label ID="lblheading" runat="server" Text="ABAP Object Detail Summary Report"></asp:Label>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:DropDownList runat="server" ID="DDLPriorities" Style="width: 300px;" AutoPostBack="false" CssClass="DropdownListSearch">
                            </asp:DropDownList>
                            <br />
                        </li>
                        <li></li>
    ...
    <div style="width: 100%; overflow: auto">
        ...
        <asp:ReportViewer ID="ReportViewer1" runat="server" Height="300px" Width="100%" ShowBackButton="False" SizeToReportContent="True" ShowCredentialPrompts="False"
            ShowDocumentMapButton="False" ShowPageNavigationControls="true" ShowRefreshButton="False" PageCountMode="Actual" ShowFindControls="false">
        </asp:ReportViewer>
    </div>
