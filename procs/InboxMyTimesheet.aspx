<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="InboxMyTimesheet.aspx.cs" Inherits="InboxMyTimesheet" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Timesheet"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <%--<center>--%>
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="Id,Action"   CellPadding="3" AutoGenerateColumns="False" Width="90%"  PageSize="15" AllowPaging="True" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                             <asp:TemplateField HeaderText="View" HeaderStyle-Width="1%">
                                 ...
                                 <ItemStyle HorizontalAlign="Center" />
                                  ...
                                  <asp:BoundField HeaderText="RM Name"
                                      DataField="RMName"
                                      ItemStyle-HorizontalAlign="Center"
                                      HeaderStyle-HorizontalAlign="Center"
                                      ItemStyle-Width="20%"
