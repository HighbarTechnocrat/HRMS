<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_InvoicePaymentMakerList.aspx.cs" Inherits="procs_VSCB_InvoicePaymentMakerList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Invoice/Payment Request Creator List"></asp:Label>
                    </span>
                </div>
                ...
                <div class="mobile_Savebtndiv" style="margin-top: 10px !important">
                    ...
                    <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Create Invoice/Payment Request Creator" ToolTip="Create Invoice/Payment Maker" class="trvl_Savebtndiv" OnClick="localtrvl_btnSave_Click">Create Invoice/Payment Request Creator </asp:LinkButton>
                </div>
                ...
                <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Invoice Creattion Assigned Employee"
                            DataField="Invoice"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-Width="35%" ItemStyle-BorderColor="Navy" />
                        <asp:BoundField HeaderText="Payment Creattion Assigned Employee"
                            DataField="Payment"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-Width="35%" ItemStyle-BorderColor="Navy" />
