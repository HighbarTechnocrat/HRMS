<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="false"
	MaintainScrollPositionOnPostback="true" CodeFile="VSCB_ApproveInvoice_New.aspx.cs" Inherits="VSCB_ApproveInvoice_New" ViewStateMode="Disabled"   %>
				...
				<div class="edit-contact">
					...
					<ul id="editform" runat="server" visible="true">
						<li class="trvl_type">
							...
							<asp:TextBox AutoComplete="off" ID="txtTriptype" runat="server" Visible="false" ReadOnly="true" Enabled="False"></asp:TextBox>
						</li>
						<li class="trvl_date">
							<span>PO/ WO Type</span><br />		
                            <asp:DropDownList runat="server" ID="lstPOType" AutoPostBack="false" CssClass="DropdownListSearch">
							</asp:DropDownList>
							<asp:TextBox AutoComplete="off" ID="txtPOtype" runat="server"    Visible="false" ReadOnly="true" Enabled="False"></asp:TextBox>
						</li>
						<li class="trvl_date">
