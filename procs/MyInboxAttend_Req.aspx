<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MyInboxAttend_Req.aspx.cs" Inherits="MyInboxAttend_Req" %>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <%--<center>--%>
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="Reg_id"   CellPadding="3" AutoGenerateColumns="False" Width="50%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField HeaderText="For Date"
                            ...
                            <asp:TemplateField HeaderText="View" HeaderStyle-Width="8%"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="left">
                                <ItemTemplate>
