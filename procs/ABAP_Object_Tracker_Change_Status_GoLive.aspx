...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_LinkBtnSavePopup, #MainContent_LinkBtnBackPopup, #MainContent_LinkButton1, #MainContent_LinkButton2, #MainContent_trvl_btnSave1 {
            background: #3D1956;
            color: #febf39 !important;
            padding: 8px 18px;
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <asp:LinkButton ID="trvl_btnSave1" runat="server" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClick="btnExportToExcel_Click">Export to Excel</asp:LinkButton>
