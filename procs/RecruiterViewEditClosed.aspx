<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="RecruiterViewEditClosed.aspx.cs" Inherits="procs_RecruiterViewEditClosed" %>
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div>
					...
					<span>
						<a href="Rec_RecruiterInboxClosed.aspx?type=VRRClosed" title="Back" runat="server" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
					</span>
...
transfer, the same will change as per policy applicable to the place of transfer. 
    ...
    <asp:HiddenField ID="HDFieldClosedReqStatus" runat="server" />
