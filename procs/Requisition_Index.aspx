...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
        ...
        #MainContent_Link_Btn_Reopen:link, #MainContent_Link_Btn_Reopen:visited,
		...
		/*--Bharat--*/
	    #MainContent_Link_Btn_Reopen:hover, #MainContent_Link_Btn_Reopen:active,
					...
					<div class="editprofile" id="editform1" runat="server" visible="true">
						<div class="editprofileform">
							...
							<table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;" >
									<td class="formtitle">
										<asp:LinkButton ID="Link_Btn_Reopen" runat="server" PostBackUrl="~/procs/Rec_RecruiterInboxClosed.aspx?type=VRRClosed">View Recruitment Requests Closed</asp:LinkButton>
									</td>
									<td class="formtitle">
									</td>
								</tr>
