...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:HiddenField ID="hiddenClientIp" runat="server" />
    ...
    <script type="text/javascript">
        ...
        //    .then(data => {
        //        // Put IP address in hidden field
        //       // document.getElementById('hiddenClientIp').value = data.ip;
        //        alert(data.ip);
        //    })
        //    .catch(error => console.error('IP fetch error sanjay:', error));
        //};
