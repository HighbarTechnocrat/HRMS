<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="InboxCustEscalation_Arch.aspx.cs" Inherits="InboxCustEscalation_Arch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Processed Customer Incident"></asp:Label>
        </span>
    </div>
        <div class="leavegrid">
