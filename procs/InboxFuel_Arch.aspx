<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InboxFuel_Arch.aspx.cs" Inherits="myaccount_InboxFeulReembursement_ACC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Approved Fuel Claims"></asp:Label>
        </span>
    </div>
            
    <div class="leavegrid">
<a href="Fuel.aspx" class="aaaa">Fuel Home</a>
    </div>
...
<%--        <div class="editprofile btndiv" id="divbtn" runat="server" visible="false">
        ...
        <ul>
            <li>
                ...
                <%--<asp:TextBox ID="txtApplicantName" runat="server" ToolTip="Enter employee name or code " CssClass="txtcls">
                </asp:TextBox>--%>
