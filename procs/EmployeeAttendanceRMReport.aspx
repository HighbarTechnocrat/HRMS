<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="EmployeeAttendanceRMReport.aspx.cs" Inherits="EmployeeAttendanceRMReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Team Attendance Report"></asp:Label>
                    </span>
                ...
                <div>
                      <span>
                     <a href="Attendance.aspx" class="aaaa" >Attendance</a>
                </span>
                </div>
                       ...
                       <%-- <li><span>Select Month Year</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                        ...
                        <li class="date">
                            ...
                            <span>From Date</span> &nbsp;&nbsp;   <span style="color:red">*</span>           
                                 <asp:TextBox ID="txtFromdate" Enabled="true"   AutoComplete="off" CssClass="txtcls" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date">
                            <br />
                            <span>To Date</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtToDate"  AutoComplete="off" runat="server" CssClass="txtcls" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
