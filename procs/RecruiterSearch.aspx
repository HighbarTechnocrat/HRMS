<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
    CodeFile="RecruiterSearch.aspx.cs" Inherits="RecruiterSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Search Resume"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_inboxEmpCode">                           
                            <asp:LinkButton ID="btnTra_Details"   runat="server" Text="Opening Details" ToolTip="Opening Details" Enabled="false" ></asp:LinkButton>
                             <span id="spmdet" runat="server" visible="false"></span>
                        </li>
                        <li class="mobile_inboxEmpCode">                         
                        ...
                        <li class="mobile_inboxEmpCode">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_recruiter_name" runat="server" MaxLength="100"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span>Employee Code </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_recruiter_code" runat="server" MaxLength="100"></asp:TextBox>
                        </li>

                        <li class="mobile_inboxEmpCode">
                            <span>Position Title </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_position_title" runat="server" MaxLength="100"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span> </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TextBox5" runat="server" MaxLength="100" Visible="false"></asp:TextBox>
                         </li>
                        ...
                        <li class="mobile_inboxEmpCode">
                         ...
                         <li class="mobile_grid"> 
                            <div style="width:105%">
                                <asp:GridView ID="gv_position_DptLocation" runat="server"  Visible="false" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%"
                         ...
                         <li class="mobile_inboxEmpCode">
                            <asp:LinkButton ID="Link_Cand" runat="server" Enabled="false" Text="Attached Resumes" ToolTip="Attached Resumes"></asp:LinkButton>
                        </li>                        
                        <li class="mobile_inboxEmpCode">
                            <span> </span>                            
                         </li>
                        <li class="mobile_grid"> 
                             <div style="width:105%">
                                <asp:GridView ID="dgMobileClaim" runat="server"  Visible="false" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%"
                                    DataKeyNames="interview_id,attach_pos_no,cand_attach_position" >
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Year of Experience"
                                            DataField="cand_exp"
                                            ItemStyle-HorizontalAlign="left"
                                            HeaderStyle-HorizontalAlign="left"
                                            ItemStyle-Width="10%" />

                                        <asp:BoundField HeaderText="Institue"
                                        ...
                                        <ItemTemplate>                                        
                                            <asp:LinkButton ID="lnkResume" runat="server" Text='Download' OnClick="lnkResume_Click"></asp:LinkButton>
                                            <asp:Label ID="lblFilename" runat="server" Visible="false"  Text='<%# Bind("ResumeFile") %>'></asp:Label>                                        
                                            <asp:Label ID="lbl_interviewid" runat="server" Visible="false"  Text='<%# Bind("interview_id") %>'></asp:Label>                                        
                                        </ItemTemplate>
                        ...
                        <li class="mobile_inboxEmpCode">
                                <br />
                                <span class="qualificationdtls">Search Details </span>
                                <br /><br />
                        </li>                        
                        <li class="mobile_inboxEmpCode">
                            <span> </span>                            
                        ...
                        <li class="mobile_inboxEmpCode">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchLocation" runat="server" placeholder="Type Location Name for help"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span>By Department </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchDept" runat="server" placeholder="Type Department Name for help" ></asp:TextBox>
                         </li>

                        <li class="mobile_inboxEmpCode">
                            <span>By Position </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchPosition" runat="server"  placeholder="Type Position Name for help"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span>By Function </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchFunction" runat="server" placeholder="Type Function Name for help"></asp:TextBox>
                         </li>

                        <li class="mobile_inboxEmpCode">
                            <span>By Qualification </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchQualfication" runat="server" placeholder="Type Qualification Name for help"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span>By Experience </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_srchexprience" runat="server" MaxLength="2" ></asp:TextBox>
                         </li>
                        ...
                        <li class="mobile_inboxEmpCode">
                         ...
                         <li class="mobile_inboxEmpCode">
                                <asp:LinkButton ID="LinkButton1" runat="server" Text="Search" ToolTip="Search Resume" CssClass="Savebtnsve" OnClientClick=" return MultiClick();" OnClick="lnkSearch_candidates_Click">Search</asp:LinkButton>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span> </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TextBox22" runat="server" MaxLength="100" Visible="false"></asp:TextBox>
                         </li>
                

                         <li class="mobile_grid">
                             <div style="width:140%">                                  
                            <asp:GridView ID="gv_search_candidates" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%"
                                     DataKeyNames="interview_id" OnRowCreated="gv_search_candidates_RowCreated" OnRowDataBound="gv_search_candidates_RowDataBound">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Being Used by "
                                            DataField="cand_recruiter"
                                            ItemStyle-HorizontalAlign="left"
                                            HeaderStyle-HorizontalAlign="left"
                                            ItemStyle-Width="15%" />   
                                        ...
                                        <asp:TemplateField HeaderText="Resume" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>                                        
                                            <asp:LinkButton ID="lnkLeaveDetails" runat="server" Text='Download' OnClick="lnkLeaveDetails_Click"></asp:LinkButton>
                                            <asp:Label ID="lblFilename" runat="server" Visible="false"  Text='<%# Bind("ResumeFile") %>'></asp:Label>                                        
                                            <asp:Label ID="lbl_interviewid" runat="server" Visible="false"  Text='<%# Bind("interview_id") %>'></asp:Label>                                        
                                        </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Attach for Position" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                          ...
                          <li>
                            <span id="spn_release" runat="server">Release</span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:CheckBox id="chkRealse" runat="server" />
                        </li>
                        <li> 
                        </li>
                          <li>      
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_position_by_recuriter" runat="server" placeholder="Type Position Name for help"></asp:TextBox>
                        </li>
    ...
    <div class="mobiletrvl_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Text="Attach" ToolTip="Save" CssClass="Savebtnsve" OnClientClick=" return MultiClick();"  OnClick="mobile_btnSave_Click1" >Attach</asp:LinkButton>
    ...
    <br />
     <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchLocations" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txt_srchLocation"
     ...
     <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchDepartment" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txt_srchDept"
        ID="AutoCompleteExtender1" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>

     <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchPosition" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txt_srchPosition"
        ID="AutoCompleteExtender3" runat="server" FirstRowSelected="true">
     </ajaxToolkit:AutoCompleteExtender>

      <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchFunction" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txt_srchFunction"
     ...
     <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchQualification" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txt_srchQualfication"
