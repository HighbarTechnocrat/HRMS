<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="InboxAttendance.aspx.cs" Inherits="InboxAttendance" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Inbox Attendance Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                          ...
                          <asp:GridView ID="gvAttendance_inboxList" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                              DataKeyNames="Emp_Code,req_id,Appr_id"  CellPadding="3" AutoGenerateColumns="False" Width="50%" OnPageIndexChanging ="gvAttendance_inboxList_PageIndexChanging"  EditRowStyle-Wrap="false">
                        <FooterStyle BackColor="White" ForeColor="#000066" />
                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956"  HorizontalAlign="Left"/>
                        ...
                        <Columns>
                           <asp:BoundField HeaderText="Request Date" DataField="regularise_dt" ItemStyle-HorizontalAlign="left">
                        <ItemStyle HorizontalAlign="Left" Width="25%"></ItemStyle>
                    </asp:BoundField>
                    
                      <asp:BoundField HeaderText="Applicant" DataField="Emp_Name" ItemStyle-HorizontalAlign="left">
                        <ItemStyle HorizontalAlign="Left" Width="60%" ></ItemStyle>
                            ...
                            <asp:TemplateField HeaderText="View" HeaderStyle-Width="20%">
                                <ItemTemplate>
                                <asp:ImageButton id="lnkEdit" runat="server" Width="15px" Height="15px" ImageUrl="~/Images/edit.png" OnClick="lnkViewdetails_Click"/>
                                </ItemTemplate>
