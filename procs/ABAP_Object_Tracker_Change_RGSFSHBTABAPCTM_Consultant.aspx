    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div>
                    <asp:Label runat="server" ID="lblmessage" Visible="True" Style="color: red; font-size: 16px; font-weight: 500; text-align: center;margin-left: 20px;"></asp:Label>
                </div>
                <div class="edit-contact">
                    ...
                    <div>
                        <asp:Label runat="server" ID="lbl_FSConsultant_Error" Visible="True" style="color: red; font-size: 16px; font-weight: 500; text-align: center;margin-left: 20px;"></asp:Label>
                    </div>
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_date">
                            <span id="abpdevdesc" runat="server">ABAP Development Description </span><br />
