<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TravelDetails.aspx.cs" Inherits="TravelDetails"%>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Travel Details"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="trvldetails_place">
                            ...
                            <asp:TextBox AutoComplete="off" ID="TextBox5" runat="server" CssClass="Dropdown" Visible="false"></asp:TextBox>
                        ...
                        <li class="trvldetails_place2">
                            ...
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender4" PopupControlID="Panel5" TargetControlID="TextBox6"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>
