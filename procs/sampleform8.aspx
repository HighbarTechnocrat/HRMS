<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleform8.aspx.cs" Inherits="myaccount_sampleform8" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform8.aspx.cs" Inherits="myaccount_SampleForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Leave Request View2"></asp:Label>
                    </span>
                </div>
  ...
  <div class="rowDivSL1">
    <div class="cellDivview1"> Type</div>
    <div class="cellDivview1"> Bal</div>
    <div class="cellDivview1">Availed</div>
    <div class="cellDivview1"> Bal</div>
  </div>

    <div class="rowDiv">
   <div class="cellDivView">PL</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
   ...
   <div class="cellDivView">ML</div>
    ...
    <div class="cellDivView">20</div>
      ...
      <div class="rowDiv">
   <div class="cellDivView">W/O PAY</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
  </div>
  ...
  <div class="rowDiv">
   <div class="cellDivView">Time Off</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
    <div class="cellDivView">20</div>
  </div>   
...
<%--SAGAR ADDED THIS FOR ADDING BUTTON 21SEPT2017--%>
  <a href="#" class="viewcalender1  " onclick="">Individual Calendar</a>
  <a href="#" class="viewcalender" onclick="">Team Calendar</a>
 ...
 <%-- JAYESH_PRAJYOT ADDED BELOW CODE FOR REQUEST  FORM 18sep2017--%>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <div class="date-picker-start-end-date">
                            ...
                            <span class="startdatepickercontent">
                                <asp:TextBox ID="txtsdate" runat="server" CssClass="txtdatepicker" placeholder="Start Date"></asp:TextBox>
                               <span class="texticon tooltip" title="Select Start Date. Date should be MM/DD/YYYY format."><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="formerror" ControlToValidate="txtsdate" SetFocusOnError="True" ErrorMessage="Please enter start date" ValidationGroup="validate"></asp:RequiredFieldValidator>
                             </span>
                            </div>
                            </li>
                        
                          <li class="profile-edit" id="Li1" runat="server" visible="false">
                            <span>Location</span><br />
                            <asp:TextBox ID="TextBox1" runat="server"> </asp:TextBox>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" Visible="false">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="ddlloc_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ddlloc" EventName="SelectedIndexChanged" />
                                </Triggers>
                       ...
                       <%-- <li class="profile-edit">
                          ...
                          <%--   <li class="date">
                        <div class="date-picker-start-end-date">
                            <div class="title-all-post">Select Date</div>
                            <span class="startdatepickercontent">
                                <asp:TextBox ID="txtsdate" runat="server" CssClass="txtdatepicker" placeholder="Start Date"></asp:TextBox>
                               <span class="datetexticon tooltip" title="Select Start Date. Date should be MM/DD/YYYY format."> <i class="fa fa-calendar" aria-hidden="true"></i></span><br />
                                <asp:Label ID="lblsdate" runat="server" Text="" Font-Size="15px"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="formerror" ControlToValidate="txtsdate" SetFocusOnError="True" ErrorMessage="Please enter start date" ValidationGroup="validate"></asp:RequiredFieldValidator>
                             </span>
                            <span class="enddatepickercontent">
                                <asp:TextBox ID="txtedate" runat="server" CssClass="txtdatepicker" placeholder="End Date"></asp:TextBox>
                                <span class="datetexticon tooltip" title="Select End Date. Date should be MM/DD/YYYY format."><i class="fa fa-calendar" aria-hidden="true"></i></span><br />
                                ...
                                <asp:CompareValidator ControlToCompare="txtsdate" ControlToValidate="txtedate" Display="Dynamic" ErrorMessage="End date should be greater than Start Date." ID="CompareValidator2"  Operator="GreaterThanEqual"  Type="Date" runat="server" ValidationGroup="validate" SetFocusOnError="false" CssClass="formerror"/>
                             </span>
                        </div>
                   <%--         <asp:TextBox ID="txtdept" runat="server"> </asp:TextBox>
                       ...
                       <%-- <li class="profile-edit">
                         ...
                         <li class="profile-edit">
                            <span>For</span><br />
                            <ew:NumericBox ID="NumericBox1" runat="server" MaxLength="6" CssClass="medium"> </ew:NumericBox>
                            <span class="texticon tooltip" title="Please provide your area pincode."><i class="fa fa-code"></i></span>
                            <br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ControlToValidate="txtpincode" ErrorMessage="Please enter valid Pin Code!" SetFocusOnError="true" CssClass="formerror"
                                ValidationExpression="\d{6}(-\d{4})?$" ValidationGroup="validate"></asp:RegularExpressionValidator>

                        </li>
                         <li class="profile-edit">
                            <span>For</span><br />
                            <ew:NumericBox ID="NumericBox2" runat="server" MaxLength="6" CssClass="medium"> </ew:NumericBox>
                            <span class="texticon tooltip" title="Please provide your area pincode."><i class="fa fa-code"></i></span>
                            <br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic" ControlToValidate="txtpincode" ErrorMessage="Please enter valid Pin Code!" SetFocusOnError="true" CssClass="formerror"
                                ValidationExpression="\d{6}(-\d{4})?$" ValidationGroup="validate"></asp:RegularExpressionValidator>
                        ...
                        <li class="profile-edit">
                           ...
                           <ew:NumericBox ID="NumericBox3" runat="server" MaxLength="6" CssClass="medium"> </ew:NumericBox>
                          <span class="texticonselect tooltip" title="Please provide your cover picture."><i class="fa fa fa-file-image-o"></i></span>
                            <br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic" ControlToValidate="txtpincode" ErrorMessage="Please enter valid Pin Code!" SetFocusOnError="true" CssClass="formerror"
                                ValidationExpression="\d{6}(-\d{4})?$" ValidationGroup="validate"></asp:RegularExpressionValidator>
                        ...
                        <li class="profile-edit">
                           ...
                           <ew:NumericBox ID="NumericBox4" runat="server" MaxLength="6" CssClass="medium"> </ew:NumericBox>
                          <span class="texticonselect tooltip" title="Please provide your cover picture."><i class="fa fa fa-file-image-o"></i></span>
                            <br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" Display="Dynamic" ControlToValidate="txtpincode" ErrorMessage="Please enter valid Pin Code!" SetFocusOnError="true" CssClass="formerror"
                                ValidationExpression="\d{6}(-\d{4})?$" ValidationGroup="validate"></asp:RegularExpressionValidator>
                           <%-- <asp:LinkButton ID="removeprofile" runat="server" OnClick="removeprofile_Click"><span></span>&nbsp;&nbsp;Remove</asp:LinkButton>--%>
                        </li>
                        <li class="profile-edit">
                            <span>Approvers</span><br />
                ...
                <%--           JAYESH COMMNETED ABOVE to disabled the functionality of save19sep2017 --%>
                            ...
                            <div class="Savebtndiv">
                                <asp:LinkButton ID="btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="btnSave_Click">Approve</asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton1" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="btnSave_Click">Send for Correct</asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton2" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="btnSave_Click">Reject</asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton3" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="btnSave_Click">Back</asp:LinkButton>
                            </div>
    <script type="text/javascript">
