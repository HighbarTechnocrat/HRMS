<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MyITAssetService_Req.aspx.cs" Inherits="MyITAssetService_Req" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My IT Asset Service Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <center>
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="Asset Allocation Request Number"
                                DataField="AARNo"
                           ...
                           <%--  <asp:BoundField HeaderText="Action To"
                            ...
                            <asp:BoundField HeaderText="RequestType"
                                DataField="RequestType"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" />
                             <asp:BoundField HeaderText="StatusId" HeaderStyle-CssClass="hiddencol"
                                DataField="StatusId"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" ItemStyle-CssClass="hiddencol" />
