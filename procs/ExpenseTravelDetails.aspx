<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ExpenseTravelDetails.aspx.cs" Inherits="ExpenseTravelDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text=" Expense Travel Details"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="trvldetails_tripid" Id="litripid" runat="server" visible="false">
                            <span id="spantripid" runat="server">Trip ID</span><br />
                            <asp:TextBox AutoComplete="off" ID="txtTripId" runat="server"></asp:TextBox>
                        </li>
                        <li>
                        ...
                        <li class="trvldetails_type" Id="litriptype" runat="server">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtTravelType" runat="server" CssClass="Dropdown" Enabled="false"></asp:TextBox>
                        ...
                        <li>
                            ...
                            <%--onkeyup="SearchEmployees(this,'#lstTravelMode');"--%>
                        ...
                        <li class="trvldetails_deviation">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtDeviation" runat="server" CssClass="DropdownText"></asp:TextBox>
                        ...
                        <li class="trvldetails_place">
                            ...
                            <asp:TextBox AutoComplete="off" ID="TextBox1" runat="server" Visible="false" CssClass="Dropdown"></asp:TextBox>
                            ...
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender3" PopupControlID="Panel4" TargetControlID="TextBox1"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>
    ...
    <script type="text/javascript">
        ...
        function SearchEmployees(txtTravelMode, lstTravelMode) {
           
            if ($(txtTravelMode).val() != "") {
                var count = 0;
                alert($(txtTravelMode).val());
                $(lstTravelMode).children('tbody').children('tr').each(function () {
                    var match = false;
                    $(this).children('td').children('label').each(function ()
                    {
                       
                        if ($(this).text().toUpperCase().indexOf($(txtTravelMode).val().toUpperCase()) > -1)
                            match = true;
                    });
                    if (match)
                    {
