<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ABAP_Prd_TimeSheetAppListView.aspx.cs" Inherits="procs_ABAP_Prd_TimeSheetAppListView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text=" Processed ABAP Object Completion List"></asp:Label>
					</span>
                    <br /> 
				</div>
				<%-- <div>
	...
	<div class="manage_grid" style="width:100%; height: auto;">
		<asp:GridView ID="gvTimeSheetList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px"
			 DataKeyNames="MainID" CellPadding="3" AutoGenerateColumns="False" Width="100%" OnPageIndexChanging="gvTimeSheetList_PageIndexChanging" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
			...
			<Columns>
                <asp:BoundField HeaderText="Employee Name" DataField="Empnamee"
