...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Attendence1.aspx.cs" Inherits="Attendence" %>
 ...
 <%-- JAYESH_PRAJYOT ADDED BELOW CODE FOR REQUEST  FORM 18sep2017--%>
                ...
                <div class="edit-contact">
                   ...
                   <%--         <asp:TextBox ID="txtdept" runat="server"> </asp:TextBox>
                      ...
                      <%--   <li>
                            <span><span>*&nbsp;</span>For Information To Levels</span><br />
...
<div class="container">
  ...
  <div class="rowDivHead1">
    <div class="cellDivAttendance">Date</div>
    <div class="cellDivAttendance"> Type</div>
    <div class="cellDivAttendance">Time</div>
    <div class="cellDivAttendance"> Status</div>
    <div class="cellDivAttendance">Category*</div>
    <div class="cellDivAttendance">Reason / Remark</div>
  </div>

    <div class="rowDiv">
   <div class="cellDivregularization">'01/09/2017</div>
    <div class="cellDivregularization">Out</div>
    <div class="cellDivregularization">04:30:00 PM</div>
    <div class="cellDivregularization">ABSENT</div>
    <div class="cellDivregularization">Late Coming</div>
    <div class="cellDivregularization">tttt</div>
   ...
   <div class="cellDivregularization">'01/09/2017</div>
    ...
    <div class="cellDivregularization">04:30:00 PM</div>
    <div class="cellDivregularization">ABSENT</div>
    <div class="cellDivregularization">Outdoor Duty</div>
    <div class="cellDivregularization">tttt</div>
   ...
   <div class="cellDivregularization">'01/09/2017</div>
    ...
    <div class="cellDivregularization">04:30:00 PM</div>
    <div class="cellDivregularization">ABSENT</div>
    <div class="cellDivregularization">Early Going</div>
    <div class="cellDivregularization">tttt</div>
