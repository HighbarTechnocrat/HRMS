<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TimesheetRecordDetailReport.aspx.cs" Inherits="TimesheetRecordDetailReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Timesheet Detail Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date">
                            ...
                            <span>To Date</span> &nbsp;&nbsp;      <span style="color:red">*</span>  
                                 <asp:TextBox ID="txtToDate"  AutoComplete="off" runat="server" CssClass="txtcls" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
                                
                        </li>
                         <li class="leavedays" runat="server" visible="false">

                            <span>Select Project</span>&nbsp;&nbsp;<br />
                            <asp:DropDownList runat="server" Enabled="false" Visible="false"  ID="ddlProject" AutoPostBack="false"></asp:DropDownList>
                ...
                <div style="width: 100%; overflow: auto">
                    ...
                    <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%"  Height="700px"   ShowBackButton="False"  SizeToReportContent="false"
