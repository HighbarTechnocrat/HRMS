<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="LocalTravel.aspx.cs" Inherits="LocalTravel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="localtrvl_location">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtLocation" runat="server" ></asp:TextBox>
                            <asp:TextBox AutoComplete="off" ID="TextBox8" runat="server" Visible="false"  placeholder="Select Location"  CssClass="Dropdown"></asp:TextBox>
                            ...
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender1" PopupControlID="Panel2" TargetControlID="TextBox8"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>

                             <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchCities" MinimumPrefixLength="1"
                            CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TextBox8"
    ...
    <div class="localtrvl_Savebtndiv">
        <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Submit" ToolTip="Save"  OnClientClick=" return MultiClick();" CssClass="Savebtnsve" OnClick="localtrvl_btnSave_Click">Submit</asp:LinkButton>
