<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="CompetencyBucket.aspx.cs" Inherits="CompetencyBucket" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                     ...
                     <span>Development Areas of the Reviewee</span> <br />
                          <asp:TextBox AutoComplete="off" ID="txtDevArea" runat="server" MaxLength="150" height="50" TextMode="MultiLine"></asp:TextBox>
                     </li>                     
                  
                     <li class="trvl_local"> 
                         <span>Method Code</span> 
                          <asp:TextBox AutoComplete="off" ID="txtMethod" runat="server" CssClass="grayDropdown"></asp:TextBox>
                     ...
                     <li class="trvl_local"> 
                         <span>Timelines</span> 
                          <asp:TextBox AutoComplete="off" ID="txtTimeLines" runat="server" CssClass="grayDropdown"></asp:TextBox>
