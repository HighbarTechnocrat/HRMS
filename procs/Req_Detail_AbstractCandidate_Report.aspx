<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Req_Detail_AbstractCandidate_Report.aspx.cs" Inherits="procs_Req_Detail_AbstractCandidate_Report" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Requisition Detail Abstract Report"></asp:Label>
                    </span>
                </div>
                 <div>
             ...
             <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
                        ...
                        <li class="mobile_InboxEmpName">      
                        <span style="padding-left:5px"> Status</span>&nbsp;&nbsp;<span style="color: red"></span><br />                                
                ...
                <div><span style="padding-left:33px">
                     <asp:RadioButton ID="RBLWithInterview" runat="server"  Text="With Interview L1 , L2 Rejected" Font-Size="Small"  Checked="true" OnCheckedChanged="RBLWithInterview_CheckedChanged" AutoPostBack="true"/>
                    <asp:RadioButton ID="RBLWithOutInterview" runat="server"  Text="WithOut Interview L1 , L2 Rejected" Font-Size="Small"  OnCheckedChanged="RBLWithOutInterview_CheckedChanged" AutoPostBack="true"/>
                    </span>
                </div>
            </div>
        </div>
