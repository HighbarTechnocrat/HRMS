<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="View_Appreciation_Letter.aspx.cs" Inherits="View_Appreciation_Letter" %>
            ...
            <div class="wishlistpagediv">
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                          ...
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="sr_no"   CellPadding="3" AutoGenerateColumns="False" Width="95%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  AllowPaging="true" PageSize="15" EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="View" HeaderStyle-Width="4%">
                            <ItemTemplate>
                            ...
                            DataField="Appreciation_Letter_list"
                              ItemStyle-HorizontalAlign="left"
                            HeaderStyle-HorizontalAlign="left"                                 
                            ItemStyle-Width="15%" 
                            ItemStyle-BorderColor="Navy" />

                            <asp:BoundField HeaderText="Send Date"
                            DataField="Send_date"
                              ItemStyle-HorizontalAlign="left"
                            HeaderStyle-HorizontalAlign="left"                                 
                            ItemStyle-Width="7%" 
