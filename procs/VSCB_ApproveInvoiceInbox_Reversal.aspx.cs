...
public partial class procs_VSCB_ApproveInvoiceInbox_Reversal : System.Web.UI.Page
{
    ...
    public void check_POWO_IsForLoginEployeee()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "Check_Invoice_forLoginEmployeeRequestInbox_Reversal";
        ...
        if (dsEmployee.Tables[0].Rows.Count > 0)
        {
            ...
            RemarkReverseInvoice.Visible = true;
            TxtRemarksReverseInvoice.Visible = true;
            TxtRemarksReverseInvoice.Text = dsEmployee.Tables[1].Rows[0]["Remarks"].ToString();
            TxtRemarksReverseInvoice.Enabled = false;
        }
        else
        {
    ...
    protected void linkBtn_reverseinvoice_Click(object sender, EventArgs e)
    {
        ...
        if (Txt_ApproverReverseRemark.Text == "")
        {
            lblmessage.Text = "Please Enter the Approver Reverse Invoice Remarks.";
            return;
        }
        DataSet dsProjectsVendors = new DataSet();
        ...
        spars[3].Value = Txt_ApproverReverseRemark.Text;

        dsProjectsVendors = spm.getDatasetList(spars, "SP_VSCB_CreateInvoice");

        string strFinalOutput = dsProjectsVendors.Tables[0].Rows[0]["FinalOutput"].ToString();
        if (strFinalOutput == "Yes")
        {
            foreach (GridViewRow row in gvInvoiceMilestone_Acc.Rows)
            {
                string dMilestoneId = Convert.ToString(gvInvoiceMilestone_Acc.DataKeys[row.RowIndex].Values[2]);
