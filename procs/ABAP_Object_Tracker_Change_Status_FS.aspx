<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_FS.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_FS" EnableSessionState="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="FS - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:DropDownList runat="server" ID="AllStatus" Width="250px" OnSelectedIndexChanged="AllStatus_SelectedIndexChanged" AutoPostBack="true" Style="height: 30px; margin: 5px 0 0 0 !important;"></asp:DropDownList>
                                </li>
                                <li></li>
                                <li></li>

                                <li class="trvl_date" runat="server" id="lireason1" visible="false">
                                    <br />
                                ...
                                <li class="trvl_date" id="liupload_1" runat="server" visible="false">
                                    ...
                                    <asp:FileUpload ID="uplFSAttachment" runat="server" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"></asp:FileUpload>
                                    ...
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Download" ItemStyle-Width="20%" HeaderStyle-Width="20%">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="lnkDownload" runat="server" Width="20px" ToolTip="Download functional specification document" Height="15px" CommandArgument='<%# Eval("FileName") %>' OnClick="ibdownloadbtn_Click" ImageUrl="~/Images/Download.png" />
                                                </ItemTemplate>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <span class="fs" runat="server" visible="false" id="fs"><br />FS</span>
                            ...
                            <asp:GridView ID="gvFSDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Development Description"
                                        ...
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="20%" HeaderStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="FS Status"
                                        DataField="FS_DisplayName"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="8%" HeaderStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                      <asp:BoundField HeaderText="FS Accepted/Rejected By"
                                        DataField="FSAcceptRejectBy"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="8%" HeaderStyle-Width="8%"
    ...
    <asp:HiddenField ID="hdnFSRevisedStartDt" runat="server" />
    <asp:HiddenField ID="hdnFSRevisedFinishDt" runat="server" />
