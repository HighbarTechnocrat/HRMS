<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="InboxCustomerFirst.aspx.cs" Inherits="InboxCustomerFirst" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="CusromerFIRST - Inbox"><%=ConfigurationManager.AppSettings["CustomerFeedbackTitle"]%> - Inbox</asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <center>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Contact Email"
                           ...
                           <%-- <asp:BoundField HeaderText="Survey Response"
                                DataField="Answer"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" />--%>

                            
                            <asp:TemplateField HeaderText="Survey Response" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                ...
                <asp:HiddenField ID="hdnISCEO" runat="server" />
            </div>
        </div>
    </div>
