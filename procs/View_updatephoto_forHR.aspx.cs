...
public partial class View_updatephoto_forhr : System.Web.UI.Page
{
    ...
    private void InboxLeaveReqstList()
    {
        try
        {
            ...
            dtleaveInbox = spm.GetPendinglist_forhr(strempcode);
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnReqid.Value != "0")
            {
                Response.Redirect("View_ApprovedPhoto_ForHR.aspx?reqid=" + hdnReqid.Value);
            }
