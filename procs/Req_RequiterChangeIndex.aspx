<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Req_RequiterChangeIndex.aspx.cs" 
  MaintainScrollPositionOnPostback="true"  Inherits="procs_Req_RequiterChangeIndex" %>
                ...
                <div class="manage_grid" style="width: 100%; height: auto; padding-top:10px;">
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Recruitment_ReqID,Request_status"   CellPadding="3" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging"  AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
