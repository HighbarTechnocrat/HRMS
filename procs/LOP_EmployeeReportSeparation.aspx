<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="LOP_EmployeeReportSeparation.aspx.cs" Inherits="LOP_EmployeeReportSeparation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="LOP Employee Reports"></asp:Label>
            </span>
        </div>
       ...
       <div class="edit-contact">
           ...
           <ul>
                <li>
                    <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">From Date:</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                ...
                <li>
                    <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">To Date:</span>&nbsp;&nbsp;<span style="color:red"></span> <br />
                    ...
                    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" TargetControlID="txtToDate"
                      ...
                      <ul>
               <li>
                   <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Select Employee: </span><br />
