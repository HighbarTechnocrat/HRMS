<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="InboxITAssetServiceRequest.aspx.cs" Inherits="InboxITAssetServiceRequest" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="IT Asset Request"></asp:Label>
                    </span>
                </div>
                    ...
                    <center>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="StatusId" ItemStyle-CssClass="hiddencol" 
                                DataField="StatusId"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="5%" HeaderStyle-CssClass="hiddencol"/>
