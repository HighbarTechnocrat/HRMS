<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="PerformanceReviewList.aspx.cs" Inherits="PerformanceReviewList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Performance Review List"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <center>
                          <asp:GridView ID="gvMngRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                            DataKeyNames="assess_id,PerformanceReviewStatus,EmpPosMappId,KRAReviewStatus"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnRowCreated="gvMngRqstList_RowCreated" OnRowDataBound="gvMngRqstList_RowDataBound"  OnPageIndexChanging="gvMngRqstList_PageIndexChanging">
                       ...
                       <%--     <asp:BoundField HeaderText="Employee Code"
                           ...
                           <asp:TemplateField ItemStyle-Width="8%" HeaderText="Details" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
