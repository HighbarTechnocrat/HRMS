<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InboxServiceRequest_Arch.aspx.cs" Inherits="InboxServiceRequest_Arch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Processed Service Requests"></asp:Label>
        </span>
    </div>
        <div class="leavegrid">
