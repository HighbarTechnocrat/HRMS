<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="ABAP_Object_Tracker_Upload.aspx.cs" ValidateRequest="false" Inherits="ABAP_Object_Tracker_Upload" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <br />
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Upload ABAP Object Plan"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li style="width: 100%; text-align: center">
                            <div id="uploadtmplDiv" runat="server" style="text-align: left">
                                <asp:LinkButton type="button" ID="lnk_downloadExcelButton" runat="server" OnClick="DownloadExcel_Click">Download ABAP Object Tracker Template</asp:LinkButton>
                                <br />
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                <asp:LinkButton ID="tsktemplate_btnSave" runat="server" Text="Upload" ToolTip="Upload Template" OnClientClick="return  saveasdraftClick();" CssClass="Savebtnsve" OnClick="AOTtemplate_btnSave_Click" CommandArgument="1"></asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
