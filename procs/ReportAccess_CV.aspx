<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="ReportAccess_CV.aspx.cs" Inherits="ReportAccess_CV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Add Update Report Access"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        <li class="mobile_inboxEmpCode">
                            <span><b>Report Access Details</b></span><br />
                            <br />
                        </li>                       
                        <li>
                        ...
                        <li>
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TextBox1" MaxLength="250" runat="server"></asp:TextBox>
                            
                        </li>
                        <li>
                            <span>Select Employee Name</span>
                            <br />
                            <asp:TextBox Visible="false" AutoComplete="off" ID="txt_FD_Name" MaxLength="250" runat="server"></asp:TextBox>
                             <asp:DropDownList runat="server" ID="ddl_EmployeeName" AutoPostBack="false" OnSelectedIndexChanged="ddl_EmployeeName_SelectedIndexChanged">
                            </asp:DropDownList>
                        ...
                        <li style="width: 71%">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dg_FimalyDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" AllowPaging="true" PageSize="15" Width="100%" EditRowStyle-Wrap="false"
                                    DataKeyNames="Emp_Code" OnPageIndexChanging="dg_FimalyDetails_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Report Name"
    ...
    <script type="text/javascript">      
        $(document).ready(function () {
            $("#MainContent_ddl_EmployeeName").select2();
        });
    </script>
    <script type="text/javascript">
