...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
		...
		#MainContent_lnk_OT_Create:link, #MainContent_lnk_OT_Create:visited,
		#MainContent_lnk_OT_List:link, #MainContent_lnk_OT_List:visited,
		#MainContent_lnk_leaveencashment:link, #MainContent_lnk_leaveencashment:visited,
		#MainContent_lnk_My_Attendance_List:link, #MainContent_lnk_My_Attendance_List:visited {
		...
		#MainContent_lnk_OT_Create:hover, #MainContent_lnk_OT_Create:active,
		#MainContent_lnk_OT_List:hover, #MainContent_lnk_OT_List:active,
		#MainContent_lnk_leaveencashment:hover, #MainContent_lnk_leaveencashment:active,
		#MainContent_lnk_My_Attendance_List:hover, #MainContent_lnk_My_Attendance_List:active {
			...
			<div class="wishlistpagediv">
				<div class="wishlistpage">
					<div class="userposts">
                        ...
                        <span  style="text-align:right; margin-left:465px;">
                             
                           &nbsp;&nbsp;&nbsp;&nbsp;  <asp:Label ID="lbltimedisplay" runat="server"  ForeColor="#ff0000" Font-Size="12"></asp:Label>
						...
						<div class="editprofileform">
							...
							<table id="tbl_menu" runat="server">
								...
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									<td class="formtitle">
										<asp:LinkButton ID="lnk_leaverequest" runat="server" PostBackUrl="~/procs/Check_In_Out_New.aspx">Record Attendance</asp:LinkButton>
									</td>
									<td class="formtitle">
								...
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									...
									<td>
                                        <asp:LinkButton ID="lnk_My_Attendance_List" Visible="true" runat="server" Text="My Attendance List" ToolTip="My Attendance List" PostBackUrl="~/procs/My_Attendance_List.aspx">My Attendance List </asp:LinkButton>                             
                                    </td>
								</tr>
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									<td class="formtitle">
								...
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									<td class="formtitle" id="IsOTShow" visible="false" runat="server">
										<br />
										<span id="span2" runat="server" style="font-size: 12pt; font-weight: bold; color: #3D1956;">OT Report: </span>
									</td>
								</tr>
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									<td class="formtitle">
										<asp:LinkButton ID="lnk_OT_Create" runat="server" Text="OD Application" Visible="false" PostBackUrl="~/procs/Employee_OT_Request.aspx">Create OT Request </asp:LinkButton>
									</td>
									<td class="formtitle">
										<asp:LinkButton ID="lnk_OT_List" runat="server" Text="My OD Applcation" Visible="false" PostBackUrl="~/procs/InboxOTRequest.aspx">OT Requests</asp:LinkButton>
									</td>
								</tr>
								<%--                                <tr style="padding-top:1px;padding-bottom:2px;">
