<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Payment_Req_App.aspx.cs" Inherits="Payment_Req_App" %>
...
<%--                        <li class="mobile_inboxEmpCode">
                        ...
                        <li class="mobile_date">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtFromdate" runat="server" AutoPostBack="false" ReadOnly="true"></asp:TextBox>
                        ...
                        <li class="Payment_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dgMobileClaim" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"  CellPadding="3" AutoGenerateColumns="False" Enabled="false" Width="100%" 
								DataKeyNames="ClaimsNo"	OnRowDataBound="dgMobileClaim_RowDataBound" OnDataBound="dgMobileClaim_DataBound" >
									...
									<asp:TemplateField HeaderText="Expenses" HeaderStyle-Width="30%">
									 <ItemTemplate>
										<asp:HiddenField ID="HFClaims_id" runat="server"  Value='<%# Eval("Claims_id") %>' />
										<asp:DropDownList ID="ddlExpenses" runat="server" CssClass="DropdownListSearch" /><span style="color:red"  id="SExpenses" >*</span>
									 </ItemTemplate>
									<ItemStyle HorizontalAlign="Center" />
								</asp:TemplateField>
...
<%--                        <li class="mobile_inboxEmpCode">
                        ...
                        <li class="Payment_grid" visible="false" runat="server" id="IsShowGridList">
                            <span>Near By Payment Details</span>
                            <div>

                                <asp:GridView ID="gvNearByPaymentDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Enabled="false" Width="126%"
                                    DataKeyNames="ID" OnRowDataBound="gvNearByPaymentDetails_RowDataBound" OnDataBound="gvNearByPaymentDetails_DataBound">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" HorizontalAlign="Center" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Particulars"
                                         ...
                                         <asp:BoundField HeaderText="Employee Name"
                                            ...
                                            HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-Width="25%" />
                                        <asp:TemplateField HeaderText="Uploaded Files" Visible="false">
                                            <ItemTemplate>
                                               
                                                <asp:LinkButton ID="lnkviewfile" runat="server" OnClientClick=<%# "DownloadFile('" + Eval("UploadedFile") + "')" %> Text='<%# Eval("UploadedFile") %>'  >
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
    ...
    <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="formerror" ControlToValidate="txtEmpCode" SetFocusOnError="True" ErrorMessage="Session Expired, Please Logout & Login again!" Display="Dynamic" ValidationGroup="validate"></asp:RequiredFieldValidator>
