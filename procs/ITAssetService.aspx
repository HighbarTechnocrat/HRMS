<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ITAssetService.aspx.cs" Inherits="ITAssetService" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="IT Inventory"></asp:Label>
                        </span>
                    </div>
                  <%--  <div class="leavegrid">
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server"  OnClick="lnk_leaverequest_Click">Create Repair/Replacement Request</asp:LinkButton>                                         
                                    </td>
                                     <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/MyITAssetService_Req.aspx">My IT Asset Service Requests</asp:LinkButton>
                                    </td>                                    
                                </tr>
                                ...
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaveinbox" runat="server" Text="" PostBackUrl="~/procs/InboxITAssetServiceRequest.aspx">Inbox</asp:LinkButton>
                                    </td>                                    
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle" runat="server" id="showPSR">
                                        <asp:LinkButton ID="lnk_MobACC" runat="server" Text="" PostBackUrl="~/procs/InboxITAssetServiceRequest_Arch.aspx">Processed IT Asset Requests</asp:LinkButton>
                                    </td>
                                     <td class="formtitle" runat="server" id="Td1">
                                        <asp:LinkButton ID="lnk_reimbursmentReport_1" runat="server" Text="" Visible="false" PostBackUrl="~/procs/ITAssetServiceRequestReport_Audit.aspx">IT Asset Service Request History Report</asp:LinkButton>
                                    </td>
                                </tr>
