<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_InboxPartialPaymentRequest.aspx.cs" Inherits="procs_VSCB_InboxPartialPaymentRequest" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Inbox Partial Payment Requests"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="mobile_Savebtndiv" style="margin-top:0px !important">
