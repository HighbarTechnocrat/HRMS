<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_CTMTesting.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_CTMTesting" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="CTM Testing - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <div runat="server" id="DivIDPopup" visible="false" style="height: auto">
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li>
                                    <span>Client Person</span><span style="color: red" runat="server" id="spnclientperson" visible="false">*</span>
                                    <br />
                                    <asp:TextBox ID="txt_clientperson" runat="server" Width="200px"></asp:TextBox>
                                </li>
                                <li>
                                    <span>Client Person Email</span><span style="color: red" runat="server" id="spnclientpersonemail" visible="false">*</span>
                                    <br />
                                    <asp:TextBox ID="txt_clientpersonemail" runat="server" Width="200px"></asp:TextBox>
                                </li>
                                <li></li>
                                ...
                                <li>
                                    <br />
                                    <span runat="server" id="spnreason">Select Reason</span><span style="color: red" runat="server" id="Span3">*</span>
                                ...
                                <li id="liddlReason2" runat="server" visible="false"></li>
                                <li id="liddlReason3" runat="server" visible="false"></li>
                                ...
                                <li class="trvl_date" id="liUploadCTMTestCase" runat="server" visible="false">
                                    <br />
                                    <span runat="server" id="Span1">Upload CTM Test Cases</span><span style="color: red" runat="server" id="Span2">*</span>
                                ...
                                <li class="trvl_date" id="liUploadUATSingOff" runat="server" visible="false">
                                    <span runat="server" id="spnuatattach">Upload UAT Sing Off</span><span style="color: red" runat="server" id="spnmedatory">*</span>
                                ...
                                <li style="width: 40%;">
                                    <br />
                                    <span runat="server" id="spnpassedhbt" visible="false">Passed HBT Test Cases Files</span>
                                    <br />
                                    <asp:GridView ID="gvHBTTestCaseFailedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Passed HBT Test Cases File"
                                                DataField="FileName"
                                                ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left"
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <span class="ctmtesting" runat="server" visible="false" id="ctmtesting"><br />CTM Testing</span>
