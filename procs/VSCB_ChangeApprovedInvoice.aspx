<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="VSCB_ChangeApprovedInvoice.aspx.cs" Inherits="VSCB_ChangeApprovedInvoice" EnableSessionState="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Change Approve Invoice TDS Amount"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_grid">
                            <div class="InvoiceMilestonegrid">
                                ...
                                <div style="width: 102%; overflow: auto">
                                    <asp:GridView ID="gvInvoiceMilestone_Acc" Visible="true" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="105%" EditRowStyle-Wrap="false"
                        ...
                        <li class="trvl_date" id="idDirectTaxAmt_ACC_2" runat="server" visible="false"></li>
                        <li class="trvl_date" id="idDirectTaxAmt_ACC_3" runat="server" visible="false"></li>
                        ...
                        <li class="trvl_grid" runat="server" id="idliCostCenterList_ACC">
                            <span>Cost Center Amount</span><br />
    ...
    <div class="trvl_Savebtndiv">
        ...
        <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_approvedinvoiceChangeReq.aspx">Back</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdn_TDSAmtount_Old" runat="server" />
