<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_ApprovedPaymentRequestViewForChange.aspx.cs" Inherits="procs_VSCB_ApprovedPaymentRequestViewForChange" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Approved Payment Requests List For Amount Paid Account Change"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li style="padding-top: 15px">
                            <span>Payment Request From Date</span>&nbsp;&nbsp;
                             <br />
                        ...
                        <li style="padding-top: 15px">
                            <span>Payment Request To Date</span>&nbsp;&nbsp;
                             <br />
                ...
                <center>
                    <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="Payment_ID,POID,IsInvoiceWithPO" CellPadding="3" AutoGenerateColumns="False" Width="145%" EditRowStyle-Wrap="false" PageSize="12" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                ...
                <asp:HiddenField ID="hdnPayementReqFromDate" runat="server" />
                <asp:HiddenField ID="hdnPayementReqToDate" runat="server" />
            </div>
        </div>
    </div>
