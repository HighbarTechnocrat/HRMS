<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="Req_Requis_Dept_Report.aspx.cs" Inherits="Req_Requis_Dept_Report" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Summary Report"></asp:Label>
                    </span>
                </div>
                 <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
						<li class="mobile_inboxEmpCode">                            
                             <span>Report By</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                                    <asp:DropDownList runat="server" ID="lstreportName" CssClass="DropdownListSearch">
										<asp:ListItem value="0">Select Report Name</asp:ListItem>
										<asp:ListItem value="SelectDeptReport" Selected="True">Department </asp:ListItem>
										<asp:ListItem value="SelectRecruiterReport">Recruiter </asp:ListItem>
										<asp:ListItem value="SelectSkillReport">Skillset </asp:ListItem>
										<asp:ListItem value="SelectLocationReport">Location</asp:ListItem>
                                    </asp:DropDownList>
                                    <br /> <br />
                        </li>
						<li></li>
