<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_ApproveInvoiceInbox_Reversal.aspx.cs" 
    Inherits="procs_VSCB_ApproveInvoiceInbox_Reversal" EnableSessionState="True" EnableViewState="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
			...
			<div class="wishlistpagediv">
				...
				<div class="edit-contact">
					...
					<ul id="editform1" runat="server">
						...
						<li class="trvl_date">
                            <span runat="server" id="Span2" >Approver Reverse Remark</span>
							<br />
							<asp:TextBox AutoComplete="off" ID="Txt_ApproverReverseRemark"  runat="server" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
	...
	<div class="trvl_Savebtndiv">
        ...
        <asp:LinkButton ID="linkBtn_reverseinvoice" runat="server" Visible="false" Text="Reverse Invoice Approve" ToolTip="Reverse Invoice Approve" CssClass="Savebtnsve" OnClientClick="return SaveMultiClickReverseInvoice();" OnClick="linkBtn_reverseinvoice_Click">Reverse Invoice Approve</asp:LinkButton>
        </span>
