<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    CodeFile="ABAP_Object_Tracker_CTM_Test_Upload_Test_Cases.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="procs_ABAP_Object_Tracker_CTM_Test_Upload_Test_Cases" 
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <br />
                        <asp:Label ID="lblheading" runat="server" Text="CTM Testing Uplaod Signoff & Update Status"></asp:Label>
                    </span>
                </div>
                <div>
               ...
               <%-- <asp:Panel ID="PnlIrSheet" runat="server" Style="display: none; position: fixed; top: 20%; left: 20%; transform: translate(-20%, -30%,-30%); width: 70%; padding: 20px; background-color: white; border: 1px solid #ccc; z-index: 1000;"
                       ...
                       <div class="edit-contact">
                            ...
                            <ul runat="server" id="Ul1" >
                               ...
                               <li class="trvl_date">
                                ...
                                <li class="trvl_date" style="width: 50%">
                                    <span>Upload CTM Test Cases :</span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    ...
                                    <asp:FileUpload ID="uplHBTTestCases" runat="server" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" AllowMultiple="false"></asp:FileUpload>
                                </li>
                                <li></li>
                            </ul>
                        </div>
                         <div class="mobile_Savebtndiv" style="padding-left:250px">
                          <asp:LinkButton ID="trvl_btnSave" runat="server" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClick="UploadHBTTestCases_btnSave_Click">Submit</asp:LinkButton>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_date" runat="server" id="liProjectManager" visible="false">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <asp:GridView ID="gvHBTTestDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Training Start"
                                        DataField="HBTTrainingStart" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"  ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />

                                    <asp:BoundField HeaderText="Training Finish"
                                        DataField="HBTTrainingEnd"  ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="8%"
                                        ItemStyle-BorderColor="Navy" />
                                    ...
                                    <asp:TemplateField HeaderText="Download Test Cases" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
                                        <ItemTemplate>
