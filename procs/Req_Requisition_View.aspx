<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" ValidateRequest="false"
	CodeFile="Req_Requisition_View.aspx.cs" Inherits="Req_Requisition_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			//$(".jHtmlArea").css({ "background-color": "blue" });  			
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				...
				<div>
					...
					<span>
                       <a href="Req_RequisitionIndex.aspx?itype=APP" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
				</div>
