<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="Ref_Candidate_View.aspx.cs" Inherits="procs_Ref_Candidate_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Refer Candidate View"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
					...
					<span>
                         <a href="Ref_Moderator_View.aspx" id="lnkback"  style="margin-right:20px" runat="server"  class="aaaa">Back</a>
                    </span>
                   ...
                   <ul id="editform" runat="server">
                      ...
                      <br />
                       ...
                       <li class="mobile_inboxEmpCode">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtApporvalcmd" Enabled="false" runat="server" MaxLength="200" TextMode="MultiLine" Rows="5" CssClass="noresize" Width="86%" onKeyUp="javascript:Count(this);"></asp:TextBox>
						</li>
                    </ul>
    ...
    <div class="mobile_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" Visible="false" runat="server" Text="Submit" ToolTip="Apporval" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="mobile_btnSave_Click">Apporval</asp:LinkButton>
        <asp:LinkButton ID="btnReject" Visible="false" runat="server" Text="Submit" ToolTip="Reject" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="btnReject_Click">Reject</asp:LinkButton>
		<asp:LinkButton ID="mobile_cancel" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Ref_Moderator_View.aspx">Back</asp:LinkButton>
    </div>
    <br />
