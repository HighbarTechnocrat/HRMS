<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="Req_SkillsetwiseReport.aspx.cs" Inherits="procs_Req_SkillsetwiseReport" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Skillset wise Summary Report"></asp:Label>
                    </span>
                </div>
                 <div>
