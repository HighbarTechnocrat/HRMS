...
public partial class procs_VSCB_ApproveInvoice_Reversal : System.Web.UI.Page
{
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (Request.QueryString.Count > 0)
                    {
                        ...
                        {
                            txtinvoice_description.Enabled = true;
                            // txtinvoice_description.Visible = false;
                            // invoice_description.Text = "hi";
                        }

                    }

                   // ReverseButtonApproval();
                }
    ...
    //public void ReverseButtonApproval()
    //{
    ...
    //    spars[2].Value = Convert.ToString(Session["Empcode"]).ToString();
    ...
    //        {
    //            linkBtn_reverseinvoice.Visible = true;
    //            RemarkReverseInvoice.Visible = true;
    //            TxtRemarksReverseInvoice.Visible = true;
    //        }
    //    }
    //}
    ...
    public void check_POWO_IsForLoginEployeee()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "Check_Invoice_forLoginEmployeeRequest_Reversal";

        spars[1] = new SqlParameter("@empcode", SqlDbType.VarChar);
        spars[1].Value = Convert.ToString(txtEmpCode.Text);

        spars[2] = new SqlParameter("@InvoiceID", SqlDbType.BigInt);
        spars[2].Value = Convert.ToInt32(hdnInvoiceId.Value);
        ...
        {
            TxtRemarksReverseInvoice.Text = dsEmployee.Tables[2].Rows[0]["Remarks"].ToString();
            linkBtn_reverseinvoice.Enabled = false;
            RemarkReverseInvoice.Visible = true;
            TxtRemarksReverseInvoice.Visible = true;
            lblmessage.Text = "Approved Invoice Reversal Status Pending Contact Approval person.";
            lblmessage.Visible = true;
            IDApprovalReversalGrid.Visible = true;
            IDApprovalReversalGrid1.Visible = true;
            IDApprovalReversalGrid2.Visible = true;
            GridViewReversalApprovalStatus.DataSource = dsEmployee.Tables[3];
            GridViewReversalApprovalStatus.DataBind();
    ...
    protected void linkBtn_reverseinvoice_Click(object sender, EventArgs e)
    {
        string confirmValue = hdnYesNo.Value.ToString();
        if (confirmValue != "Yes")
        {
        ...
        if (TxtRemarksReverseInvoice.Text == "")
        {
            lblmessage.Text = "Please Enter the Reverse Invoice Remarks.";
            return;
        }
        DataSet dsProjectsVendors = new DataSet();
        ...
        spars[0] = new SqlParameter("@qtype", SqlDbType.VarChar);
        spars[0].Value = "InvoiceApprovalRequest_Reversal";

        spars[1] = new SqlParameter("@InvoiceID", SqlDbType.BigInt);
        spars[1].Value = Convert.ToInt32(hdnInvoiceId.Value);

        spars[2] = new SqlParameter("@Approval_Emp_Code", SqlDbType.VarChar);
        spars[2].Value = Convert.ToString(Session["Empcode"]);

        spars[3] = new SqlParameter("@Remarks", SqlDbType.VarChar);
        spars[3].Value = TxtRemarksReverseInvoice.Text;
    ...
    //protected void linkBtn_reverseinvoiceApprove_Click(object sender, EventArgs e)
    //{
    //    DataSet dsProjectsVendors = new DataSet();
    //    SqlParameter[] spars = new SqlParameter[4];

    //    spars[0] = new SqlParameter("@qtype", SqlDbType.VarChar);
    //    spars[0].Value = "UpdateFinalByAccount_ReverseInvoice";
    ...
    //    {
    //        string dMilestoneId = Convert.ToString(gvInvoiceMilestone_Acc.DataKeys[row.RowIndex].Values[2]);
    //        DataSet dsProjectsVendorsGV = new DataSet();
    //        SqlParameter[] sparsGV = new SqlParameter[3];

    //        sparsGV[0] = new SqlParameter("@qtype", SqlDbType.VarChar);
    //        sparsGV[0].Value = "UpdateInvoice_Milestone_TDS_Amt__ReverseInvoice";

    //        sparsGV[1] = new SqlParameter("@InvoiceID", SqlDbType.BigInt);
    //        sparsGV[1].Value = Convert.ToDouble(hdnInvoiceId.Value);

    //        sparsGV[2] = new SqlParameter("@MstoneID", SqlDbType.BigInt);
    //        sparsGV[2].Value = Convert.ToInt32(dMilestoneId);

    //        dsProjectsVendorsGV = spm.getDatasetList(sparsGV, "SP_VSCB_CreateInvoice");
    //    }
    //}
}
