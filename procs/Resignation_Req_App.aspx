    ...
    CodeFile="Resignation_Req_App.aspx.cs" Inherits="Resignation_Req_App" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Accept Resignation"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <span>
                    <a href="ResignationMenu.aspx" class="aaaa">Resignation Menu</a>
                </span>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_inboxEmpCode">                          
                            <span>Reason: </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtReason" TextMode="MultiLine" runat="server" Height="90" MaxLength="200" Enabled="false"></asp:TextBox>
                        </li>
                       <li class="mobile_inboxEmpCode">
                           </li>
    ...
    <div class="mobile_Savebtndiv">
        ...
        <asp:LinkButton ID="mobile_btnSave_COSACC" runat="server" Visible="false" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click" OnClientClick="return SaveMultiClick_COSSACC();">Submit</asp:LinkButton>
         <asp:LinkButton ID="mobile_btnReject" runat="server" Visible="false" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="mobile_btnReject_Click" OnClientClick="return CancelMultiClick();">Reject</asp:LinkButton>
