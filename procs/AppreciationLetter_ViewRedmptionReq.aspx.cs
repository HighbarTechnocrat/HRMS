...
public partial class AppreciationLetter_ViewRedmptionReq : System.Web.UI.Page
{
    ...
    private void Redmption_Point_GridView()
    {
        try
        {
            ...
            spars[0].Value = "View_Redmption_Point";
    ...
    protected void lnkAppreciationLetter_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnReqid.Value != "0")
            {
                Response.Redirect("AppreciationLetter_ViewRedmption.aspx?reqid=" + hdnReqid.Value);
            }
