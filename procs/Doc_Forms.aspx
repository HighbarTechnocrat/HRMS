<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Doc_Forms.aspx.cs" Inherits="procs_Doc_Forms" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Forms"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                    ...
                    <div class="leavegridMain">
                        ...
                        <asp:GridView ID="dghbtPolicies" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                            ...
                            <Columns>
<%--                                <asp:BoundField DataField="SubDocDescription" HeaderText="Form">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Center" Width="80%" />
                                </asp:BoundField>--%>
                                <asp:TemplateField HeaderText="Forms" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true">
                                    <ItemTemplate>
