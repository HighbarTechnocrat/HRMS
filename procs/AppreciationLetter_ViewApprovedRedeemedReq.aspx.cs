...
public partial class AppreciationLetter_ViewApprovedRedeemedReq : System.Web.UI.Page
{
    ...
    private void Redmption_Point_GridView()
    {
        try
        {
            ...
            spars[0] = new SqlParameter("@qtype", SqlDbType.VarChar);
            spars[0].Value = "View_Approved_Redmption_Point";
    ...
    protected void lnkAppreciationLetter_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnReqid.Value != "0")
            {
                Response.Redirect("AppreciationLetter_ApprovedRedeemedReq.aspx?reqid=" + hdnReqid.Value);
            }
