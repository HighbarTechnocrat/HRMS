<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Module_index.aspx.cs" Inherits="Module_index" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    ...
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Module Index"></asp:Label>
                        </span>
                    </div>
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server" PostBackUrl="~/procs/Leaveindex.aspx">Leave Menu</asp:LinkButton>                                         
                                    </td>
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:4px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/travelindex.aspx">Travel Index</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_Attendancereg" runat="server"  Text ="Reimbursement Index" PostBackUrl="~/procs/Reembursementindex.aspx">Reimbursement Index</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                    <%--<ul>
