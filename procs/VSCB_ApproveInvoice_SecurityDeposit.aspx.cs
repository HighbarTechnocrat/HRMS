...
public partial class VSCB_ApproveInvoice_SecurityDeposit : System.Web.UI.Page
{
    ...
    private void Calculate_DirectTax_Amount()
    {
        ...
        if (Convert.ToString(lstDirectTaxSections.SelectedValue).Trim() != "0" && Convert.ToString(lstDirectTaxSections.SelectedValue).Trim() != "1")
        {
            //if (Convert.ToString(txtDirectTaxPercentage.Text).Trim() == "")
            //{
            //    lblmessage.Text = "Please enter Direct Tax Percentage.";
        ...
        Adv_Bal_Amt1 = Convert.ToDecimal(Convert.ToDecimal(txtAmtWithTax_Invoice.Text) - Convert.ToDecimal(txtSecurityDeposit.Text));
