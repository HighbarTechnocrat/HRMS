<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ApprTravelRequestView.aspx.cs" Inherits="ApprTravelRequestView" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <span>
                    <a href="teamcalender_Travel.aspx" class="aaaa" >Travel Team Calendar</a>
                </span>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="trvL_detail">
                            <asp:LinkButton ID="btnTra_Details" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve" PostBackUrl=""></asp:LinkButton>
                        ...
                        <li class="trvl_Accomodation">
                            <asp:LinkButton ID="trvl_accmo_btn" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve" PostBackUrl="~/procs/Accomodation.aspx"></asp:LinkButton>
                        ...
                        <li class="trvl_local">
                            <asp:LinkButton ID="trvl_localbtn" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve" PostBackUrl="~/procs/LocalTravel.aspx"></asp:LinkButton>
                        ...
                        <li class="trvl_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dgTravelTravel" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="70%" EditRowStyle-Wrap="false">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
