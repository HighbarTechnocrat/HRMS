<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
	CodeFile="ExitProcess_Mo_Index.aspx.cs" Inherits="procs_ExitProcess_Mo_Index" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Retention Moderation Inbox"></asp:Label>
					</span>
				</div>
				<div>
					...
					<ul id="editform" runat="server">
						...
						<li style="padding-top: 30px">
							<span>Project Name</span>&nbsp;&nbsp;
                             <br />
							<asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstLocation">
							</asp:DropDownList>
						</li>
					</ul>
				</div>
				...
				<div class="manage_grid" style="width: 100%; height: auto; padding-top: 20px;">
					...
					<center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="RetentionID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" OnRowDataBound="gvMngTravelRqstList_RowDataBound">
                        ...
                        <Columns>
							 ...
							 <asp:BoundField HeaderText="Emp Code"
                                DataField="Emp_Code" ItemStyle-Width="8%" />
							<asp:BoundField HeaderText="Emp Name" DataField="Emp_Name" ItemStyle-Width="18%" />	

							<asp:BoundField DataField="Department_Name" HeaderText="Department" ItemStyle-Width="14%" />
							
							 <asp:BoundField DataField="Location_name" HeaderText="Project" ItemStyle-Width="18%" />	

                            <asp:BoundField HeaderText="Retention Type" DataField="RetentionTypeName"                               
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />			
							
							<asp:BoundField HeaderText="With Effect From" DataField="WithEffectFrom" ItemStyle-Width="8%" />

							<asp:BoundField HeaderText="From Date" DataField="FromDate" ItemStyle-Width="7%" /> 

                            <asp:BoundField HeaderText="To Date" DataField="ToDate" ItemStyle-Width="7%" />

							 
                             <asp:BoundField HeaderText="Status Name"
                                DataField="StatusName" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="7%" />
