<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InboxITAssetServiceRequest_Arch.aspx.cs" Inherits="InboxITAssetServiceRequest_Arch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Processed IT Asset Requests"></asp:Label>
        </span>
    </div>
        <div class="leavegrid">
...
<%--        <div class="editprofile btndiv" id="divbtn" runat="server" visible="false">
    ...
    <div class="manage_grid" style="width: 100%; height: auto;">
        <center>
                ...
                DataKeyNames="Id,StatusId,RequestType" CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
            ...
            <SortedDescendingHeaderStyle BackColor="#00547E" />
             <Columns>
                            <asp:BoundField HeaderText="IT Asset Request Number"
                                DataField="AARNo"
                            ...
                            <asp:BoundField HeaderText="Status"
                                DataField="Status"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" />
                            <asp:BoundField HeaderText="RequestType"
                                DataField="RequestType"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" />
                            <asp:BoundField HeaderText="StatusId" ItemStyle-CssClass="hiddencol"
                                DataField="StatusId"
                                 ItemStyle-HorizontalAlign="Center"                                
                                ItemStyle-Width="20%" HeaderStyle-CssClass="hiddencol" />
