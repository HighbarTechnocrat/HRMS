...
public partial class VSCB_PaymentAppMatrixList : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        //Response.Write(hdnTallycode.Value);
        //Response.Write(hdnCostCenter.Value);
        //Response.End();
    ...
    private void getSelected_CostCenter_Approver()
    {
        try
        {
            ...
            spars[0].Value = "get_selected_CostCenter_Approvers_Payment"; // "get_selected_CostCenter_Approvers";
    ...
    private void getMngInvoiceReqstList()
    {
        ...
        { 
            ...
            spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
            spars[0].Value = "get_CostCenter_PaymentApprovers_list"; // "get_CostCenter_Approvers_list";
    ...
    {
        DataSet dsProjectsVendors = new DataSet();
        string sInsertUpdateFlg = "insert_PaymentApprovers";
        try
        {
            SqlParameter[] spars = new SqlParameter[5];

            spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
            spars[0].Value = "get_CostCenter_PaymentApprovers";
            ...
            if (dsProjectsVendors != null)
            {
                if (dsProjectsVendors.Tables.Count > 0)
                {
                    if (dsProjectsVendors.Tables[0].Rows.Count > 0)
                    {
                        sInsertUpdateFlg = "update_PaymentApprovers";
                        if (dsProjectsVendors.Tables[0].Rows.Count == 1)
                        {
    ...
    protected void trvl_btnSave_Click(object sender, EventArgs e)
    {
        ...
        { 
            ...
            //if(sInsertUpdateFlg== "insert_InvoiceApprovers")
            //{
            //    lblmessage.Text = "Invoice & Payment Approver Added successfully";
            //}
            //else
            //{
            //    lblmessage.Text = "Invoice & Payment Approver Updated successfully";
            //}
            divSearchCostCenter.Visible = true;
            divSeachButtons.Visible = true;
            RecordCount.Visible = true;
