<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
     CodeFile="viewattached_resume.aspx.cs" Inherits="viewattached_resume" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Attached Resume"></asp:Label>
                    </span>
                </div>
                            ...
                            <div>
                                <asp:GridView ID="dgMobileClaim" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Details" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <ItemTemplate>
    ...
    <div class="mobiletrvl_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Visible="false" Text="Submit" ToolTip="Save" CssClass="Savebtnsve"  OnClick="mobile_btnSave_Click" >Submit</asp:LinkButton>
        <!--<asp:LinkButton ID="mobile_cancel" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="Savebtnsve" >Cancel</asp:LinkButton>-->
        <asp:LinkButton ID="claimmob_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick ="claimmob_btnBack_Click1" ></asp:LinkButton>
