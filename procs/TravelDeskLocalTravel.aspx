<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TravelDeskLocalTravel.aspx.cs" Inherits="TravelDeskLocalTravel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Local Travel"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="localtrvl_trip">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtTripId" runat="server" Visible="True" CssClass="grayDropdownTxt"></asp:TextBox>
                        ...
                        <li class="localtrvl_type">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtTravelType" runat="server" CssClass="grayDropdown" Visible="True"></asp:TextBox>
                            <asp:Panel ID="Panel3" Style="display: none;" runat="server" CssClass="taskparentclasskkk">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:ListBox ID="ListBox2" runat="server" CssClass="taskparentclasskkk" AutoPostBack="true" Visible="false">
                        ...
                        <li class="localtrvl_fromdate">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtFromdate" runat="server" AutoPostBack="True"  CssClass="grayDropdownTxt" OnTextChanged="txtFromdate_TextChanged"></asp:TextBox>
                        ...
                        <li class="localtrvl_date">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtToDate" runat="server" AutoPostBack="True" CssClass="grayDropdownTxt" OnTextChanged="txtToDate_TextChanged"></asp:TextBox>
                        ...
                        <li class="localtrvl_location">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtLocation" runat="server" CssClass="grayDropdown"></asp:TextBox>
                            ...
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender1" PopupControlID="Panel2" TargetControlID="txtLocation"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>
                        </li>
                        <%--<li class="localtrvl_trip">
                        ...
                        <li class="localtrvl_requirement">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtRequirement" runat="server" MaxLength="30" CssClass="grayDropdownTxt"></asp:TextBox>
                        </li>
                          ...
                          <asp:TextBox AutoComplete="off" ID="txtTravelMode" runat="server" CssClass="Dropdown"></asp:TextBox>
                            <asp:Panel ID="Panel4" Style="display: none;" runat="server" CssClass="taskparentclasskkk">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:ListBox ID="lstTravelMode" runat="server" CssClass="taskparentclasskkk" AutoPostBack="true" OnSelectedIndexChanged="lstTravelMode_SelectedIndexChanged"></asp:ListBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </asp:Panel>

                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender3" PopupControlID="Panel4" TargetControlID="txtTravelMode"
                                Position="Bottom" runat="server">
                            </ajaxToolkit:PopupControlExtender>
                           ...
                           <li class="localtrvl_trip">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtDeviation" runat="server" Visible="True" CssClass="grayDropdownTxt"></asp:TextBox>
                           </li>
    ...
    <div class="localtrvl_Savebtndiv">
        <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Confirmation" ToolTip="Confirmation" CssClass="Savebtnsve" OnClick="localtrvl_btnSave_Click">

        </asp:LinkButton>


        <asp:LinkButton ID="localtrvl_delete_btn" runat="server" Visible="false" Text="Delete" ToolTip="Cancel" CssClass="Savebtnsve" OnClick="localtrvl_delete_btn_Click"></asp:LinkButton>
    ...
    <script type="text/javascript">
        function SetCntrls(Deviation) {
            ...
            if (Deviation == "Booked") {
                document.getElementById("<%=txtTravelMode.ClientID%>").disabled = false
                document.getElementById("<%=txtTravelMode.ClientID%>").style.backgroundColor = "#ffffff"; // backcolor
               
            }
            else {
                document.getElementById("<%=txtTravelMode.ClientID%>").disabled = true
                document.getElementById("<%=txtTravelMode.ClientID%>").value = "";
                document.getElementById("<%=txtTravelMode.ClientID%>").style.backgroundColor = "#ebebe4"; // backcolor
