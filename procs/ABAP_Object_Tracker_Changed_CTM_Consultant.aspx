<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_Changed_CTM_Consultant.aspx.cs" Inherits="ABAP_Object_Tracker_Changed_CTM_Consultant" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Changed CTM Consultants"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_grid" id="liabapdetails" runat="server">
                            <br />
                            <br />
                            <span class="ctmtest" runat="server" visible="true" id="ctmtest">CTM Testing</span>
                            <asp:GridView ID="gvCTMTestDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="CTM Revised Start"
                                    ...
                                    <asp:BoundField HeaderText="CTM Actual Start"
                                    ...
                                    <asp:BoundField HeaderText="CTM Actual Finish"
                        ...
                        <li class="trvl_date">
                            ...
                            <span>
                                <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/ABAP_Object_Tracker_Changed_CTM_Consultants.aspx">Back</asp:LinkButton>
                            </span>
                        </li>
