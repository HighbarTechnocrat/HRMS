<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Req_Requisition_RequiterChange.aspx.cs"
    MaintainScrollPositionOnPostback="true"  Inherits="procs_Req_Requisition_RequiterChange" %>
  ...
  <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div>
					...
					<span>
                       <a href="Req_RequiterChangeIndex.aspx?itype=APP" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
                            ...
                            <ul>
                                <li class="trvl_date Req_Position" id="Recruiter" runat="server" visible="true">
                                 ...
                                 <li class="trvl_date Req_Position" id="Li2" runat="server" visible="true">
                                    <span>Recruiter Change</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
    ...
    <div class="Req_Savebtndiv" style="margin-left:150px;">
       ...
       --%>
        ...
        <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Req_RequiterChangeIndex.aspx?itype=APP" >Back</asp:LinkButton>
