<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_ApproveInvoice_Reversal.aspx.cs" 
    Inherits="procs_VSCB_ApproveInvoice_Reversal" EnableSessionState="True" EnableViewState="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
		...
		.AmtTextAlign {
         ...
         #MainContent_linkBtn_reverseinvoice {
          background: #3D1956;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
				...
				<div class="edit-contact">
					...
					<ul id="editform1" runat="server">
						...
						<li class="trvl_date" id="idWithoutInv_InvoiceType_1" runat="server">
							...
							<asp:DropDownList runat="server" ID="lstExpenses" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstExpenses_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
						...
						<li class="trvl_date" id="idWithoutInv_InvoiceType_3" runat="server">
                            <span id="idspnSelectitem_details" runat="server">Select Item</span>&nbsp;&nbsp;<span style="color: red" id="idspnitemstar" runat="server">*</span><br />
							<br />
							<asp:DropDownList runat="server" ID="lstItem_details" CssClass="DropdownListSearch">
							</asp:DropDownList>
						</li>
						...
						<li class="trvl_grid">
							<div class="InvoiceMilestonegrid">
								<asp:GridView ID="gvInvoiceMilestone" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="105%" EditRowStyle-Wrap="false"
									DataKeyNames="srno,PaymentStatusID,MstoneID">
									<FooterStyle BackColor="White" ForeColor="#000066" />
									<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
									<PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
									...
									<asp:GridView ID="gvInvoiceMilestone_Acc" Visible="false" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="105%" EditRowStyle-Wrap="false"
										...
										<Columns>
											...
											<asp:TemplateField HeaderText="Percentage(%)" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
												<ItemTemplate>
													<asp:TextBox AutoComplete="off" ID="txtDirectTaxPercentage_ACC" Width="60px" runat="server" MaxLength="5" AutoPostBack="true" ReadOnly="true" Enabled="False" OnTextChanged="txtDirectTaxPercentage_ACC_TextChanged" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
											...
											<asp:TemplateField HeaderText="Is LDC Available" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
												<ItemTemplate>
													<asp:CheckBox ID="chkLDC_Applicable_ACC" Enabled="false" runat="server" AutoPostBack="true" OnCheckedChanged="chkLDC_Applicable_ACC_CheckedChanged" />
												</ItemTemplate>
						...
						<li class="trvl_date" id="idDirectTaxApplicable_TDS_1" runat="server" visible="false">
							...
							<asp:DropDownList runat="server" ID="lstDirectTaxSections" AutoPostBack="true" CssClass="DropdownListSearch" OnSelectedIndexChanged="lstDirectTax_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
						...
						<li class="trvl_date" id="idDirectTaxApplicable" runat="server" visible="false">
							...
							<asp:DropDownList runat="server" ID="lstDirectTax" AutoPostBack="false" CssClass="DropdownListSearch" ReadOnly="true" Enabled="False" OnSelectedIndexChanged="lstDirectTax_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
						<li class="trvl_date" id="idPercentage" runat="server" visible="false">
							<span>Percentage(%)</span>
							<asp:TextBox AutoComplete="off" ID="txtDirectTaxPercentage" runat="server" MaxLength="5" AutoPostBack="true" ReadOnly="true" Enabled="False" OnTextChanged="txtDirectTaxPercentage_TextChanged"></asp:TextBox>
						</li>
						...
						<li class="trvl_date">
							<span>Amount (With GST)(A)</span><br />
							<asp:TextBox AutoComplete="off" ID="txtAmtWithTax_Invoice" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
						</li>
						<li class="trvl_date" runat="server" id="DAdvSet1" visible="false">
							<asp:CheckBox ID="ChkAdvSettlement" Visible="false" Enabled="false" runat="server" Text="Is Payment Advance Settlement" />
							<span style="color: red; font-size: 13px;"></span>
						</li>

						<li class="trvl_date" runat="server" id="DAdvSet" visible="false">
							<span>Advance Settlement Amount (B)</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
							<asp:TextBox AutoComplete="off" ID="txtAdv_Settlement_Amt" Enabled="false" runat="server"></asp:TextBox>
						</li>

						<li class="trvl_date" runat="server" id="DAdvSet2" visible="false">
							<asp:CheckBox ID="ChkSecuritySettlement" Visible="false" runat="server" Enabled="false" Text="Is Security Deposit Settlement" />
							<span style="color: red; font-size: 13px;"></span>
						</li>
						<li class="trvl_date" runat="server" id="SASecurity" visible="false">

							<span>Security Deposit Settlement Amount (C) </span>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtSecurityDeposit" Enabled="false" runat="server" AutoPostBack="true" OnTextChanged="txtSecurityDeposit_TextChanged"></asp:TextBox>
						</li>

						<li class="trvl_date" runat="server" id="DAdvSet4">
							<div runat="server" id="ADVtax" visible="false">
								<span>Direct Tax on Advance Amount </span>
								<br />
								<asp:TextBox AutoComplete="off" ID="txt_Advance_TDS_Amt" Enabled="false" runat="server"></asp:TextBox>
							</div>
						</li>
						<li class="trvl_date" runat="server" id="SAADV_Amt" visible="false">
							<div runat="server" id="ADVtax2" visible="false">
							<%
								if (ChkAdvSettlement.Checked && ChkSecuritySettlement.Checked)
								{%>
							<span>Invoice Payable Amt (Exclude Advance Amt)(A-B) </span>
							<% }
							...
							<% }
								...
								{%>
							<span>Invoice Payable Amt (Exclude Advance Amt)(A-C) </span>
							<% }
								else
								{
							%>
							<span>Invoice Payable Amt (Exclude Advance Amt)(A-B-C) </span><% } %>
							<br />
							<asp:TextBox AutoComplete="off" ID="txtAdv_Bal_Amt" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
								</div>
						</li>
						<%--<li></li>
						<li></li>--%>
						...
						<li class="trvl_date" runat="server" id="DAdvSet5"></li>
						...
						<li class="trvl_grid" runat="server" id="idliCostCenterList_ACC">
							...
							<br />
							<asp:LinkButton ID="trvldeatils_btnSave" runat="server" Text="Add Cost Center" ToolTip="Add Cost Center" CssClass="Savebtnsve" OnClick="trvldeatils_btnSave_Click"></asp:LinkButton>
							...
							<asp:GridView ID="dgCostcenterList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="50%" OnRowDataBound="dgCostcenterList_RowDataBound">
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="Cost Center Amount (Without GST) " ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
										<ItemTemplate>
											<asp:Label ID="lblCostCenterAmt" runat="server" Visible="false"></asp:Label>
						...
						<li class="trvl_date">
                            	<span runat="server" id="RemarkReverseInvoice" visible="false">Remark Reverse Invoice </span>
							<br />
							<asp:TextBox AutoComplete="off" ID="TxtRemarksReverseInvoice" visible="false" runat="server" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
						</li>
						...
						<li class="trvl_date"></li>
                         ...
                         <li class="trvl_date" id="invoice_description" runat="server">
							<span>Invoice Description</span>
							<asp:TextBox AutoComplete="off" ID="txtinvoice_description" runat="server" MaxLength="100" TextMode="MultiLine" Enabled="false"></asp:TextBox>
						</li>
						...
						<li class="trvl_date"></li>
                        <br /><br />
                        <li class="trvl_Approver" runat="server" id="IDApprovalReversalGrid" visible="false">
                            <span><b>Approval Reversal Status</b></span><br />

							<asp:GridView ID="GridViewReversalApprovalStatus" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="75%">
								<FooterStyle BackColor="White" ForeColor="#000066" />
								<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
								<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
								<RowStyle ForeColor="#000066" />
								...
								<SortedDescendingHeaderStyle BackColor="#00547E" />
								<Columns>
									<asp:BoundField HeaderText="Approver Reversal Name"
										DataField="Emp_Name"
										ItemStyle-HorizontalAlign="left"
										HeaderStyle-HorizontalAlign="left"
										ItemStyle-Width="33%"
						...
						<li class="trvl_date" runat="server" id="IDApprovalReversalGrid1" visible="false"></li>
						<li class="trvl_date" runat="server" id="IDApprovalReversalGrid2" visible="false"></li>
	...
	<div class="trvl_Savebtndiv">
        ...
        <asp:LinkButton ID="linkBtn_reverseinvoice" runat="server" Visible="false" Text="Reverse Invoice" ToolTip="Reverse Invoice" CssClass="Savebtnsve" OnClientClick="return SaveMultiClickReverseInvoice();" OnClick="linkBtn_reverseinvoice_Click">Reverse Invoice</asp:LinkButton>
        </span>
	...
	<asp:HiddenField ID="hdnAdvance_IsTDC" runat="server" />
    <asp:HiddenField ID="hdnGSTAmt" runat="server" /> 
	...
	<script type="text/javascript">
        ...
        function SaveMultiClickReverseInvoice() {
			try {
				var retunboolean = true;
				var ele = document.getElementById('<%=linkBtn_reverseinvoice.ClientID%>');
