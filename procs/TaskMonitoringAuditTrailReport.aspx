<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TaskMonitoringAuditTrailReport.aspx.cs" Inherits="TaskMonitoringAuditTrailReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Task Monitoring Audit Trail Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date">
                            ...
                            <span>Task Reference Date From </span>&nbsp;&nbsp;              
                                 <asp:TextBox ID="txtFromdate" Enabled="true" CssClass="txtcls" AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date">
                            ...
                            <span>Task Reference Date To</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtToDate" AutoComplete="off" CssClass="txtcls" runat="server" AutoPostBack="true"   OnTextChanged="txtToDate_TextChanged" MaxLength="10" Enabled="true" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date">
                            ...
                            <span>From Task Due Date</span> &nbsp;&nbsp;              
                                 <asp:TextBox ID="txtDueDateFrom" Enabled="true" CssClass="txtcls" AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtDueDateFrom_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="date">
                            ...
                            <span>To Task Due Date </span>&nbsp;&nbsp;        
                                 <asp:TextBox ID="txtDueDateTo" AutoComplete="off" CssClass="txtcls" runat="server" AutoPostBack="true" OnTextChanged="txtDueDateTo_TextChanged" MaxLength="10" Enabled="true" AutoCompleteType="Disabled"></asp:TextBox>
