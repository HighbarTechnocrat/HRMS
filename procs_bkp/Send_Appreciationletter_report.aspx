<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Send_Appreciationletter_report.aspx.cs" Inherits="Send_Appreciationletter_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <br /> 
            <asp:Label ID="lblheading" runat="server" Text="Send Appreciation Letter Report"></asp:Label>
        </span>
    </div>
