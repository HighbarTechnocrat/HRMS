<%@ Page Title="" Language="C#" MasterPageFile="~/CustSinner.master" AutoEventWireup="true"
    CodeFile="Custs_MyServicePendingReq.aspx.cs" Inherits="Custs_MyServicePendingReq" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Inprocess Service Request"></asp:Label>
                    </span>
                </div> 
                ...
                <div class="cancelbtndiv">
                    <asp:LinkButton ID="lnkcont" Text="Load More.." Visible="false" ToolTip="Load More.." CssClass="submitbtn" runat="server" OnClick="lnkcont_Click"></asp:LinkButton>
                </div>
