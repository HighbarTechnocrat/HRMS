<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="VSCB_Advance_Payment_Create.aspx.cs" Inherits="procs_VSCB_Advance_Payment_Create" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Create Advance/ Security Deposit Payment Request"></asp:Label>
                    </span>
                </div>
                    ...
                    <ul id="editform" runat="server">
                        ...
                        <li class="trvl_date">
                         ...
                         <li class="trvl_type">
                           ...
                           <asp:TextBox AutoComplete="off" ID="txtHPOType" runat="server"  Enabled="False"></asp:TextBox>
                        </li>
                        <li class="trvl_date">                            
                           <div id="divScurity_Diposit" runat="server" visible="false">
                            <span>Security Deposit Amount</span>&nbsp;&nbsp;<br />
                            <asp:TextBox AutoComplete="off" ID="txtSecurity_DepositAmt" runat="server" Enabled="False" CssClass="BalAmt AmtTextAlign"></asp:TextBox>
                            </div>             
                        </li>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul id="Ul2" runat="server">
                                <li class="trvl_date" style="padding-bottom: 20px">
                                    <span style="text-decoration: underline; color: #F28820; font-size: 16px" id="SPCreate" runat="server">Create Advance Payment Request : </span>&nbsp;&nbsp;
                                    <br />
                                </li>
                                <li class="trvl_grid">
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:DropDownList runat="server" ID="lstPaymentType" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstPaymentType_SelectedIndexChanged">
                                    </asp:DropDownList>
                                ...
                                <li class="trvl_date">
                                    ...
                                    <span>Advance Payment Amount (without GST)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
    ...
    <asp:HiddenField ID="hdnIGST_Per" runat="server" />
     <asp:HiddenField ID="hdnAleadyProcess_totalInvoiceAmt" runat="server" />
