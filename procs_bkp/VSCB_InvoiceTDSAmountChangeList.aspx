<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_InvoiceTDSAmountChangeList.aspx.cs" Inherits="procs_VSCB_InvoiceTDSAmountChangeList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Invoice TDS Amount Change List"></asp:Label>
                    </span>
                </div>
