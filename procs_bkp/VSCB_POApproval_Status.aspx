<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_POApproval_Status.aspx.cs" Inherits="procs_VSCB_POApproval_Status" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="PO/WO Approval Status Report"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="edit-contact">
					<ul id="editform" runat="server">
						<li style="padding-top: 30px">
							<span>PO/ WO No.</span>&nbsp;&nbsp;
                             <br />
							<asp:DropDownList runat="server" ID="lstPOWONo" CssClass="DropdownListSearch" OnSelectedIndexChanged="lstPOWONo_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
						<li style="padding-top: 30px">
							<span>Vendor Name</span>&nbsp;&nbsp;
                             <br />
							<asp:DropDownList runat="server" ID="lstVendorName" CssClass="DropdownListSearch" Width="98%" OnSelectedIndexChanged="lstVendorName_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
						...
						<li style="padding-top: 15px">
							<span>Cost Center</span>&nbsp;&nbsp;
                             <br />
							<asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstCostCentre" OnSelectedIndexChanged="lstCostCentre_SelectedIndexChanged">
							</asp:DropDownList>
						</li>
                        
                        <li style="padding-top: 15px">
                            <span>PO/WO From Date</span>&nbsp;&nbsp;
                             <br />
				...
				<div class="mobile_Savebtndiv" style="margin-top: 10px !important">
					<asp:LinkButton ID="mobile_btnSave" runat="server" Text="Submit" ToolTip="Search" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click">View Report </asp:LinkButton>
				    ...
				    <asp:LinkButton ID="mobile_cancel" runat="server" Text="View & Send Mail to Approver" Visible="false" ToolTip="View & Send Mail to Approver" class="trvl_Savebtndiv" PostBackUrl="~/procs/VSCB_Rpt_POWO_Pending_Status.aspx" OnClick="mobile_cancel_Click">View & Send Mail to Approver</asp:LinkButton>
