<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_HBT_Test_Upload_Test_Cases.aspx.cs" Inherits="ABAP_Object_Tracker_HBT_Test_Upload_Test_Cases" EnableSessionState="True" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <br />
                        <asp:Label ID="lblheading" runat="server" Text="HBT Test Case Uplaod"></asp:Label>
                    </span>
                </div>
                <div>
                            ...
                            <ul runat="server" id="Ul1" >
                               ...
                               <li class="trvl_date">
                                ...
                                <li class="trvl_date">
                                 ...
                                 <%-- <li class="trvl_date">
                                    <span">Development Description 5</span>
                                    <asp:TextBox AutoComplete="off" ID="TextBox6" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>

                                    <span>Interface 3</span>
                                    <asp:TextBox AutoComplete="off" ID="TextBox7" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
                                </li>

                                <li class="trvl_date">
                                    <span">Development Description 6</span>
                                    <asp:TextBox AutoComplete="off" ID="TextBox8" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>

                                    <span>Interface 4</span>
                                    <asp:TextBox AutoComplete="off" ID="TextBox9" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
                                </li>--%>
                                ...
                                <li class="trvl_date" style="width: 50%" id="liupload" runat="server">
                                    <span>Upload HBT Test Cases :</span>&nbsp;&nbsp;<span style="color: red">*</span>
