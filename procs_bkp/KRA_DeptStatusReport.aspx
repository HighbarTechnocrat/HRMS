<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="KRA_DeptStatusReport.aspx.cs" Inherits="KRA_DeptStatusReport" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Department Status Report"></asp:Label>
                    </span>
                </div>
                <div>
