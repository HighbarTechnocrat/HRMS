<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ViewCandidate.aspx.cs"
	MaintainScrollPositionOnPostback="true" Inherits="procs_ViewCandidate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
		...
		/*#MainContent_LinkButton7{
			background: #3D1956 !important; 
			color: #febf39 ;
			padding: 0.5% 1.4%;
			margin: 0% 0% 0 0;
		}*/
#MainContent_lnkuplodedfile, #MainContent_Lnk_Questionnaire {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Edit Candidate Information"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div class="edit-contact">
					...
					<asp:Label runat="server" ID="RecordCount" Style="color:#F28820;font-size:15px;font-weight:bold"> Requisition History </asp:Label>
					<center>
						...
						<li class="mobile_InboxEmpName " style="margin-bottom: 15px">
							...
							<br />
							<asp:DropDownList runat="server" ID="lstEducationType"  AutoPostBack="true" CssClass="DropDownSerach" OnSelectedIndexChanged="lstEducationType_SelectedIndexChanged"></asp:DropDownList>
						</li>
						<li>
							<span>Full Time / Part Time  </span>&nbsp;&nbsp;<span style="color: red" runat="server" id="spfull" visible="false">*</span>
							<br />
							<asp:DropDownList ID="DDLFullTime" CssClass="DropDownSerach" Enabled="false" runat="server">
								<asp:ListItem Text="Select" Value="0"></asp:ListItem>
						...
						<li>
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtDiscipline" runat="server" CssClass="noresize"  Enabled="false" TextMode="MultiLine" onKeyUp="javascript:Count(this);" ></asp:TextBox>
						...
						<asp:GridView ID="DgvEducationDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<ItemTemplate>
												...
												<asp:ImageButton ID="lnkEdit" runat="server" ToolTip="Modify" ImageUrl="~/Images/edit.png" Width="15px" Height="15px" Style="float: left" OnClick="lnkEdit_Click" />
						...
						<asp:GridView ID="GrdCompanyInfo" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid"
							...
							<Columns>
								...
								<ItemTemplate>
												<asp:ImageButton ID="lnkCmpEdit" runat="server" ToolTip="Modify" ImageUrl="~/Images/edit.png" Width="15px" Height="15px" Style="float: left" OnClick="lnkCmpEdit_Click" />
						...
						<li class="mobile_grid">
							...
							<asp:GridView ID="gvotherfile" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%"
								DataKeyNames="MultipleFileID,FileName">
								<FooterStyle BackColor="White" ForeColor="#000066" />
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%">
										<ItemTemplate>
											...
											<asp:LinkButton ID="lnkdeleteFiles" title="Delete" runat="server" Text='Delete' OnClick="lnkdeleteFiles_Click"></asp:LinkButton>
										</ItemTemplate>
										<ItemStyle HorizontalAlign="Center" />
									</asp:TemplateField>
	...
	<div class="mobile_Savebtndiv">
		...
		<asp:LinkButton ID="mobile_btnSave" runat="server" Text="Submit" ToolTip="Modify" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="mobile_btnSave_Click">Modify</asp:LinkButton>
