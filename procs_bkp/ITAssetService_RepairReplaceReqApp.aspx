<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ITAssetService_RepairReplaceReqApp.aspx.cs" Inherits="ITAssetService_RepairReplaceReqApp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
     ...
     <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Repair/Replacement Request Approval"></asp:Label>
                    </span>
                </div>
                <div>
          ...
          <li></li>
            ...
            <li class="mobile_inboxEmpCode">  
                <span>Request Type</span>&nbsp;&nbsp;<br />
                  <asp:DropDownList Visible="true" ID="ddlReqType" Enabled="false"  runat="server" Width="200px"> 
            ...
            <%--<li class="mobile_inboxEmpCode">
                <span>Search Employee</span>&nbsp;&nbsp;<br />
                  <asp:DropDownList runat="server" ID ="ddl_Employee"> 
                 </asp:DropDownList><br /><br />
            </li>
            <li></li>--%>
            <li class="mobile_inboxEmpCode">
         ...
         <div>
           ...
           <%-- <li  id="lblAppDtls" runat="server" visible="false" class ="mobile_inboxEmpCode"> <span><b>Approver Details</b></span><br /><br /></li>
            ...
            <li id="gvAppFiles" runat="server">
             ...
             <hr runat="server" id="Hr5" />
            <li id="AppRemark" runat="server"><br />
                Approver Remarks<br />
    ...
    <div class="mobile_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click" OnClientClick="return SaveMultiClick();">Approve</asp:LinkButton>
        <asp:LinkButton ID="mobile_cancel" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="Savebtnsve" OnClick="mobile_cancel_Click" OnClientClick="return CancelMultiClick();">Reject</asp:LinkButton>
        <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="mobile_btnBack_Click"  OnClientClick="return SentBackMultiClick();">Sent Back For Correction</asp:LinkButton>
        </div>
    <br />
    ...
    <script type="text/javascript">
        ...
        function SentBackMultiClick() {
            try {
                ...
                if (ele != null) {
                    ele.disabled = true;
                    if (retunboolean == true)
                        var retunboolean = ConfirmSentBack();
        ...
        function ConfirmSentBack() {
            //Testing();
            var confirmval = false;
            var confirm_value = document.createElement("INPUT");
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Are you want to Sent Back for Correction?")) {
                confirm_value.value = "Yes";
                confirmval = true;
            } else {
                confirm_value.value = "No";
