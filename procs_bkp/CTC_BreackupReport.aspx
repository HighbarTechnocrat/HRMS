<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="CTC_BreackupReport.aspx.cs" Inherits="procs_CTC_BreackupReport" %>
 ...
 <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
  ...
  <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery.autocomplete.js" type="text/javascript"></script>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="CTC Breackup report"></asp:Label>
                    </span>
                </div>
                 <div>
    ...
    <div class="mobile_Savebtndiv"  style="text-align:center;padding-top:10px;">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Visible="false" Text="Submit" ToolTip="Generate Report" CssClass="Savebtnsve">Generate Report</asp:LinkButton>
          <asp:LinkButton ID="mobile_btnBack" runat="server" Visible="false" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/ReportsMenu.aspx" >Back</asp:LinkButton>
    </div>
	<br />
