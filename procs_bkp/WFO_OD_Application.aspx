<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="WFO_OD_Application.aspx.cs" Inherits="WFO_OD_Application" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="taskparentclass">
                            <span>For</span><%--&nbsp;&nbsp;<span style="color: red">*</span>--%><br />
                        ...
                        <li class="Reason">
                            ...
                            <br />
                            <asp:TextBox ID="txtReason" AutoComplete="off" runat="server" MaxLength="500"></asp:TextBox>
                        </li>
                        <li class="Reason">
    ...
    <div>
        ...
        <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/Attendance.aspx">Back</asp:LinkButton>
