<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform.aspx.cs" Inherits="myaccount_SampleForm" %>
  ...
  <a href="#" class="aaa" onclick="">Leave Menu</a>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li>
                            ...
                            <asp:TextBox ID="txtlastname" runat="server" Columns="30" MaxLength="50" Visible ="false"> </asp:TextBox>
                            <%--<span class="texticon tooltip" title="Please provide your last name." ="false"><i class="fa fa-user"></i></span>--%>
                            <br />
                        ...
                        <div class="date-picker-start-end-date">
                            ...
                            <span class="startdatepickercontent">
                                <asp:TextBox ID="txtsadate" runat="server" CssClass="txtdatepicker" placeholder="Start Date"></asp:TextBox>
                               <span class="texticon tooltip" title="Select Start Date. Date should be MM/DD/YYYY format."><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="formerror" ControlToValidate="txtsadate" SetFocusOnError="True" ErrorMessage="Please enter start date" ValidationGroup="validate"></asp:RequiredFieldValidator>
                             </span>
                            </div>
                            </li>
                       ...
                       <%-- <li class="profile-edit">
                        ...
                        <div class="date-picker-start-end-date">
                            ...
                            <span class="enddatepickercontent">
                                ...
                                <asp:CompareValidator ControlToCompare="txtsadate" ControlToValidate="txtedate" Display="Dynamic" ErrorMessage="End date should be greater than Start Date." ID="CompareValidator2"  Operator="GreaterThanEqual"  Type="Date" runat="server" ValidationGroup="validate" SetFocusOnError="false" CssClass="formerror"/>
                             </span>
                        </div>
                   <%--         <asp:TextBox ID="txtdept" runat="server"> </asp:TextBox>
                       ...
                       <%-- <li class="profile-edit3">
                        ...
                        <li>--%></li>
                        <li class="proviewbtn btndiv" style="float:none !important;">
                ...
                <%--           JAYESH COMMNETED ABOVE to disabled the functionality of save19sep2017 --%>
                            ...
                            <div class="Savebtndiv">
                                <asp:LinkButton ID="btnSave" runat="server" Text="Submit" ToolTip="Save" OnClick="btnSave_Click">Submit</asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton1" runat="server" Text="Back" ToolTip="Back" OnClick="btnSave_Click">Back</asp:LinkButton>
                                <asp:LinkButton ID="btn_Correction" runat="server" Text="Correction" ToolTip="Correction" >Correction</asp:LinkButton>
                            </div>
