<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="TallyCodeLocation.aspx.cs" 
    Inherits="procs_TallyCodeLocation" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Add Tally Code For Location"></asp:Label>
                    </span>
                </div>
				 <div>
					...
					<ul id="editform" runat="server">
                        <li class="trvl_date"> 
                            ...
                            <span>Location </span>&nbsp;&nbsp;<span style="color: red">*</span>
                             <asp:DropDownList runat="server" ID="DDL_Location" CssClass="DropdownListSearch" Enabled="true" AutoPostBack="true"  OnSelectedIndexChanged="DDL_Location_SelectedIndexChanged">
                            </asp:DropDownList>
                              </li>

                       <li class="trvl_date"> 
                           <span>Tally Code </span>&nbsp;&nbsp;<span style="color: red">*</span>
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:DropDownList ID="ddl_department" runat="server" CssClass="DropdownListSearch" Enabled="true" >
                        <asp:ListItem Value="0">Select Department</asp:ListItem>
                        <asp:ListItem Value="Prime">Prime</asp:ListItem>
                        <asp:ListItem Value="Strategic">Strategic</asp:ListItem>
                    </asp:DropDownList></li>
                ...
                <br />
                 ...
                 <div class="edit-contact">
					<ul id="Ul1" runat="server">
                        <li class="trvl_date"> 
                             <span >Search By Location </span>&nbsp;&nbsp;<span style="color:red"></span>
                            <br />
                             <asp:DropDownList runat="server" ID="lstSearchLocation" CssClass="DropdownListSearch">
                            </asp:DropDownList>
                        </li>
          ...
          <asp:Label runat="server" ID="lbltotalRecords"  Style="color: red; font-size: 15px; font-weight: 500; text-align: center;"></asp:Label>
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="comp_code"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="15" AllowPaging="true"  OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
                ...
                <asp:HiddenField ID="hdnTxt_Skillset" runat="server" />
