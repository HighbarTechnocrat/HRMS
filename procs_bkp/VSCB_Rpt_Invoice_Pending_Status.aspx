<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="VSCB_Rpt_Invoice_Pending_Status.aspx.cs" Inherits="procs_VSCB_Rpt_Invoice_Pending_Status" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Invoice Pending Status Report"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li style="padding-top: 30px">
                            ...
                            <asp:DropDownList runat="server" ID="lstVendorName" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstPOWONo_SelectedIndexChanged"></asp:DropDownList>
                        </li>

                        <li style="padding-top: 30px">
                            <span>Cost Center</span>&nbsp;&nbsp;<br />
                            <asp:DropDownList runat="server" ID="lstCostCenter" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstPOWONo_SelectedIndexChanged"></asp:DropDownList>
                        </li>
                ...
                <div style="width: 100%;">
                    ...
                    <asp:GridView ID="gvMngPaymentList_Batch" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="InvoiceID" CellPadding="3" AutoGenerateColumns="False" Width="155%" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="true" OnRowDataBound="gvMngPaymentList_Batch_RowDataBound" OnPageIndexChanging="gvMngPaymentList_Batch_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Invoice Creation By"
                                DataField="InvoiceCreatedBy"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="10%" />

                            <asp:BoundField HeaderText="Approver1"
                                DataField="Approver1"
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="15%" />

                            <asp:BoundField HeaderText="Approver2"
                                DataField="Approver2"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="15%" />

                            <asp:BoundField HeaderText="Approver3"
                                DataField="Approver3"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="15%" />
                            <asp:BoundField HeaderText="Approver4"
                                DataField="Approver4"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="15%" />

                            <asp:BoundField HeaderText="Approver5"
                                DataField="Approver5"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy" ItemStyle-Width="15%" />
