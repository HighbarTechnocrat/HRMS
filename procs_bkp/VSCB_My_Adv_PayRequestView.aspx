<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_My_Adv_PayRequestView.aspx.cs" Inherits="procs_VSCB_My_Adv_PayRequestView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Advance Payment Request View"></asp:Label>
                    </span>
                </div>
                <div>
                </div>
                <div id="div_buttons" runat="server">
                    ...
                    <span>
                        <a href="VSCB_InboxMy_Adv_PayRequest.aspx" title="Back" runat="server" visible="false" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
                    ...
                    <ul id="editform" runat="server">
                        <li class="trvl_date">
                            ...
                            <asp:DropDownList runat="server" Enabled="false" ID="lstPOWONumber" CssClass="DropdownListSearch">
                             ...
                             <asp:TextBox AutoComplete="off" ID="txtPONumber" runat="server" Enabled="false" Visible="false"></asp:TextBox>
                            <br />
                        </li>
                            ...
                            <ul id="Ul2" runat="server">
                               ...
                               <li></li>
                                ...
                                <li class="trvl_date" id="liGSTAmt_1" runat="server">
                                 ...
                                 <li class="trvl_date" id="liAdvAmtWithGSt_2" runat="server" >							        
						        </li>
                                 <li class="trvl_date" id="liAdvAmtWithGSt_3" runat="server">							        
						        </li>
								...
								<li class="trvl_date">
									...
									<br />
									<asp:DropDownList runat="server" ID="lstPaymentType" CssClass="DropdownListSearch" >
							       </asp:DropDownList>
								</li>
                                <li class="trvl_date"> 
                                    <span id="spnPaymentSuppotingFiles" runat="server" visible="false">Advance Payment Supporting Files</span>&nbsp;&nbsp;<%--<span style="color:red">*</span>--%><br />
									<br />
								...
								<li>
									<div runat="server" id="Cancel1" visible="false">
									<span>Cancel Remark</span>&nbsp;&nbsp;<span style="color: red">*</span>
									<br />
									<asp:TextBox AutoComplete="off" ID="txtRemark1" CssClass="noresize" TextMode="MultiLine" runat="server" Rows="5" Width="86%"  onKeyUp="javascript:Count(this);" ></asp:TextBox>
							        </div>
								</li>
								<li></li>
								<div><span id="spnPaymentSuppotingFiles1" runat="server" visible="false">Advance Payment Supporting Files</span></div>
    ...
    <div class="Req_Savebtndiv" style="text-align: center">
        ...
        <asp:LinkButton ID="trvldeatils_delete_btn" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="Savebtnsve" OnClientClick="return CancelMultiClick();" Visible="false" OnClick="trvldeatils_delete_btn_Click">Cancel</asp:LinkButton>
    </div>
    ...
    <asp:HiddenField ID="hdnPyamentStatus" runat="server" />    
