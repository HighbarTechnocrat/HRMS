...
public partial class VSCB_MyBatch : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_CreateBatch.aspx?batchid=" + hdnMilestoneId.Value + "&mngexp=1");
    }
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_myBatch_List";
