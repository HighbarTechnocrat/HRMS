<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="RecruiterReschedule.aspx.cs"
   MaintainScrollPositionOnPostback="true" Inherits="procs_RecruiterReschedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Interview Reschedule Screen"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span>
                       <a href="Rec_RecruiterInbox.aspx?type=RECIRescedule" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
    ...
    <div class="manage_grid" style="width: 90%; height: auto; padding-left:40px" runat="server" id="DivSendshortlisting3">
                        ...
                        <Columns>
                           ...
                           <asp:BoundField HeaderText="Interview Round"  DataField="InterviewRound" ItemStyle-HorizontalAlign="center" 
							  ...
							  <asp:BoundField HeaderText="Interview Type"  DataField="InterviewType" ItemStyle-HorizontalAlign="center" 
                                ItemStyle-Width="15%"   ItemStyle-BorderColor="Navy" />
							<asp:TemplateField HeaderText="Download IR Sheet" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
							<ItemTemplate>
							<asp:ImageButton ID="lnkIRsheetExport" runat="server" Width="20px" ToolTip="Download IR Sheet" Height="15px" Visible='<%# String.IsNullOrEmpty(Convert.ToString(Eval("InterviewFeedback"))) ? false : true %>' OnClick="lnkIRsheetExport_Click" ImageUrl="~/Images/Download.png" />
							</ItemTemplate>
                    ...
                    <ul id="Ul2" runat="server">
                       ...
                       <%-- <li>
                        ...
                        <li class="mobile_grid" style="margin-bottom:20px" runat="server" id="SpanEducationDetails1">
                            <span runat="server" id="SpanEducationDetails">Education Details</span><br />
                        ...
                        <li class="mobile_grid" style="margin-bottom:20px" runat="server" id="SpanWorkExperiencedetail1">
                            <span runat="server" id="SpanWorkExperiencedetail">Work experience details</span><br />
                        ...
                        <li class="mobile_InboxEmpName">                            
                         ...
                         <li class="upload" runat="server" visible="false">
                            <span style="margin-bottom:10px"> IR Sheet</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                            <asp:FileUpload ID="uploadfile" runat="server"  Width="200px"/>
                         </li>
                         <li class="mobile_grid"  runat="server"  style="padding-bottom:20px">
                        ...
                        <li class="mobile_InboxEmpName">                            
                          ...
                          <li class="trvl_date">
                             <span>Interview Round</span>&nbsp;&nbsp;<span style="color:red">*</span>
                              <br />
                               <asp:DropDownList runat="server" ID="DDLInterviewRound" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="DDLInterviewRound_SelectedIndexChanged">
                            </asp:DropDownList>
                        ...
                        <li class="mobile_InboxEmpName">                            
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TxtInterviewDate"   runat="server"></asp:TextBox>
                              <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" TargetControlID="TxtInterviewDate"
                        ...
                        <li class="mobile_InboxEmpName">                            
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TxtInterviewTime"  MaxLength="9" runat="server"></asp:TextBox>
                        </li>
                         <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                              <span>Interviewer</span>&nbsp;&nbsp;<span style="color:red">*</span>
                            <br />
                        ...
                        <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="DDLInterviewFeedback" Visible="false">
                            </asp:DropDownList>
                        </li>
                         ...
                         <li class="mobile_InboxEmpName" >
                            ...
                            <asp:CheckBox  runat="server"  ID="chkbonxtround"/>--%>
                             </li>
                       <li></li>
                         <li></li>
                        ...
                        <li class="mobile_InboxEmpName">                            
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="TxtInterviewerComments"  Enabled="false" MaxLength="200" runat="server" TextMode="MultiLine" Rows="5" CssClass="noresize" ></asp:TextBox>
                        </li>
                    </ul>
                </div>
     </div>
    <%--first button  Reschedule Interview--%>
      <div class="mobile_Savebtndiv"  id="DivInterviewerShortListButton"  runat="server">
        <asp:LinkButton ID="trvldeatils_btnSave" runat="server" Text="Submit" ToolTip="Submit"
         ...
         <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Clear Search"  ToolTip="Back" Visible="false"  OnClick="mobile_btnBack_Click"
          class="trvl_Savebtndiv">Submit</asp:LinkButton>
          </div>


   <%--  <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees_M" MinimumPrefixLength="3"
        CompletionInterval="2" EnableCaching="false" CompletionSetCount="2" TargetControlID="TxtinterviewerfirstLevel"
