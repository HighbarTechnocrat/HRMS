<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TravelExpense.aspx.cs" Inherits="TravelExpense" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <%-- <link rel="stylesheet" href="<%=ReturnUrl("css") %>highbar/trvlexpenses.css" type="text/css" media="all" />--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <div class="wishlistpagediv">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="trvlExp_trip">
                            <span>Trip No</span><br />

                            <asp:TextBox ID="txtTripNo" runat="server"></asp:TextBox>
                        ...
                        <li class="trvlExp_type">
                            ...
                            <asp:TextBox ID="txtTriptype" runat="server" CssClass="Dropdown"></asp:TextBox>
                            <asp:Panel ID="Panel3" Style="display: none;" runat="server" CssClass="taskparentclasskkk">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:ListBox ID="ListBox2" runat="server" CssClass="taskparentclasskkk" AutoPostBack="true" OnSelectedIndexChanged="ListBox2_SelectedIndexChanged">
                        ...
                        <li class="trvlExp_detail">
                            <span>Travel Details</span>
                            <asp:LinkButton ID="btnExpTra_Details" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve"></asp:LinkButton>
                        </li>
                        ...
                        <li class="trvlExp_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dgLeaveBalance" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="70%" EditRowStyle-Wrap="false">
                        ...
                        <li class="trvlExp_Advances">
                            <span>Advances Required: </span>
                            <br />
                            <asp:TextBox ID="txtAdvance" runat="server" MaxLength="100"></asp:TextBox>
                        </li>



                        <li class="trvlExp_Paid">
                            <span>Advances Paid: </span>
                            <br />
                            <asp:TextBox ID="txtAdPaid" runat="server" MaxLength="100"></asp:TextBox>
                        </li>


                        <li class="trvlExp_Currency">
                            <span>Currency Required:</span>
                            <br />
                            <asp:TextBox ID="txtreqCur" runat="server" MaxLength="100"></asp:TextBox>
                        </li>
                        <li class="trvlExp_inboxEmpCode">
                            <%--<span>Employee Code</span><br />--%>
                        ...
                        <li class="trvlExp_Accomodation">
                            <span>Accommodation</span>
                            <asp:LinkButton ID="trvlExp_accmo_btn" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve"></asp:LinkButton>
                        </li>
                        <li class="trvlExp_inboxEmpCode">
                            <%--<span>Employee Code</span><br />--%>
                        ...
                        <li class="trvlExp_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="70%" EditRowStyle-Wrap="false">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvlExp_local">
                            ...
                            <asp:LinkButton ID="trvlExp_localbtn" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve"></asp:LinkButton>
                        </li>
                        ...
                        <li class="trvlExp_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="70%" EditRowStyle-Wrap="false">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvlExp_grid">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="GridView3" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="70%" EditRowStyle-Wrap="false">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                          ...
                          <li class="trvlExp_inter">
                              <%-- <span>Reason For Deviation:
                            </span>--%>
                              <br />
                              <asp:TextBox ID="TextBox15" runat="server" MaxLength="100" Visible="false"></asp:TextBox>
                          </li>
                        <li class="trvlExp_Daily">
                            ...
                            <li class="trvlExp_totamount">
                                ...
                                <br />
                                <asp:TextBox ID="TextBox12" runat="server" MaxLength="100"></asp:TextBox>
                            </li>
                            ...
                            <li class="trvlExp_lessadv">
                                ...
                                <br />
                                <asp:TextBox ID="TextBox13" runat="server" MaxLength="100"></asp:TextBox>
                                ...
                                <li class="trvlExp_PayEmp">
                                    ...
                                    <li class="trvlExp_Reason">
                                        ...
                                        <br />
                                        <asp:TextBox ID="TextBox14" runat="server" MaxLength="100"></asp:TextBox>
                                    </li>
                                    ...
                                    <li class="trvlExp_inter">
                                        ...
                                        <br />
                                        <asp:TextBox ID="TextBox16" runat="server" MaxLength="100" Visible="false"></asp:TextBox>
                                    </li>



                                    <%--                         <li class="trvlExp_Approver">
                            <span>Approver</span>
                            <br />
    ...
    <div class="trvlExp_Savebtndiv">
        <asp:LinkButton ID="trvlExp_btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="btnSave_Click1">Submit</asp:LinkButton>

        <asp:LinkButton ID="trvlExpExp_btnBack" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="btnSave_Click1">Back</asp:LinkButton>
