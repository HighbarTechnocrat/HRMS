<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="TravelExpenseReport_Audit.aspx.cs" Inherits="TravelExpenseReport_Audit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<link href="../js/dist/select2.min.css" rel="stylesheet" />
     ...
     <script type="text/javascript">      
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Travel Expense Audit Report"></asp:Label>
            </span>
        </div>

       <div class="leavegrid">                    
             <a href="travelindex.aspx" class="aaa">Travel Home</a>
        </div>  
