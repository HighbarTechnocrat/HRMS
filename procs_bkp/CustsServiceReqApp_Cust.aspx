<%@ Page Title="" Language="C#" MasterPageFile="~/CustSinner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="CustsServiceReqApp_Cust.aspx.cs" Inherits="CustsServiceReqApp_Cust" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <span runat="server" id="backToEmployee" visible="false">
                    <a href="Custs_MyServiceReq.aspx" class="aaaa">Back</a>
                </span>
                ...
                <span runat="server" id="backToEscalatedService" visible="false">
                    <a href="MyEscalatedService.aspx" class="aaaa">Back</a>
                </span>
                <span style="display:none">
                    <a href="Service.aspx" style="margin-right: 18px;" class="aaaa">EmployeeFIRST Home</a>&nbsp;&nbsp; 
                </span>
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li id="liStatisfied3" runat="server" visible="false">
                              <asp:ImageButton 
                                ID="btnSatisfied" 
                                runat="server" 
                                ImageUrl="~/Smiley/Extremely_Satisfied.png" 
                                Width="35px" 
                                Height="35px" 
                                OnClick="btnSatisfied_Click" 
                                ToolTip="Satisfied"                                 
                                AlternateText="Satisfied"/> 
                        
                                 <asp:ImageButton 
                                ID="btnNotSatisfied" 
                                runat="server" 
                                 ImageUrl="~/Smiley/Extremely_Dissatisfied.png" 
                                Width="35px" 
                                Height="35px" 
                                OnClick="btnNotSatisfied_Click" 
                                ToolTip="Not Satisfied" 
                                AlternateText="Not Satisfied" />
                           </li>
                        <li id="liStatisfied4" runat="server" visible="false">
                        </li>
                        <div id="divhr1" runat="server">
                       <hr />
                            </div>
                         <li class="mobile_date" runat="server" id="liStatisfied1" visible="false">
                            <span runat="server" id="spnStatisfie">Service Feedback</span> 
                            <asp:TextBox AutoComplete="off" ID="txt_ServiceFeedback" Enabled="true" runat="server" TextMode="MultiLine" MaxLength="500" Rows="6" Width="188%" CssClass="noresize"></asp:TextBox>
                       
                        </li>

                        <li class="mobile_date" runat="server" id="liStatisfied2" visible="false">                             
                        </li>
                        ...
                        <li class="mobile_inboxEmpCode" style="width: 100%" runat="server" id="empShow6">
                            <asp:LinkButton ID="service_btnAssgine" Visible="false" runat="server" Text="Escelate to CS" ToolTip="Escelate to CS" CssClass="Savebtnsve" OnClientClick="return SendForAssigne();" OnClick="service_btnAssgine_Click">Escelate to CS</asp:LinkButton>                            
                            <asp:LinkButton ID="service_btnEscelateToHOD" Visible="false" runat="server" Text="Escelate to PRM" ToolTip="Escelate to PRM" CssClass="Savebtnsve" OnClick="service_btnEscelateToHOD_Click" OnClientClick="return SendForHOD();">Escelate to PRM</asp:LinkButton>
                            <asp:LinkButton ID="service_btnClose" Visible="false" runat="server" Text="Escelate to DH" ToolTip="Escelate to DH" CssClass="Savebtnsve" OnClick="service_btnClose_Click" OnClientClick="return SendForClose();">Escelate to DH</asp:LinkButton>
                            <asp:LinkButton ID="service_btnEscelateToCEO" Visible="false" runat="server" Text="Escelate to CEO" ToolTip="Escelate To CEO" CssClass="Savebtnsve" OnClick="service_btnEscelateToCEO_Click" OnClientClick="return SendForCEO();">Escelate to CEO</asp:LinkButton>
                            <asp:LinkButton ID="service_btnSendSPOC" Visible="false"  runat="server" Text="Feedback" ToolTip="Feedback" CssClass="Savebtnsve" OnClick="service_btnSendSPOC_Click" OnClientClick="return SendForSPOC();">Submit Feedback</asp:LinkButton>
                        ...
                        <li style="visibility: hidden" class="mobile_inboxEmpCode"></li>
                        <li class="mobile_grid" id="liuploadedFile3" runat="server">
                            <span>Uploaded Files</span>
                            <br />
                        ...
                        <li id="liuploadedFile4" runat="server"></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <asp:HiddenField ID="hdnCustsStatusId" runat="server" />
    <asp:HiddenField ID="hdnCustsEscalationPRMDHCEO" runat="server" />
    <asp:HiddenField ID="hdnCustsEscalationEmpCode" runat="server" />
    <asp:HiddenField ID="hdnCustsEscalationLevelId" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function SendForAssigne() {
            try {
                var msg = "Are you sure you want to Escalate Service Request?";
                var retunboolean = true;
                var ele = document.getElementById('<%=service_btnAssgine.ClientID%>');
        ...
        function SendForSPOC() {
            try {
               var msg = "Are you sure you want to Submit Service Request?";
                var retunboolean = true;
