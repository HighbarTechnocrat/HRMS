...
public partial class VSCB_approvedinvoiceChangeReq : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(ReturnUrl("sitepathmain") + "procs/vscb_index");
    }
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_ChangeApprovedInvoice.aspx?invid=" + hdnInvoiceId.Value +"&mngexp=1");
    }
    #endregion
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_Approved_Invoice_List_For_TDS_Change";
    ...
    private void get_InboxInvoices_DropdownList()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_ApprovedInvoice_Search_DropdownList_Change";
    ...
    private void getMngInvoiceReqstList_Onload()
    {
        try
        {
            ...
            spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
            spars[0].Value = "get_Invoice_List_Approvers_Acc_OnLoad";
