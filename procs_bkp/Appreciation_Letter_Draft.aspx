<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"  validateRequest="false"
    CodeFile="Appreciation_Letter_Draft.aspx.cs" Inherits="procs_Appreciation_Letter_Draft" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
                        <li class="mobile_inboxEmpCode">                            
                            ...
                            <br />
                             <asp:DropDownList runat="server" ID="lstSkillset"  CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="emp_status_SelectedIndexChanged">                               
                            </asp:DropDownList> </li>

                        <li class="leavedays">
                            <div id="liSubject" runat="server" > 
                        <span id="txt_lettere_sub" runat="server">Appreciation Letter</span>&nbsp;&nbsp;<span style="color:red">*</span>
                        <asp:TextBox ID="txt_app_letter" AutoComplete="off" runat="server"></asp:TextBox>
                        <br />
                                </div>
                    </li> 
                        ...
                        <li class="leavedays">
                            ...
                            <asp:TextBox ID="txt_point" AutoComplete="off" runat="server"></asp:TextBox>
                            <br />
                                    </div>
                        </li> 
                        <li>
                    ...
                    <br />
                        ...
                        <li  > 
                            <br />
                            <div id="txtdraft" runat="server" > 
                            <%--<asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>--%>
                            <span>Letter Description</span>&nbsp;&nbsp;<span style="color:red">*</span><br /> 
                              <div id="HtmlFiter">                        
...
<br />
                        ...
                        <li></li>
                          <li class="mobile_InboxEmpName">                            
                           <%-- <span >Active </span>&nbsp;&nbsp;<span style="color:red"></span>
                            <br />--%>
                             <asp:CheckBox runat="server" ID="chkActive" Visible="false" Checked="true" >                               
                            </asp:CheckBox> </li>  
                    </ul>
                </div>
            </div>
    ...
    <div class="mobile_Savebtndiv">
        ...
        <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve"  PostBackUrl="~/procs/Appreciation_Letter_index.aspx" > Back  </asp:LinkButton>
