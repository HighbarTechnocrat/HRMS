<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="LeavesReport_Hr.aspx.cs" Inherits="LeavesReport_Hr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Leave Report - HR"></asp:Label>
        </span>
    </div>
    ...
    <div class="edit-contact">
        <ul>
             <li>
                <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Select Leave Type:</span> &nbsp;&nbsp; <span style="color:red">*</span><br />
