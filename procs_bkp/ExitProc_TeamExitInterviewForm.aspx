<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ExitProc_TeamExitInterviewForm.aspx.cs" Inherits="procs_ExitProc_TeamExitInterviewForm" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Team Exit Interview Forms"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    ...
                    <center>
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px" 
                            DataKeyNames="ResignationID"   CellPadding="3" AutoGenerateColumns="False" Width="100%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Resignation submitted on"
                                ...
                                ItemStyle-BorderColor="Navy"
                                />
                            <asp:BoundField HeaderText="Exit Interview Submitted on"
                                DataField="Exit Interview Submitted on"
                                 ItemStyle-HorizontalAlign="center"
                                ItemStyle-Width="8%" 
                                ItemStyle-BorderColor="Navy"
                                />
