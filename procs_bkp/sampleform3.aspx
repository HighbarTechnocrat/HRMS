<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleform3.aspx.cs" Inherits="myaccount_sampleform3" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform3.aspx.cs" Inherits="myaccount_SampleForm" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Leave Request View"></asp:Label>
                    </span>
                </div>
                 
                  <%-- PRAJYOT comment this CODE FOR REQUEST  FORM --%>
...
<%--<%--prajyot comment this for button--%>
 ...
 <%-- JAYESH_PRAJYOT ADDED BELOW CODE FOR REQUEST  FORM 18sep2017--%>
                ...
                <%--           JAYESH COMMNETED ABOVE to disabled the functionality of save19sep2017 --%>
                            ...
                            <div class="Savebtndiv1">
                           <ul>
                                 <li><asp:LinkButton ID="btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="btnSave_Click">Modify</asp:LinkButton></li>
                                 <li><asp:LinkButton ID="Linkbtn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="btnSave_Click">Cancel Leave</asp:LinkButton></li>
                                 <li><asp:LinkButton ID="Linkbtn2" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="btnSave_Click">Back</asp:LinkButton></li>
                               </ul>
                            </div>
