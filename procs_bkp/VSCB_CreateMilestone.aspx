<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="VSCB_CreateMilestone.aspx.cs" Inherits="VSCB_CreateMilestone" EnableSessionState="True" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        textarea#MainContent_txtMilestone {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Create Milestones"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="true">
                        <li class="trvl_type">
                            ...
                            <asp:DropDownList runat="server" ID="lstTripType" AutoPostBack="false" CssClass="DropdownListSearch">
                            </asp:DropDownList>
                        </li>
                        <li class="trvl_date">
                            <span>Currency</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                            <asp:DropDownList runat="server" ID="lstCurrency" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstTripType_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        <li class="trvl_date">
                        ...
                        <li class="trvl_date" id="liPOWOStatus" runat="server" visible="true">
                        ...
                        <li class="trvl_date" id="liAmountWithTax" runat="server" visible="false">
                        ...
                        <li class="trvl_date" id="liPOWODirectTaxAmt" runat="server" visible="false">
                        ...
                        <li class="trvl_date" id="liPOWOPaidAmt" runat="server" visible="false">
                        ...
                        <li class="trvl_date" id="liMilestoneSettelmentAmt" runat="server" visible="false">
                            <span id="spnMilestoneSettelmentAmt" runat="server" visible="false">Settlement Amount (D)</span><br />
                            <asp:TextBox AutoComplete="off" ID="txtPO_Settlment_Amt" runat="server" ReadOnly="true" Enabled="False" Visible="false" CssClass="textboxBackColor AmtTextAlign"></asp:TextBox>
                        </li>
                        <li class="trvl_date" id="liPOWOBalAmt" runat="server" visible="false">
                            <span id="spnPOWOBalAmt" runat="server" visible="false">Balance Amount (A-B-C-D)</span><br />
                        ...
                        <li class="trvl_date" id="liPOWODShortClosedAmt" runat="server" visible="false">
                        ...
                        <li class="trvl_date" id="liSettlement_1" runat="server" visible="false">
                        ...
                        <li class="trvl_date" id="liSettlement_2" runat="server" visible="false"></li>
                        <li class="trvl_date" id="liSettlement_3" runat="server" visible="false"></li>

                        <li class="trvl_type">
                            <span>PO / WO Title</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                            <asp:DropDownList runat="server" ID="ddlHPOTYPE" AutoPostBack="true" OnSelectedIndexChanged="ddlHPOTYPE_SelectedIndexChanged" CssClass="DropdownListSearch">
                            </asp:DropDownList> 
                        </li>
                        <li class="trvl_date">
                            <div id="divScurity_Diposit" runat="server" visible="false">
                            <span>Security Deposit Amount</span>&nbsp;&nbsp;
                            <asp:TextBox AutoComplete="off" ID="txtSecurity_DepositAmt" runat="server" CssClass="AmtTextAlign"></asp:TextBox>
                            </div>
                        </li>
                        ...
                        <div id="DivTrvl" class="edit-contact" runat="server" visible="false">
                            <ul>
                                ...
                                <li class="trvl_date">
                                    <span>CGST(%)</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtCGSTPer" runat="server" AutoPostBack="true" OnTextChanged="txtCGSTPer_TextChanged"></asp:TextBox>
                                </li>
                                <li class="trvl_date">
                                    <span>SGST(%)</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtSGSTPer" runat="server" AutoPostBack="true" OnTextChanged="txtSGSTPer_TextChanged"></asp:TextBox>
                                </li>
                                <li class="trvl_date">
                                    <span>IGST(%)</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtIGSTPer" runat="server" AutoPostBack="true" OnTextChanged="txtIGSTPer_TextChanged"></asp:TextBox>
                                </li>
                        ...
                        <li class="trvl_grid" id="litrvlgrid" runat="server">
                            <div class="manage_grid" style="overflow: scroll; width: 100%; margin-bottom: 5px;">
                                ...
                                <asp:GridView ID="dgTravelRequest" HeaderStyle-CssClass="GVFixedHeader" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                    DataKeyNames="srno,PaymentStatusID,IsShortClone,MstoneID" OnRowDataBound="dgTravelRequest_RowDataBound">
                        ...
                        <li class="trvl_local">
                            <span>Shipping Address</span> &nbsp;&nbsp;<span id="Span1" runat="server" style="color: red; font-size: 10px; font-weight: normal; font-style: italic;">Maximum 500 Characters</span><br />
                            <asp:TextBox ID="txtShippingAddress" runat="server" MaxLength="500" TextMode="MultiLine" Height="70px" Width="100%"></asp:TextBox>
                        </li>
                        <li class="trvl_local"></li>
                        <li class="trvl_local"></li>

                        <li class="trvl_local">
                            <span>PO Remarks</span> &nbsp;&nbsp;<span id="Span2" runat="server" style="color: red; font-size: 10px; font-weight: normal; font-style: italic;">Maximum 500 Characters</span><br />
                            <asp:TextBox ID="txtPORemarks" runat="server" MaxLength="500" TextMode="MultiLine" Height="70px" Width="100%"></asp:TextBox>
                        </li>
                        <li class="trvl_local"></li>
                        <li class="trvl_local"></li>
                        ...
                        <li class="trvl_local" id="liRemarks_1" runat="server" visible="false">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_remakrs" runat="server" TextMode="MultiLine" MaxLength="200" CssClass="txtRemarks"></asp:TextBox>
                        </li>
    ...
    <div class="trvl_Savebtndiv">
        ...
        <asp:LinkButton ID="btnCancel" Visible="false" runat="server" Text="Short Close" ToolTip="Short Close" CssClass="Savebtnsve" OnClientClick="return CancelMultiClick();" OnClick="btnCancel_Click"></asp:LinkButton>
        ...
        <asp:LinkButton ID="btnCorrection" Visible="false" runat="server" Text="Download PO/ WO" ToolTip="Download PO/ WO" CssClass="Savebtnsve" OnClientClick="Download_ApprovedPO()">Download PO/ WO</asp:LinkButton>
        <%--  OnClick="btnCorrection_Click"  --%>
