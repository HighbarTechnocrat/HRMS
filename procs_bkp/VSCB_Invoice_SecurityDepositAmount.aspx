<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="VSCB_Invoice_SecurityDepositAmount.aspx.cs" Inherits="procs_VSCB_Invoice_SecurityDepositAmount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Create Invoice against Security Deposit Balance Amount"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li class="trvl_date">
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="lstPOWONumber" CssClass="DropdownListSearch" AutoPostBack="true" OnSelectedIndexChanged="lstPOWONumber_SelectedIndexChanged">
                            </asp:DropDownList>
                            <br />
                        </li>
                        ...
                        <li class="trvl_date">
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPODirectTaxAmt" CssClass="BalAmt" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                            <span>Paid Amount (With GST) (C)</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPoWOPaidAmt" CssClass="BalAmt" runat="server" Enabled="false" Visible="false"></asp:TextBox>
                        ...
                        <li class="trvl_date" runat="server">
							<span>Payment Advance Amount (P)</span><br />
							<asp:TextBox AutoComplete="off" ID="txt_Pay_Adv_Amt" runat="server" ReadOnly="true" Enabled="False" CssClass="BalAmt AmtTextAlign"></asp:TextBox>
						</li>
						<li class="trvl_date" runat="server">
							<span>Payment Advance Settlement (Q)</span><br />
							<asp:TextBox AutoComplete="off" ID="txt_Pay_Adv_Settlement" runat="server" ReadOnly="true" Enabled="False" CssClass="BalAmt AmtTextAlign"></asp:TextBox>
						</li>
						<li class="trvl_date" runat="server">
							<span>Payment Advance Bal Amount (P-Q)</span><br />
							<asp:TextBox AutoComplete="off" ID="txt_Pay_Adv_Bal_Amt" runat="server" ReadOnly="true" Enabled="False" CssClass="BalAmt AmtTextAlign"></asp:TextBox>
						</li>
                        ...
                        <div>
                            ...
                            <span class="LableName" runat="server" visible="false" id="spMilestones">PO/ WO Milestones
                            </span>
                    ...
                    <div runat="server" id="DivCreateInvoice" visible="true">
                        <div class="edit-contact">
                            ...
                            <ul id="Ul2" runat="server">
                                <li class="trvl_date" style="padding-bottom: 20px;width:300px !important">
                                    <span style="text-decoration: underline; color: #F28820; font-size: 16px" id="SPCreate" runat="server">Create Invoice against Security Deposit : </span>&nbsp;&nbsp;
                                    <br />
                                </li>
                                <li class="trvl_grid">
                                ...
                                <li class="trvl_date">
                                    <span style="display:none">Payment Request No </span>                                 
                                    <asp:Label AutoComplete="off" ID="txtPaymentRequestNo" runat="server" Enabled="false" CssClass="PayNo" Visible="false"></asp:Label> 
                                    
                                    <span> Invoice Amount (without GST)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAmountPaidWithoutTax" CssClass="number" runat="server" AutoPostBack="true" OnTextChanged="txtAmountPaidWithoutTax_TextChanged"></asp:TextBox>

                                </li>

                                
						        <li class="trvl_date" id="liCGST_Per" runat="server" visible="true">
							        <span>CGST(%)</span>
							        <br />
							        <asp:TextBox AutoComplete="off" ID="txtCGST_Per" runat="server"> </asp:TextBox>
						        </li>
						        <li class="trvl_date" id="liSGST_Per" runat="server" visible="true">
							        <span>SGST(%)</span><br />
							        <asp:TextBox AutoComplete="off" ID="txtSGST_Per" runat="server"></asp:TextBox>
						        </li>
						        <li class="trvl_date" id="liIGST_Per" runat="server" visible="true">
							        <span>IGST(%)</span><br />
							        <asp:TextBox AutoComplete="off" ID="txtIGST_Per" runat="server" ></asp:TextBox>
						        </li>

                                <li class="trvl_date">
                                    <span style="display:none">Request Date </span> 
                                    <asp:TextBox AutoComplete="off" ID="txtRequestDate" runat="server" Enabled="false" Visible="false"></asp:TextBox>

                                     <span style="display:none">Is Advance Payment with GST</span> 
                                    <br />&nbsp;&nbsp;&nbsp;
                                    <asp:CheckBox ID="chkIsAdvAmtWithGST" runat="server" Text="Is Advance Payment with GST" OnCheckedChanged="chkIsAdvAmtWithGST_CheckedChanged" AutoPostBack="true" />
                                      
                                </li>
                                <li class="trvl_date"> 
                                </li>

                                <li class="trvl_date" id="liGSTAmt_1" runat="server" visible="false">
							        <span>CGST Amount</span>
							        <br />
							        <asp:TextBox AutoComplete="off" ID="txtCGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
						        </li>
						         <li class="trvl_date" id="liGSTAmt_2" runat="server" visible="false">
							        <span>SGST Amount</span><br />
							        <asp:TextBox AutoComplete="off" ID="txtSGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
						        </li>
						          <li class="trvl_date" id="liGSTAmt_3" runat="server" visible="false">
							        <span>IGST Amount</span><br />
							        <asp:TextBox AutoComplete="off" ID="txtIGST_Amt" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
						        </li>

                                 <li class="trvl_date" id="liAdvAmtWithGSt_1" runat="server" visible="false">
							        <span>Advance Payment Amount (with GST)</span>&nbsp;&nbsp;
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAmountPaidWithTax" CssClass="number"   Enabled="false" runat="server"></asp:TextBox>
						        </li>
                                 <li class="trvl_date" id="liAdvAmtWithGSt_2" runat="server" visible="false">							        
						        </li>
                                 <li class="trvl_date" id="liAdvAmtWithGSt_3" runat="server" visible="false">							        
						        </li>
                                ...
                                <li class="trvl_date" runat="server" id="Account1" visible="false">
                                    ...
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAccountPaidAmt" Enabled="false" runat="server" CssClass="textBoxAlign"></asp:TextBox>
                                </li>
                                <li class="trvl_date" runat="server" id="Account2" visible="false">
                                    <span>Balance Amount </span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAccountAmtBal" runat="server" CssClass="textBoxAlign" Enabled="false"></asp:TextBox>
                                </li>

                                <li class="trvl_date" runat="server" id="Account3" visible="false"></li>

                                <li class="trvl_date">
                                    <span style="display:none">Payment Type</span> 
                                    <asp:DropDownList runat="server" ID="lstPaymentType" CssClass="DropdownListSearch" Visible="false">
                                    </asp:DropDownList>
                                ...
                                <li class="trvl_date"> 
                                     <span>Upload Payment Supporting Files</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtRemark" CssClass="noresize" TextMode="MultiLine" runat="server" Rows="5" Width="86%" onKeyUp="javascript:Count(this);"></asp:TextBox>
                                </li>
                    ...
                    <div class="Req_Savebtndiv" style="text-align: center"> 
                        <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Create Payment Request" ToolTip="Create Payment Request" CssClass="Savebtnsve" OnClick="localtrvl_btnSave_Click" OnClientClick="return SaveMultiClick();"> Create Payment Request </asp:LinkButton>
                        <asp:LinkButton ID="trvldeatils_btnSave" runat="server" Visible="false" Text="Submit" ToolTip="Cancel Request" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();">Cancel Request</asp:LinkButton>
                        <asp:LinkButton ID="trvldeatils_cancel_btn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_InboxMy_Adv_PayRequest.aspx">    Back</asp:LinkButton>
                        <asp:LinkButton ID="accmo_delete_btn" runat="server" Text="Clear Data" ToolTip="Clear Data" CssClass="Savebtnsve" Visible="false">  Clear Data </asp:LinkButton>
                    </div> 
                </div>
            </div>
        </div>
    ...
    <asp:GridView ID="GrdInvoiceDetails" CssClass="Milestones" Visible="false" runat="server" DataKeyNames="MstoneID,InvoiceID" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="130%" OnRowDataBound="GrdInvoiceDetails_RowDataBound">
        <FooterStyle BackColor="White" ForeColor="#000066" />
        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
        <RowStyle ForeColor="#000066" />
        ...
        <Columns>
            <asp:TemplateField HeaderText="Payment Request">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkView" title="Create" CssClass="BtnShow" Width="30px" runat="server" Visible='<%# Eval("PaymentStatusID").ToString() == "2" ? false : true %>' Text='Create' OnClick="lnkView_Click"></asp:LinkButton>
    ...
    <div style="display: none">
        <span class="LableName" runat="server" visible="false" id="spInvoice">Invoice Milestone Details
        </span>
        <asp:GridView ID="gvInvoiceMilestone" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="110%" EditRowStyle-Wrap="false"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Settlement Amount (Without GST)"
                    DataField="Milestone_settlementAmt"
                    ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-HorizontalAlign="Right"
                    ItemStyle-Width="8%"
    ...
    <div style="display: none">
        ...
        <li class="trvl_date">
            ...
            <br />
            <asp:TextBox AutoComplete="off" ID="txtInvoiceAmount" runat="server" CssClass="textBoxAlign" Enabled="false"></asp:TextBox>
        </li>
        <li class="trvl_date">
            <span>Direct Tax Amount (if Any) (B)</span>
            <br />
            <asp:TextBox AutoComplete="off" ID="txtInvoiceTDSAmt" runat="server" CssClass="textBoxAlign" Enabled="false"></asp:TextBox>
        </li>

        <li class="trvl_date">
            <span>Invoice Paid Amount (C)</span>
            <br />
            <asp:TextBox AutoComplete="off" ID="txtInvoicePaidAmount" runat="server" CssClass="textBoxAlign" Enabled="false"></asp:TextBox>
        </li>
        <li class="trvl_date">
            <span>Payment Requested for (Amount)</span>
            <br />
            <asp:TextBox AutoComplete="off" ID="txtPaymentRequestAmount" CssClass="textBoxAlign" runat="server" Enabled="false"></asp:TextBox>
        </li>
        <li class="trvl_date">
            <span>Invoice Balance Amount (A-B-C)</span>&nbsp;&nbsp;<span style="color: red">*</span>
            <br />
            <asp:TextBox AutoComplete="off" ID="txtInvoiceBalAmt" runat="server" CssClass="textBoxAlign" Enabled="false"></asp:TextBox>
        </li>
    ...
    <div class="edit-contact">
        ...
        <ul id="Ul1" runat="server">
            ...
            <span class="LableName" runat="server" visible="false" id="SPPayHist">Invoice History
            </span>
            <asp:GridView ID="GrdInvoiceHistDetails" DataKeyNames="Payment_ID" runat="server" CssClass="Milestones" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="View" HeaderStyle-Width="1%" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:BoundField HeaderText="Amt With Tax"
                        DataField="AmtWithTax"
                        ItemStyle-HorizontalAlign="right"
                        HeaderStyle-HorizontalAlign="right"
                        ItemStyle-Width="9%"
                    ...
                    <asp:BoundField HeaderText="Payable Amt With_Tax"
                        DataField="Payable_Amt_With_Tax"
                        ItemStyle-HorizontalAlign="right"
                        HeaderStyle-HorizontalAlign="right"
                        ItemStyle-Width="9%"
                        ItemStyle-BorderColor="Navy" />
                    <asp:BoundField HeaderText="Advance Settlement Amt"
                        DataField="ADSettlement_Amt"
                        ItemStyle-HorizontalAlign="right"
                        HeaderStyle-HorizontalAlign="right"
                        ItemStyle-Width="9%"
                        ItemStyle-BorderColor="Navy" />
    ...
    <asp:HiddenField ID="hdnCGST_Per" runat="server" />
    <asp:HiddenField ID="hdnSGST_Per" runat="server" />
    <asp:HiddenField ID="hdnIGST_Per" runat="server" />
     <asp:HiddenField ID="hdn_SecurityDeposit_Balance_Amt" runat="server" />
