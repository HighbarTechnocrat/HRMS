<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="ViewEmployeeCV.aspx.cs" ValidateRequest="false" Inherits="ViewEmployeeCV" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <span>
                    <a href="InboxEmployeeCV.aspx" style="margin-right: 18px;" class="aaaa">View Employee CV</a>&nbsp;&nbsp; 
                </span>
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li>
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="ddl_IsAnyDomain" Enabled="false" AutoPostBack="true" OnSelectedIndexChanged="ddl_IsAnyProject_SelectedIndexChanged">
                        ...
                        <li style="margin-top: 10px;">
                            <asp:LinkButton ID="lnk_FinalSubmit" Visible="true" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/InboxEmployeeCV.aspx"></asp:LinkButton>
                        </li>
                        <hr />
                    </ul>
                </div>
