<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ResignationMenu.aspx.cs" Inherits="ResignationMenu" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Resignation"></asp:Label>
                        </span>
                    </div>
                    <div class="leavegrid">
                        <a href="http://localhost/hrms/PersonalDocuments.aspx" class="aaa" >My Corner</a>
                     </div>
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server"  OnClick="lnk_leaverequest_Click">Submit Resignation</asp:LinkButton>                                         
                                    </td>
                                     <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/MyResignation_Req.aspx">My Resignation</asp:LinkButton>
                                    </td>                                    
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                ...
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaveinbox" runat="server" Text="" PostBackUrl="~/procs/InboxResignation.aspx?app=HRML">Inbox</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_reimbursmentReport_1" runat="server"  Visible="True" Text="" PostBackUrl="~/procs/MobileReport_Audit.aspx">Audit Report</asp:LinkButton>
                                    </td>

                                </tr>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_MobPastApproved_ACC" runat="server" Text=""  PostBackUrl="~/procs/InboxResignation_Arch.aspx?app=HRML">Archieved Resignations</asp:LinkButton>
                                    </td>
                                </tr>
                                <%--                                 <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
