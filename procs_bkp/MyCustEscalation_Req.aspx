<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MyCustEscalation_Req.aspx.cs" Inherits="MyCustEscalation_Req" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Customer Incident"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto; padding-top:40PX">
                    <center>
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="Custome Request ID"
