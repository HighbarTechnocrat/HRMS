<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Policies.aspx.cs" Inherits="procs_Policies" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="HBT Policies"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                    ...
                    <div runat="server" id="DivMessage" visible="false">
                         <asp:Label ID="lblmsg" runat="server" Text="You are not entitled for HBT Policies" ForeColor="#ff0000"></asp:Label>
                    ...
                    <div class="leavegridMain">
                        ...
                        <asp:GridView ID="dghbtPolicies" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                            ...
                            <Columns>
                                <%--                                <asp:BoundField DataField="SubDocDescription" HeaderText="HR Policies">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle HorizontalAlign="Center" Width="80%" />
                                </asp:BoundField>--%>
                                <asp:TemplateField HeaderText="HR Policies" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="true">
                                    <ItemTemplate>
