<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_PaymentRequest.aspx.cs" Inherits="procs_VSCB_PaymentRequest" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Create Payment Request"></asp:Label>
					</span>
				</div>
				...
				<div class="edit-contact">
					<ul id="editform" runat="server">
						...
						<li class="trvl_date">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtPoWoDate" runat="server" AutoPostBack="True" Enabled="false"></asp:TextBox>
						</li>
						...
						<div>
						 ...
						 <div>
							<span class="LableName" runat="server" visible="true" id="spInvoice">Invoice Milestone Details
							</span>  
					...
					<div runat="server" id="DivCreateInvoice" visible="false">
						<div class="edit-contact">
							...
							<span class="LableName" runat="server" visible="true" id="Span2">Payment Invoice Detail
                                ...
                                <asp:GridView ID="GVEditpaymentReqamtpaid" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="110%" EditRowStyle-Wrap="false"
                                    DataKeyNames="srno,PaymentStatusID,MstoneID"   >
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="Center" BackColor="White" />
                                    ...
                                    <Columns>
										...
										ItemStyle-BorderColor="Navy" />
                                         ...
                                         <asp:TemplateField HeaderText="Amount To be Requested" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                 <asp:TextBox ID="txtMilestoneInvoiceAmt"  Text='<%# Eval("Milesstone_Amt_ForInvoicetxt") %>' Width="70px" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" AutoComplete="off" runat="server"  CssClass="txtWidth" AutoPostBack="true" OnTextChanged="txtMilestoneInvoiceAmt_TextChanged" MaxLength="18"></asp:TextBox>
									...
									<asp:BoundField HeaderText="IGST Amount"
                                     ...
                                     <asp:BoundField HeaderText="Settlement Amount (Without GST)"
										...
										DataField="DircttaxAmt"
										ItemStyle-HorizontalAlign="Right"
                                        HeaderStyle-HorizontalAlign="Right"
										ItemStyle-Width="8%" ItemStyle-BorderColor="Navy" />

                                        <asp:BoundField HeaderText="Milestone Payble Invoice Amount"
								...
								<li class="trvl_date">
									...
									<br />
									<asp:TextBox AutoComplete="off" ID="txtAmountPaidWithTax" CssClass="number" runat="server" Enabled="false"></asp:TextBox>
								</li>
					...
					<div class="Req_Savebtndiv" style="text-align: center">
						...
						<asp:LinkButton ID="trvldeatils_cancel_btn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_PaymentRequestAll.aspx">    Back</asp:LinkButton>

						<asp:LinkButton ID="accmo_delete_btn" runat="server" Text="Clear Data" ToolTip="Clear Data" CssClass="Savebtnsve" Visible="false" OnClick="accmo_delete_btn_Click">  Clear Data </asp:LinkButton>
                    ...
                    <div class="edit-contact" runat="server" id="PaymnetHistoryOnInvoice" visible="false">
						<ul id="Ul3" runat="server">
							<span class="LableName" runat="server">Invoice Payments History
							</span>
							<asp:GridView ID="GVPaymnetHistoryOnInvoice" DataKeyNames="Payment_ID" runat="server" CssClass="Milestones" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%">
								<FooterStyle BackColor="White" ForeColor="#000066" />
								<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
								<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
								<RowStyle ForeColor="#000066" />
