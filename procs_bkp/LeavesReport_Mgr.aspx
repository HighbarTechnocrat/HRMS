<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="LeavesReport_Mgr.aspx.cs" Inherits="LeavesReport_Mgr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Leave Report - Team"></asp:Label>
        </span>
    </div>
    ...
    <div class="edit-contact">
        <ul>
             <li>
                <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Select Leave Type: <%--&nbsp;&nbsp; <span style="color:red">*</span>--%></span><br />
                <asp:DropDownList ID="ddlleaveTypeHR" CssClass="DropDownList" runat="server" TabIndex="0" Style="float: none;"></asp:DropDownList>
            </li>

        </ul>
        <ul>
             <li>
                 <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Report for:</span> &nbsp;&nbsp; <span style="color:red">*</span><br />
                    <asp:RadioButton runat="server" ID="RdEmployee" Text="An Employee" AutoPostBack="true" OnCheckedChanged="Fullday_CheckedChanged" GroupName="optradio" />
                    <asp:RadioButton runat="server" class="form-check-input" ID="RdDirect" Text="Direct Reportees" AutoPostBack="true" OnCheckedChanged="Fullday_CheckedChanged"  GroupName="optradio" />
                    <asp:RadioButton runat="server" class="form-check-input" ID="RdAll" Text="All Reportees" AutoPostBack="true" OnCheckedChanged="Fullday_CheckedChanged"  GroupName="optradio" />
                
            </li>
            <li>
                 <asp:TextBox Visible="false" ID="txtFromfor" runat="server" CssClass="Dropdown"></asp:TextBox>
            </li>
        ...
        <ul>
            <li>
                ...
                <asp:TextBox ID="txtempname" runat="server"  ToolTip="Enter employee name or code" Visible="false" CssClass="txtcls" Enabled="false"></asp:TextBox>
                <asp:TextBox ID="txtempnameNonHr" runat="server"  ToolTip="Enter employee name or code " Visible="false" CssClass="txtcls" Enabled="false" ></asp:TextBox>
                </li>
            <li>

                <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Filter Records > Entered Leave Days:</span><br />
                <asp:TextBox ID="txtnoofDays" runat="server" MaxLength="2" CssClass="txtcls" ToolTip="Enter no.of leave days for search" autocomplete="off"></asp:TextBox>
            </li>
        ...
        <ul>
            <li>
                 <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">From Month: &nbsp;&nbsp; <span style="color:red">*</span></span><br />
            ...
            <li>
                 <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">To Month: &nbsp;&nbsp; <span style="color:red"></span></span><br />
