<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="MyRetentionInbox.aspx.cs" Inherits="procs_MyRetentionInbox" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Retention Employee Inbox"></asp:Label>
                    </span>
                </div>
				<div>
					...
					<ul id="editform" runat="server">
						...
						<li style="padding-top: 30px">
							<span>Retention Type</span>&nbsp;&nbsp;
                             <br />
							<asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstRetentionType">
							</asp:DropDownList>
						</li>
					</ul>
				</div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto; padding-top:20px;">
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="RetentionID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
