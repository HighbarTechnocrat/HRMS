<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_POWO_OtherApprovalList.aspx.cs" Inherits="procs_VSCB_POWO_OtherApprovalList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="PO/WO Approval Matrix"></asp:Label>
                    </span>
                </div>
              ...
              <%--  <div class="manage_grid" style="overflow: scroll; width: 100%; padding-top: 20px; margin-bottom: 30px;">--%>
                    ...
                    DataKeyNames="Tallycode,CostCentre,department,POTypeID" CellPadding ="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false" PageSize="15" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                        ...
                        <Columns>
                           ...
                           <asp:BoundField HeaderText="PO/ WO Type"
                            ...
                            <asp:BoundField HeaderText="Approver Level 3"
                                ...
                                ItemStyle-HorizontalAlign="Left"
                                HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-Width="20%" ItemStyle-BorderColor="Navy"  Visible="false"/>
