<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="EmployeeTransferReqInbox.aspx.cs" Inherits="EmployeeTransferReqInbox" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Inbox - Employee Transfer Request"></asp:Label>
                    </span>
                </div>

                <span>
                    <a href="EmployeeTransfer.aspx" class="aaaa">Transfer Request</a>
                </span>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <%--<center>--%>
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="id,Status"   CellPadding="3" AutoGenerateColumns="False" Width="70%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Submitted By"
                                DataField="CreatedBy"
                                ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="25%" 
