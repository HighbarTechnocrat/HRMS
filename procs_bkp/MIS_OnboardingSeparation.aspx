<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="MIS_OnboardingSeparation.aspx.cs" Inherits="MIS_OnboardingSeparation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Onboarding & Separation Report"></asp:Label>
            </span>
        </div>
       ...
       <div class="edit-contact">
           <ul>
               <li>
                   <span id="spn_dept" runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Department: </span><br /><%--<span style="color:red">*</span> --%>
