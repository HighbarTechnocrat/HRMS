...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        window.open("http://localhost/oneHRAPI/api/ExcelDownload/Download?path1=" + OfferPath + "" + FileName);
		...
		function DownloadFile(FileName) {
			...
			{
                window.open("http://localhost/oneHRAPI/api/ExcelDownload/Download?path1=" + AppointPath + "" + FileName);
