<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MyAttend_Reg_Req_App.aspx.cs" Inherits="MyAttend_Reg_Req_App" %>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="Approver">
                            ...
                            <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px"
                                DataKeyNames="Leave_Req_id" CellPadding="3"  AutoGenerateColumns="False" Width="143%" OnPageIndexChanging="gvMngLeaveRqstList_PageIndexChanging" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Remark"
                                     ...
                                     <asp:BoundField HeaderText="Leave Status"
                                        ...
                                        ItemStyle-Width="10%"
                                        ItemStyle-BorderColor="Navy" />
                                    <asp:BoundField HeaderText="Approver Remark"
                                        DataField="appr_comments"
                                        ItemStyle-HorizontalAlign="center"
                                         HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-Width="25%"
                                        ItemStyle-BorderColor="Navy" />
                                    <%--<asp:TemplateField HeaderText="Approve / Reject" HeaderStyle-Width="23%"  ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                        ...
                        <li>
                            ...
                            <asp:LinkButton ID="btnback_mng" runat="server" CssClass="Savebtnsve" Text="Back" PostBackUrl="~/procs/MyInboxAttend_Req.aspx">Back</asp:LinkButton>
                        </li>
                        <li></li>
                        <li></li>
                        <li>
