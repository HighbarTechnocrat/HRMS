<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
	CodeFile="Insurance_Reminder_Report.aspx.cs" Inherits="procs_Insurance_Reminder_Report" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Reminder Report"></asp:Label>
                    </span>
                </div>
                 <div>
             ...
             <div>
                <span>
                    <a href="ReportsMenu.aspx" class="aaaa">Report Menu</a>
                </span>
                 </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" >
                        ...
                        <li class="mobile_inboxEmpCode">                            
                            ...
                            <asp:ListBox runat="server"  ID="lstinsuranceType" CssClass="DropdownListSearch" SelectionMode="multiple"></asp:ListBox>
                                    <br /> <br />
                        </li>
                         <li class="mobile_InboxEmpName">                            
                             <span>Status</span>&nbsp;&nbsp;<span style="color: red"></span><br />                                
                              <asp:ListBox runat="server"  ID="lstStatus" CssClass="DropdownListSearch" SelectionMode="multiple"></asp:ListBox>
                                    <br />  <br />                     

                         </li>  
                        <li class="mobile_InboxEmpName">      
                        <span>Responsible Employee</span>&nbsp;&nbsp;<span style="color: red"></span><br />                                 
                            <asp:ListBox runat="server"  ID="lstResponsibleEmp" CssClass="DropdownListSearch" SelectionMode="multiple"></asp:ListBox>
                                    <br /> <br />
                            </li>
