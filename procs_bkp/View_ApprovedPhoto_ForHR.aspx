<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="View_ApprovedPhoto_ForHR.aspx.cs" Inherits="View_ApprovedPhoto_ForHR" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Approve / Correction Employee Photo"></asp:Label>
                    </span>
                </div>
 
                <span>
                    <a href="View_updatephoto_forHR.aspx?itype=0" style="margin-right: 10px;" class="aaaa">Back</a>
                </span>
                    ...
                    <ul id="editform" runat="server" visible="false">
                      ...
                      <asp:TextBox AutoComplete="off" ID="txtRemark" runat="server" MaxLength="400" TextMode="MultiLine" Height="80px" ></asp:TextBox>
                        ...
                        <li>
                            ...
                            <asp:LinkButton ID="btnIn" runat="server" CssClass="Savebtnsve" Text="Approve" OnClick="btnIn_Click" Visible="true" OnClientClick="return SaveMultiClick();">Approve</asp:LinkButton>
                            <asp:LinkButton ID="btnback_mng" runat="server" CssClass="Savebtnsve" OnClientClick="return SaveCurrectionClick();" visible="true" Text="Correction" OnClick="btnIn_Correction">Correction</asp:LinkButton>
