<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Req_Candidate_Report.aspx.cs" Inherits="Req_Candidate_Report" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Candidate Detail Report"></asp:Label>
                    </span>
                </div>
                 <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server">
                        ...
                        <li class="mobile_inboxEmpCode">
                            <span>CV Source</span>&nbsp;&nbsp;<span style="color: red"></span><br />
                        ...
                        <li class="mobile_InboxEmpName">
                            <span>Currently on Notice</span>&nbsp;&nbsp;<span style="color: red"></span><br />
                        ...
                        <li class="mobile_InboxEmpName" style="display:none">
                            ...
                            <%--  <asp:DropDownList runat="server" ID="DDLStatus"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>--%>
