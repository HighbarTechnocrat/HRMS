<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_Change_RGS_Consultant.aspx.cs" Inherits="ABAP_Object_Tracker_Change_RGS_Consultant" EnableSessionState="True" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Change RGS Consultant"></asp:Label>
                    </span>
                </div>
                <div>
