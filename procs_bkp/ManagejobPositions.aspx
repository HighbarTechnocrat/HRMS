<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
     CodeFile="ManagejobPositions.aspx.cs" Inherits="ManagejobPositions" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Manage Position Details"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 90%; height: auto;">
                    <center>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Open Position"
                                DataField="opena"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="15%" />
                            ...
                            <asp:BoundField HeaderText="Fullfill Position"
                                DataField="fullfill"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="15%" />
