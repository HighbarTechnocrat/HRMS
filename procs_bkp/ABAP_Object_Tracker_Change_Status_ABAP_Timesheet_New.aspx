<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_Change_Status_ABAP_Timesheet_New.aspx.cs"
    Inherits="ABAP_Object_Tracker_Change_Status_ABAP_Timesheet_New" EnableSessionState="True" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_LinkBtnSavePopup, #MainContent_LinkBtnBackPopup, #MainContent_LinkButton1, #MainContent_LinkButton2, #MainContent_btn_SumitTimesheet, #MainContent_LinkButton3, #MainContent_LinkButton45, #MainContent_btn_AddOtherTask, #MainContent_btn_SaveAddedTask {
            background: #3D1956;
            color: #febf39 !important;
            padding: 8px 18px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <div class="wishlistpagediv">
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li style="width: 100%">
                            <br />
                            <asp:LinkButton ID="btn_AddOtherTask" runat="server" Text="+" ToolTip="Add Other Task" CssClass="Savebtnsve" OnClick="btn_AddOtherTask_Click"></asp:LinkButton><label> <-- Click Here Add Other Task</label>
                            <ul style="width: 100%">
                                <li>
                                    <asp:Label runat="server" ID="lblmessage" Visible="True" Style="color: red; font-size: 14px; font-weight: 400; text-align: center;"></asp:Label>
                                </li>

                                <li id="liDate" runat="server" visible="false" style="width: 25%" class="trvl_date"> 
                                    <h1 style="text-align: left; font-weight: bold">Add Other Task</h1>
                                    ...
                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" Format="dd/MM/yyyy" TargetControlID="txtFromdate" runat="server"></ajaxToolkit:CalendarExtender>
                                </li>
                                <li id="liHrs" runat="server" visible="false" style="width: 25%" class="trvl_date">
                                    <span>Hours (12 Hrs - HH:MM)</span><span style="color: red">*</span><br />
                                    <asp:TextBox MaxLength="50" ID="txtHours" runat="server" onblur="validateTimesheet1(this.id)"></asp:TextBox>
                                </li>
                                <li id="liProject" runat="server" visible="false" style="width: 25%" class="trvl_date">
                                    <span>Select Project</span><span style="color: red">*</span><br />
                                    <asp:DropDownList runat="server" ID="ddlProject" CssClass="DropdownListSearch"></asp:DropDownList>
                                    <asp:TextBox runat="server" Visible="false" ID="txtProject"></asp:TextBox>
                                </li>
                                <li id="liTask" runat="server" visible="false" style="width: 25%" class="trvl_date">
                                    <br />
                                    <span>Select Task</span><span style="color: red">*</span><br />
                                    <asp:DropDownList runat="server" ID="ddlTask" CssClass="DropdownListSearch"></asp:DropDownList>
                                    <asp:TextBox runat="server" Visible="false" ID="txtTask"></asp:TextBox>
                                </li>
                                <li>
                                    <asp:LinkButton ID="btn_SaveAddedTask" runat="server" Text="Add Task" ToolTip="Add Task" CssClass="Savebtnsve" OnClick="btn_SaveAddedTask_Click" Visible="false"></asp:LinkButton>
                                </li>
                            </ul>
                        </li>
                        <li></li>
    ...
    <script type="text/javascript">
        ...
        function validateTimesheet1(textboxId) {
            var txtBox = document.getElementById(textboxId);
            var value = txtBox.value.trim();
            var timePattern = /^([0-1]?[0-9]|2[0-4]):([0-5][0-9])$/;
