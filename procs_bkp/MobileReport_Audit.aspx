<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="MobileReport_Audit.aspx.cs" Inherits="MobileReport_Audit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<link href="../js/dist/select2.min.css" rel="stylesheet" />
     ...
     <script type="text/javascript">      
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="Mobile Claim Audit Report"></asp:Label>
            </span>
        </div>
