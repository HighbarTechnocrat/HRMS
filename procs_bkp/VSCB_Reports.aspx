<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_Reports.aspx.cs" Inherits="VSCB_Reports" %>
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="wishlistpage">
					<div class="userposts">
						<span>
							<asp:Label ID="lblheading" runat="server" Text="Vendor Billing Reports"></asp:Label>
						</span>
					</div>
					<%--  <div class="leavegrid">
						...
						<div class="editprofileform">
							...
							<table>
								...
								<tr style="padding-top: 1px; padding-bottom: 2px;">
									<td class="formtitle">
										<asp:LinkButton ID="lnk_leaverequest" runat="server" Visible="true" ToolTip="Vendor Payment History" PostBackUrl="~/procs/VSCB_Rpt_VendorPaymenthistory.aspx">Vendor Payment History</asp:LinkButton>
									</td>
									<td class="formtitle">
