...
public partial class VSCB_InvoiceAppMatrixList : System.Web.UI.Page
{
    ...
    private void getSelected_CostCenter_Approver()
    {
        try
        {
            ...
            spars[0].Value = "get_selected_CostCenter_Approvers";
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
            spars[0].Value = "get_CostCenter_Approvers_list";
