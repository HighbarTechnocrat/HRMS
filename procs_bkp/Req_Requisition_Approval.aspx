<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" ValidateRequest="false"
	CodeFile="Req_Requisition_Approval.aspx.cs" Inherits="Req_Requisition_Approval" MaintainScrollPositionOnPostback="true" %>
						...
						<div id="DivTrvl" class="edit-contact" runat="server" visible="true">
							<ul>
								...
								<li class="trvl_date Req_Position">
									...
									<asp:DropDownList runat="server" ID="lstPositionDept" Enabled="false" CssClass="DropdownListSearch">
									</asp:DropDownList>
									<br />
								</li>
								...
								<li class="trvl_date">
									...
									<asp:TextBox AutoComplete="off" ID="txtNoofPosition" runat="server" Enabled="false" MaxLength="2"></asp:TextBox>
								</li>
								...
								<li class="trvl_date Req_Salary" >
									<div>
										...
										<asp:TextBox AutoComplete="off" Enabled="false" ID="txtSalaryRangeFrom" class="number" runat="server" MaxLength="4"></asp:TextBox>
										&nbsp;  To  &nbsp;
							...
							<ul>
								...
								<li class="trvl_date">
									<div style="display: none">
										...
										<asp:DropDownList runat="server" ID="lstRecommPerson" CssClass="DropdownListSearch"></asp:DropDownList>
										<br />
										<br />
									</div>
								</li>
								...
								<li>
									<asp:LinkButton ID="localtrvl_delete_btn" runat="server" Visible="false" Text="Questionnaire" ToolTip="Get JD From Bank" CssClass="Savebtnsve"> Get JD From Bank  </asp:LinkButton>
								...
								<li class="Req_Requi_Cmt" id="lsttrvlapprover" runat="server">
									...
									<asp:TextBox AutoComplete="off" ID="txtComments" CssClass="noresize" runat="server" TextMode="MultiLine" Rows="5"></asp:TextBox>
								</li>
								<li class="trvl_date Req_Position">
						...
						<div id="Div_Oth" class="edit-contact" runat="server" visible="false">
							<ul>
								...
								<li class="trvl_date Req_Position" id="Recruiter" runat="server" visible="false">
									...
									<asp:DropDownList runat="server" ID="listRecruiter" CssClass="DropdownListSearch">
									</asp:DropDownList></li>

								<li class="Req_Requi_Cmt" id="Li1" runat="server">
									<span>Approver Comments</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
									<asp:TextBox AutoComplete="off" ID="txtApprovercmt" CssClass="noresize" runat="server" TextMode="MultiLine" Rows="5"></asp:TextBox>
								</li>
