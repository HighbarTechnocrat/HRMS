<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Attendence.aspx.cs" Inherits="Attendence" %>
                        ...
                        <li class="dg_grid">
                            <div class="att_grid"  style="overflow:auto;height:550px">
                                ...
                                <asp:GridView ID="dgAttendanceReg" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="90%" RowStyle-Wrap="False"
                                    DataKeyNames="att_id" OnRowDataBound="dgAttendanceReg_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Status"
                                            ...
                                            ItemStyle-HorizontalAlign="Left"
                                            ItemStyle-Width="8%" 
                                            ItemStyle-BorderColor="Navy" HtmlEncode="False" />
                                        ...
                                        <asp:TemplateField HeaderText="Reason / Remark">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtReason"  AutoComplete="off"  runat="server" Text='<%# Bind("att_reason_remark") %>' MaxLength="30" ></asp:TextBox>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Select" Visible="false">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkisRegularise" runat="server" />
                                            </ItemTemplate>
