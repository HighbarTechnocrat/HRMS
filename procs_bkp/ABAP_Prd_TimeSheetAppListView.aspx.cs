...
public partial class procs_ABAP_Prd_TimeSheetAppListView : System.Web.UI.Page
{
    ...
    private void getTimeListList()
    {
        try
        {
            ...
            spars[0].Value = "GetApprovedTimeSheetListView";
    ...
    protected void lnkEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("~/procs/ABAP_Prd_TimeSheet_PMApprovedview.aspx?ID=" + HFIDD.Value);
    }
