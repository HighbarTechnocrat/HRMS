<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Appraisal_Competancy.aspx.cs" Inherits="Appraisal_Competancy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Section 1.B: Attributes"></asp:Label>
                    </span>
                </div>
                <div>
                                        ...
                                        <asp:TemplateField  HeaderText="Reviewee Rating" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="10%">
                                             <ItemTemplate >
                                               <%-- <asp:CheckBox ID="chkRowReviewee"  Checked='<%# Eval("Reviewee_RatingID") %>'  runat="server" ItemStyle-Width="70" />--%>
                                                 <asp:DropDownList ID="ddlRowReviewee" runat="server" style="padding-left: 33px !important;border-top:solid;border-top-color:#05568B;border-top-width:1.5pt;
                                         ...
                                         <asp:TemplateField HeaderText=" Reviewer Rating" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="10%">
                                             <ItemTemplate >
                                                <%--<asp:CheckBox ID="chkRowReviewer"  Checked='<%# Eval("Reviewer_RatingID") %>'  runat="server" ItemStyle-Width="50" />--%>
                                                  <asp:DropDownList ID="ddlRowReviewer"  runat="server" style="padding-left: 33px !important;border-top:solid;border-top-color:#05568B;border-top-width:1.5pt;
                                                ;border-left:solid;border-left-color:#05568B;border-left-width:1.5pt;;border-right:solid;border-right-color:#05568B;border-right-width:1.5pt;">
                                                 </asp:DropDownList>
    ...
    <div class="mobiletrvl_Savebtndiv">
        ...
        <asp:LinkButton ID="btnDelete" runat="server" visible="false" Text="Delete" ToolTip="Delete" CssClass="Savebtnsve" OnClick="btnDelete_Click">Delete</asp:LinkButton>
