<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableSessionState="True"
    CodeFile="ABAP_Object_Tracker_Change_Status_UATSignoff.aspx.cs" Inherits="ABAP_Object_Tracker_Change_Status_UATSignoff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="UAT Sign-off - Update Status"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <%--<asp:Panel ID="PnlIrSheet" runat="server" Style="display: none; position: fixed; top: 20%; left: 20%; transform: translate(-20%, -30%,-30%); width: 80%; padding: 20px; background-color: white; border: 1px solid #ccc; z-index: 1000; height: 530px">--%>
                <asp:Panel ID="PnlIrSheet" runat="server" CssClass="testABAP">
                    <div runat="server" id="DivIDPopup" visible="false" style="max-height: 500px;">
                        <asp:Label ID="Label5" runat="server" Text="Change UAT Sign-off Date"></asp:Label>
                        <asp:LinkButton ID="LinkButton2" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" OnClick="LinkBtnBackPopup_Click" BackColor="#3D1956" Style="float: right;">Back</asp:LinkButton>
                        ...
                        <div class="edit-contact">
                            ...
                            <ul runat="server" id="editform1">
                                ...
                                <li class="trvl_date" runat="server" id="UATDisplay1">
                                    <asp:Label ID="Label4" runat="server" Text="Final UAT Date"></asp:Label>
                                    <br />
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform2" runat="server">
                        ...
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <asp:GridView ID="gvUATSingOffDetails" runat="server" CssClass="Milestones" DataKeyNames="UATSignOffId" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                CellPadding="3" AutoGenerateColumns="False" Width="120%" ShowHeaderWhenEmpty="True">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            applyGridViewScroll('#MainContent_gvUATSingOffDetails', gridOptions);
