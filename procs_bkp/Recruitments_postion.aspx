<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
    CodeFile="Recruitments_postion.aspx.cs" Inherits="Recruitments_postion" %>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_detail">                           
                            <asp:LinkButton ID="btnTra_Details" Visible="false" runat="server" Text="+" ToolTip="Browse" CssClass="Savebtnsve" OnClick="btnTra_Details_Click"></asp:LinkButton>
                             <span id="spmdet" runat="server" visible="false">Details (Recruitment Process)</span>
                        </li>
                        ...
                        <li class="mobile_inboxEmpCode">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_age" runat="server" MaxLength="2"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span>Experience (Years): </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="Txt_Experience" runat="server" MaxLength="100"></asp:TextBox>
                         </li>
                     ...
                     <li class="mobile_inboxEmpCode">  
                            <table style="width:750px">
                                <tr>
                                   <td>
                                         <span>PG/Master/Doctrate: </span>                            
                                    </td>
                                   <td>
                                         <span>Type: </span>                            
                                    </td>
                                    <td>
                                        <span>Premium institute: </span>                            
                                    </td>
                                </tr>
                                 <tr>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_PGMastDo" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_PGMastDoc_Type" runat="server" CssClass="Dropdown" ></asp:TextBox>
                                        <asp:Panel ID="Panel4" Style="display: none;" runat="server" CssClass="taskparentclasskkk">                              
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:ListBox ID="lst_PGMastDoc_Type" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="PGMastDoc_Type_SelectedIndexChanged">
                                        ...
                                        <ajaxToolkit:PopupControlExtender ID="PopupControlExtender3" PopupControlID="Panel4" TargetControlID="txt_PGMastDoc_Type"
                                            Position="Bottom" runat="server">
                                        </ajaxToolkit:PopupControlExtender>
                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_PGMastDo_institute" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                   ...
                                   <tr>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_graduate" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_graduate_type" runat="server" CssClass="Dropdown" ></asp:TextBox>
                                        <asp:Panel ID="Panel7" Style="display: none;" runat="server" CssClass="taskparentclasskkk">                              
                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:ListBox ID="lst_graduate_type" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="lst_graduate_type_SelectedIndexChanged">
                                                                    <asp:ListItem Selected="False" Text="Full Time">Full Time</asp:ListItem>
                                                                    <asp:ListItem Selected="False" Text="Part Time">Part Time</asp:ListItem>
                                                    </asp:ListBox>
                                                </ContentTemplate>
                                        ...
                                        <ajaxToolkit:PopupControlExtender ID="PopupControlExtender6" PopupControlID="Panel7" TargetControlID="txt_graduate_type"
                                            Position="Bottom" runat="server">
                                        </ajaxToolkit:PopupControlExtender>
                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_graduate_institute" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_diploma" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                      <td style="padding:10px">
                                         <asp:TextBox AutoComplete="off" ID="txt_diploma_type" runat="server" CssClass="Dropdown" ></asp:TextBox>
                                        <asp:Panel ID="Panel8" Style="display: none;" runat="server" CssClass="taskparentclasskkk">                              
                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:ListBox ID="lst_diploma_type" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="lst_diploma_type_SelectedIndexChanged">
                                                                    <asp:ListItem Selected="False" Text="Full Time">Full Time</asp:ListItem>
                                                                    <asp:ListItem Selected="False" Text="Part Time">Part Time</asp:ListItem>
                                                    </asp:ListBox>
                                                </ContentTemplate>
                                        ...
                                        <ajaxToolkit:PopupControlExtender ID="PopupControlExtender7" PopupControlID="Panel8" TargetControlID="txt_diploma_type"
                                            Position="Bottom" runat="server">
                                        </ajaxToolkit:PopupControlExtender>
                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_diploma_institute" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                 </tr>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_others" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                      <td style="padding:10px">
                                       <asp:TextBox AutoComplete="off" ID="txt_others_type" runat="server" CssClass="Dropdown" ></asp:TextBox>
                                        <asp:Panel ID="Panel9" Style="display: none;" runat="server" CssClass="taskparentclasskkk">                              
                                            <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:ListBox ID="lst_others_type" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="lst_others_type_SelectedIndexChanged">
                                                                    <asp:ListItem Selected="False" Text="Full Time">Full Time</asp:ListItem>
                                                                    <asp:ListItem Selected="False" Text="Part Time">Part Time</asp:ListItem>
                                                    </asp:ListBox>
                                                </ContentTemplate>
                                        ...
                                        <ajaxToolkit:PopupControlExtender ID="PopupControlExtender8" PopupControlID="Panel9" TargetControlID="txt_others_type"
                                            Position="Bottom" runat="server">
                                        </ajaxToolkit:PopupControlExtender>

                                    </td>
                                      <td style="padding:10px">
                                        <asp:TextBox AutoComplete="off" ID="txt_others_institute" runat="server" MaxLength="100" Width="100px"></asp:TextBox>     
                                    </td>
                                 </tr>
                         ...
                         <li class="mobile_inboxEmpCode">                            
                            <span class="qualificationdtls"> Functions </span> &nbsp;&nbsp;  <asp:LinkButton ID="addfunctions" runat="server" ToolTip="Add Functions" Text="+" OnClick="addfunctions_Click">+</asp:LinkButton>
                        ...
                        <li class="mobile_grid">                           
                         ...
                         <li class="mobile_inboxEmpCode">   
                          ...
                          <li class="mobile_inboxEmpCode">                            
                           <span class="qualificationdtls">   Positions  </span> &nbsp;&nbsp; <asp:LinkButton ID="lnk_addPositions" runat="server" ToolTip="Add Positions" Text="+" OnClick="lnk_addPositions_Click">+</asp:LinkButton>
                        ...
                        <li class="mobile_grid">
                            ...
                            <asp:GridView ID="gv_candidates_positions" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="80%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Remove Position" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                        ...
                        <li>
                            <span style="display:none">For Department&nbsp;&nbsp;*</span><br />
                            ...
                            <span id="idisconfidential" runat="server" visible="false">IS Confidential</span> &nbsp;&nbsp;&nbsp; <asp:CheckBox ID="chkConfidential" runat="server" Visible="false" /> <br />
                       ...
                       <li>
                        ...
                        <li>&nbsp;</li>
                          ...
                          <li>
                            <span id="spn_release" runat="server">Release
