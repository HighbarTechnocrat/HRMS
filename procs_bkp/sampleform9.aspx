<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleform9.aspx.cs" Inherits="myaccount_sampleform9" %>--%>
...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform9.aspx.cs" Inherits="myaccount_SampleForm7" %>
...
<%--<div class="container4">
  ...
  <div class="rowDivAttendance">
   ...
   <div class="cellDivManage">'01/09/2017</div>
    ...
    <table rules="all" id="ContentPlaceHolder5_gvproduct" style="border-color:White;border-width:0px;border-style:None;width:70%;border-collapse:collapse;" cellspacing="0" cellpadding="2"align="center">
				<tbody><tr style="background-color:#05568B;">
					<th scope="col" align="center" style="width:10%; color:#fff">Date</th><th scope="col" style="width:8%;color:#fff" align="center">Type</th><th scope="col" style="width:10%;color:#fff"align="center">Time</th><th scope="col" style="width:10%; color:#fff;" align="center"> Status</th><th scope="col" style="width:10%;color:#fff;" align="center">Category*</th><th scope="col" style="width:13%; color:#fff" align="center">Reason / Remark</th><th scope="col" style="width:10%; color:#fff" align="center">Approver 1</th><th scope="col" style="width:10%;color:#fff;" align="center">Approver 2</th><th scope="col" style="width:10%;color:#fff;" align="center">Approver 3</th>
                                </th>
				</tr><tr>
					<td style="width:6%;" align="center">'01/09/2017</td><td align="left">
                                    <span id="ContentPlaceHolder5_gvproduct_lblproductname_0">Out</span>
                                </td><td align="left">
                                    <span id="ContentPlaceHolder5_gvproduct_lblcatname_0">04:30:00 PM</span>
                                </td><td align="left">
                                    <span id="ContentPlaceHolder5_gvproduct_lblsdate_0">ABSENT</span>
                                </td><td align="left">
                                    <span id="ContentPlaceHolder5_gvproduct_lbledate_0">Early Going</span>
                                </td><td style="width:5%;" align="center">
                                    <input name="ctl00$ContentPlaceHolder5$gvproduct$ctl02$hdnviewstatus" id="ContentPlaceHolder5_gvproduct_hdnviewstatus_0" value="Show" type="hidden">
                                    <span id="ContentPlaceHolder5_gvproduct_lblviewstatus_0">ttt</span>
                                </td><td style="width:3%;" align="center">
                                  <span id="ContentPlaceHolder5_gvproduct_lblfollow_0">Approved</span>
                                </td><td style="width:5%;" align="center">
                                  <span id="ContentPlaceHolder5_gvproduct_lblcomment_0"></span>
                                </td><td style="width:2%;" align="center">
                                    <a id="ContentPlaceHolder5_gvproduct_lnkedit_0" title="Edit" href="javascript:__doPostBack('ctl00$ContentPlaceHolder5$gvproduct$ctl02$lnkedit','')"><img id="ContentPlaceHolder5_gvproduct_imgeditmapt_0" title="Edit""></a>
