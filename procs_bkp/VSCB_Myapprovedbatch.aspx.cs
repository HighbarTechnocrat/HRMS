...
public partial class VSCB_Myapprovedbatch : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    get_InboxBatchRequest_DropdownList();
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_MyApproved_BatchRequest_List";
    ...
    private void get_InboxBatchRequest_DropdownList()
    {
        DataSet dsList = new DataSet();
        SqlParameter[] spars = new SqlParameter[2];

        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_MyApprovedBatchRequest_Search_DropdownList";
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        hdnBatchId.Value = Convert.ToString(gvMngTravelRqstList.DataKeys[row.RowIndex].Values[0]).Trim();
