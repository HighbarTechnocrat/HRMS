<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_AssignbankRefApproveBatch.aspx.cs" Inherits="VSCB_AssignbankRefApproveBatch" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Assign Bank Ref. No to Batch for Approval"></asp:Label>
                    </span>
                </div>
                <div>
                    <span>
                ...
                <div class="edit-contact">
                    <ul id="Ul1" runat="server">
                        ...
                        <li class="trvl_type" style="display: none">
                            <span>Batch No.</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                            <asp:DropDownList runat="server" ID="lstBactchRefNo" AutoPostBack="true" CssClass="DropdownListSearch" OnSelectedIndexChanged="lstBactchRefNo_SelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:TextBox AutoComplete="off" ID="txtTriptype" runat="server" CssClass="Dropdown" Visible="false"></asp:TextBox>
                        </li>
                        <li class="trvl_type" style="display: none"></li>
                        <li class="trvl_type" style="display: none"></li>
                        ...
                        <li class="trvl_date">
                            <span>Batch No.:</span>
                            <asp:TextBox AutoComplete="off" ID="txtbatchNo" runat="server" ReadOnly="true" Enabled="False" Visible="true"></asp:TextBox>
                        </li>
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtbatchTotalPayment" runat="server" ReadOnly="true" Enabled="False" CssClass="AmtTextAlign" ></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                        ...
                        <li class="trvl_date">
                            <span>Bank Ref.No:</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                            <asp:TextBox AutoComplete="off" ID="txtBankRefNo" runat="server" MaxLength="100"></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                            <span>Bank Ref.Date:</span><br />
                            <asp:TextBox AutoComplete="off" ID="txtBankRefDate" runat="server" MaxLength="10"></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="dd-MM-yyyy" TargetControlID="txtBankRefDate"
                                runat="server">
                            </ajaxToolkit:CalendarExtender>
                        </li>
                        <li class="trvl_date">
                            <span>Bank Ref.Link:</span>&nbsp;&nbsp;<span style="color: red">*</span><br />
                            <asp:TextBox AutoComplete="off" ID="txtBankRef_Link" runat="server" MaxLength="200"></asp:TextBox>
                        </li>

                        <li class="trvl_local">
                            <span style="display:none">Upload Batch Transaction</span>
                            <asp:FileUpload ID="InvoiceUploadfile" runat="server" accept="pdf/*" AllowMultiple="false" Visible="false"></asp:FileUpload>
                            <br />
                        ...
                        <li class="trvl_grid">
                            ...
                            <span class="LableName" id="spnVoucherDetails" runat="server" visible="false">Voucher Details</span>
                            <asp:GridView ID="gvMngPaymentList_Batch" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                DataKeyNames="Payment_ID,InvoiceID,POID,paymentType_id" CellPadding="3" AutoGenerateColumns="False" Width="170%" EditRowStyle-Wrap="false" PageSize="25" AllowPaging="True" OnPageIndexChanging="gvMngPaymentList_Batch_PageIndexChanging">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="left" ItemStyle-Width="3%">
                                        <ItemTemplate>
                        ...
                        <li class="trvl_Approver">
                            <span id="Span1" runat="server" style="display: none">Batch Approver </span>
                            <asp:GridView ID="DgvApprover" runat="server" BackColor="White" Visible="false" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="75%">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                        ...
                        <li class="trvl_Approver">
                            <span id="spnBatchPaymentApprover" runat="server" visible="false">Batch Approver </span>
                            <asp:GridView ID="DgBatchPaymentApprover" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="75%">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                <RowStyle ForeColor="#000066" />
                ...
                <div class="trvl_Savebtndiv">
                    <span>
                        <asp:LinkButton ID="trvl_btnSave" runat="server" Text="Submit" ToolTip="Submit" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="mobile_btnSave_Click"></asp:LinkButton>
                    </span>
