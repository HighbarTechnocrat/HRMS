<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Encash_leave.aspx.cs" Inherits="Encash_leave" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Leave Encashment"></asp:Label>
                    </span>
                ...
                <div class="leavegrid">
                    <h3 id="hheadyear" runat="server">Leave Encashment can be applied till 25th January 2019 only</h3>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li>
                            ...
                            <asp:TextBox runat="server" ID="lblmessage1" Visible="False" Style="color: red; font-size: 14px; font-weight: 400; text-align: center;" ></asp:TextBox>
                        </li>
                        ...
                        <li>
                            ...
                            <asp:TextBox ID="txtLeaveType" AutoComplete="off" runat="server" Enabled="false" CssClass="Dropdown" OnTextChanged="txtLeaveType_TextChanged" AutoPostBack="true" Text="Leave Encashment"></asp:TextBox>
                            <%-- <i class="fa fa-caret-down" aria-hidden="true"></i>--%>
                            <asp:Panel ID="Panel4" Style="display: none;" runat="server" CssClass="taskparentclasskkk">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional" Visible="false">
                                    <ContentTemplate>
                                        <asp:ListBox ID="lstLeaveType" runat="server" CssClass="taskparentclass2" AutoPostBack="true" OnSelectedIndexChanged="lstLeaveType_SelectedIndexChanged"></asp:ListBox>
                                    </ContentTemplate>
                        ...
                        <li class="taskparentclass">
                            ...
                            <asp:DropDownList ID="ddlFromFor" Visible="false" runat="server">
                                <asp:ListItem>Full Day</asp:ListItem>
                                <asp:ListItem>First Half</asp:ListItem>
                                <asp:ListItem>Second Half</asp:ListItem>
                            </asp:DropDownList>

                            <asp:TextBox ID="txtFromfor" runat="server" AutoPostBack="true" OnTextChanged="txtFromfor_TextChanged" CssClass="Dropdown"></asp:TextBox>
                            <%--<i class="fa fa-caret-down" aria-hidden="true"></i>--%>
                        ...
                        <li class="fordate">
                            ...
                            <asp:TextBox ID="txtToFor" runat="server" AutoComplete="off" CssClass="Dropdown" AutoPostBack="true" OnTextChanged="txtToFor_TextChanged"></asp:TextBox>
                            <%--<i class="fa fa-caret-down" aria-hidden="true"></i>--%>
                        ...
                        <li class="leavedays">
                            ...
                            <asp:TextBox ID="txtLeaveDays" AutoComplete="off" runat="server"></asp:TextBox>
                        </li>
    ...
    <script type="text/javascript">
        ...
        function validateLeaveType(leavetypeid)
        {
          ...
          //  document.getElementById("<%=txtToFor.ClientID%>").disabled = false;
            ...
            document.getElementById("<%=txtFromfor.ClientID%>").value = "";--%>
            ...
            //document.getElementById("<%=txtToFor.ClientID%>").className += "Dropdown";
            //document.getElementById("<%=txtToFor.ClientID%>").removeAttribute.css
            //document.getElementById(<%=txtToFor.ClientID%>).classList.add('Dropdown');
            //document.getElementById(<%=txtToFor.ClientID%>).classList.remove('grayDropdown');
            
           <%-- var mytxttofor = document.getElementById("<%=txtToFor.ClientID%>").classList;
            if (mytxttofor.contains("grayDropdown")) {
                mytxttofor.remove("grayDropdown");
                mytxttofor.add("Dropdown");
            }

            var mytodate = document.getElementById("<%=txtToDate.ClientID%>").classList;
            if (mytodate.contains("grayDropdownTxt")) {
                mytodate.remove("grayDropdownTxt");              
            }
            document.getElementById("<%=txtToDate.ClientID%>").disabled = false;--%>
           <%-- var el = document.getElementById(<%=txtToFor.ClientID%>);
            el[i].className = 'Dropdown';--%>
         //  alert(leavetypeid);
            //document.getElementById(<%=txtToFor.ClientID%>).className = "Dropdown";
            //document.getElementById('<%=txtToDate.ClientID%>').Enabled = true;

            if (leavetypeid == "5")
            {
              //  if (mytxttofor.contains("Dropdown"))
              //  {
              //      mytxttofor.remove("Dropdown");
              //      mytxttofor.add("grayDropdown");
              //  }
                
              //mytodate.add("grayDropdownTxt");
              //document.getElementById("<%=txtToDate.ClientID%>").disabled = true;
                ...
                //document.getElementById("<%=hdnToDate.ClientID%>").value = document.getElementById("<%=txtFromdate.ClientID%>").value;
              <%--  alert(leavetypeid);                
         
               document.getElementById(<%=txtToFor.ClientID%>).classList.remove("Dropdown");
                document.getElementById(<%=txtToFor.ClientID%>).classList.add("grayDropdown");--%>
                //document.getElementById(<%=txtToFor.ClientID%>).className = "grayDropdown";
            }
            document.getElementById("<%=txtToFor.ClientID%>").disabled = false;
            document.getElementById("<%=lstTofor.ClientID%>").disabled = false;
            document.getElementById("<%=txtToDate.ClientID%>").disabled = false;

            if (leavetypeid == "5") {
                document.getElementById("<%=txtToFor.ClientID%>").disabled = true;
                 document.getElementById("<%=lstTofor.ClientID%>").disabled = true;
                 document.getElementById("<%=txtToDate.ClientID%>").disabled = true;
             }
           ...
           // document.getElementById("<%=txtToDate.ClientID%>").disabled = false;
            ...
            <%-- if (leavetypeid == "5")
            {
                if (leavetypeFSH == "First Half") 
                {
                    ...
                    document.getElementById("<%=txtToDate.ClientID%>").disabled = true;
                    document.getElementById("<%=txtToFor.ClientID%>").disabled = true;
                    //  document.getElementById("<%=txtToFor.ClientID%>").value = document.getElementById("<%=txtFromfor.ClientID%>").value;
                    // document.getElementById("<%=txtToFor.ClientID%>").
                }
                else 
                {
                    document.getElementById("<%=txtToDate.ClientID%>").disabled = false;
            ...
            if (leavetypeFSH == "First Half")
            {
                    ...
                    document.getElementById("<%=lstTofor.ClientID%>").disabled = true;
                    document.getElementById("<%=txtToFor.ClientID%>").value = "";
                    document.getElementById("<%=lstTofor.ClientID%>").value = "";
