<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="SheduleInterviewer.aspx.cs" 
   MaintainScrollPositionOnPostback="true" Inherits="procs_SheduleInterviewer" %>
 ...
 <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery-1.4.1.min.js" type="text/javascript"></script>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Interview Scheduler Screen"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div>
                   ...
                   <span>
                       <a href="Rec_RecruiterInbox.aspx?type=RECISL" title="Back" runat="server"  id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server">
                        ...
                        <li class="Req_Requi_Cmt" id="lsttrvlapprover" runat="server">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtComments" runat="server" CssClass="noresize" Enabled="false" TextMode="MultiLine" Rows="5"></asp:TextBox>
                        </li>
                        <li class="trvl_date Req_Position">
    ...
    <div class="manage_grid" style="width: 100%; height: auto; padding-left:40px" runat="server" id="DivInterviewerShortlist">
                          <asp:GridView ID="gvInterviewerShortlist" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px" 
                            DataKeyNames="Candidate_ID,InterviewShortListMain_ID"  CellPadding="3" AutoGenerateColumns="False" Width="95%" 
                           EditRowStyle-Wrap="false" OnRowDataBound="gvInterviewerShortlist_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                             ...
                             <asp:TemplateField HeaderText="Inter. Schedule" HeaderStyle-Width="10%">
                             <ItemTemplate>
                                 <asp:HiddenField ID="hdGRIDCandidate_ID" runat="server"   Value='<%# Bind("Candidate_ID") %>'/>
                             <asp:ImageButton id="lnkEditInterShedule" runat="server"  Width="15px" Height="15px" OnClick="lnkEditInterShedule_Click" ImageUrl="~/Images/edit.png"/>
                             </ItemTemplate>
                             <ItemStyle HorizontalAlign="Center" />
                         </asp:TemplateField>
                            ...
                            <asp:BoundField HeaderText="Name"  DataField="CandidateName"  ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left" ItemStyle-Width="20%" ItemStyle-BorderColor="Navy"/>
                            ...
                            <asp:BoundField HeaderText="Reason"  DataField="Remarks" ItemStyle-HorizontalAlign="center" 
   ...
   <div class="edit-contact">
       ...
       <div runat="server" id="DivSheduleInterview" visible="false">
   <div class="edit-contact">
                    <ul id="Ul1" runat="server">
                         <li class="trvl_date" style="padding-bottom:20px">                            
                            <span  style="font-size:larger">Candidate Details </span>&nbsp;&nbsp;
                        ...
                        <li class="mobile_inboxEmpCode">                            
                            <span >Name </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtname1" runat="server"  MaxLength="50"  Enabled="false"></asp:TextBox>
                        </li>
                        <li class="mobile_inboxEmpCode">                            
                            <span >Email </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtemail1" MaxLength="50" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        <li class="mobile_InboxEmpName">                            
                            <span >Mobile </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtmobile1" MaxLength="10" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        <li class="mobile_InboxEmpName">                            
                            <span >Current Location </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtcurrentlocation1" Enabled="false" MaxLength="20" runat="server"></asp:TextBox>
                        </li>
                      
                       <%-- <li class="mobile_InboxEmpName">                            
                            <span > Experience(Years) </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtexperience1" Enabled="false" MaxLength="2" runat="server"></asp:TextBox>
                        </li>

                        <li class="mobile_inboxEmpCode">                            
                            <span >Current CTC(lakh) </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtcurrentctc1" Enabled="false" MaxLength="9" runat="server"></asp:TextBox>
                        </li>
                        <li class="mobile_InboxEmpName">                            
                            <span > Expected CTC(lakh) </span>&nbsp;&nbsp;
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtexpectedctc1" Enabled="false" MaxLength="9" runat="server"></asp:TextBox>
                        </li>--%>
                         
                        <li class="upload" style="margin-bottom:15px">
                            <span style="margin-bottom:10px"> Resume View</span>&nbsp;&nbsp;<br />
                             <asp:LinkButton ID="lnkuplodedfile1"  runat="server" ForeColor="#ff0000"  OnClientClick="return DownloadFile();"></asp:LinkButton>
                        </li>
                       <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                        ...
                        <li style="padding-bottom:10px">
                             <span>Interview Scheduled Status </span>&nbsp;&nbsp;
                            <br />
                            <asp:DropDownList runat="server" ID="DDlSheduleStatus" AutoPostBack="true" OnSelectedIndexChanged="DDlSheduleStatus_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                         ...
                         <li class="mobile_InboxEmpName" style="padding-bottom:10px"> 
                            ...
                            <br />
                            <asp:DropDownList runat="server" ID="DDLInterviewRound" AutoPostBack="true" OnSelectedIndexChanged="DDLInterviewRound_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                         <li>
                           <span>Interviewer</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                         ...
                         <li class="mobile_InboxEmpName"> 
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtInterviewDate" MaxLength="9" runat="server" Enabled="false"></asp:TextBox>
                        ...
                        <li class="mobile_InboxEmpName"> 
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtInterviewTime" MaxLength="5" runat="server"></asp:TextBox>
                         </li>
                        <li></li>
      ...
      <div class="mobile_Savebtndiv"  id="DivInterviewerShortListButton"  runat="server"  visible="false">
        <asp:LinkButton ID="trvldeatils_btnSave" runat="server" Text="Submit" ToolTip="Submit"  Visible="false"
         ...
         <asp:LinkButton ID="mobile_btnBack" runat="server" Text="Clear Search"  ToolTip="Back"   OnClick="mobile_btnBack_Click"
          class="trvl_Savebtndiv">Close</asp:LinkButton>
    ...
    <script type="text/javascript">      
        $(document).ready(function () {
            ...
            $("#MainContent_DDlSheduleStatus").select2();
        });
    </script>
