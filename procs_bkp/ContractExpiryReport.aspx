<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ContractExpiryReport.aspx.cs" Inherits="ContractExpiryReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Contract Expiry Report"></asp:Label>
                    </span>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="true">
                       ...
                       <%-- <li><span>Select Month Year</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                        ...
                        <li></li>--%>
                        <li class="date" runat="server" visible="false" >
                            <br />
                        ...
                        <li class="date" runat="server" visible="false">
                            <br />
                            <span>To Date</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtToDate"  CssClass="txtcls" AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li runat="server" visible="false">
                            <br />
                            <span>Reportees</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                        ...
                        <li runat="server" visible="false">
                            <br />
                            <span>Direct/ All / An Employee</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                        ...
                        <li class="leavedays" runat="server" visible="false">
                            <br />
                        ...
                        <li runat="server" visible="false"></li>
			 ...
			 PageCountMode="Actual"></rsweb:reportviewer>
                </div>
            </div>
        </div>
    </div>
