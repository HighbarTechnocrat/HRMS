<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ABAP_Object_Tracker_CTM_Test_Cases_Index.aspx.cs"
    MaintainScrollPositionOnPostback="true" EnableSessionState="True"
    Inherits="procs_ABAP_Object_Tracker_CTM_Test_Cases_Index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        #MainContent_lnk_SendforCorrection {
            background: #3D1956;
            color: #febf39 !important;
            padding: 8px 18px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <asp:Label ID="lblheading" runat="server" Text="CTM Approval"></asp:Label>
                </div>
                <div>
                ...
                <asp:LinkButton ID="lnk_Index" runat="server" CssClass="Savebtnsve" PostBackUrl="~/procs/ABAP_Object_Tracker_Index.aspx" BackColor="#3D1956" style="margin: 0px 20px 0px 0px !important;"><%=System.Configuration.ConfigurationManager.AppSettings["ABAPObjectPageTitle"]%></asp:LinkButton>
                ...
                <asp:Panel ID="PnlIrSheet" runat="server" CssClass="testABAP">
                    <div id="DivIDPopup" runat="server" style="max-height: 500px; overflow: auto;">
                        <div class="edit-contact">
                            ...
                            <div class="userposts">
                                <asp:Label ID="Label1" runat="server" Text="CTM Testing Uplaod Test Cases & Update Status"></asp:Label>
                            </div>
                            <ul runat="server" id="Ul1">
                                <li class="trvl_date">
                                    <span>Client Person</span>
                                    <asp:TextBox AutoComplete="off" ID="txtCTMName" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
                                </li>
                                <li class="trvl_date">
                                    <span>Interface</span>
                                ...
                                <li class="trvl_date">
                                    <span>Scope </span>
                                    <asp:TextBox AutoComplete="off" ID="txtScope" runat="server" ReadOnly="true" Enabled="False"></asp:TextBox>
                                </li>
                                ...
                                <li>
                                    <%--<asp:label id="lnkUATSingOffDownload" runat="server" style="cursor: pointer;" OnClick="DownloadUATSingOffFile" CssClass="download-link" ></asp:label>--%>
                                    <asp:LinkButton ID="lnkUATSingOffDownload" runat="server" OnClick="DownloadUATSingOffFile" CssClass="download-link" ToolTip="Download UAT Sign Off" />
                                </li>
                                <li></li>
                                <li>
                                    <br />
                                    <span>Download CTM Test Cases File</span>
                                    <br />
                                    <asp:GridView ID="gvuploadedFiles" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="CTM Test Cases Files"
                                                DataField="FileName"
                        ...
                        <div class="mobile_Savebtndiv" style="padding-left: 15px">
                            <br />
                            ...
                            <asp:LinkButton ID="lnk_SendforCorrection" runat="server" Text="Submit" CssClass="Savebtnsve" ToolTip="Send for Correction" OnClick="lnkbtnclick_SendForCottectHbtTestCases">Send for Correction</asp:LinkButton>
                            <asp:LinkButton ID="btnback_mng" runat="server" CssClass="Savebtnsve" Text="Back" ToolTip="Back" OnClick="LinkBtnBackPopup_Click">Back</asp:LinkButton>
                        </div>
                    </div>
                </asp:Panel>
                    ...
                    <ul id="editform1" runat="server">
                        <li class="trvl_grid" id="lifsdetails" runat="server">
                            ...
                            <asp:GridView ID="gvCTMTestDetails" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                AutoGenerateColumns="False" Width="110%" EditRowStyle-Wrap="true" DataKeyNames="CTMDetailsId" ShowHeaderWhenEmpty="true" OnRowDataBound="GridView1_RowDataBound">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="CTM Consultant Name"
                                    ...
                                    <asp:BoundField HeaderText="CTM Testing Status"
                                    ...
                                    <%-- <asp:BoundField HeaderText="CTM Test Cases Files"
                                        DataField="CTMTestCasesFiles"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="20%"
                                        ItemStyle-BorderColor="Navy" />

                                     <asp:BoundField HeaderText="UAT Sign Off File"
                                        DataField="UATSingOffFile"
                                        ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-Width="20%"
                                        ItemStyle-BorderColor="Navy" />--%>
                                    ...
                                    <asp:TemplateField HeaderText="Download Test Cases" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" Visible="false">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="lnkIRsheetExport" runat="server" Width="20px" ToolTip="Download Test Cases" Height="15px" CommandArgument='<%# Eval("CTMTestCasesFiles") %>' OnClick="ibdownloadbtn_Click" ImageUrl="~/Images/Download.png" />
                                        </ItemTemplate>
    ...
    <asp:HiddenField ID="hdndownloadflagcheck" runat="server" />

    <asp:HiddenField ID="hdnbLocationName" runat="server" />
