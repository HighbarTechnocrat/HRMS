<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Rec_RequisitionViewListApproved.aspx.cs" 
   MaintainScrollPositionOnPostback="true"  Inherits="procs_Rec_RequisitionViewListApproved" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text=" View Recruitment Status List"></asp:Label>
                    </span>
                </div>
                <%-- <div>
