<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Rec_RecruiterCandidateInbox.aspx.cs" 
      MaintainScrollPositionOnPostback="true" Inherits="Rec_RecruiterCandidateInbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="manage_grid" style="width: 100%; height: auto;">
                          <asp:GridView ID="gvRecruterInoxList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px" 
                            DataKeyNames="CandidateId"   CellPadding="3" AutoGenerateColumns="False" Width="100%"  OnPageIndexChanging="gvRecruterInoxList_PageIndexChanging"  EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
                      ...
                      <PagerStyle CssClass="gridpager" HorizontalAlign="Right" />
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Requisition Date" DataField="RequisitionDate"
                              ...
                              <asp:BoundField HeaderText="Module Desc" DataField="ModuleDesc"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%" />

                            <asp:BoundField HeaderText="Candidate Name" DataField="CandidateName"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />

                            <asp:BoundField HeaderText="Candidate Email" DataField="CandidateEmail"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="8%" />

                            <asp:BoundField HeaderText="Candidate Current Location" DataField="CandidateCurrentLocation"
                                HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%" />
