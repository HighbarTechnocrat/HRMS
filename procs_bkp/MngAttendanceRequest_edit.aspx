<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MngAttendanceRequest_edit.aspx.cs" Inherits="MngAttendanceRequest_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text=" Modify Attendance Regularization"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="EmpName" style="display:none">
                        ...
                        <li class="dg_grid">
                            ...
                            <div class="att_grid">
                                ...
                                <asp:GridView ID="dgAttendanceReg" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" RowStyle-Wrap="False"
                                    DataKeyNames="att_id,att_category" OnRowDataBound="dgAttendanceReg_RowDataBound" OnRowCreated="dgAttendanceReg_RowCreated">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Reason / Remark">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtReason" runat="server" Width="65%" Text='<%# Bind("att_reason_remark") %>'></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:TemplateField>
    ...
    <div class="att_buttons">
        ...
        <asp:LinkButton ID="att_submit" OnClick="btnSave_Click" Visible="false" runat="server">Submit</asp:LinkButton>

        <asp:LinkButton ID="att_back"   runat="server" PostBackUrl="~/procs/MngAttendanceRequest.aspx">Back</asp:LinkButton>
