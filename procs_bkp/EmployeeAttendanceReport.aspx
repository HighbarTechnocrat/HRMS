<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="EmployeeAttendanceReport.aspx.cs" Inherits="EmployeeAttendanceReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Employee Attendance Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                       ...
                       <%-- <li><span>Select Month Year</span>&nbsp;&nbsp;<span style="color:red">*</span> <br />
                        ...
                        <li class="date">
                            <br />
                            <span>To Date</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtToDate"  AutoComplete="off" CssClass="txtcls" runat="server" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
