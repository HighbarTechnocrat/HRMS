<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="MngAttendanceRequest.aspx.cs" Inherits="MngAttendanceRequest" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Manage Attendance Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                          ...
                          <asp:GridView ID="gvMngAttendanceRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="req_id"  CellPadding="3" AutoGenerateColumns="False" Width="30%" OnPageIndexChanging ="gvMngAttendanceRqstList_PageIndexChanging"  EditRowStyle-Wrap="false">
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="Sr.No" DataField="rownumber" ItemStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                             </asp:BoundField>

                             <asp:BoundField HeaderText="Request Date" DataField="regularise_dt" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
                      
                            <asp:TemplateField HeaderText="Details" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>                                         
                                        <asp:LinkButton ID="lnkViewdetails" runat="server" Text="View" OnClick="lnkViewdetails_Click"></asp:LinkButton>
                                    </ItemTemplate>
                            </asp:TemplateField>
