<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="VSCB_ApprovePaymentRequest_View.aspx.cs" Inherits="VSCB_ApprovePaymentRequest_View" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Approved Payment Request"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txtCostCenter" runat="server" Enabled="false" Visible="false"></asp:TextBox>
                        </li>

                        
                        <li class="trvl_date">
                            <span>PO/ WO Status </span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                        ...
                        <li class="trvl_date">
                            <span>PO/ WO Amount (Without GST) </span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtBasePOWOWAmt" CssClass="textboxBackColor"  runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        
                        <li class="trvl_date">
                            <span>PO/ WO Amount (With GST) (A)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPoWoAmtWithTaxes" CssClass="textboxBackColor" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                            <span>Direct Tax Amount (B)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPODirectTaxAmt" CssClass="textboxBackColor" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        <li class="trvl_date">
                            <span>Paid Amount (With GST) (C)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPoWOPaidAmt" CssClass="textboxBackColor" runat="server" Enabled="false" Visible="false"></asp:TextBox>
                        ...
                        <li class="trvl_date">
                            <span>Balance Amount (A-B-C) </span>&nbsp;&nbsp;<span style="color: red">*</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtPoWOPaidBalAmt" CssClass="textboxBackColor" runat="server" Enabled="false"></asp:TextBox>
                        </li>
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:LinkButton ID="lnkWOPOSignCopy" runat="server"  OnClientClick="Download_SingCopy()" CssClass="BtnShow" Visible="false"></asp:LinkButton>
                        </li>
                         ...
                         <asp:GridView ID="GrdInvoiceDetails" CssClass="Milestones" runat="server" DataKeyNames="MstoneID,InvoiceID" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="130%">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Milestone Amount for Invoice (With GST)"
                                     ...
                                     <asp:BoundField HeaderText="Milestone Payable Amount"
                        ...
                        <div class="edit-contact">
                            ...
                            <ul id="Ul2" runat="server">
                                ...
                                <li class="trvl_date">
                                    ...
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtInvoiceAmount"  CssClass="textboxalignAmount" runat="server" Enabled="false"></asp:TextBox>
                                </li>
                                <li class="trvl_date">
                                    <span>Direct Tax Amount (if Any) (B)</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtInvoiceTDSAmt" CssClass="textboxalignAmount" runat="server" Enabled="false"></asp:TextBox>
                                </li>

                                <li class="trvl_date">
                                    <span>Invoice Paid Amount (C)</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtInvoicePaidAmount" CssClass="textboxalignAmount" runat="server" Enabled="false"></asp:TextBox>
                                </li>

                                <li class="trvl_date">
                                    <span>Invoice Balance Amount (A-B-C)</span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtInvoiceBalAmt" CssClass="textboxalignAmount" runat="server" Enabled="false"></asp:TextBox>

                                    <span style="display: none">Payment Requested for (Amount)</span>
                                    <asp:TextBox AutoComplete="off" ID="txtPaymentRequestAmount" runat="server" CssClass="textboxalignAmount" Enabled="false" Visible="false"></asp:TextBox>
                                </li>
                                <li class="trvl_date"></li>
                                ...
                                <li class="trvl_date">
                                    <span>Payment Requested. </span>&nbsp;&nbsp;<span style="color: red">*</span>
                                    <br />
                                    <asp:TextBox AutoComplete="off" ID="txtAmountPaidWithTax" CssClass="textboxalignAmount" Enabled="false" runat="server"></asp:TextBox>
                                </li>

                                <li class="trvl_date" runat="server" id="Account2">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <span>Amount Hold by Accounts </span>
                                            <br />
                                            <asp:TextBox AutoComplete="off" ID="txtAccountAmtBal" CssClass="textboxalignAmount" runat="server" Enabled="false"></asp:TextBox>
                                ...
                                <li class="trvl_date" runat="server" id="Account1">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <span>Amount paid by Accounts </span>
                                            <asp:TextBox AutoComplete="off" ID="txtAccountPaidAmt" runat="server" CssClass="textboxalignAmount" Enabled="false" OnTextChanged="txtAccountPaidAmt_TextChanged"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <li class="trvl_date" style="display: none">
                                    <span style="display: none">Remark </span>&nbsp;&nbsp;									 
									<asp:TextBox Visible="false" AutoComplete="off" ID="txtApprovalRemark" CssClass="noresize" runat="server" Width="288%" TextMode="MultiLine" Rows="5" onKeyUp="javascript:Count(this);"></asp:TextBox>
                                </li>
                                <li class="trvl_date" style="display: none"></li>
                                <li class="trvl_date" style="display: none"></li>

                                <li class="trvl_Approver">
                                    <span class="LableFiles" id="spnPaymentSupportingFiles" runat="server" visible="false">Payments Supporting Files</span>&nbsp;&nbsp;<br />
                                ...
                                <li class="trvl_date" style="display: none">
                                    <span id="spnPowoFiles" runat="server" class="LableFiles" visible="false">PO/WO Files</span><br />
                                    <asp:LinkButton ID="lnkfile_PO" runat="server" OnClick="lnkfile_PO_Click" Visible="false" CssClass="BtnShow"></asp:LinkButton><br />
                                    <br />

                                    <span id="spnPowoSupportingFiles" runat="server" class="LableFiles" visible="false">PO/WO Supporting Files</span><br />
                                    <asp:GridView ID="gvuploadedFiles_POWO" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        DataKeyNames="Srno">
                                        <FooterStyle BackColor="White" ForeColor="#000066" />
                                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="File View" HeaderStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="lnkFileView" runat="server" CssClass="BtnShow" ToolTip=" File View" Width="15px" Height="15px" ImageUrl="~/Images/Download.png" OnClientClick=<%# "DownloadFile('" + Eval("FileName") + "')" %> />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                ...
                                <li class="trvl_date" style="display: none"></li>
                                 ...
                                 <li class="trvl_Approver">
                                    <span class="LableName" runat="server" id="spnApprovals">Payment Approvals:
                                    </span>
                                    <asp:GridView ID="DgvApprover" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="90%">
                                        <FooterStyle BackColor="White" ForeColor="#000066" />
                                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                        <RowStyle ForeColor="#000066" />
                                ...
                                <li class="trvl_date">
                                    <br />
                                    <span id="spnInvoicefile" runat="server" class="LableFiles" visible="false">Invoice Files</span>&nbsp;&nbsp;<br />
                                    <asp:LinkButton ID="lnkfile_Invoice" runat="server" OnClientClick="DownloadFile_S()"  CssClass="BtnShow" Visible="false"></asp:LinkButton><br />
                                    <br />

                                    <span id="spnInvoiceSupportingfile" runat="server" class="LableFiles" visible="false">Invoice Supporting Files</span>&nbsp;&nbsp;<br />

                                    <asp:GridView ID="gvuploadedFiles_Invoice" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                        DataKeyNames="Srno">
                                        <FooterStyle BackColor="White" ForeColor="#000066" />
                                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="File View" HeaderStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="lnkFileView" runat="server" CssClass="BtnShow" ToolTip=" File View" Width="15px" Height="15px" ImageUrl="~/Images/Download.png" OnClientClick=<%# "DownloadFile1('" + Eval("FileName") + "')" %> />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="File Name">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkviewfile" CssClass="BtnShow" runat="server" OnClientClick=<%#"DownloadFile1('" + Eval("filename") + "')" %> Text='<%# Eval("filename") %>'>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                ...
                                <li class="trvl_date"></li>
                                 ...
                                 <li class="trvl_Approver">
                                    <span class="LableName" >Invoice Approvals:</span>
                                    <asp:GridView ID="gvInvoiceApprovers" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="90%">
                                        <FooterStyle BackColor="White" ForeColor="#000066" />
                                        <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                        <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                        <RowStyle ForeColor="#000066" />
    ...
    <script type="text/javascript">      
        ...
        function DownloadFile_S() {
           ...
           function Download_SingCopy() {
             ...
             var localFileName = document.getElementById("<%=lnkWOPOSignCopy.ClientID%>").innerText;
