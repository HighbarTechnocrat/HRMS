<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="InboxPayments_Arch.aspx.cs" Inherits="InboxPayments_Arch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Approved Payment Vouchers"></asp:Label>
        </span>
    </div>
        <div class="leavegrid">
...
<%--        <div class="editprofile btndiv" id="divbtn" runat="server" visible="false">
    ...
    <div class="manage_grid" style="width: 100%; height: auto;">
        <center>
                ...
                DataKeyNames="Rem_id" CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" 
                    OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
