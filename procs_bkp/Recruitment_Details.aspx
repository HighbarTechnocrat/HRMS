<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
    CodeFile="Recruitment_Details.aspx.cs" Inherits="Recruitment_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Details (Recruitment Process)"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="mobile_inboxEmpCode">                           
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="Txt_Time" runat="server" AutoPostBack="false" MaxLength="5"></asp:TextBox>
                        </li>
                        <li>
                            <span>Activity </span>&nbsp;&nbsp;<span style="color:red">*</span><br />


                            <asp:TextBox AutoComplete="off" ID="txtComm_Type" runat="server" CssClass="Dropdown"></asp:TextBox>
                        ...
                        <li>                           
                            <span>Sub-Type </span>&nbsp;&nbsp;<span style="color:red">*</span><br />


                            <asp:TextBox AutoComplete="off" ID="Txt_Way" runat="server" CssClass="Dropdown"></asp:TextBox>
                        ...
                        <li class="claimmob_Remark">
                            <span>Details </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="Txt_Details" TextMode="MultiLine" runat="server" MaxLength="300" Height="100px"></asp:TextBox>
                        </li>
                        ...
                        <li class="mobile_inboxEmpCode">
                            <asp:LinkButton ID="Link_Cand" runat="server" Text="Interview Panel:" ToolTip="Interview Panel" OnClick="Link_Cand_Click"></asp:LinkButton>
                        </li>
                        <li class="mobile_inboxEmpCode">
                            <span> </span>
                         </li>
                        ...
                        <li>    
                            ...
                            <asp:TextBox AutoComplete="off" ID="Txt_Status" runat="server" CssClass="Dropdown"></asp:TextBox>
    ...
    <br />
     <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel1"
        ID="AutoCompleteExtender1" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel2"
        ID="AutoCompleteExtender2" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel3"
        ID="AutoCompleteExtender3" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel4"
        ID="AutoCompleteExtender4" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel5"
        ID="AutoCompleteExtender5" runat="server" FirstRowSelected="true">
        </ajaxToolkit:AutoCompleteExtender>
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="3"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="TxtPanel6"
