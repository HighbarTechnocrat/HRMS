<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_POWO_Approval_MatrixList.aspx.cs" 
    Inherits="procs_VSCB_POWO_Approval_MatrixList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="POWO Approval Matrix List (Namaste)"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <%--                        <li style="padding-top: 30px">
                            <span>PO Type</span>&nbsp;&nbsp;
                             <br />
                            <asp:DropDownList runat="server" ID="lstPotype" CssClass="DropdownListSearch">
                            </asp:DropDownList>
                        </li>
                        --%>
                        ...
                        <li style="padding-top: 30px">
                            <span>Employee Name</span>&nbsp;&nbsp;
                             <br />
                            <asp:DropDownList runat="server" CssClass="DropdownListSearch" ID="lstEmployees">
                            </asp:DropDownList>
                        </li>
                ...
                <div class="mobile_Savebtndiv" style="margin-top: 10px !important">
                    ...
                    <asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Create Invoice/Payment Request Creator" ToolTip="Create Invoice/Payment Maker" class="trvl_Savebtndiv" OnClick="localtrvl_btnSave_Click">Create POWO Approval Matrix</asp:LinkButton>
                </div>
                ...
                <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                    DataKeyNames="Dept_ID" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false" PageSize="15" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="lnkLeaveDetails" ToolTip="View" runat="server" Width="15px" 
                                    Height="15px" ImageUrl="~/Images/edit.png" OnClick="lnkLeaveDetails_Click" />
                            </ItemTemplate>
                        ...
                        <asp:BoundField HeaderText="Approval-1"
                            DataField="Emp_Code1"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-Width="15%" ItemStyle-BorderColor="Navy" />

                        <asp:BoundField HeaderText="Approval-2"
                            DataField="Emp_Code2"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-Width="20%" ItemStyle-BorderColor="Navy" />

                        <asp:BoundField HeaderText="Approval-3"
                            DataField="Emp_Code3"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
                            ItemStyle-Width="20%" ItemStyle-BorderColor="Navy" />

                        <asp:BoundField HeaderText="Approval-4"
                            DataField="Emp_Code4"
                            ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-HorizontalAlign="Left"
