<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" EnableViewState="true"
    MaintainScrollPositionOnPostback="true" CodeFile="ABAP_Object_Tracker_AuditReport.aspx.cs" Inherits="ABAP_Object_Tracker_AuditReport" EnableSessionState="True" %>
            ...
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <br />
                        &nbsp;&nbsp;
                        <asp:Label ID="lblheading" runat="server" Text="ABAP Object Tracker Audit Report"></asp:Label>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform1" runat="server">
                        ...
                        <li class="trvl_date">
                            ...
                            <asp:DropDownList ID="ddlStage" runat="server" Style="width: 300px;" CssClass="DropdownListSearch">
                                <asp:ListItem Text="Select a Stage" Value="0" />
                                <asp:ListItem Text="RGS" Value="RGS" />
                                <asp:ListItem Text="FS" Value="FS" />
                                <asp:ListItem Text="ABAP" Value="ABAP" />
                                <asp:ListItem Text="HBTTest" Value="HBT Testing" />
                                <asp:ListItem Text="CTMTest" Value="CTM Tetsing" />
                            </asp:DropDownList>
                        </li>
