...
public partial class KRATemplate : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
       ...
       string iRoleid = Convert.ToString(gvMngTravelRqstList.DataKeys[row.RowIndex].Values[1]).Trim();
        ...
        Response.Redirect("KRA_Template_Create.aspx?kraid=" + hdnPOWOID.Value + "&mngexp="+ iRoleid); 
    }
    ...
    private void getMngTravelReqstList()
    {
        ...
        {  
            ...
            spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
            spars[0].Value = "get_Roles_KRA_list";
