<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ExitInterviewProcessReport.aspx.cs" Inherits="ExitProcessReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Employee Exit Interview Proccess Summary Report"></asp:Label>
        </span>
    </div>
    ...
    <div class="edit-contact">
        <ul>
            <li id="hideDepartment" runat="server" style="display:none">
                <span id="spn_dept" runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Department: </span>
                <br />
                <%--<span style="color:red">*</span> --%>
                <asp:DropDownList ID="ddlDepartment" CssClass="DropdownListSearch" runat="server">
                </asp:DropDownList>
            </li>
        </ul>
        <ul>
            <li>
                <span runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Employee Name </span>
                <br />
                <%--<span style="color:red">*</span> --%>
                <asp:DropDownList ID="ddlEmployee" CssClass="DropdownListSearch" runat="server">
                </asp:DropDownList>
            </li>
            <li>
                <span runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Status </span>
                <br />
                <%--<span style="color:red">*</span> --%>
                <asp:DropDownList ID="ddlStatus" CssClass="DropdownListSearch" runat="server">
                </asp:DropDownList>
            </li>
        </ul>
