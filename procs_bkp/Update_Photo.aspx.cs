    ...
    protected void btnIn_Click(object sender, EventArgs e)
    {
        ...
        { 
			...
			using (var memoryStream = new System.IO.MemoryStream())
			{
			   ...
			   using (System.Drawing.Image uploadedImage = System.Drawing.Image.FromStream(memoryStream))
			   {
			            int imageWidth = uploadedImage.Width;
			            int imageHeight = uploadedImage.Height;
 
 			           if (imageWidth != 190 || imageHeight != 255)
            			   {
				                lblmessage.Text = "Please upload a photo with dimensions of 190 pixels (width) by 255 pixels (height)";
				                return;
            			   }
        		    } 
			}
