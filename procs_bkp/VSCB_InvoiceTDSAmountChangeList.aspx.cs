...
public partial class procs_VSCB_InvoiceTDSAmountChangeList : System.Web.UI.Page
{
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("VSCB_ApproveInvoiceTDSAmtChange.aspx?invid=" + hdnInvoiceId.Value + "&mngexp=1");
    }
    #endregion
    ...
    private void getMngInvoiceReqstList()
    {
        try
        {
            ...
            spars[0].Value = "get_Invoice_List_TDSAmountChangeApprovers";
    ...
    private void get_InboxInvoices_DropdownList()
    {
        ...
        spars[0] = new SqlParameter("@stype", SqlDbType.VarChar);
        spars[0].Value = "get_MyApprovedInvoiceTDSAmountChange_Search_DropdownList";
        spars[1] = new SqlParameter("@empcode", SqlDbType.VarChar);
