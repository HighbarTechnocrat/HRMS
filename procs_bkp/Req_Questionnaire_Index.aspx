<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="Req_Questionnaire_Index.aspx.cs" Inherits="Req_Questionnaire_Index" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Questionnaire"></asp:Label>
                    </span>
                </div>
				 <div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto; padding-top:10px;">
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="AssignQuestionnaire_ID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="10" AllowPaging="true"  OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField  HeaderText="File View" HeaderStyle-Width="8%">  
                             <ItemTemplate>           
								  <asp:ImageButton id="lnkEdit1" runat="server" ToolTip=" File View" Width="15px" Height="15px" ImageUrl="~/Images/Download.png" OnClientClick=<%# "DownloadFile('" + Eval("UploadData") + "')" %> />
                             <%--  <asp:LinkButton ID="lnkViewFiles" runat="server" ToolTip=" File View" Text='View' CssClass="ViewFiles" OnClientClick=<%# "DownloadFile('" + Eval("UploadData") + "')" %>  ></asp:LinkButton>      --%>                                                            
                           </ItemTemplate>  
                                 <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>  
