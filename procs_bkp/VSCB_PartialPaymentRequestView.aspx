<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="VSCB_PartialPaymentRequestView.aspx.cs" Inherits="procs_VSCB_PartialPaymentRequestView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Partial Payment Request View"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div>
					<span>
						...
						<a href="VSCB_MyPartialPaymentRequest.aspx" title="Back" runat="server" visible="false" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
					</span>
				</div>
				...
				<div class="edit-contact">
					<ul id="editform" runat="server">
						...
						<div>
							...
							<asp:GridView ID="GrdPartialPayment" CssClass="Milestones" runat="server" DataKeyNames="MstoneID,InvoiceID" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%">
								<FooterStyle BackColor="White" ForeColor="#000066" />
								<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
								<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
								<RowStyle ForeColor="#000066" />
								...
								<Columns>
									...
									<asp:BoundField HeaderText="Amount to be Paid"
										...
										ItemStyle-Width="5%"
										ItemStyle-BorderColor="Navy" />
									<asp:BoundField HeaderText="Amount to be Account"
					...
					<div runat="server" id="DivCreateInvoice" visible="true">
						<div class="edit-contact">
							...
							<ul id="Ul2" runat="server">
								...
								<li class="trvl_date" runat="server" id="OldPayNo">
									...
									<br />
									<br />
									<%--<asp:TextBox AutoComplete="off" ID="txtOldPaymentRequestNo" runat="server" Enabled="false"></asp:TextBox>--%>
                        ...
                        <asp:GridView ID="GridViewAccountpaidbyAmount" CssClass="Milestones" runat="server" DataKeyNames="MstoneID,InvoiceID" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="130%">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Amount paid by Account" DataField="AccountpaidbyAmount" ItemStyle-HorizontalAlign="right"
                                    HeaderStyle-HorizontalAlign="right" ItemStyle-Width="5%" ItemStyle-BorderColor="Navy" />
								...
								<li class="trvl_date">
									<span>Amount to be paid (with Tax) </span>&nbsp;&nbsp;<span style="color: red">*</span>
									<br />
								...
								<li class="trvl_date">
									...
									<br />
									<asp:TextBox AutoComplete="off" ID="txtApprovalRemark" Enabled="false" CssClass="noresize" runat="server" Width="288%" TextMode="MultiLine" Rows="5" onKeyUp="javascript:Count(this);"></asp:TextBox>
								</li>
								<li></li>
								<li></li>
								<li class="trvl_date">
	...
	<div class="Req_Savebtndiv" style="text-align: center">
		...
		<asp:LinkButton ID="localtrvl_btnSave" runat="server" Text="Create & verify Payment Request" Visible="false" ToolTip="Create & verify Payment Request" CssClass="Savebtnsve" OnClick="localtrvl_btnSave_Click" OnClientClick="return SaveMultiClick();">Create & verify Payment Request </asp:LinkButton>
		...
		<asp:LinkButton ID="trvldeatils_cancel_btn" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/VSCB_MyPartialPaymentRequest.aspx">   Back</asp:LinkButton>

		</div>
	<div>
		<span class="LableName" runat="server" visible="false" id="SPPayHist">Earlier Payments History
		</span>
