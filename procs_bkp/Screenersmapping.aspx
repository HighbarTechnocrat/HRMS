<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Screenersmapping.aspx.cs" 
    Inherits="procs_Screenersmapping" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Screener Mapping Info"></asp:Label>
                    </span>
                </div>
				 <div>
					...
					<ul id="editform" runat="server" >
                       ...
                       <li class="trvl_date">                        
						...
						<div style=" padding-left:300px">							
							<br />							
                            <asp:LinkButton ID="mobile_btnSave" Text="Add Screener" ToolTip="Add Screener"  runat="server" OnClick="mobile_btnSave_Click" ></asp:LinkButton>
                        <%--<asp:LinkButton ID="mobile_cancel" runat="server" Text="Clear Screener" ToolTip="Clear Screener" CssClass="Savebtnsve" OnClick="mobile_cancel_Click" >Clear Search</asp:LinkButton>      
                        --%>
							</div>
					</ul>
					</div>
          ...
          <asp:Label runat="server" ID="lbltotalRecords"  Style="color: red; font-size: 15px; font-weight: 500; text-align: center;"></asp:Label>
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Screeners_Mapping_ID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="15" AllowPaging="true"  OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging" >
