<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Req_StatusofInterview_L2_Report.aspx.cs" Inherits="procs_Req_StatusofInterview_L2_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <script src="<%=ReturnUrl("sitepath")%>js/singleautocomplete/jquery.autocomplete.js" type="text/javascript"></script>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="L2 Report"></asp:Label>
                    </span>
                </div>
                 <div>
                ...
                <div class="edit-contact">
                      <ul id="Ul1" runat="server">
                        ...
                        <span>From Date</span>&nbsp;&nbsp; <span style="color:red">*</span><br />
                                    <asp:TextBox AutoComplete="off" ID="txtfromdate" CssClass="txtcls" runat="server" AutoPostBack="true" MaxLength="10"  OnTextChanged="txtfromdate_TextChanged" ></asp:TextBox>  
                        ...
                        <span>To Date</span>&nbsp;&nbsp;<br />
                                     <asp:TextBox AutoComplete="off" ID="txttodate" CssClass="txtcls" runat="server" AutoPostBack="true" MaxLength="10" OnTextChanged="txtfromdate_TextChanged" ></asp:TextBox>  
                      ...
                      <li class="mobile_InboxEmpName">                             
                        ...
                        <span>Skill Set</span>&nbsp;&nbsp;<span style="color: red"></span><br />
                                    <asp:DropDownList runat="server" ID="DDLSkillSet"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>
                                    <br /> <br /> 
                            </li>
                       ...
                       <li class="mobile_InboxEmpName">     
                        <span>Interveiwer</span>&nbsp;&nbsp;<span style="color: red"></span><br />
                                    <asp:DropDownList runat="server" ID="lstInterveiwer"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>
                                    <br /> <br />
                            </li>
                        <li class="mobile_InboxEmpName">        
                        <span> Candidate Name </span>&nbsp;&nbsp;<span style="color: red"></span><br />
                                    <asp:DropDownList runat="server" ID="DDLCandiate"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>
                                    <br /> <br />
                            </li>
                       <li class="mobile_InboxEmpName">       
                        <span>Interveiw Status</span>&nbsp;&nbsp;<span style="color: red"></span><br />
                                    <asp:DropDownList runat="server" ID="DDlInterviewstatus"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>
                                    <br /> <br />
                            </li>
                       <li class="mobile_InboxEmpName">       
                        <span> Interveiw Feedback </span>&nbsp;&nbsp;<span style="color: red"></span><br />
                                    <asp:DropDownList runat="server" ID="ddlinterviewfeedback"  CssClass="DropdownListSearch">
                                    </asp:DropDownList>
                                    <br /> <br />
                            </li>
    ...
    <div class="mobile_Savebtndiv" style="text-align:center; padding-top:20px">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%"  Height="700px"   ShowBackButton="False" SizeToReportContent="false"
            ShowCredentialPrompts="False" ShowDocumentMapButton="False"
            ShowPageNavigationControls="true" ShowFindControls="true" ShowExportControls="true"
