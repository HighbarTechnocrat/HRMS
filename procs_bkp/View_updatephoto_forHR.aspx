<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="View_updatephoto_forHR.aspx.cs" Inherits="View_updatephoto_forhr" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Approve Employee Uplaoded Photo"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 100%; height: auto;">
                    <%--<center>--%>
                          <asp:GridView ID="gvMngLeaveRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                           DataKeyNames="Sr_No"   CellPadding="3" AutoGenerateColumns="False" Width="85%" OnPageIndexChanging ="gvMngLeaveRqstList_PageIndexChanging"  AllowPaging="true" PageSize="15" EditRowStyle-Wrap="false">
