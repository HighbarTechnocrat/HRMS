<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_POWO_Approval_Matrix.aspx.cs" 
    Inherits="procs_VSCB_POWO_Approval_Matrix" 
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="POWO Approval Matrix (Namaste)"></asp:Label>
                    </span>
                </div>
                <div>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="trvl_grid" id="ligrd" runat="server">
                            ...
                            <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                ...
                                <Columns>
                                      <asp:BoundField HeaderText="PO Type" DataField="POType" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left"
                                        ItemStyle-BorderColor="Navy" ItemStyle-Width="20%" />

                                    <asp:TemplateField HeaderText="Approval-1" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApproval1" Visible="false" runat="server" Text='<%# Eval("Emp_Code1") %>'></asp:Label>
                                            <asp:DropDownList ID="lstApproval1" runat="server" CssClass="DropdownListSearch" Width="200px"></asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="8%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Approval-2" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApproval2" Visible="false" runat="server" Text='<%# Eval("Emp_Code2") %>'></asp:Label>
                                            <asp:DropDownList ID="lstApproval2" runat="server" CssClass="DropdownListSearch" Width="200px"></asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="8%" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Approval-3" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApproval3" Visible="false" runat="server" Text='<%# Eval("Emp_Code3") %>'></asp:Label>
                                            <asp:DropDownList ID="lstApproval3" runat="server" CssClass="DropdownListSearch" Width="200px"></asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="8%" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Approval-4" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApproval4" Visible="false" runat="server" Text='<%# Eval("Emp_Code4") %>'></asp:Label>
                                            <asp:DropDownList ID="lstApproval4" runat="server" CssClass="DropdownListSearch" Width="200px"></asp:DropDownList>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="8%" />
                                    </asp:TemplateField>
...
<%--                        <li class="trvl_date"></li>
    ...
    <br /><br />
    <div class="trvl_Savebtndiv" runat="server" id="DivbuttonAll" visible="false">
