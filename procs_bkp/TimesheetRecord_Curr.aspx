<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TimesheetRecord_Curr.aspx.cs" Inherits="TimesheetRecord_Curr" EnableEventValidation="false" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div>
                    ...
                    <span>
                       <a href="InboxMyTimesheet.aspx" style="margin-right: 10px;" class="aaaa">Back</a>
                    </span>
                </div>
...
<%--                        <div class="cancelbtndiv">
                    ...
                    <div class="editprofile" id="editform1" runat="server" visible="true" style="margin: 7px -17% !important;">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li style="width:43%">
                           ...
                           <%--<br /> <asp:Label runat="server" ID="lblmessageInfo" Visible="True" Text="Records with Idle hours cannot be edited. Add new records for a date and idle hours for that date will be removed/ recalculated automatically. " Style="color: green; font-size: 14px; font-weight: 400; text-align: center;"></asp:Label>--%>
                        ...
                        <li></li>
                        <li style="width:78%" id="hide01" runat="server">
                            <br />
                        ...
                        <li class="date" id="hide1" runat="server">
                            ...
                            <span>Date</span> &nbsp;&nbsp;<span style="color:red">*</span>               
                                 <asp:TextBox ID="txtFromdate" Enabled="true"  AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" Format="dd/MM/yyyy"  TargetControlID="txtFromdate"   runat="server">
                                </ajaxToolkit:CalendarExtender>
                        </li>
                        <li class="leavedays" id="hide7" runat="server">
                             <br />
                        ...
                        <li class="leavedays" id="hide3" runat="server">
                         ...
                         <li class="leavedays" id="hide4" runat="server">
                             <br />
                           <span>Note</span>&nbsp;&nbsp;<br />
                             <asp:TextBox MaxLength="500" TextMode="MultiLine" Rows="6" Width="188%" ID="txtDescription" runat="server" ></asp:TextBox>
                            
                        </li>
                        <li></li>
                        <li id="hide5" runat="server">
                            <asp:LinkButton ID="btnBack" runat="server" CssClass="Savebtnsve" Text="Save" OnClick="btnBack_Click1" OnClientClick="return SaveOutClick();">Save</asp:LinkButton>
                            <asp:LinkButton ID="btnIn" runat="server" Visible="false" CssClass="Savebtnsve" Text="Save" OnClick="btnEdit_Click" OnClientClick="return SaveInClick();">Save</asp:LinkButton>
                        </li>
                        <li>
                        ...
                        <li class="Approver">
                            <br />
                             <span>Record Timesheet List</span>
                            <br />
                            <%--<span>Approver </span>--%>
                            <br />
                            <asp:ListBox Visible="false" ID="lstApprover" runat="server"></asp:ListBox>
                    <asp:GridView ID="DgvApprover" runat="server" BackColor="White" DataKeyNames="Id,Timesheet_id" BorderColor="Navy" PageSize="20" AllowPaging="True" OnPageIndexChanging="DgvApprover_PageIndexChanging" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="107%">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Hours"
                             ...
                             <asp:TemplateField HeaderText="Edit" HeaderStyle-Width="8%"  ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="left">
                                <ItemTemplate>
...
<%--                       <li>
    ...
    <div class="Savebtndiv" id="hide6" runat="server">
    ...
    <div>
        ...
        <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" OnClientClick="return SaveMainSubmitClick()" OnClick="btnback_mng_Click" CssClass="Savebtnsve" >Submit</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdnAppr" runat="server" />
    <asp:HiddenField ID="hdnApp_EmailAddress" runat="server" />
    <asp:HiddenField ID="hdnApp_Emp_Name" runat="server" />
    ...
    <script type="text/javascript">
     ...
     <%--   function ShowTime() {
        ...
        function ConfirmFinal() {
            ...
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            if (confirm("Do you want to final Submit ?")) {
                confirm_value.value = "Yes";
            } else {
                confirm_value.value = "No";
                document.getElementById("<%= hdnInTime.ClientID %>").value = '';
