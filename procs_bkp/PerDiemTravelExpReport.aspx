<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="PerDiemTravelExpReport.aspx.cs" Inherits="PerDiemTravelExpReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Per-diem & Travel Expenses Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date" style="padding-bottom:15px">
                         ...
                         <li class="leavedays" runat="server" visible="true">
                            ...
                            <asp:DropDownList runat="server"  ID="ddlProject" AutoPostBack="false"></asp:DropDownList>
