<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_approvedinvoiceChangeReq.aspx.cs" Inherits="VSCB_approvedinvoiceChangeReq" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Change Invoice TDS Amount if Batach not created"></asp:Label>
                    </span>
                </div>
