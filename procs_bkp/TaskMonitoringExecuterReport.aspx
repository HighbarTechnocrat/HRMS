<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
	CodeFile="TaskMonitoringExecuterReport.aspx.cs" Inherits="TaskMonitoringExecuterReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
	...
	<style>
		...
		#MainContent_btnReset, #MainContent_btnIn {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Task Monitoring Executor Report"></asp:Label>
					</span>
				...
				<div>
					<span>
						<a href="TaskMonitoring.aspx" class="aaaa">Task Monitoring</a>
					</span>
				</div>
				...
				<div class="edit-contact">
					...
					<ul id="editform" runat="server" visible="true">
						...
						<li class="leavedays" runat="server" visible="true">
							<span>Task Supervisor</span>&nbsp;&nbsp;<br />
							<asp:DropDownList runat="server" Enabled="true" ID="ddlTaskExecuter" AutoPostBack="true" OnSelectedIndexChanged="ddlTaskExecuter_SelectedIndexChanged"></asp:DropDownList>
						</li>
						<li runat="server" visible="true"></li>
						<li class="leavedays" runat="server" visible="true">
							<br />
							<span>Task Reference ID</span>&nbsp;&nbsp;<br />
							<asp:DropDownList runat="server" Enabled="true" ID="ddlTaskRefId" AutoPostBack="true" OnSelectedIndexChanged="ddlTaskRefId_SelectedIndexChanged"></asp:DropDownList>
						</li>

						<li class="date">
							<br />
							<span>Task Reference Date From </span>&nbsp;&nbsp;              
                                 <asp:TextBox ID="txtFromdate" Enabled="true" AutoComplete="off" CssClass="TxtHeight" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
						...
						<li class="date">
							...
							<span>Task Reference Date To</span> &nbsp;&nbsp;        
                                 <asp:TextBox ID="txtToDate" AutoComplete="off" runat="server" CssClass="TxtHeight" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged" MaxLength="10" Enabled="true" AutoCompleteType="Disabled"></asp:TextBox>
						...
						<li class="leavedays" runat="server" visible="true">
							...
							<asp:DropDownList runat="server" Enabled="true" ID="ddlTaskId" AutoPostBack="true" OnSelectedIndexChanged="ddlTaskId_SelectedIndexChanged"></asp:DropDownList>
						</li>

						<li class="date">
							<br />
							<span>From Task Due Date </span>&nbsp;&nbsp;              
                                 <asp:TextBox ID="txtDueDateFrom" Enabled="true" CssClass="TxtHeight" AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtDueDateFrom_TextChanged" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
							<ajaxToolkit:CalendarExtender ID="CalendarExtender3" Format="dd/MM/yyyy" TargetControlID="txtDueDateFrom" runat="server">
							</ajaxToolkit:CalendarExtender>
						</li>
						<li class="date">
							<br />
							<span>To Task Due Date </span>&nbsp;&nbsp;        
                                 <asp:TextBox ID="txtDueDateTo" AutoComplete="off" CssClass="TxtHeight" runat="server" AutoPostBack="true" OnTextChanged="txtDueDateTo_TextChanged" MaxLength="10" Enabled="true" AutoCompleteType="Disabled"></asp:TextBox>
							<ajaxToolkit:CalendarExtender ID="CalendarExtender4" Format="dd/MM/yyyy" TargetControlID="txtDueDateTo" runat="server">
							</ajaxToolkit:CalendarExtender>
						...
						<li class="leavedays" runat="server" visible="true">
							<br />
							<span>Status</span>&nbsp;&nbsp;<br />
							<asp:DropDownList runat="server" Enabled="true" ID="ddlStatus" AutoPostBack="false"></asp:DropDownList>
						</li>
						<li><br />
							<span>Overdue Tasks Only</span>&nbsp;&nbsp;<br />
							<asp:CheckBox runat="server" Enabled="true" ID="chkOverdueTasksOnly" AutoPostBack="false" Text="Overdue Tasks Only"></asp:CheckBox>
						</li>
						<li class="leavedays" runat="server" visible="false" id="li1"></li>
					</ul>
					<div style="text-align: center">
						...
						<asp:LinkButton ID="btnReset" runat="server" Visible="true" CssClass="Savebtnsve" Text="Reset" OnClick="btnReset_Click">Reset</asp:LinkButton></li>
					</div>
				...
				<div style="width: 100%; overflow: auto">
					...
					<rsweb:ReportViewer ID="ReportViewer2" runat="server" Height="700px"
						Width="100%" ShowBackButton="False" 
	...
	<script type="text/javascript">      
		$(document).ready(function () {
			$("#MainContent_ddlTaskExecuter").select2();
			$("#MainContent_ddlTaskRefId").select2();
			$("#MainContent_ddlTaskId").select2();
