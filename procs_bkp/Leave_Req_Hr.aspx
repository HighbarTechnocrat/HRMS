<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Leave_Req_Hr.aspx.cs" Inherits="Leave_Req_Hr" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="leavegrid">
                    ...
                    Search Employee: <asp:TextBox ID="txtEmpName_List" runat="server"  placeholder="Enter employee name or code for search"  Width="200px"></asp:TextBox>
                    <asp:LinkButton ID="btnSearch_empHr"  runat="server" Text="Ok" ToolTip="Ok" CssClass="SavebtnsveHr" OnClick="btnSearch_empHr_Click">Ok</asp:LinkButton> 
                ...
                <div class="leavegrid">
                    <h3 id="hrleavedtls_head" runat="server" visible="false">Leave Card - 2020</h3>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li>
                            <asp:Label runat="server" ID="lblmessage2" Visible="True" Style="color: red; font-size: 14px; font-weight: 400; text-align: center;"></asp:Label>
    ...
    <div>
        ...
        <asp:LinkButton ID="btnback_mng" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/MyLeave_Req_6.aspx">Back</asp:LinkButton>
    ...
    <asp:HiddenField ID="hdnEmployeeCode_Leaverequest" runat="server" />

<ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployees" MinimumPrefixLength="1"
CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txtEmpName_List"
