<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="SelfAssessmentCreate.aspx.cs" Inherits="SelfAssessmentCreate" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Self Assessment Index"></asp:Label>
                    </span>
                </div>
            ...
            <%-- You will be covered under Appraisal Cycle of the year 2023-24. <br /> If you are under Notional Rating, you will be assigned the same without going through the assessment process.--%>
                <div class="manage_grid" style="width: 100%; height: auto;">
					<asp:Label ID="lblmsg" runat="server" Text="You will not applicable for current Appraisal cycle.. <br /><br /><br /><br />" ForeColor="Red" Visible="false" Style="font-size:11pt;"></asp:Label>
                    <center>
                          <asp:GridView ID="gvMngRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                            DataKeyNames="App_Year_id,empcode,AssessmentPeriodFrom,AssessmentPeriodTo,EmpPosMappId,ValidFrom,ValidTo,p_s,pyear" OnRowDataBound="gvMngRqstList_RowDataBound"  CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
                        ...
                        <Columns>
                          ...
                          <%--  <asp:BoundField HeaderText="From" 
                            ...
                            <asp:BoundField HeaderText="Assessment Period"
                                DataField="AssessmentPeriod"
                                 ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-HorizontalAlign="Center"
                           ...
                           <asp:TemplateField HeaderText="Details" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" >
                            <ItemTemplate>
                            <asp:LinkButton ID="lnkLeaveDetails" runat="server" Visible="false" Text='Create' OnClick="lnkLeaveDetails_Click">
                            </asp:LinkButton>
                ...
                <asp:Label id="lblgoalmsg" runat="server"></asp:Label>
                 <span id="lblPOWO_Content" runat="server"></span>
                <asp:HiddenField ID="hdnAppYearTypeid" runat="server" />
                 <asp:HiddenField ID="hdnempcode" runat="server" />
                 <asp:HiddenField ID="hdnAssessmentPeriodFrom" runat="server" />
                 <asp:HiddenField ID="hdnAssessmentPeriodTo" runat="server" />
                ...
                <asp:HiddenField ID="hdnValidFrom" runat="server" />
                <asp:HiddenField ID="hdnValidTo" runat="server" />
                <asp:HiddenField ID="hdn_ps" runat="server" />
                <asp:HiddenField ID="hdn_pyear" runat="server" />
