<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="EmployeeCVReviewInbox.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="EmployeeCVReviewInbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Verify Employee Data"></asp:Label>
                    </span>
                </div>
                <%-- <div>
                ...
                <div>
                    <span style="margin-bottom: 20px">
                        <a href="IndexEmployeeCV.aspx" style="margin-right: 18px;" class="aaaa">CV Update</a>&nbsp;&nbsp;<br />
                    </span>
    ...
    <div class="mobile_Savebtndiv" style="display: none">
    ...
    <div class="manage_grid" style="width: 100%; height: auto;">
        <asp:GridView ID="gvRecruterInoxList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px"
            DataKeyNames="Emp_id" CellPadding="3" AutoGenerateColumns="False" Width="100%" OnPageIndexChanging="gvRecruterInoxList_PageIndexChanging" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Project Location" DataField="emp_projectName"
                    HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%" />

                <asp:BoundField HeaderText="Reporting Manager" DataField="RMName"
        ...
        <asp:GridView ID="GVInterviewfeedback" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="solid" BorderWidth="1px"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Requisition Status"
                    ...
                    ItemStyle-HorizontalAlign="center" ItemStyle-Width="8%" ItemStyle-BorderColor="Navy" />
                ...
                <asp:BoundField HeaderText="Selection Status" DataField="InterviewFeedback" ItemStyle-HorizontalAlign="center"
                    ItemStyle-Width="10%" ItemStyle-BorderColor="Navy" />
