<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Fuel_Req_ArchNew.aspx.cs" 
    Inherits="procs_Fuel_Req_ArchNew" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="fuel_claimed">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_tollcharge" runat="server" MaxLength="10"  Enabled="false"></asp:TextBox>
                        </li>
                       
                        <li class="fuel_claimed">
                            <span> Airport Parking(If Any) </span>
                            <asp:TextBox AutoComplete="off" ID="txt_AirportParking1" runat="server" MaxLength="10"  Enabled="false"></asp:TextBox>
