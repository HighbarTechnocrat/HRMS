<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="FuelSummaryReport.aspx.cs" Inherits="FuelSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="userposts">
        <span>
            <asp:Label ID="lblheading" runat="server" Text="Fuel Claim Summary Report"></asp:Label>
        </span>
    </div>
    ...
    <div class="edit-contact">
        ...
        <ul>
            <li>
                <span runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Select Year </span>
                <br />
                <%--<span style="color:red">*</span> --%>
                <asp:DropDownList ID="ddlYear" CssClass="DropdownListSearch" runat="server">
                </asp:DropDownList>
            </li>
        </ul>
