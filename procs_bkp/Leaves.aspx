<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Leaves.aspx.cs" Inherits="Leaves" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Leaves"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                            <a href="HolidayList.aspx" class="aaaa">Holiday List</a>
                        </span>
                    </div>
                        ...
                        <div class="editprofileform">
                            ...
                            <table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 4px">
                                    ...
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_TeamCalendar" Visible="true" runat="server" PostBackUrl="~/procs/TeamReport.aspx">Team Calendar</asp:LinkButton>
                                    </td>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    ...
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leavereport" runat="server" Text="Leave Report - Team" Visible="false" PostBackUrl="~/procs/LeavesReport_Mgr.aspx">Leave Report - Team</asp:LinkButton>
                                    </td>
                                    <%--                                    <td class="formtitle">
                                        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/procs/TeamReport.aspx">Team Calendar</asp:LinkButton>                                                
                                    </td>--%>
                                </tr>
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle">
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    ...
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leavereport_Hr" runat="server" Text="Leave Report - HR" Visible="false" PostBackUrl="~/procs/LeavesReport_Hr.aspx">Leave Report - HR</asp:LinkButton>
                                    </td>
                                </tr>

                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle">
                                        <%--<asp:LinkButton ID="lnk_leaveencashment" Visible="true" runat="server" PostBackUrl="~/procs/Encash_leave.aspx">Leave Encashment</asp:LinkButton>--%>
