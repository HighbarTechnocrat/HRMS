<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" ValidateRequest="false"
	CodeFile="Req_RequisitionIndex.aspx.cs" Inherits="Req_RequisitionIndex" %>
				...
				<div class="manage_grid" style="width: 100%; height: auto; padding-top: 20px;">
					...
					<center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="Recruitment_ReqID,Request_status"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging"  OnRowDataBound="gvMngTravelRqstList_RowDataBound" >
