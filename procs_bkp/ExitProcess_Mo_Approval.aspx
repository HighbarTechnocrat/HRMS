<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
	CodeFile="ExitProcess_Mo_Approval.aspx.cs" Inherits="procs_ExitProcess_Mo_Approval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
		...
		<div class="commonpages">
			<div class="wishlistpagediv">
				<span>
				    ...
				    <a href="ExitProcess_Mo_Index.aspx?type=Pending" style="margin-right: 18px;" visible="false" runat="server" id="btBack" class="aaaa">Back</a>&nbsp;&nbsp; 
				   <a href="ExitProcess_Mo_Index.aspx?type=APP" style="margin-right: 18px;" visible="false" runat="server" id="btBack1" class="aaaa">Back</a>&nbsp;&nbsp; 
				...
				<div class="edit-contact">
					<ul id="editform" runat="server" visible="true">
						...
						<li class="mobile_InboxEmpName">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtEmployeeName" Enabled="false" runat="server"></asp:TextBox>
						...
						<li class="mobile_inboxEmpCode">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtRetentionType" Enabled="false" runat="server"></asp:TextBox>
						
						</li>
						<li class="mobile_inboxEmpCode">
							<div runat="server" id="Effect" visible="false">
						...
						<li class="mobile_inboxEmpCode">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtRetentionFromDate" runat="server" CssClass="OfferDates" Enabled="false" ></asp:TextBox>
						...
						<li class="mobile_inboxEmpCode">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtRetentionTillDate" runat="server" Enabled="false" CssClass="OfferDates" ></asp:TextBox>
						...
						<li class="mobile_inboxEmpCode">
							...
							<br />
							<asp:TextBox AutoComplete="off" ID="txtRemark" runat="server" Enabled="false" Style="width: 84%;" CssClass="noresize"  Rows="5" TextMode="MultiLine" onKeyUp="javascript:CountRemark(this);" ></asp:TextBox>
						</li><li></li>
						<li>
					...
					<ul id="UlModeration" runat="server">
						<hr />
						<li class="mobile_inboxEmpCode">
							<br />
						...
						<li>
							<div id="ApprovalDate" runat="server" visible="false" >
						...
						<li></li>
						<li>
							<span>Upload Revised Letter </span><span style="color:red">*</span>
							<br />
					...
					<div class="Req_Savebtndiv" style="text-align: center">
						...
						<asp:LinkButton ID="lnk_Cancle" Visible="true" runat="server" Text="Back" ToolTip="Back" CssClass="Savebtnsve" PostBackUrl="~/procs/ExitProcess_Mo_Index.aspx?Type=Pending"></asp:LinkButton>
	...
	<script type="text/javascript">
		...
		function DownloadMFile() {
			...
			var FileName = document.getElementById("<%=lnkRevisedFile.ClientID%>").innerText;
