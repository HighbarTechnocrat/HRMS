<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Appraisal_HODCalendar.aspx.cs" Inherits="Appraisal_HODCalendar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="View Performance Appraisal Forms"></asp:Label>
                    </span>
                </div>

                <span>
                    <a href="Appraisalindex.aspx" class="aaaa" >Appraisal Index</a><div><br /><br /></div>
                </span>

               <div class="projectlist1">             
                    <div class="projectlistddl">
                    <asp:TextBox ID="txtcompanysearch" visible="true"  placeholder="Enter company for search" runat="server" CssClass="txtbox" ></asp:TextBox>
                    

                    </div>
                    <div class="projectlistddl">
                    <asp:TextBox ID="txtlocation" placeholder="Enter location for search" runat="server" CssClass="txtbox" ></asp:TextBox>
			        
		            </div>
                    <div class="projectlistddl">
                        <asp:TextBox ID="txtdepartmentsearch" visible="true"  placeholder="Enter department for search" runat="server" CssClass="txtbox" ></asp:TextBox>
			        
		            </div>
                    <div class="project-text-box">              
                    <asp:TextBox ID="txtemployee" visible="true" runat="server"  placeholder="Employee Name" Width="100" CssClass="txtbox" ></asp:TextBox>           
                    </div>
                    
             </div>
             <div class="hodcal">
                 <span class="projectsearch" >
                 <asp:LinkButton ID="projectsearchbtn" runat="server" ToolTip="Search"  OnClick="lnksearch_Click"
                ...
                <asp:LinkButton ID="projectresetbtn" OnClick="lnkreset_Click" ToolTip="Reset Search" TabIndex="4" runat="server"><i class="fa fa-undo" aria-hidden="true"></i>
                 ...
                 <span>
                 <asp:Button ID="btnExport" runat="server" Text="Export To Excel"  visible="false" style="background-color:#febf39;font-size: 12px;" OnClick = "ExportToExcel" />
                        </span>
                <div class="manage_grid" style="width: 100%; height: auto;"><br />
                    <center>
                       <asp:GridView ID="gvMngSelfAssessList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" 
                            DataKeyNames="assess_id,pyear,rev_type"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="10" AllowPaging="True"  OnRowDataBound="gvMngSelfAssessList_RowDataBound" OnPageIndexChanging="gvMngSelfAssessList_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Reviewee"
                             ...
                             <asp:BoundField HeaderText="Reviewer (N1)"
                                ...
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy"/>
                             <asp:BoundField HeaderText="Final Reviewer (N2)"
                                DataField="FinalReviewer"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="left"
                                ItemStyle-BorderColor="Navy"/>
                             <asp:BoundField HeaderText="Additional Reviewer (AD1)"
                          ...
                          <asp:BoundField HeaderText="Status"
                            ...
                            <asp:TemplateField HeaderText="Details" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" >
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkLeaveDetails" runat="server" Visible="true" Text='View' OnClick="lnkLeaveDetails_Click">
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchDepartments" MinimumPrefixLength="1"
      ...
      <ajaxToolkit:AutoCompleteExtender ServiceMethod="SearchEmployee" MinimumPrefixLength="1"
        CompletionInterval="1" EnableCaching="false" CompletionSetCount="1" TargetControlID="txtemployee"
