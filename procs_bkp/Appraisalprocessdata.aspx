<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Appraisalprocessdata.aspx.cs" Inherits="Appraisalprocessdata" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div style="display:none">
                    <span>PO/ WO No.</span>&nbsp;&nbsp;<br />
                        ...
                        <span>Invoice No.</span>&nbsp;&nbsp;<br />
                            <asp:DropDownList runat="server" ID="lstInvoiceNo" CssClass="DropdownListSearch"></asp:DropDownList>

                       <span>Vendor Name</span>&nbsp;&nbsp;<br />
                            <asp:DropDownList runat="server" ID="lstVendorName" CssClass="DropdownListSearch"></asp:DropDownList>

                       <span>Payment Req. From Date</span>&nbsp;&nbsp;
                             <br />
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server">
                        <li style="padding-top: 30px">
                             <span>Performance Appraisal Year</span>&nbsp;&nbsp;<br />
                            <asp:DropDownList runat="server" ID="lstPMS_Year" CssClass="DropdownListSearch"></asp:DropDownList>
                                <asp:FileUpload ID="ploadexpfile" Visible="false" runat="server" AllowMultiple="true" accept=".xls,.xlsx" Width="50%"></asp:FileUpload>
                        </li>
                        <li style="padding-top: 30px">
                ...
                <div class="mobile_Savebtndiv" style="margin-top: 20px !important;"> 
                    ...
                    <asp:LinkButton ID="mobile_btnSave" runat="server" Text="View PMS Appraisal Data" ToolTip="View PMS Appraisal Data" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click">View PMS Appraisal Data</asp:LinkButton>
                    </span> 
                <span>
                    <asp:LinkButton ID="mobile_btnBack" runat="server" Visible="false" Text="Clear Search" OnClick="mobile_btnBack_Click" ToolTip="Clear Search" class="trvl_Savebtndiv">Clear Report</asp:LinkButton>
                </span>
                <span>
