...
public partial class procs_ExitProc_TeamExitInterviewForm : System.Web.UI.Page
{
    ...
    private void getTeamExitInterviewFormList()
    {
        try
        {
            ...
            dtExitFrm = spm.GetTeamExitInterviewFormDetails(strempcode);
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("ExitProccess_InterviewForm.aspx?resignationid=" + hdnReqid.Value+"&Type=View");
