<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="Update_Photo_index.aspx.cs" Inherits="Update_Photo_index" %>
            ...
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts"> <br />
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Upload Photo"></asp:Label>
                        </span>
                    </div>
                    <div>
                        <span>
                            ...
                            <table>
                                ...
                                <tr style="padding-top: 1px; padding-bottom: 2px;">
                                    <td class="formtitle" id="td1" runat="server">
                                        <asp:LinkButton ID="lnk_leaveinbox" runat="server" Visible="true" ToolTip="Upload Photo" PostBackUrl="~/procs/Update_Photo.aspx"  >Employee Upload Photo</asp:LinkButton>
                                    </td>
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_MobACC" runat="server" Visible="true" ToolTip="Approve Employee Photo" PostBackUrl="~/procs/View_updatephoto_forhr.aspx">Approve Employee Photo(0)</asp:LinkButton>
                                    </td>
                                </tr>

                                 <tr style="padding-top: 1px; padding-bottom: 2px;"> 
                                 <td class="formtitle">
                                     <asp:LinkButton ID="lnk_leaverequest" runat="server" Visible="true" ToolTip="Photo Update Report" PostBackUrl="~/procs/Update_Photo_Report.aspx">Photo Update Report</asp:LinkButton>
                                <br /> <br /><br /><br />
                                     </td>
                             </tr>
