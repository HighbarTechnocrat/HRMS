<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="VSCB_InvoiceView.aspx.cs" Inherits="VSCB_InvoiceView" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Approved Invoices"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    <ul id="editform" runat="server">
                        ...
                        <li style="padding-top: 30px">
                           <span>Vendor Name</span>&nbsp;&nbsp;
                            ...
                            <span style="display:none">PO/ WO Date</span>                               
                            <asp:DropDownList runat="server" Visible="false" CssClass="DropdownListSearch" ID="lstPOWODate">
                            </asp:DropDownList>
                        </li>
                        <li style="padding-top: 30px">
                        ...
                        <li style="padding-top: 15px">
                            ...
                            <span style="display:none">Invoice Date</span>                             
                            <asp:DropDownList runat="server" Visible="false" CssClass="DropdownListSearch" ID="lstpInvoiceDate">
                            </asp:DropDownList>
                        </li>
                        <li style="padding-top: 15px">
                  ...
                  <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                        DataKeyNames="InvoiceID" CellPadding="3" AutoGenerateColumns="False" Width="125%" EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnPageIndexChanging="gvMngTravelRqstList_PageIndexChanging">
                        ...
                        <Columns> 
                          ...
                          <asp:BoundField HeaderText="Vendor Name"
                            ...
                            <asp:BoundField HeaderText="Invoice Base Amount"
                                DataField="AmtWithoutTax"
                                ItemStyle-HorizontalAlign="Right"
                                HeaderStyle-HorizontalAlign="Right"
                                ItemStyle-BorderColor="Navy" />

                             <asp:BoundField HeaderText="Invoice Amount with Tax"
                             ...
                             <asp:BoundField HeaderText="Direct Tax Amount"
                              ...
                              <asp:BoundField HeaderText="Final Payable"
                            ...
                            <asp:BoundField HeaderText="Invoice Status"
