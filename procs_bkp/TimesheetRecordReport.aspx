<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="TimesheetRecordReport.aspx.cs" Inherits="TimesheetRecordReport" EnableEventValidation="false" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="My Timesheet Report"></asp:Label>
                    </span>
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="date">
                            ...
                            <span>To Date</span> &nbsp;&nbsp;<span style="color:red">*</span>               
                                 <asp:TextBox ID="txtToDate"  AutoComplete="off" runat="server" AutoPostBack="true" OnTextChanged="txtFromdate_TextChanged" MaxLength="10" Enabled="false" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="leavedays" runat="server" visible="false" id="li2">
                            <span>Select Project</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                            <asp:DropDownList Visible="false" runat="server" ID="ddlProject"></asp:DropDownList>
                            <asp:TextBox runat="server" ID="txtProject"></asp:TextBox>
                        </li>

                        
                        <li class="leavedays" runat="server" visible="false" id="li3">
                           <span>Select Task</span>&nbsp;&nbsp;<span style="color:red">*</span><br />
                            <asp:DropDownList Visible="false" runat="server" ID="ddlTask"></asp:DropDownList>
                            <asp:TextBox runat="server" ID="txtTask"></asp:TextBox>
                        </li>
                        <li>
                           
                            <asp:LinkButton ID="btnIn" runat="server" Visible="true" CssClass="Savebtnsve" Text="Submit" OnClick="btnIn_Click" OnClientClick="return SaveInClick();">Submit</asp:LinkButton>
                        </li>
                        <li></li>
                        <li></li>
                        <li></li>
                        ...
                        <li></li>
                        <li>
                            <asp:LinkButton ID="LinkButton1" runat="server" Visible="false" CssClass="Savebtnsve" Text="Submit" OnClick="ExportToExcel">Submit</asp:LinkButton>
                        </li>
