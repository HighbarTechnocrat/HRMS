<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ExpenseWithoutTravlReqst.aspx.cs" Inherits="myaccount_ExpenseWithoutTravlReqst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Travel Expenses Request"></asp:Label>
                    </span>
                </div>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server">
                        ...
                        <li class="trvl_grid" id="litrvlgrid" runat="server">
                            ...
                            <div>
                                ...
                                <asp:GridView ID="dgTravelRequest" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                     DataKeyNames="trip_id,Exptrip_dtls_id" >
                                    ...
                                    <Columns>
                                     ...
                                     <%--   <asp:TemplateField HeaderText="Through Travel Desk">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkCOS" runat="server" Checked='<%#Convert.ToBoolean(Eval("tt")) %>' />
                        ...
                        <li class="trvl_Advances" id="litrvlAdvnce" runat="server">
                            <span id="spnadvrequired" runat="server">Advances Required: </span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtAdvance" runat="server" MaxLength="100"></asp:TextBox>
                        </li>
                        <li class="trvl_Currency" id="litrvlcurrency" runat="server">
                            <span id="lbl_cur" runat="server" visible="false">Currency Required:</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txtreqCur" runat="server" MaxLength="100" Visible="false"></asp:TextBox>
                        </li>
                        ...
                        <li class="trvl_grid"  id="litrvlgridAccomodation" runat="server">
                            <div>
                                ...
                                <asp:GridView ID="dgAccomodation" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                   DataKeyNames="trip_id,local_accomodation_id" >
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvl_grid">
                            <div>
                                ...
                                <asp:GridView ID="dgLocalTravel" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="100%" EditRowStyle-Wrap="false"
                                    DataKeyNames="trip_id,local_travel_id">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" />
                                    <PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
                                    <RowStyle ForeColor="#000066" />
                        ...
                        <li class="trvl_Approver" id="lsttrvlapprover"  runat="server">
                            <%--<span>Approver </span>--%>
                            <br />
                            <asp:ListBox ID="lstApprover" runat="server" Visible="false"></asp:ListBox>
                        </li>
                        ...
                        <span>Daily Halting Allowance (INR) </span>
                         <asp:TextBox AutoComplete="off" ID="txtdailyhaltingallowance" runat="server" MaxLength="10" Enabled="true"></asp:TextBox>
                     </li>
                  
                     <li class="trvl_local">
                        <span>Total Amount Claimed</span>
                         <asp:TextBox AutoComplete="off" ID="txtTotAmtClaimed" runat="server" MaxLength="10" Enabled="true"></asp:TextBox>
                     </li>
                     ...
                     <li class="trvl_local">
                        <span>Net Payable to Company</span>
                         <asp:TextBox AutoComplete="off" ID="txtnetPaybltoComp" runat="server" MaxLength="10" Enabled="true"></asp:TextBox>
                     </li>
                  
                     <li class="trvl_local">
                        <span>Net Payable to Employee</span>
                         <asp:TextBox AutoComplete="off" ID="txtnetPaybltoEmp" runat="server" MaxLength="10" Enabled="true"></asp:TextBox>
                     </li>
                   
                     <li class="trvl_local">
                        <span>Reason For Deviation</span>
                         <asp:TextBox AutoComplete="off" ID="txtReasonDeviation" runat="server" MaxLength="100"></asp:TextBox>
                     </li>
                    
                     <li class="trvl_local">
                        <span>Upload File</span>
                         <asp:FileUpload ID="ploadexpfile" runat="server"></asp:FileUpload>
                     </li>
    ...
    <div class="trvl_Savebtndiv">
        <asp:LinkButton ID="trvl_btnSave" runat="server" Text="Submit" ToolTip="Save" CssClass="Savebtnsve" OnClick="trvl_btnSave_Click">Submit</asp:LinkButton>
