<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Attend_Req_C_App.aspx.cs" Inherits="Attend_Req_C_App" %>
...
<%--                        <li class="upload">
    ...
    <div>
        ...
        <span style="display:none">
            <asp:LinkButton ID="btnCorrection" Visible="false" runat="server" Text="Correction" ToolTip="" CssClass="Savebtnsve">Send for Correction</asp:LinkButton>
        </span>
