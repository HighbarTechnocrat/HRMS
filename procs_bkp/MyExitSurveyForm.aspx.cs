...
public partial class procs_MyExitSurveyForm : System.Web.UI.Page
{
    ...
    private void getMyExitSurveyFormList()
    {
        try
        {
            // DataSet dsList = new DataSet();

            dtExitFrm = spm.GetMyExitFormDetails(strempcode);
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("ExitProcess_SurveyForm.aspx?resignationid=" + hdnReqid.Value);
