<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ABAP_Prd_TimeSheet_PMApprove.aspx.cs"
    MaintainScrollPositionOnPostback="true"
    Inherits="procs_ABAP_Prd_TimeSheet_PMApprove" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <ul id="editform" runat="server" visible="true">
                        ...
                        <li class="mobile_inboxEmpCode">
                            <span>Week Start Date</span>&nbsp;&nbsp;                
                                <asp:TextBox ID="txtFromdate" AutoComplete="off" runat="server" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                      ...
                      <asp:TextBox ID="txtToDate" AutoComplete="off" runat="server" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <li class="trvl_grid" runat="server" id="idliCostCenterList_ACC">
                            ...
                            <asp:GridView ID="dgTimesheetView" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Project Name" DataField="Comp_Code" ItemStyle-CssClass="gridviewpaddingleft"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />

                                    <asp:TemplateField HeaderText="Object No." HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:HiddenField ID="HDComp_Code" runat="server" Value='<%# Eval("comp_codee") %>' />
                                            <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                            <asp:HiddenField ID="HDUpdateID" runat="server" Value='<%# Eval("IDEdit") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="center" Width="2%" />
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="Is Completed" DataField="IsCompleted" ItemStyle-CssClass="gridviewpaddingleft"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="1%" />

                                    <asp:BoundField HeaderText="Object Name (TCode)" DataField="ObjectCode" ItemStyle-CssClass="gridviewpaddingleft"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="8%" />
                                    <asp:BoundField HeaderText="Object Type" DataField="Object_TypeName" ItemStyle-CssClass="gridviewpaddingleft"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="8%" />

                                    <asp:BoundField HeaderText="Object Description" DataField="ObjectDescription" ItemStyle-CssClass="gridviewpaddingleft"
                                        HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />

                                    <asp:TemplateField HeaderText="Approver Status" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="lstIsCompleted" runat="server" Width="100px" CssClass="DropdownListSearch">
                                    ...
                                    <asp:TemplateField HeaderText="Approver Remarks" ItemStyle-Width="15%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TxtPMRemarks" MaxLength="200" TextMode="MultiLine" Text='<%# Eval("PMRemarks") %>' AutoComplete="off" runat="server" Width="10px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <div class="mobile_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Text="Approve" ToolTip="Save" CssClass="Savebtnsve" OnClientClick="return SaveMultiClick();" OnClick="mobile_btnSave_Click">Approve</asp:LinkButton>
