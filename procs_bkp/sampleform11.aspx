...
<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="sampleform11.aspx.cs" Inherits="myaccount_SampleForm" %>
            ...
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        ...
                        <asp:Label ID="lblheading" runat="server" Text="Inbox Attendance Regularization"></asp:Label>
                    </span>
                </div>
...
<div class="containerDiv11">
  
  
  <div class="rowDivSL11">
    <div class="cellDivview11">Request Date</div>
    <div class="cellDivview11">Applicant</div>
    <div class="cellDivview11">Details</div>
  </div>

    <div class="rowDiv">
   <div class="cellDivView11">16/09/2017</div>
    <div class="cellDivView11">Ashok Wani</div>
     <div class="cellDivView11">View</div>
