<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
    CodeFile="Recruitment_index.aspx.cs" Inherits="Recruitment_index" %>
        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    ...
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="Recruitment Module"></asp:Label>
                        </span>
                    </div>
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_leaverequest" runat="server"  OnClick="lnk_leaverequest_Click">New Candidate Details</asp:LinkButton>                                         
                                    </td>
                                </tr>
                                <tr style="padding-top:1px;padding-bottom:4px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/ManageRecruitments.aspx">Manage Candidate Details</asp:LinkButton>
                                        
                                    </td>
                                </tr>
                                   <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_Attendancereg" runat="server"   OnClick="lnk_Attendancereg_Click">Position Creation</asp:LinkButton>
                                        
                                    </td>
                                </tr>
                                   <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_Attendancereg" runat="server"  PostBackUrl="~/procs/ManagejobPositions.aspx">Manage Position</asp:LinkButton>
                                    </td>
                                </tr>
                              <tr style="padding-top:1px;padding-bottom:2px;">
                                    <td class="formtitle">
                                          <asp:LinkButton ID="lnk_leavereport" runat="server" Visible="false" PostBackUrl="~/procs/RecruitmentsPositions.aspx">Position List</asp:LinkButton>
                                    </td>
                                </tr> 
