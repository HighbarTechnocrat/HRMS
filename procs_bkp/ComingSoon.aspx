<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="ComingSoon.aspx.cs" Inherits="ComingSoon" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Coming Soon..."></asp:Label>
                    </span>
                </div>

                <div class="editprofile" id="Div1" runat="server" visible="false">
                        <div class="editprofileform">
