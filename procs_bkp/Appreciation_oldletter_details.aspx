                    ...
                    <div >
                       ...
                       <%-- <li  > 
                            ...
                            <span>Letter Description</span>&nbsp;&nbsp;<span style="color:red">*</span><br /> 
                               <div id="HtmlFiter">                        
                        <textarea runat="server" id="txtDescription"  cols="300" rows="30"></textarea>
                         <asp:HiddenField ID="hdnDescription" runat="server" />
                          <asp:RequiredFieldValidator  ID="rfvDescription" runat="server" ControlToValidate="txtDescription"  ErrorMessage="Description is required!" Display="Dynamic" ForeColor="Red" EnableClientScript="true" SetFocusOnError="true" />
