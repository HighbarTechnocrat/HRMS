...
public partial class procs_ABAP_Prd_TimeSheetAppList : System.Web.UI.Page
{
    ...
    private void getTimeListList()
    {
        try
        {
            ...
            spars[0].Value = "GetApproverTimeSheetList";
    ...
    protected void lnkEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("~/procs/ABAP_Prd_TimeSheet_PMApprove.aspx?ID=" + HFIDD.Value);
    }
