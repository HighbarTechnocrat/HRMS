<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
	CodeFile="Req_Offer_View.aspx.cs" Inherits="procs_Req_Offer_View" %>
	...
	<div class="commpagesdiv">
		<div class="commonpages">
			<div class="wishlistpagediv">
				<div class="userposts">
					<span>
						<asp:Label ID="lblheading" runat="server" Text="Offer View Request"></asp:Label>
					</span>
				</div>
				<div>
				...
				<div>
					...
					<span>
						<a href="Req_Offer_Index.aspx?itype=APP" title="Back" runat="server" id="btnRecBack" style="margin-right: 10px;" class="aaaa">Back</a>
					</span>
				</div>
					...
					<ul id="editform" runat="server">
							...
							<ul>
								...
								<li class="trvl_date Req_Salary">
									<div>
										...
										&nbsp;  To  &nbsp;
                            <asp:TextBox AutoComplete="off" ID="txtSalaryRangeTo" CssClass="SalaryRange" runat="server" MaxLength="5"></asp:TextBox>
									</div>
								</li>
								<li class="trvl_date Req_Salary">
						...
						<div id="Div_CanDetails" class="edit-contact" runat="server" visible="false">
                            ...
                            <br />
										...
										<li class="trvl_date" style="padding-bottom: 5px">
											<br />
                            ...
                            <br />
										...
										<li class="mobile_grid" style="margin-bottom: 0px" runat="server" id="SpanEducationDetails1">
                            ...
                            <br />
										...
										<li class="mobile_grid" style="margin-bottom: 0px" runat="server" id="SpanWorkExperiencedetail1">
											<span runat="server" id="SpanWorkExperiencedetail"></span>
										</li>
										<li runat="server" id="SpanWorkExperiencedetail2"></li>
										<asp:GridView ID="GVWorkExperiencedetail" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="80%"
						...
						<div id="Div_Oth" class="edit-contact" runat="server" visible="true">
							...
							<ul>
								...
								<li><span>Probable Joining Date </span>&nbsp;&nbsp;<span style="color: red">*</span>
									<br />
								...
								<br />
								<br />
								<asp:GridView ID="GRDOfferHistory" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="96%"
									DataKeyNames="OtherFileAttach_ID">
									<FooterStyle BackColor="White" ForeColor="#000066" />
									<HeaderStyle BackColor="#C7D3D4" Font-Bold="True" ForeColor="#3D1956" HorizontalAlign="Center" />
									<PagerStyle ForeColor="#000066" HorizontalAlign="left" BackColor="White" />
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="Files View" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="5%">
											<ItemTemplate>
												<asp:ImageButton ID="lnkViewFiles" runat="server" ToolTip=" File View" Width="15px" Height="15px" Visible='<%# String.IsNullOrEmpty(Convert.ToString(Eval("Offer_Approval_File"))) ? false : true %>' ImageUrl="~/Images/Download.png" OnClientClick=<%# "DownloadFilemultipleOffer('" + Eval("Offer_Approval_File") + "')" %> />
											</ItemTemplate>
											<ItemStyle HorizontalAlign="Center" />
										</asp:TemplateField>
									</Columns>
		...
		<div class="mobile_Savebtndiv">
			<asp:LinkButton ID="mobile_btnSave" runat="server" Text="Approval" ToolTip="Approval" CssClass="Savebtnsve" Visible="false" OnClientClick="return SaveMultiClick();">Approval</asp:LinkButton>
			<asp:LinkButton ID="mobile_cancel" runat="server" Text="Reject" ToolTip="Reject" CssClass="Savebtnsve" OnClick="mobile_cancel_Click" Visible="false" OnClientClick="return RejectMultiClick();">Reject</asp:LinkButton>
