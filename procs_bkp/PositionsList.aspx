<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitments.master" AutoEventWireup="true"
     CodeFile="PositionsList.aspx.cs" Inherits="PositionsList" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Position List"></asp:Label>
                    </span>
                </div>
                ...
                <div class="manage_grid" style="width: 90%; height: auto;">
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="pos_id"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Position Description"
                                DataField="position_desp"
                                ItemStyle-HorizontalAlign="left"
                                HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-Width="20%" />
                            
                           <asp:TemplateField HeaderText="attach Resume" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                            <asp:LinkButton ID="lnkLeaveDetails" runat="server" Text='Add Resume' OnClick="lnkLeaveDetails_Click">
                            </asp:LinkButton>                           
                            </ItemTemplate>
