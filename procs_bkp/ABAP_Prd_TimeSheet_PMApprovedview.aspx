<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ABAP_Prd_TimeSheet_PMApprovedview.aspx.cs" 
    Inherits="procs_ABAP_Prd_TimeSheet_PMApprovedview" MaintainScrollPositionOnPostback="true" %>
     ...
     <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div>
                    <span>
                        <a href="Timesheet.aspx" class="aaaa">ABAP Obeject Completion Index</a>
                    </span>
                </div>
                       ...
                       <br /><br />
                            ...
                            <asp:GridView ID="dgTimesheetView" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
								...
								<Columns>
                                    ...
                                    <asp:TemplateField HeaderText = "Object No." HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="100" ><ItemTemplate>
                                    <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                     ...
                                     <asp:BoundField HeaderText="Object Type" DataField="ObjectTypeName" ItemStyle-CssClass="gridviewpaddingleft"
					                 HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%" />
                                    ...
                                    <asp:BoundField HeaderText="Approver Status" DataField="PMStatus" ItemStyle-CssClass="gridviewpaddingleft"
					                 HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="5%" />

                                    <asp:BoundField HeaderText="Approver Remarks" DataField="PMRemarks" ItemStyle-CssClass="gridviewpaddingleft"
					                 HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%" />
