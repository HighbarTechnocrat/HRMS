<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" 
    CodeFile="Req_Questionnaire_Search.aspx.cs" Inherits="Req_Questionnaire_Search" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Search Questionnaire Recruitment"></asp:Label>
                    </span>
                </div>
                 <div>
    ...
    <div class="mobile_Savebtndiv">
        <asp:LinkButton ID="mobile_btnSave" runat="server" Text="Filter Questionnaire" ToolTip="Filter Questionnaire" CssClass="Savebtnsve" OnClick="mobile_btnSave_Click"  OnClientClick="return SaveMultiClick();">Filter Questionnaire</asp:LinkButton>
      ...
      <div class="manage_grid" style="width: 100%; height: auto; padding-top:40px;">
                    ...
                    <center>
                          <asp:GridView ID="gvMngTravelRqstList" runat="server" BackColor="White" BorderColor="Navy" BorderStyle="Solid" BorderWidth="1px"
                            DataKeyNames="AssignQuestionnaire_ID"   CellPadding="3" AutoGenerateColumns="False" Width="100%"   EditRowStyle-Wrap="false" PageSize="20" AllowPaging="True" OnRowCommand="gvMngTravelRqstList_RowCommand1" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField  HeaderText="File View" HeaderStyle-Width="10%">  
                             <ItemTemplate>  
     ...
     <div class="mobile_Savebtndiv">
     <asp:LinkButton ID="mobile_cancel" runat="server" Text="Cancel" ToolTip="Select Questionnaire File" CssClass="Savebtnsve" OnClick="mobile_cancel_Click" OnClientClick="return CancelMultiClick();"  Visible="false">Select Questionnaire File</asp:LinkButton>      
         </div>
     <br />
