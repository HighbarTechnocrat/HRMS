<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" CodeFile="ABAP_ObjectCompletionReport.aspx.cs" Inherits="procs_ABAP_ObjectCompletionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       ...
       <div class="userposts">
            <span>
                <asp:Label ID="lblheading" runat="server" Text="ABAP Object Completion Report"></asp:Label>
            </span>
        </div>
       ...
       <div class="edit-contact">
           ...
           <ul>
               <li>
                   <span id="spn_dept" runat="server" style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Object Type </span><br />
                   <asp:DropDownList ID="ddlObjectType" CssClass="DropdownListSearch" runat="server"  Width="230px">
                      
                   </asp:DropDownList>
               </li>
               <li>
                   <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Employee Name </span>
                   <asp:DropDownList ID="DDLEmployee" CssClass="DropdownListSearch" runat="server" Width="230px">
                      
                   </asp:DropDownList>
               </li>
               <li>
                   <span style="font-weight: normal; font-size: 14px; color: hsl(0, 0%, 0%);">Project Name </span>
                   <asp:DropDownList ID="DDLprojectName" CssClass="DropdownListSearch" runat="server" Width="230px">
