...
public partial class procs_Custs_InboxService_AllRequest : System.Web.UI.Page
{
    ...
    protected void InboxTravelReqstList_TDCOSACC()
    {
        try
        {
            ...
            dsTrDetails = spm.CustomerService_GetInboxAllServiceRequest(Convert.ToString(hdnEmpCode.Value), start1, end1);
            //Travel Request Count
    ...
    protected void lnkEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        GridViewRow row = (GridViewRow)btn.NamingContainer;
        hdnRemid.Value = Convert.ToString(gvMngTravelRqstList.DataKeys[row.RowIndex].Values[0]).Trim();
        Response.Redirect("~/procs/CustsService_Req_View.aspx?id=" + hdnRemid.Value + "&type=arr");
    }
