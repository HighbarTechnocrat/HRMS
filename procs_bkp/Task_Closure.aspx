<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
    CodeFile="Task_Closure.aspx.cs" ValidateRequest="false" Inherits="Task_Closure" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Task Closure Request"></asp:Label>
                    </span>
                </div>
                <div>
                ...
                <span runat="server" id="backToArr" visible="true">
                    <a href="Task_Closure_Inbox.aspx" class="aaaa">Back</a>
                </span>
                <span>
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li>
                         ...
                         <li class="mobile_InboxEmpName">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_Metting_Title" TextMode="MultiLine" CssClass="noresize" Rows="6" Enabled="false" runat="server" Visible="True"></asp:TextBox>
                        </li>
                       <hr />
                        <li class="mobile_inboxEmpCode">
                        ...
                        <li>
                            <span>Attendees</span>
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_Attendees" Enabled="false" CssClass="noresize" TextMode="MultiLine" Rows="4" runat="server" Visible="True"></asp:TextBox>
                        </li>    
                        <li></li>
                        <hr />
                        <li class="mobile_inboxEmpCode">
                        ...
                        <li></li>
                         <li>
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_TaskIntimation" Enabled="false" CssClass="noresize" TextMode="MultiLine" Rows="4" runat="server" Visible="True"></asp:TextBox>
                        </li>    
                        <li></li>
                       ...
                       <li class="mobile_InboxEmpName">
                        ...
                        <li>
                            ...
                            <br />
                            <asp:TextBox AutoComplete="off" ID="txt_Executor"  runat="server" Visible="false" Enabled="false"></asp:TextBox>
                            <asp:DropDownList runat="server" ID="ddl_Task_Executor" AppendDataBoundItems="false" AutoPostBack="false" OnSelectedIndexChanged="ddl_Task_Executor_SelectedIndexChanged">
                            </asp:DropDownList>
                        </li>
                        ...
                        <li style="width:30">
                            <br />
                            <span id="IsShowUploadFile" runat="server" visible="false">Uploaded File</span>  
                            <br />
                            <div>
                        ...
                        <li class="mobile_InboxEmpName">
                            ...
                            <asp:TextBox AutoComplete="off" ID="txt_Current_remark" MaxLength="500" runat="server"  CssClass="noresize" TextMode="MultiLine" Rows="4" Visible="True"></asp:TextBox>
                        </li>
                        <li style="margin-top: 10px; align-items: center; width: 100%; margin-left: 20%;">
                            <asp:LinkButton ID="lnk_Task_Create" Visible="true" runat="server" Text="Approve" ToolTip="Create" OnClientClick="return CreateTaskClick();" CssClass="Savebtnsve" OnClick="lnk_Task_Create_Click"></asp:LinkButton>
                            <asp:LinkButton ID="lnk_Task_Update" Visible="true" runat="server" Text="Re-Assign" ToolTip="Update" OnClientClick="return UpdateTaskClick();" CssClass="Savebtnsve" OnClick="lnk_Task_Update_Click"></asp:LinkButton>
                        </li>                       
                        <hr />                        
                        <li class="mobile_inboxEmpCode">
                        ...
                        <li style="width: 100%">
                         ...
                         <li class="mobile_inboxEmpCode" id="IsShowHistorydetails" runat="server" visible="false">
