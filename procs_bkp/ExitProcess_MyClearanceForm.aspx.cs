...
public partial class procs_ExitProcess_MyClearanceForm : System.Web.UI.Page
{
    ...
    private void getMyClearance()
    {
        try
        {
            // DataSet dsList = new DataSet();

            dtExitFrm = spm.GetMyClearance(strempcode);
    ...
    protected void lnkLeaveDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("ExitProcess_ClearanceApproveForm.aspx?resignationid=" + hdnReqid.Value + "&Type=MyView");
