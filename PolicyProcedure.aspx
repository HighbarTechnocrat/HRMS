    ...
    <div class="page-wrapper animated fadeInDown">
        <section class="markets">
            <div class="auto-container">
                <div class="col-sm-12">
                    <div class="userposts"><span>Policy & Procedure</span> 
                        <asp:HiddenField ID="HDEmpCode" runat="server" />
                    </div>

                    <div class="row" runat="server" id="Div1">
                        <div class="col-sm-3 team-box">
                            <%--<a href="http://localhost/hrms/hbtpolicies">--%>
				<a href="procs/Policies.aspx?Id=1">
                                <img src="Images/Gallery/Insidepages/Policies.jpg" class="img-responsive" /></a>
                                                        <p>&nbsp</p>
                        </div>
                        <div class="col-sm-3 team-box">
                            <%--<a href='<%=ReturnUrl("hccurlmain")%>/presentations'>--%>
				<a href="procs/Doc_UserManual.aspx?Id=2">
                                <img src="Images/Gallery/Insidepages/MANUALS.jpg" class="img-responsive" /></a>
                                                        <p>&nbsp</p>

                        </div>
                        <div class="col-sm-3 team-box">
                            <%--<a href='<%=ReturnUrl("hccurlmain")%>/marketing'>--%>
				<a href="procs/Doc_Marketing.aspx?Id=3">
                                <img src="Images/Gallery/Insidepages/MARKETING.jpg" class="img-responsive" /></a>
                            <p>&nbsp</p>
                        </div>
                       <div class="col-sm-3 team-box">
                            <%--<a href='<%=ReturnUrl("hccurlmain")%>/forms'>--%>
                           <a href="procs/Doc_Forms.aspx?Id=4">
				<%--<a >--%>
                                <img src="Images/Gallery/Insidepages/Forms.jpg" class="img-responsive" /></a>
                            <p>&nbsp</p>
                        </div>
                    </div>
                  ...
                  <div class="row" runat="server" id="Div2">
                        ...
                        <div class="col-sm-3 team-box">
                             <a href='<%=ReturnUrl("hccurlmain")%>/procs/App_Latter_Index.aspx'>
                                <img src="Images/Gallery/Insidepages/Appointment_Letter.jpg" class="img-responsive" /></a>
                            <p>&nbsp</p>
                        </div>
<%--  
                        <div class="col-sm-3 team-box">
                            <a href="http://localhost/hrms/cs.aspx">
                                <img src="Images/Gallery/Insidepages/CS_1.jpg" class="img-responsive" /></a>
                            <p>&nbsp</p>
                        </div>
                    ...
                    <div runat="server" id="DivMessage" visible="false">
                        <asp:Label ID="lblmsg" runat="server" Text="You are not entitled for Policy Procedure" ForeColor="#ff0000"></asp:Label>
                    </div>
