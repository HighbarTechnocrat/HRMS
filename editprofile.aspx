<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="editprofile.aspx.cs" Inherits="myaccount_editprofile" %>
<%--SAGAR COMMENTED BELOW LINE FOR REMOVING INNERHEADER CONTROL FROM INNER PAGES 14OCT2017--%>
...
<%--SAGAR added BELOW LINE FOR REMOVING INNERHEADER CONTROL FROM INNER PAGES 14OCT2017--%>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="myaccount" style="display: none;">
                        ...
                        <div class="myaccountlist">
                            <ul>
                                <li class="listselected"><a href="<%=ReturnUrl("sitepathmain") %>procs/editprofile" title="Edit Profile"><b>Edit Profile</b></a></li>
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Edit Profile"></asp:Label>
                    </span>
                </div>
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        <li>
                            <span><span>*&nbsp;</span>First Name</span><br />
                            <asp:TextBox ID="txtfirstname" runat="server" MaxLength="50"> </asp:TextBox>
                            <span class="texticon tooltip" title="Please provide your first name."><i class="fa fa-user"></i></span>
                            <br />
                        ...
                        <li>
                            <span><span>*&nbsp;</span>Last Name</span><br />
                        ...
                        <li>
                            <span><span>*&nbsp;</span>User Name</span><br />
                        ...
                        <li class="profile-edit">
                            <span><span>*&nbsp;</span>Department</span><br />
                        ...
                        <li class="profile-edit" id="divsubdept" runat="server" visible="false">
                          ...
                          <%--  wasim added below code 25 oct 17--%>
                            ...
                            <asp:UpdatePanel ID="upl_subdept" runat="server" Visible="false">
                             ...
                             <%--  wasim added below one line code 25 oct 17--%>
                        ...
                        <li class="profile-edit">
                             ...
                             <%--  wasim added below one code 25 oct 17--%>
                         ...
                         <li>
                            <span><span>*&nbsp;</span>Email Id</span><br />
                        ...
                        <li class="profile-edit">
                           ...
                           <%-- <span><span>*&nbsp;</span>Mobile No</span><br />--%>
                        ...
                        <li class="profile-edit3">
                            <%--<span>Alternate Mobile No</span><br />--%>
                        ...
                        <li class="profile-edit3">
                           <%-- <span>Personal Telephone No</span><br />--%>
                        ...
                        <li class="profile-edit3">
                          ...
                          <%--  <span>Office Telephone No</span><br />--%>
                        ...
                        <li class="profile-edit3">
                            ...
                            <%--<span>Office Extension No</span><br />--%>
                        ...
                        <li class="profile-edit2">
                            ...
                            <%--  wasim added below one line code 25 oct 17--%>
                            <%--<span><span></span>Permanent Address</span><br />--%>
                        ...
                        <li class="profile-edit2">
                            ...
                            <%--  wasim added below one line code 25 oct 17--%>
                            <%--<span><span></span>Temporary Address</span><br />--%>
                        ...
                        <li class="proviewbtn btndiv" style="float:left !important;">
                            ...
                            <div class="cancelbtndiv">
                                <asp:LinkButton ID="btncancel" runat="server" Text="Cancel" ToolTip="Cancel" CssClass="cancelbtncncl" OnClick="btnCancelChanges_Click"><i class="fa fa-undo" aria-hidden="true"></i>Cancel</asp:LinkButton>
                            </div>
                        </li>
