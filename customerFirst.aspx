        ...
        <div class="commonpages">
            <div class="wishlistpagediv">
                <div class="wishlistpage">
                    <div class="userposts">
                        <span>
                            <asp:Label ID="lblheading" runat="server" Text="CUSTOMERFIRST"></asp:Label>
                        </span>
                    </div>
                  <%--  <div class="leavegrid">
                        ...
                        <div class="editprofileform">
							...
							<table>
                                <tr style="padding-top:1px;padding-bottom:2px;">
                                    ...
                                    <td class="formtitle">
                                        <asp:LinkButton ID="lnk_mng_leaverequest" runat="server" PostBackUrl="~/procs/ViewSurveyReport.aspx">View Survey</asp:LinkButton>
                                    </td>    
