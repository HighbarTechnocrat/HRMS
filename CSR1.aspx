<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="CSR.aspx.cs" Inherits="GalleryHome" %>
    ...
    <div class="auto-container">
        <div class="col-sm-12">
           ...
           <div class="sec-title wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
              <br />
                  <h2>Policy & Procedure : Corporate Social Responsibility</h2>
            </div>
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/hivaids"><div style="border-color: transparent; padding: 133px 0px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/hiv.png" height="100px"> </div>
                       <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">HIV Aids</span> </h4>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/hivaids">
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/csrpolicy"> <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/csr.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">CSR Policy</span> </h4>                       
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/csrpolicy">
                            <div class="right-arrow">+</div>
                            <h2>CSR Policy</h2>
                        </a>
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/waterpolicy"><div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/waterPolicy.png" width="100px"> </div>
                         <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Water Policy</span> </h4>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/waterpolicy">
                            <div class="right-arrow">+</div>
                            <h2>Water Policy</h2>
                        </a>
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/sustainabilityreport">  <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Sustainability.png" width="100px"> </div>
                          <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Sustanability Report</span> </h4>                                          
                    </div>
                </div></a> 
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/sustainabilityreport">
                            <div class="right-arrow">+</div>
                            <h2>Sustanability Report</h2>
                        </a>
