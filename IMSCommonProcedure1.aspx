    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-sm-12">
             ...
             <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <div style="border-color: transparent; padding: 113px 0px 45px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <a href="http://localhost/hrms/mr">     <div class="cshero-fancybox-inner">
                         <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">MR</span> </h4>
                         </div></a>
                </div>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                       <a class="expand" href="http://localhost/hrms/mr">
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 45px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <a href="http://localhost/hrms/qaqc">  <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">QA QC</span> </h4>                                          
                    </div></a>
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                          <a class="expand" href="http://localhost/hrms/qaqc">
                            <div class="right-arrow">
                            <h2>QA QC</h2></div>
                        </a>                  
                    </li>
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 45px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                   <a href="http://localhost/hrms/ems">    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>                          
                          <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">EMS</span> </h4>                         
                         </div> </a>
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                         <a class="expand" href="http://localhost/hrms/ems">
                            <div class="right-arrow">
                            <h2>EMS</h2></div>
                        </a>
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
				<div style="border-color: transparent; padding: 113px 0px 45px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <a href="http://localhost/hrms/emsperformance">    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">EMS Performance</span> </h4>                                            
                    </div></a>
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                         <a class="expand" href="http://localhost/hrms/emsperformance">
                            <div class="right-arrow">
                            <h2>EMS Performance</h2></div>
                        </a>
            ...
            <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <div style="border-color: transparent; padding: 113px 0px 45px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                 <a href="http://localhost/hrms/ohsms">   <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>
                         <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">OH&SMS</span> </h4>                                             
                    </div></a>  
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                       <a class="expand" href="http://localhost/hrms/ohsms">
                            <div class="right-arrow">
                            <h2>OH&SMS</h2></div>
                        </a>
		    ...
		    <div class="PolicyProcedureIMS wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <div style="border-color: transparent; padding: 113px 20px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                <a href="http://localhost/hrms/ohsmsperformance">     <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="Images/Gallery/Document.png" width="100px"> </div>
                         <h4 class="cshero-fancybox-title-wrap" style="top: 10%;font-size: 16px !important;"> <span class="cshero-title-main">Ohsms performance</span> </h4>                                              
                    </div></a>
                </div>
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/ohsmsperformance">
                            <div class="right-arrow">
                            <h2>Ohsms performance</h2></div>
                        </a>
