...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Photo Gallery</span> </div>
        ...
        <div class="col-sm-12">
             <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 51px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
             ...
             <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand">
                            <div class="right-arrow"><h2>Power </h2></div>
                        </a>
                        <div class="detail">
                                  <a href="http://localhost/hrms/ps/6b0kgTGNAapd3n28TD_vig==">
                                    Hydro Power                                </a>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
             ...
             <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <div style="border-color: transparent; padding: 113px 0px 50px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand">
                            <div class="right-arrow">
                            <h2>Industrial & Buildings </h2></div>
                        </a>
                        <div class="detail">
                              <a href="http://localhost/hrms/ps/0JKuwKKfZXmayODjj6E9tQ==">
