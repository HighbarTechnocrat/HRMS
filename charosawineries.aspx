...
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="charosawineries.aspx.cs" Inherits="charosawineries" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="charosawineries.aspx.cs" Inherits="charosawineries" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="Label1" runat="server" Text="Charosa Wineries"></asp:Label><br/>
<%--                        <asp:Label ID="lblheading" runat="server" Text="charosawineries">
                        <p>Highbar Technologies is one of the most preferred IT solutions provider for the infrastructure industry. 
                         Highbar's portfolio of ERP solutions, line of business IT solutions and process consulting is aimed at increasing efficiencies for organizations.
                         Infrastructure domain knowledge backed by IT expertise and strategic alliances are the key differentiators which enable us to provide end-to-end, customized IT solutions to infrastructure organisations.
                        </p>
                        </asp:Label><br/>
                        <p><a href="images\profile\sample_pdf.pdf" title="sample_pdf">sample_pdf</a></p>--%>                                 
