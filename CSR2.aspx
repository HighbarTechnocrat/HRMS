       ...
       <div class="page-wrapper animated fadeInDown"> 
        ...
        <div class="col-sm-12">
            ...
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
				  ...
				  <div style="border-color: transparent; padding: 113px 0px 51px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
							<a href="http://localhost/hrms/hivaids">                        
            ...
            <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
				  ...
				  <div style="border-color: transparent; padding: 113px 0px 51px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
					  <a href="http://localhost/hrms/csrpolicy"> 
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
              ...
              <div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
				  ...
				  <div style="border-color: transparent; padding: 113px 0px 51px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
					  <a href="http://localhost/hrms/waterpolicy">
			...
			<div class="markets-box wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
				  ...
				  <div style="border-color: transparent; padding: 113px 0px 51px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                     <div class="cshero-fancybox-inner">
					 <a href="http://localhost/hrms/sustainabilityreport"> 
                ...
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/sustainabilityreport">
                            <div class="right-arrow">
                            <h2>Sustanability Report</h2></div>
                        </a>
