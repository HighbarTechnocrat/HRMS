...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
            ...
            <div class="userposts"><span>Communications</span> </div>

        <div class="page-wrapper animated fadeInDown"> 
        <section class="markets">
		<div class="auto-container">
        <div class="col-sm-12">
            <div class="markets-boxC wow fadeInUp hidden-xs"  data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href='<%=ReturnUrl("pressreleaseOnCommunication")%>'><div style="border-color: transparent; padding: 110px 45px 37px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/Press.png" height="100px"> </div>
                       <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main" style="white-space:nowrap;">Press Releases</span> </h4>
             ...
             <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand"  href='<%=ReturnUrl("pressreleaseOnCommunication")%>'>
             ...
             <div class="markets-boxC wow fadeInUp hidden-xs"  data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/ps/L7S11lAQzL9NKuo_x0byJg=="><div style="border-color: transparent; padding: 110px 60px 32px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/interview.png" width="100px"> </div>
                         <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Interviews</span> </h4>                    
             ...
             <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                         <a class="expand" href="http://localhost/hrms/ps/L7S11lAQzL9NKuo_x0byJg==">
                            <div class="right-arrow">
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                <a href="http://localhost/hrms/financialresults.aspx"><div style="border-color: transparent; padding: 110px 42px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/FinancialResults.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main" style="white-space:nowrap;">Financial Results</span> </h4>
            ...
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                         <a class="expand" href="http://localhost/hrms/financialresults.aspx">
                            <div class="right-arrow">
                            <h2>Financial Results</h2></div>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                  <a href="http://localhost/hrms/annualreports.aspx"> <div style="border-color: transparent; padding: 110px 45px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/AnnualReports.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main" style="white-space:nowrap;">Annual Reports</span> </h4>                                      
                    </div>
                </div></a>    
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
                <ul>
                    <li>
                        <a class="expand" href="http://localhost/hrms/annualreports.aspx">
                            <div class="right-arrow">
