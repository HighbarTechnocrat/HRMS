<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="projectlist2.aspx.cs" Inherits="projectlist2" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="projectlist2.aspx.cs" Inherits="projectlist2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style>
        ...
        .msgselect1 
        {
           background:url(http://localhost/hrms/themes/creative1.0/images/arrow.png) no-repeat; 
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="ProjectList"></asp:Label><br />
        ...
        <div class="projectmenu">
            <ul>
                <li><a href="#">Kolkata Elevated Corridor </a><i class="fa fa-plus" aria-hidden="true">
                </i></li>
                <li><a href="#">DMRC CC-30 </a><i class="fa fa-plus" aria-hidden="true"></i></li>
