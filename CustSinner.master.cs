...
public partial class inner : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            var AccessPages = new[] { "ExitProcess_Index.aspx", "ResignationForm.aspx", "MyResignations.aspx", "ExitProcess_SurveyForm.aspx", "ExitProccess_InterviewForm.aspx", "ExitProcClearanceForm.aspx", "ExitProcess_MyExitInterviewForm.aspx", "ExitProcess_ClearanceApproveForm.aspx", "MyExitSurveyForm.aspx", "ExitProcess_MyClearanceForm.aspx" };
            if (AccessPages.Contains(pageName))
            {
                form1.Action = HPath + pageName;
            }
            else
            {
