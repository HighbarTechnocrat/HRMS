<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Attend_Req_App.aspx.cs" Inherits="Attend_Req_App" %>
                ...
                <div class="edit-contact">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li class="leavedays">
                            ...
                            <asp:TextBox ID="txtLeaveDays" Enabled="false" runat="server" AutoPostBack="True" ></asp:TextBox>
                        </li>
...
<%--                        <li class="upload">
    ...
    <div>
        ...
        <span>
            <asp:LinkButton ID="btnCorrection" Visible="false" runat="server" Text="Correction" ToolTip="" CssClass="Savebtnsve" OnClick="btnCorrection_Click" OnClientClick="return SaveMultiClick_Correction();">Send for Correction</asp:LinkButton>
        </span>
    ...
    <asp:HiddenField ID="hdnempCode_Lofin" runat="server" />
