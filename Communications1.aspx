<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="Communications.aspx.cs" Inherits="GalleryHome" %>
    ...
    <div class="auto-container">
        <div class="col-sm-12">
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href='<%=ReturnUrl("pressreleaseOnCommunication")%>'><div style="border-color: transparent; padding: 133px 0px 30px; background: #9b9b9b; min-height: 300px; " class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                       ...
                       <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Press Releases</span> </h4>
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
               <a href="http://localhost/hrms/ps/L7S11lAQzL9NKuo_x0byJg=="> <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                 <a href="http://localhost/hrms/financialresults.aspx"><div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/FinancialResults.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Financial Results</span> </h4>
            ...
            <div class="markets-boxC wow fadeInUp hidden-xs" data-wow-delay="600ms" data-wow-duration="1000ms">
                  <a href="http://localhost/hrms/annualreports.aspx"> <div style="border-color: transparent; padding: 113px 0px 30px; background: #9b9b9b; min-height: 300px;" class="cshero-fancybox-wrap  clearfix fancybox-layout5 text-center">
                    <div class="cshero-fancybox-inner">
                        <div class="cshero-fancybox-image"> <img alt="" src="http://localhost/hrms/Images/Gallery/AnnualReports.png" width="100px"> </div>
                        <h4 class="cshero-fancybox-title-wrap"> <span class="cshero-title-main">Annual Reports</span> </h4>                                      
                    </div>
                </div></a>     
            </div>
            <div id="integration-list" class="hidden-sm hidden-md hidden-lg">
