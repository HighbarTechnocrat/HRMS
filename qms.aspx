<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qms.aspx.cs" Inherits="qms" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="qms.aspx.cs" Inherits="qms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="QMS"></asp:Label><br/> </span>
  ...
  <div class="half">
    <div class="tab blue">
      ...
      <label  for="tab-four">IS Dept Procedures</label>
      <div class="tab-content">
          <ul>
       <%-- <a href="#" title="IS Manual"></a>--%>
<%--<a href="http://localhost/hrms/files/pdf/hcc m 01 20 01 (r4).pdf" title="IS Manuale">IS Manual- hcc m 01 20 01 (r4)</a></p>--%>
            <li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc m 01 20 01 (r4).pdf" title="IS Manuale">IS Manual- hcc m 01 20 01 (r4) (r1)</a></li>
              <li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc p 001 20 018 (r2).pdf" title="Proc for Internet A">Proc for Internet A-hcc p 001 20 018 (r2)</a></li>
              </ul>
      </div>
        <div class="tab-content">
       <%-- <p><a href="#" title="Proc for Internet A"></a>--%>
<%--<a href="http://localhost/hrms/files/pdf/hcc p 001 20 018 (r2).pdf" title="Proc for Internet A">Proc for Internet A-hcc p 001 20 018 (r2)</a></p>--%>
      </div>
    </div>
    <div class="tab blue">
     <%--JAYESH_PRAJYOT COMMENTED BELOW RADIO BUTTON CODE 12oct2017--%>
     ...
     <%--JAYESH_PRAJYOT COMMENTED ABOVE RADIO BUTTON CODE 12oct2017--%>
      <label for="tab-five">TECHNOLOGY</label>
      <div class="tab-content">
<ul><li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc p 001 03 002 (r4).pdf" title="Innovation">Innovation-hcc p 001 03 002 (r4)</a></li>
<li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc f 001 03 002 (r1).xls" title="Innovation">Innovation-hcc f 001 03 002 (r1)</a></li>
<li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc f 001 03 003 (r1).xls" title="Innovation">Innovation-hcc f 001 03 003 (r1)</a></li></ul>
      </div>
    </div>
    <div class="tab blue">
   <%--JAYESH_PRAJYOT COMMENTED BELOW RADIO BUTTON CODE 12oct2017--%>
 ...
 <%--JAYESH_PRAJYOT COMMENTED ABOVE RADIO BUTTON CODE 12oct2017--%>
      <label for="tab-six">CORPORATE COMMUNICATION</label>
      <div class="tab-content">
          <ul>
      <%--  <p><a href="#" title="Corporate Communicate"></a>--%>
<%--<a href="http://localhost/hrms/files/pdf/hcc f 001 19 002 (r3).doc" title="Corporate Communicate">Corporate Communicate-hcc f 001 19 002 (r3)</a></p>--%>
          <li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc f 001 19 002 (r3).doc" title="Corporate Communicate">Corporate Communicate-hcc f 001 19 002 (r3)</a></li>
          <li class="ullink"><a href="http://localhost/hrms/files/pdf/hcc f 001 19 006 (r2).xls" title="Corporate Communicate">Corporate Communicate- hcc f 001 19 006 (r2)</a></li>
              <%--<p><a href="#" title="Corporate Communicate"></a>
<a href="http://localhost/hrms/files/pdf/hcc f 001 19 006 (r2).xls" title="Corporate Communicate">Corporate Communicate- hcc f 001 19 006 (r2)</a></p>--%>
              </ul>
      </div>
    </div>
  </div>
...
<%--  <div class="half">
    <div class="tab blue">
      ...
      <div class="tab-content">
        <p><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a><a href="#"> Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe,</a><a href="#"> itaque.</a></p>
      </div>
    </div>
    <div class="tab blue">
      <input id="tab-five" type="radio" name="tabs2">
      ...
      <div class="tab-content">
        <p><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a> <a href="#">Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum?</a><br/> <a href="#">Saepe, itaque.</a></p>
      </div>
    </div>
    <div class="tab blue">
      <input id="tab-six" type="radio" name="tabs2">
      ...
      <div class="tab-content">
        <p><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</a></p>
      </div>
    </div>
  </div>--%>
