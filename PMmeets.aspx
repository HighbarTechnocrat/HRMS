...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <link href="<%=ReturnUrl("css") %>profile/mprofile.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-sm-12">
           <div class="userposts">
				<span>Project Managers Conference</span> 
		   </div>		             
           <div class="row">
  			<div class="col-sm-3 team-box">
				 <a href="http://localhost/hrms/ps/K5SgGsTenJ_P2SkmqoParg=="><img src="Images/Gallery/Insidepages/Photographs_pm.jpg" class="img-responsive"/></a>
				 <p>&nbsp</p>      
            </div>
			   <div class="col-sm-3 team-box">
				 <a href="http://localhost/hrms/ps/35dRgnuPrkoYSLnhx5X5lg=="><img src="Images/Gallery/Insidepages/Videos_pm.jpg" class="img-responsive" /> </a>
			    <p>&nbsp</p>   
