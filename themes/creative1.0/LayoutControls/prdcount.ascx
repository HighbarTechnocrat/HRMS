<%@ Control Language="C#" AutoEventWireup="true" CodeFile="prdcount.ascx.cs" Inherits="Themes_SecondTheme_LayoutControls_prdcount"  ViewStateMode="Enabled" EnableViewState="true"%>
