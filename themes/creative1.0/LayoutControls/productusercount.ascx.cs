...
public partial class themes_creative1_LayoutControls_productusercount : System.Web.UI.UserControl
{
    ...
    protected void popularcontrol()
    {
        try
        {
         ...
         DataTable dthome = classrecommend.getuserproductonrecommend(username);
