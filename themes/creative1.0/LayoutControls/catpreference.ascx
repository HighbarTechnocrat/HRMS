<%@ Control Language="C#" AutoEventWireup="true" CodeFile="catpreference.ascx.cs" Inherits="Themes_SecondTheme_LayoutControls_catpreference" ViewStateMode="Enabled" EnableViewState="true" %>

<asp:Panel ID="pnlcats" runat="server">
    <asp:Repeater ID="rptcategname" runat="server">
        <ItemTemplate>
            <asp:Panel ID="pnlcatname" runat="server">
                ...
                <div class="list_carousel">
                    ...
                    <asp:Repeater ID="rptcatproduct" runat="server" OnItemDataBound="rptcategname_ItemDataBound" OnItemCommand="rptcatproduct_ItemCommand">
                        <ItemTemplate>
                                    ...
                                    <div class="view view-content">
                                        ...
                                        <div class="mask">
                                            ...
                                            <div class="ratingstar">
                                                <ajaxToolkit:Rating ID="ratingcat" runat="server" MaxRating="5"
