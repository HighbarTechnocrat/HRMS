<%@ Control Language="C#" AutoEventWireup="true" CodeFile="leaveCalender.ascx.cs" Inherits="themes_creative_LayoutControls_leaveCalender" %>
        ...
        <tr>
            <td valign="top" align="left"  >
                ...
                <asp:Calendar ID="Calendar1" runat="server" OnDayRender="Calendar1_DayRender" 
                    Font-Bold="False"  Width="250px"   DayNameFormat="Short" 
                    FirstDayOfWeek="Monday" TitleFormat="MonthYear" BorderColor="#2A2A2A" ForeColor="Black"
                    Font-Overline="false" Font-Size="14px" OnVisibleMonthChanged="Calendar1_VisibleMonthChanged" >
                    <TitleStyle BackColor="#2A2A2A" Font-Bold="True" Font-Size="14px"
...
<%--         <tr style="display:none">
         ...
         <tr>
            <td class="anlign">
                <asp:Image ID="imgAbsent" runat="server"
                    ImageUrl="~/images/Calendar/Absent.png" Height="13px" Width="25px" Style="margin-bottom: 0px" />
        ...
        <tr>
            <td class="anlign">
                <asp:Image ID="Image1" runat="server"
                    ImageUrl="~/images/Calendar/approveTravels.png" Height="13px" Width="25px" />
                 &nbsp;Approved Travels                     
