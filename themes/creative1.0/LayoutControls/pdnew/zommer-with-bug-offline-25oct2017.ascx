...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <%--JAYESH COMMENTED BELOW CODE TO HIDE like,dislike function 25oct2017--%>
<div class="sticky-right-panel">
  ...
  <ul>
   ...
   <%-- <li>
      <div id="popup" runat="server"><a id="popup_trigger" class="popup_trigger" href="#modal" title="Write Comment"><i class="fa fa-edit"></i></a></div>
        ...
        <!--
         //commented by sony to resolve build errors as on 16 Oct 2017        -->         
        <div id="popup" style="display:none;"  runat="server"></div>
  ...
  <%--JAYESH COMMENTED ABOVE CODE TO HIDE like,dislike function 25oct2017--%>
