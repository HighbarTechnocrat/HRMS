        ...
        <article class="readmore"><asp:Label ID="lbldescription" runat="server" Text=""></asp:Label>
            ...
            <div class="date-director fadeInDown" id="div3" runat="server" ><span class="producer-heading">
             ...
             <div id="multipledoc" runat="server" visible="false" >
              ...
              <%--Jayesh add below code to add view all button on pd page 20nov2017--%>
             <%--<asp:LinkButton ID="lnkview" style="background-color:grey" runat="server" CssClass="lnkview" Visible="true" PostBackUrl='<%#onclick_hlnkcategory("46","task") %>'>View All</asp:LinkButton>--%>
                 <%-- <a href="javascript:history.go(-1);" >View All</a>--%>
             <%--Jayesh add above code to add view all button on pd page 20nov2017--%>

             <%-- <asp:LinkButton ID="lnkview" style="background-color:grey" runat="server" CssClass="lnkview" Visible="true" PostBackUrl='<%#onclick_hlnkcategory(Eval("categoryid"),Eval("categoryname")) %>'>View All</asp:LinkButton>--%>
           <%-- <div class="date-director fadeInDown" id="div1" runat="server" > <span class="producer-heading">--%><%--<i class="fa fa-edit"></i>--%>
               <%-- SAGAR COMMENTED BELOW LINE FOR REMOVING POSTED BY AND NAME OF THE USER WHO POSTED THE POST 9OCT2017--%>
                ...
                <%--<asp:Label ID="lbluser" runat="server" CssClass="producer-name"></asp:Label> </a>--%>
            </div>
       <%--  <asp:Repeater ID="ln" runat="server">
                <ItemTemplate>
          
 <asp:LinkButton ID="l" style="background-color:grey" runat="server"  PostBackUrl='<%#onclick_hlnkcategory(Eval("categoryid"),Eval("categoryname")) %>'>View All</asp:LinkButton>
...
<div id="viewbtn">
<%--sagar added below code for view all button redirect to ps page without repeater control 13dec2017 --%>            
<asp:Button ID="viewps" runat="server" Text="View All" OnClick="viewall_Click"></asp:Button>
<%--sagar added above code for view all button redirect to ps page without repeater control 13dec2017 --%>  
    </div>




            <div class="producerdiv wow fadeInDown" id="divproducer" runat="server" visible="false"> <span class="producer-heading">Producer: </span><asp:Label ID="lblproducer" runat="server" CssClass="producer-name"></asp:Label> 
                <br />
            </div>
