...
(function ($) {
	...
	**
    ...
    $(".bp_is_active #user-thumb, #user-close").on("click", function () {
        $("#topseach_navuser, #user-sidebar").toggleClass("active");
    });
    /*---------------------------------------------------------
	** 
	...
	**
    ...
    $(window).load(function () {
        //$(".text-birth").mCustomScrollbar({ theme: "dark-thin" });
        $("#topseach_notificationsbody").mCustomScrollbar({ theme: "dark-thin" });
        $(".reminder-content-list").mCustomScrollbar({ theme: "dark-thin" });
        $("#topseach_pnlchat").mCustomScrollbar({ theme: "dark-thin" });
        $("#topseach_topheadpromo").mCustomScrollbar({ theme: "dark-thin" });
        $("#navigation").mCustomScrollbar({ theme: "dark-thin" });
        $("#topseach_pnkmsg").mCustomScrollbar({ theme: "dark-thin" });
	...
	**
    ...
    $("#user-sidebar nav ul li.menu-parent a, #user-sidebar #dropdown-user-menu li.menu-item-has-children a").on("click", function () {
        if ($(this).attr("class") == "dropdownOn")
        {
            $("#menu-bp li").removeClass("dropdownOn");
            $("#menu-bp li a").removeClass("dropdownOn");
            $("#menu-bp li a").parent("li").find('ul').hide();
        }
        else {
            $("#menu-bp li").removeClass("dropdownOn");
            $("#menu-bp li a").removeClass("dropdownOn");
