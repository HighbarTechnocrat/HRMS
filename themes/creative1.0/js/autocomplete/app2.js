$(function() {
    ...
    //var hdvalue = $("#MainContent_addhvalue").val();
    //var hdarray = $("#MainContent_addharray").val();
    $("#MainContent_addhvalue").val(data.split("\"").join(""));
    //$("#MainContent_addharray").val(JSON.stringify($element.tagsinput('items')));
    //if (hdvalue != "" && hdvalue != null)
    //{
    //    hdvalue = hdvalue + "," + data.split("\"").join("");
    //}
    //else
    //{
    //    hdvalue = data.split("\"").join("");
    //}
    //if (hdarray != "" && hdarray != null)
    //{
    //    hdarray = hdarray + ",";
    //}
    //else {
    //    hdarray = JSON.stringify($element.tagsinput('items'));
    //}
//$("#MainContent_addhvalue").val(hdvalue);
//$("#MainContent_addharray").val(JSON.stringify($element.tagsinput('items')));
  }).trigger('change');
    //<script>
