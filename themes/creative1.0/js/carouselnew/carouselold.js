! function(t, e, i, s) {
    ...
    p = {
        ...
        if (this.trigger("initialize"), this.$element.addClass(this.settings.baseClass).addClass(this.settings.themeClass).toggleClass("IM-rtl", this.settings.rtl), this.browserSupport(), this.settings.autoWidth && this.state.imagesLoaded !== !0) {
            var e, i, n;
        ...
        this.$element.addClass("IM-loading"), this.$stage = t("<" + this.settings.stageElement + ' class="IM-wrapper"/>').wrap('<div class="IM-wrapper-outer">'), this.$element.append(this.$stage.parent()), this.replace(this.$element.children().not(this.$stage.parent())), this._width = this.$element.width(), this.refresh(), this.$element.removeClass("IM-loading").addClass("IM-loaded"), this.eventsCall(), this.internalEvents(), this.addTriggerableEvents(), this.trigger("initialized")
        ...
        }).addClass("IM-responsive-" + s)) : n = t.extend({}, this.options), (null === this.settings || this._breakpoint !== s) && (this.trigger("change", {
            property: {
                name: "settings",
                value: n
            }
        ...
        this.$element.toggleClass("IM-center", this.settings.center), this.settings.loop && this._items.length < this.settings.items && (this.settings.loop = !1), this.settings.autoWidth && (this.settings.stagePadding = !1, this.settings.merge = !1)
        ...
        (new Date).getTime();
        this.trigger("refresh"), this.setup(), this.optionsLogic(), this.$stage.addClass("IM-refresh"), this.update(), this.$stage.removeClass("IM-refresh"), this.state.orientation = e.orientation, this.watchVisibility(), this.trigger("refreshed")
        ...
        if (this.state.isTouch) {
            if ("mouseup" === e.type && this.$stage.removeClass("IM-grab"), this.trigger("dragged"), this.drag.targetEl.removeAttribute("draggable"), this.state.isTouch = !1, this.state.isScrolling = !1, this.state.isSwiping = !1, 0 === this.drag.distance && this.state.inMotion !== !0) return this.state.inMotion = !1, !1;
        ...
        this.trigger("translating"), this.state.inMotion = this.speed() > 0, this.support3d ? this.$stage.css({
        ...
        t = this.normalize(t), t !== s && (this._speed = 0, this._current = t, this.suppress(["translating", "translated"]), this.animate(this.coordinates(t)), this.release(["translating", "translated"]))
        ...
        function s() {
            i(this.$element.get(0)) && (this.$element.removeClass("IM-hidden"), this.refresh(), e.clearInterval(this.e._checkVisibile))
        }
        i(this.$element.get(0)) || (this.$element.addClass("IM-hidden"), e.clearInterval(this.e._checkVisibile), this.e._checkVisibile = e.setInterval(t.proxy(s, this), 500))
    ...
    var s = function(e) {
        this._core = e, this._videos = {}, this._playing = null, this._fullscreen = !1, this._handlers = {
            ...
            "prepared.owl.carousel": t.proxy(function(e) {
                var i = t(e.content).find(".IM-video");
                i.length && (i.css("display", "none"), this.fetch(i, t(e.content)))
            }, this)
        }, this._core.options = t.extend({}, s.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".IM-video-play-icon", t.proxy(function(t) {
            this.play(t)
        }, this))
    };
    s.Defaults = {
        ...
        var s, n, o, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "",
            ...
            d = function(t) {
                n = '<div class="IM-video-play-icon"></div>', s = c.lazyLoad ? '<div class="IM-video-tn ' + l + '" ' + h + '="' + t + '"></div>' : '<div class="IM-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(s), e.after(n)
            };
        return e.wrap('<div class="IM-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (h = "data-src", l = "IM-lazy"), a.length ? (d(a.attr(h)), a.remove(), !1) : void("youtube" === i.type ? (o = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg", d(o)) : "vimeo" === i.type && t.ajax({
            type: "GET",
        ...
        this._core.trigger("stop", null, "video"), this._playing.find(".IM-video-frame").remove(), this._playing.removeClass("IM-video-playing"), this._playing = null
        ...
        "youtube" === r.type ? i = '<iframe width="' + a + '" height="' + h + '" src="http://www.youtube.com/embed/' + r.id + "?autoplay=1&v=" + r.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === r.type && (i = '<iframe src="http://player.vimeo.com/video/' + r.id + '?autoplay=1" width="' + a + '" height="' + h + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'), o.addClass("IM-video-playing"), this._playing = o, s = t('<div style="height:' + h + "px; width:" + a + 'px" class="IM-video-frame">' + i + "</div>"), n.after(s)
    }, s.prototype.isInFullScreen = function() {
        var s = i.fullscreenElement || i.mozFullScreenElement || i.webkitFullscreenElement;
        return s && t(s).parent().hasClass("IM-video-frame") && (this._core.speed(0), this._fullscreen = !0), s && this._fullscreen && this._playing ? !1 : this._fullscreen ? (this._fullscreen = !1, !1) : this._playing && this._core.state.orientation !== e.orientation ? (this._core.state.orientation = e.orientation, !1) : !0
...
function(t, e, i, s) {
    var n = function(e) {
        this.core = e, this.core.options = t.extend({}, n.Defaults, this.core.options), this.swapping = !0, this.previous = s, this.next = s, this.handlers = {
            ...
            "translating.owl.carousel": t.proxy(function() {
    ...
    n.Defaults = {
        ...
        if (1 === this.core.settings.items && this.core.support3d) {
            ...
            this.core.current() !== this.previous && (r && (e = this.core.coordinates(this.previous) - this.core.coordinates(this.next), s.css({
                left: e + "px"
            }).addClass("animated IM-animated-out").addClass(r).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", i)), o && n.addClass("animated IM-animated-in").addClass(o).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", i))
        }
    }, n.prototype.clear = function(e) {
        t(e.target).css({
            left: ""
        }).removeClass("animated IM-animated-out IM-animated-in").removeClass(this.core.settings.animateIn).removeClass(this.core.settings.animateOut), this.core.transitionEnd()
    }, n.prototype.destroy = function() {
        var t, e;
...
function(t) {
    ...
    e.Defaults = {
        ...
        navElement: "div",
        navContainer: !1,
        navContainerClass: "IM-nav",
        navClass: ["IM-prev", "IM-next"],
        slideBy: 2,
        dotClass: "IM-dot",
        dotsClass: "IM-dots",
        dots: !1,
