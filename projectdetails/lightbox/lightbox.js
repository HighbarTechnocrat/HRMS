...
function initLightbox()
{
	...
	imgPreloader.onload=function(){
		...
		//var objLoadingImage1 = document.getElementById("lblad");
		//objLoadingImage.src = loadingImage;
		//objLoadingImage.setAttribute('id', 'loadingImage');
		//objLoadingImage.style.position = 'absolute';
		//objLoadingImage.style.zIndex = '150';
    ...
    //sagar commented original below code for adding title name 20dec2017
    ...
    //sagar added below code for adding title name 20dec2017
	//var objKeyboardMsg = document.getElementById("lblad");
	//objKeyboardMsg.setAttribute('id', 'keyboardMsg');
	//objKeyboardMsg.innerHTML = 'press <kbd>x</kbd> to close';
	//objLightboxDetails.appendChild(objKeyboardMsg);
...
//    var x = document.getElementById('lblad').innerText;
//    alert(x);
//}
