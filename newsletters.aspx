       ...
       <%-- <div class="projectlistddl">
        ...
        <div class="financialresults">
            <ul>
                ...
                <li><a href="#" class="financialresultstitle">2017 </a><a href="#" class="financialresultsauthor">August </a><a href="files\Newsletter\HCC News August 2017- Kishanganga HEP.pdf" class="financialresultsyear">Kishanganga Hydro Power Project</a><%--<i class="fa fa-plus" aria-hidden="true"></i></li>--%>
                    <li><a href="#" class="financialresultstitle">2017 </a><a href="#" class="financialresultsauthor">May</a><a href="files\Newsletter\HCC News May 2017 - Harvesting Hydro Power.pdf" class="financialresultsyear">Harvesting Hydro Power</a><%--<i class="fa fa-plus" aria-hidden="true"></i></li>--%>
               <li><a href="#" class="financialresultstitle">2017 </a><a href="#" class="financialresultsauthor">February</a><a href="files\Newsletter\HCC News February 2017 -  Connecting the dots in Bridge Construction.pdf" class="financialresultsyear">Connecting the dots in Bridge Construction</a><%--<i class="fa fa-plus" aria-hidden="true"></i></li>--%>
