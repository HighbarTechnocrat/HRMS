<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="KeyPersonnel.aspx.cs" Inherits="GalleryHome" %>
...
<div class="page-wrapper animated fadeInDown">      
    <div class="auto-container">
              ...
              <div class="sec-title wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1000ms">
                 <br />
                   <h2 class="keyp">Key Personnel</h2>
            </div>
   <div class="row">
	 <div class="col-md-12">
		<div class="row">
			<div class="col-sm-3 team-box">
				 <img src="Images/Gallery/Ajit_Gulabchand.jpg" class="img-responsive"/><a>Ajit Gulabchand</a>
                 <p><a>Chairman & Managing Director</a></p>
                  <p align="left" style="text-align:justify">
                  <%--Ajit Gulabchand, Chairman and Managing Director of Hindustan Construction Company Ltd.,
                  has spearheaded the transformation of the company from a construction major into a 
                  diversified infrastructure group of global scale, developing and building responsible 
                  infrastructure through next practices. With a group turnover of over Rs. 8768 Cr 
                  (US $ 1.32 billion), HCC’s businesses span across Engineering & Construction, 
                  Real Estate, Infrastructure, Urban development & Management.--%>

                  </p>
            </div>
            <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/Shalaka.jpg" class="img-responsive">
				  <a href="#"> Shalaka Gulabchand  Dhawan</a>
				 <p><a>Whole-Time Director</a></p>
                 <p align="left" style="text-align:justify">
                 <%--Ms. Shalaka Gulabchand Dhawan has over 15 years of experience in the Construction Industry. 
                 At HCC, she started her career in 2000 as Executive (Planning and Business Development) and 
                 was elevated to the position of Vice President (Business Development) of the Company. She 
                 also serves as a Director on the Board of Hincon Holdings Ltd., Hincon Finance Ltd., 
                 Dhawan Management Pvt. Ltd., Champali Garden Pvt. Ltd., HCC Mauritius Investment Ltd., Highbar Technologies Ltd. --%>
                
                 </p>
			</div>
             <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/arjun.jpg" class="img-responsive">
				  <a href="#">Arjun Dhawan</a>
				 <p><a>Group CEO & Whole-time Director</a></p>
			</div>
            <%-- <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/Amit-Uplenchwar1.jpg" class="img-responsive">
				  <a href="#"> Amit Uplenchwar</a>
				<p><b>CEO - E & C Business</b></p>
			</div>--%>
        </div>
     </div>
     <%--<div class="col-md-12">
		<div class="row">
			<div class="col-sm-3 team-box">
				 <img src="Images/Gallery/Ajit_Gulabchand.jpg" class="img-responsive"/><a>Ajit Gulabchand</a>
                 <p><b>Chairman & Managing Director</b></p>
                
            </div>
            <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/Shalaka.jpg" class="img-responsive">
				  <a href="#"> Shalaka Gulabchand  Dhawan</a>
				 <p><b>Whole-Time Director</b></p>
			</div>
             <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/arjun.jpg" class="img-responsive">
				  <a href="#">Arjun Dhawan</a>
				 <p><b>Group CEO & Whole-time Director</b></p>
			</div>
             <div class="col-sm-3 team-box">
				  <img src="Images/Gallery/Amit-Uplenchwar1.jpg" class="img-responsive">
				  <a href="#"> Amit Uplenchwar</a>
    ...
    $(function () {
        $('#add_button').click(function (e, ele) {
            $('#letter_submit').ajaxSubmit({
                url: "https://www.hccnet.in/hccuser/",
                type: 'post',
                dataType: 'json',
                beforeSend: function () {
                    $('[id$=_error]').text('');
