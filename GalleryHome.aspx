...
<%@ Page Title="" Language="C#" MasterPageFile="~/cms.master" AutoEventWireup="true" CodeFile="GalleryHome.aspx.cs" Inherits="GalleryHome" %>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row" style="display: none">
                        <div class="col-sm-3 team-box">
                            <a href='<%=ReturnUrl("HydroPower") %>' class="leaverembursTranning">
                                <img src="Images/Gallery/Insidepages/Photos.jpg" class="img-responsive" />

                            </a>
                            <p>&nbsp</p>
                        </div>
                        <div class="col-sm-3 team-box">
                            <a href="https://ess.highbartech.com/hrms/ps/ylAI0oJu7HJ7MQqa9fgC8w==">
                                <img src="Images/Gallery/Insidepages/Videos.jpg" class="img-responsive"></a>
                            <p>&nbsp</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 team-box">
                        <a href="PhotoGalleryHome.aspx?gallaryid=2" target="_self">
                            <img src="images/Gallery/Insidepages/Go-Live.jpg" class="img-responsive" />
                        </a>
                        <p>&nbsp&nbsp&nbsp</p>
                    </div>

                        <div class="col-sm-3 team-box">
                            <a href="PhotoGalleryHome.aspx?gallaryid=3" target="_self">
                                <img src="images/Gallery/Insidepages/KickOff.jpg" class="img-responsive" />
                            </a>
                            <p>&nbsp&nbsp&nbsp</p>
                        </div>
                         
                        <div class="col-sm-3 team-box">
                            <a href="PhotoGalleryHome.aspx?gallaryid=4" target="_self">
                                <img src="images/Gallery/Insidepages/Celebratrion.jpg" class="img-responsive" />
                            </a>
                            <p>&nbsp&nbsp&nbsp</p>
                        </div>

                        <div class="col-sm-3 team-box">
                            <a href="PhotoGalleryHome.aspx?gallaryid=5" target="_self">
                                <img src="images/Gallery/Insidepages/BBP-Walkthrough.jpg" class="img-responsive" />
                            </a>
                            <p>&nbsp&nbsp&nbsp</p>
                        </div>
                        <div class="col-sm-3 team-box">
                            <a href="PhotoGalleryHome.aspx?gallaryid=6" target="_self">
                                <img src="images/Gallery/Insidepages/Clients-Testimonial.jpg" class="img-responsive" />
                            </a>
                            <p>&nbsp&nbsp&nbsp</p> 
                        </div>
                    </div>
