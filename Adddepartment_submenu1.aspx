<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adddepartment_submenu1.aspx.cs" Inherits="humanresource_policies" %>--%>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lavasa.aspx.cs" Inherits="lavasa" %>--%>
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Accordian.aspx.cs" Inherits="Accordian" %>--%>


<%@ Page Title="" Language="C#" MasterPageFile="~/inner.master" AutoEventWireup="true"
    CodeFile="Adddepartment_submenu1.aspx.cs" Inherits="Adddepartment_submenu1" %>
    ...
    <div class="commpagesdiv">
        <div class="commonpages">
            <div class="wishlistpagediv">
                ...
                <div class="userposts">
                    <span>
                        <asp:Label ID="lblheading" runat="server" Text="Human Resource Policies"></asp:Label><br/> </span>
...
<a href="#" title="Requisition Format For Car Hire">Requisition Format For Car Hire</a></p>--%>
    ...
    <div class="tab blue">
     ...
     <%--JAYESH_PRAJYOT COMMENTED ABOVE RADIO BUTTON CODE 12oct2017--%>
      ...
      <div class="tab-content">
<ul><li class="ullink"><a href="http://localhost/hrms/files/Public-Holiday-2017_final.pdf" title="Holiday List for the year 2017">Holiday List for the year 2017</a></li>
...
<li class="ullink"><a href="http://localhost/hrms/files/Public-Holiday-2017_final.pdf" title="Holiday List for the year 2015">Holiday List for the year 2015</a></li></ul>
      </div>
    </div>
    <div class="tab blue">
   <%--JAYESH_PRAJYOT COMMENTED BELOW RADIO BUTTON CODE 12oct2017--%>
