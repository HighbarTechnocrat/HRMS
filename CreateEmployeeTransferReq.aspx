...
<%--                        <div class="cancelbtndiv">
                    ...
                    <ul id="editform" runat="server" visible="false">
                        ...
                        <li><br /><br /><span>Employees to be Transferred:</span></li>
                        <li></li>
                         <li class="Approver">
                            <%--<span>Approver </span>--%>
                            <br />
                            <asp:ListBox Visible="false" ID="lstApprover" runat="server"></asp:ListBox>
                    <asp:GridView ID="DgvApprover" runat="server" BackColor="White" DataKeyNames="Id" BorderColor="Navy" PageSize="20" AllowPaging="True" OnPageIndexChanging="DgvApprover_PageIndexChanging" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" Width="140%">
    ...
    <script type="text/javascript">
     ...
     <%--   function ShowTime() {
        ...
        function SaveInClick() {
            try {
                var msg = "Do you want to add employee?";
                var retunboolean = true;
